#!/usr/bin/env python3
"""
Skill implementation for t5-small with hardware platform support
"""
...
class T5SmallSkill:
    """Skill for t5-small model with hardware platform support."""
    
    def __init__(self, model_id="t5-small", device=None):
...
def create_skill(model_id="t5-small", device=None):
    """Create a skill instance."""
            return T5SmallSkill(model_id=model_id, device=device)