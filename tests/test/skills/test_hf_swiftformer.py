...
try::
    ...
    """
    Class-based test file for all SWIFTFORMER-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        swiftformer_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "swiftformer-base": {}}}}}}}}}}}}}}}}}}
        "description": "SWIFTFORMER models",
        "class": "SwiftformerModel"
        }

        }

class TestSwiftformerModels:
    """Base test class for all SWIFTFORMER-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "swiftformer-base"
        
        # Verify model exists in registry:
        if self.model_id not in swiftformer_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = swiftformer_MODELS_REGISTRY["swiftformer-base"],
        else:
            self.model_info = swiftformer_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_swiftformer_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available SWIFTFORMER models in the registry:."""
    return list())))swiftformer_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered SWIFTFORMER models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestSwiftformerModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_swiftformer_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test SWIFTFORMER-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable SWIFTFORMER-family models:")
        for model in models:
            info = swiftformer_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nSWIFTFORMER Models Testing Summary:")
        total = len())))results)
