...
class TestCvtModels:
    ...
    def __init__(self, model_id=None):
        ...
        self.model_id = model_id or "google/cvt-base-patch16-224"
        ...
        if self.model_id not in CVT_MODELS_REGISTRY:
            ...
            self.model_info = CVT_MODELS_REGISTRY["google/cvt-base-patch16-224"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "google/cvt-base-patch16-224"
