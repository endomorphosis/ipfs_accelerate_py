...
UNISPEECH_MODELS_REGISTRY = {
    "unispeech-base": {
        "description": "unispeech base model",
        "class": "UnispeechForCTC",
    }
}

class TestUnispeechModels:
    """Test class for unispeech models."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test unispeech models")
    ...
    # Run test
    model_id = args.model or "unispeech-base"
