...
BLIP_2_MODELS_REGISTRY = {
    "blip_2-base": {
        "description": "blip_2 base model",
        "class": "Blip_2Model",
    }
}

class TestBlip2Models:
    """Test class for blip_2 models."""
    
    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "blip_2-base"
        
        # Use registry information
        if self.model_id not in BLIP_2_MODELS_REGISTRY:
            logger.warning(f"Model {self.model_id} not in registry, using default")
            self.model_info = BLIP_2_MODELS_REGISTRY["blip_2-base"]
        else:
            self.model_info = BLIP_2_MODELS_REGISTRY[self.model_id]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test blip_2 models")
    ...
    # Run test
    model_id = args.model or "blip_2-base"
