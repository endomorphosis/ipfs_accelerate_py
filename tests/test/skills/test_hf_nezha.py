...
try::
    ...
    """
    Class-based test file for all NEZHA-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        nezha_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "nezha-base": {}}}}}}}}}}}}}}}}}}
        "description": "NEZHA models",
        "class": "NezhaModel"
        }

        }

class TestNezhaModels:
    """Base test class for all NEZHA-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "nezha-base"
        
        # Verify model exists in registry:
        if self.model_id not in nezha_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = nezha_MODELS_REGISTRY["nezha-base"],
        else:
            self.model_info = nezha_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_nezha_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available NEZHA models in the registry:."""
    return list())))nezha_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered NEZHA models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestNezhaModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_nezha_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test NEZHA-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable NEZHA-family models:")
        for model in models:
            info = nezha_MODELS_REGISTRY[model],
