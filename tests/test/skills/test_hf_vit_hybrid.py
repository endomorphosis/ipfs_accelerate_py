...
class TestVit_HybridModels:
    """Base test class for all VIT_HYBRID-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "vit-hybrid-base"
        
        # Verify model exists in registry:
        if self.model_id not in vit_hybrid_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = vit_hybrid_MODELS_REGISTRY["vit-hybrid-base"],
        else:
            self.model_info = vit_hybrid_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_vit_hybrid_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    ...
    return list())))vit_hybrid_MODELS_REGISTRY.keys())))))
...
def test_all_models())))output_dir="collected_results", all_hardware=False):
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_vit_hybrid_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    if args.list_models:
        ...
        for model in models:
            info = vit_hybrid_MODELS_REGISTRY[model],
