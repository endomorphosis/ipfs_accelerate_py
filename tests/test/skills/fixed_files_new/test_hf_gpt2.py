...
try:
    ...
    """
Class-based test file for all gpt2-family models.
...
try:
    ...
    logger.warning("tokenizers not available, using mock")        if not HAS_TOKENIZERS:
    class MockTokenizer:
...
class TestGpt2Models:
    """Base test class for all gpt2-family models."""
 ...
 def test_pipeline(self,(self, device="auto"):
        ...
        # Check for dependencies        if not HAS_TRANSFORMERS:
        results["pipeline_error_type"] = "missing_dependency"
        results["pipeline_missing_core"] = ["transformers"]
        results["pipeline_success"] = False
        return results        if not HAS_TOKENIZERS:
        results["pipeline_error_type"] = "missing_dependency"
        ...
        return results    def test_from_pretrained(self,(self, device="auto"):
        ...
        return results    def run_tests(self,(self, all_hardware=False):
        """
...
def get_available_models():
    """Get a list of all available gpt2 models in the registry."""
    return list(GPT2_MODELS_REGISTRY.keys())

def test_all_models(output_dir="collected_results", all_hardware=False):
    """Test all registered gpt2 models."""
