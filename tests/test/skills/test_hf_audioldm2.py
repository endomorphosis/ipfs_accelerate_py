...
try::
    ...
    """
    Class-based test file for all AudioLDM2-family models.
This file provides a unified testing interface for:
    - AudioLdm2ForConditionalGeneration
    """
...
class TestAudioLdm2Models:
    """Base test class for all AudioLDM2-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "cvssp/audioldm2"
        
        # Verify model exists in registry:
        if self.model_id not in AUDIOLDM2_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = AUDIOLDM2_MODELS_REGISTRY[],"cvssp/audioldm2"],
        else:
        ...
        # Define model parameters
            ...
            ,
        # Define test inputs
            self.test_text = "A dog barking in the distance"
            self.test_texts = [],
            "A dog barking in the distance",
            "A dog barking in the distance ())))alternative)"
            ]
...
def test_from_pretrained())))self, device="auto"):
    ...
    try::
        ...
        **pretrained_kwargs
        ...
        model_class = None
        if self.class_name == "AudioLdm2ForConditionalGeneration":
            model_class = transformers.AudioLdm2ForConditionalGeneration
        else:
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_audioldm2_{}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available AudioLDM2 models in the registry:."""
    return list())))AUDIOLDM2_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered AudioLDM2 models."""
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_audioldm2_summary_{}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test AudioLDM2-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable AudioLDM2-family models:")
        for model in models:
            info = AUDIOLDM2_MODELS_REGISTRY[],model]
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nAudioLDM2 Models Testing Summary:")
        total = len())))results)
    ...
    # Test single model ())))default or specified)
        model_id = args.model or "cvssp/audioldm2"
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}model_id}")
