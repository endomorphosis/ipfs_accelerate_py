...
try::
    ...
    """
    Class-based test file for all SUPERPOINT-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        superpoint_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "superpoint-base": {}}}}}}}}}}}}}}}}}}
        "description": "SUPERPOINT models",
        "class": "SuperpointModel"
        }

        }

class TestSuperpointModels:
    """Base test class for all SUPERPOINT-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "superpoint-base"
        
        # Verify model exists in registry:
        if self.model_id not in superpoint_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = superpoint_MODELS_REGISTRY["superpoint-base"],
        else:
            self.model_info = superpoint_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_superpoint_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available SUPERPOINT models in the registry:."""
    return list())))superpoint_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered SUPERPOINT models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestSuperpointModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_superpoint_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test SUPERPOINT-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable SUPERPOINT-family models:")
        for model in models:
            info = superpoint_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nSUPERPOINT Models Testing Summary:")
        total = len())))results)
