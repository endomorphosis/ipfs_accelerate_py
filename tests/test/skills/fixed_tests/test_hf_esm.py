...
class TestHFEsm(unittest.TestCase):
    """Test for the HuggingFace esm model"""
    ...
    def test_model_loading(self):
        """Test loading esm model with proper hardware detection"""
        try:
    ...
    def test_model_with_mock(self, mock_tokenizer, mock_model):
        """Test esm model functionality with mocks"""
        # Setup mocks
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test esm model")
    parser.add_argument("--model", type=str, default="facebook/esm2_t6_8M_UR50D", help="Model ID to test")
