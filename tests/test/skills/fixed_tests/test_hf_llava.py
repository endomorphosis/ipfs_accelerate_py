...
LLAVA_MODELS_REGISTRY = {
    ...
    "llava-hf/llava-v1.6-vicuna-7b-hf": {
        "description": "LLaVA 1.6 7B vision-language model based on Vicuna",
        "class": "LlavaForConditionalGeneration",
        "type": "llava",
        "image_size": 336,
        "task": "image-to-text",
    ...
    "llava-hf/llava-v1.6-vicuna-13b-hf": {
        "description": "LLaVA 1.6 13B vision-language model based on Vicuna",
        "class": "LlavaForConditionalGeneration",
        "type": "llava",
        "image_size": 336,
        "task": "image-to-text",
    ...
    "llava-hf/llava-v1.6-mistral-7b-hf": {
        "description": "LLaVA 1.6 7B vision-language model based on Mistral",
        "class": "LlavaForConditionalGeneration",
        "type": "llava",
        "image_size": 336,
        "task": "image-to-text",
    ...
    "llava-hf/llava-v1.6-34b-hf": {
        "description": "LLaVA 1.6 34B vision-language model",
        "class": "LlavaForConditionalGeneration",
        "type": "llava",
        "image_size": 336,
        "task": "image-to-text",
...
class TestLlavaModels(ModelTest):
    """Test class for LLaVA vision-language models."""
    ...
    def setUp(self):
        ...
        self.variant = self.model_info.get("variant", "llava-1.5")
    ...
    def test_pipeline(self, device="auto"):
        ...
        try:
            ...
            # Note: LLaVA doesn't have a dedicated pipeline task in transformers yet,
            # so we use "image-to-text" which may not be optimal but closest
            ...
            for _ in range(num_runs):
                ...
                # The pipeline will handle the image loading and prompt combination
                output = pipeline(test_image, prompt=self.test_prompts[0], max_new_tokens=256)
                end_time = time.time()
            ...
            self.examples.append({
                ...
                "input": f"Image: {test_image}, Prompt: {self.test_prompts[0]}",
...
def main():
    ...
    if args.unittest or "unittest" in sys.argv:
        ...
        # Run test
        model_id = args.model or "llava-hf/llava-1.5-7b-hf"
        tester = TestLlavaModels()
        if args.model:
