...
class TestHFFlaubert(unittest.TestCase):
    """Test for the HuggingFace flaubert model"""
    ...
    def test_model_loading(self):
        """Test loading flaubert model with proper hardware detection"""
        try:
    ...
    def test_model_with_mock(self, mock_tokenizer, mock_model):
        """Test flaubert model functionality with mocks"""
        # Setup mocks
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="flaubert/flaubert_base_cased", help="Model ID to test")
