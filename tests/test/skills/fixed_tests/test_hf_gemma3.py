...
class TestHFGemma3(unittest.TestCase):
    """Test for the HuggingFace gemma3 model"""
    ...
    def test_model_loading(self):
        """Test loading gemma3 model with proper hardware detection"""
        try:
    ...
    def test_model_with_mock(self, mock_tokenizer, mock_model):
        """Test gemma3 model functionality with mocks"""
        # Setup mocks
        mock_tokenizer_instance = MagicMock()
        mock_tokenizer_instance.decode.return_value = "This is a mock response from gemma3"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test gemma3 model")
    parser.add_argument("--model", type=str, default="google/gemma-7b", help="Model ID to test")
