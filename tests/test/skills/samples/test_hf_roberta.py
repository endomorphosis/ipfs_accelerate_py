...
class TestRorobertaaModels:
    def __init__(self, model_id="roberta-base-uncased", device=None):
        """Initialize the test class for BERT models.
        
        Args:
            model_id: The model ID to test (default: "roberta-base-uncased")
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.RobertaForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.RobertaForMaskedLM.from_pretrained(self.model_id)
...
def save_results(results, model_id=None, output_dir="collected_results"):
    ...
    try:
        ...
        filename = f"hf_roberta_{model_id_safe}_{timestamp}.json"
...
def main():
    ...
    parser.add_argument("--model", type=str, default="roberta-base-uncased", help="Model ID to test")
    ...
    if args.list_models:
        ...
        for model_id, info in ROBERTA_MODELS_REGISTRY.items():
    ...
    roberta_tester = TestRorobertaaModels(model_id=args.model, device=args.device)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {roberta_tester.device}")
