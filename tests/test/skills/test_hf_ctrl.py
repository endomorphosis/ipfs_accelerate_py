...
try::
    ...
    """
    Class-based test file for all CTRL-family models.
...
class TestCtrlModels:
    ...
    def __init__())))self, model_id=None):
        ...
        self.model_id = model_id or "ctrl-base"
        
        # Verify model exists in registry:
        if self.model_id not in ctrl_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = ctrl_MODELS_REGISTRY["ctrl-base"],
        else:
