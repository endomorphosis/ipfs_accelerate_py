...
def test_generators_imports():
    ...
    print(f"\nGenerator imports: {success_count}/{total_count} successful ({success_count/total_count*100 if total_count > 0 else 0:.1f}%)")
...
def test_duckdb_api_imports():
    ...
    print(f"\nDuckDB API imports: {success_count}/{total_count} successful ({success_count/total_count*100 if total_count > 0 else 0:.1f}%)")
    return success_count, total_count
...
def test_class_instantiation():
    ...
    classes_to_test = [
        ...
        {
            "name": "generators.test_generators.fixed_merged_test_generator_clean.TestGenerator", 
            "args": [],
            "kwargs": {}
        }
    ]
