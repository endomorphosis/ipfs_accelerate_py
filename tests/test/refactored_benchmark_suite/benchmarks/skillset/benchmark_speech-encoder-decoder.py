...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark speech-encoder-decoder skillset implementation")
    ...
    benchmark_name = "speech-encoder-decoder_inference_benchmark" if args.type == "inference" else "speech-encoder-decoder_throughput_benchmark"
