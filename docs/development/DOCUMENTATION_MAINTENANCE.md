...
| Link integrity (maintained surfaces) | Fail on broken relative links in Current pages | `python scripts/docs/check_current_docs_links.py` (also run by `documentation-gates.yml`) |
