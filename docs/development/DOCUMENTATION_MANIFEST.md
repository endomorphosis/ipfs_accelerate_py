...
| [documentation lifecycle](DOCUMENTATION_LIFECYCLE.md) | Current | — | `documentation-governance` | documentation governance | `docs/INDEX.md`, `docs/README.md`, docs tree, `pyproject.toml` | `5f572b7391eccc5a1c3975e6c2f9fb4946e0d85e` (2026-08-03) | Supersedes informal ad-hoc treatment of plans and summaries as current contracts |
