...
#### 1. `ipfs_accelerate_py/codeql_cache.py`
...
**Usage:**
```python
from ipfs_accelerate_py.codeql_cache import CodeQLCache
...
#### 2. `ipfs_accelerate_py/credential_manager.py`
...
**Usage:**
```python
from ipfs_accelerate_py.credential_manager import CredentialManager, CredentialScope
...
#### 3. `ipfs_accelerate_py/cache.py` (Enhanced)
...
**Usage:**
```python
from ipfs_accelerate_py.cache import GitHubAPICache
...
```python
from ipfs_accelerate_py.cache import get_global_cache
from ipfs_accelerate_py.codeql_cache import get_global_codeql_cache
from ipfs_accelerate_py.credential_manager import get_global_credential_manager
