...
python scripts/generators/models/test_webnn_webgpu_integration.py --simulate

# Optional: Run with a real browser (requires browser installation)
python scripts/generators/models/test_webnn_webgpu_integration.py --platform webgpu --browser chrome --headless
```
...
python scripts/generators/models/test_webnn_webgpu_simplified.py --platform webgpu --mixed-precision --bits 4
```
