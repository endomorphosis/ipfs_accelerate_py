...
2. `libp2p` is installed (`pip install "libp2p @ git+https://github.com/libp2p/py-libp2p.git@main"`)
...
**Requirements**:
- `libp2p` must be installed: `pip install "libp2p @ git+https://github.com/libp2p/py-libp2p.git@main"`
...
if not stats['p2p_enabled']:
    print('Install libp2p: pip install "libp2p @ git+https://github.com/libp2p/py-libp2p.git@main"')
"
```
