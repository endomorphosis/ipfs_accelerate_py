...
```bash
python scripts/generators/models/test_webnn_webgpu_integration.py --install-drivers
```
...
python scripts/generators/models/test_webnn_webgpu_simplified.py --platform webgpu --bits 4 --browser chrome

# Test WebNN with 8-bit quantization on Edge
python scripts/generators/models/test_webnn_webgpu_simplified.py --platform webnn --bits 8 --browser edge

# Test both platforms with default settings
python scripts/generators/models/test_webnn_webgpu_simplified.py --platform both

# Test with mixed precision
python scripts/generators/models/test_webnn_webgpu_simplified.py --platform webgpu --mixed-precision
```
...
4. **WebDriver Issues**:
   - Update WebDriver: `python scripts/generators/models/test_webnn_webgpu_integration.py --install-drivers`
