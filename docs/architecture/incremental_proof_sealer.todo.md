...
- Reconciliation kind: main_checkout_dirty
- Reconciliation reason: main_checkout_dirty
- Reconciliation fingerprint: 791620a423cedea339c778286d9506a94a7da770
- Reconciliation discovery: /home/barberb/.local/state/ipfs_accelerate_py/incremental-proof-sealer-v1/repo/data/agent_supervisor/incremental_proof_sealer/state/discovery/2026-08-12-ips-062-reconciliation-791620a423ce.md
- Canonical board task: false
- Fingerprint: 791620a423cedea339c778286d9506a94a7da770
- Dedupe key: reconciliation_guardrail:main_checkout_dirty
- Depends on:
- Outputs: data/agent_supervisor/incremental_proof_sealer/state/discovery, docs/architecture/incremental_proof_sealer.todo.md
- Board namespace: incremental-proof-sealer-v1
...
- Parallel lane: accelerate
- Resource class: cpu-large
- Validation: test -f /home/barberb/.local/state/ipfs_accelerate_py/incremental-proof-sealer-v1/repo/data/agent_supervisor/incremental_proof_sealer/state/discovery/2026-08-12-ips-062-reconciliation-791620a423ce.md
- Acceptance: Reconciliation guardrail filed this because 2 branch or worktree cleanup candidates are blocked by main_checkout_dirty. Use evidence and the machine-readable reconciliation plan in /home/barberb/.local/state/ipfs_accelerate_py/incremental-proof-sealer-v1/repo/data/agent_supervisor/incremental_proof_sealer/state/discovery/2026-08-12-ips-062-reconciliation-791620a423ce.md, reconcile the dirty checkout or dirty worktree group deliberately, then rerun the supervisor cleanup/reconciliation pass and confirm that the blocked candidate count decreases.
