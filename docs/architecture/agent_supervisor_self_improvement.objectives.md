...
- Objective validation repair: ASI-043 remains G093's terminal accepted-work producer, while ASI-068 is the single current depth-2 validation-gate projection and reruns the shared efficiency/compiler/delta producer suite on the candidate tree. ASI-068 closes the literal criterion map and completion lifecycle without replacing typed producer evidence or manually mutating generated status fields. The recursively generated ASI-050/ASI-G129 item remains retired as an orphaned duplicate and must not be revived; G091, G092, and G093 separately own base-context survival, retry-delta reduction, and terminal accepted-work accounting.
- Refinement depth: 2
