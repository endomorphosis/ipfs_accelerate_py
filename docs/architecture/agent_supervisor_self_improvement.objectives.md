...
- Objective validation repair: ASI-044 is the single depth-2 executable projection of G096 and is already aligned in the master todo, analysis bundle shard, vector record `52887ef3a6297733`, and merge family `objective/ASI-G096`. G094, G095, and G096 separately own exact-reuse authority, optional-provider trust, and concurrent-miss coordination; no smaller child goal is necessary.
- Refinement depth: 2
