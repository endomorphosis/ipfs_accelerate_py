...
- Objective validation repair: ASI-043 is the single depth-2 executable projection of ASI-G093 and runs the shared efficiency/compiler/delta producer suite on the current tree. The recursively generated ASI-050/ASI-G129 item is already retired as an orphaned duplicate and must not be revived; G091, G092, and G093 now separately own base-context survival, retry-delta reduction, and terminal accepted-work accounting.
- Refinement depth: 2
