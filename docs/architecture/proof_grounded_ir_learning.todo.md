...
## PGIR-123 Resolve 1 dirty backlogged worktrees blocked by unsupported_status
...
- Priority: P1
- Track: ops
- Fingerprint: 39a438c2b82156fd21c6990b4178c4558801f263
- Dedupe key: reconciliation_guardrail:dirty_backlogged_worktree:unsupported_status
- Depends on:
- Outputs: docs/architecture/proof_grounded_ir_learning.todo.md
- Validation: test -f /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery/2026-08-18-pgir-123-reconciliation-39a438c2b821.md
- Acceptance: Reconciliation guardrail filed this because 1 branch or worktree cleanup candidates are blocked by unsupported_status. This task is intentionally operator-gated because unknown dirty checkout content must not be committed, stashed, or discarded automatically. Use evidence and the machine-readable reconciliation plan in /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery/2026-08-18-pgir-123-reconciliation-39a438c2b821.md, reconcile the dirty checkout or dirty worktree group deliberately, then rerun the supervisor cleanup/reconciliation pass and confirm that the blocked candidate count decreases.
...
- Priority: P2
- Track: ops
- Fingerprint: 4eb8c8ce8f4bff0c4f642448b00bf98c87633a89
- Dedupe key: reconciliation_guardrail:dirty_backlogged_worktree:submodule_gitlink_diverged
- Depends on:
- Outputs: docs/architecture/proof_grounded_ir_learning.todo.md
- Validation: test -f /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery/2026-08-18-pgir-124-reconciliation-4eb8c8ce8f4b.md
- Acceptance: Reconciliation guardrail filed this because 1 branch or worktree cleanup candidates are blocked by submodule_gitlink_diverged. This task is intentionally operator-gated because unknown dirty checkout content must not be committed, stashed, or discarded automatically. Use evidence and the machine-readable reconciliation plan in /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery/2026-08-18-pgir-124-reconciliation-4eb8c8ce8f4b.md, reconcile the dirty checkout or dirty worktree group deliberately, then rerun the supervisor cleanup/reconciliation pass and confirm that the blocked candidate count decreases.

## PGIR-125 Resolve 1 dirty backlogged worktrees blocked by unsupported_status
