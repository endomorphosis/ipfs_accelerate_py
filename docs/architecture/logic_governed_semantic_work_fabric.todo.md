...
- Write scope: owned paths plus ignored data/agent_supervisor/logic_governed_semantic_work_fabric/run-actual-v5 operational artifacts only
...
- Rollback or compensation procedure: Never overwrite a partial namespace; quarantine and preserve run-actual-v5 plus its receipt, advance to a fresh namespace, and keep LGSWF-006 unaccepted.
