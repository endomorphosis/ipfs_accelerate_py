...
- Write scope: owned paths plus ignored data/agent_supervisor/logic_governed_semantic_work_fabric/run-actual-v6 operational artifacts only
...
- Rollback or compensation procedure: Never overwrite a partial namespace; quarantine and preserve run-actual-v6 plus its receipt, advance to a fresh namespace, and keep LGSWF-006 unaccepted.
...
## LGSWF-142 Resolve dirty main checkout blocking 1 worktree merges
...
- Reconciliation fingerprint: e401f08594fdc05bed6e6e6b1e4a3c496adf4d7a
- Reconciliation discovery: /home/barberb/lift_coding/.worktrees/ipfs-accelerate-lgswf-actual-head/data/agent_supervisor/logic_governed_semantic_work_fabric/run-actual-v6/discovery/2026-08-16-lgswf-142-reconciliation-e401f08594fd.md
- Canonical board task: false
- Fingerprint: e401f08594fdc05bed6e6e6b1e4a3c496adf4d7a
- Dedupe key: reconciliation_guardrail:main_checkout_dirty
- Depends on:
- Outputs: data/agent_supervisor/logic_governed_semantic_work_fabric/run-actual-v6/discovery, docs/architecture/logic_governed_semantic_work_fabric.todo.md
- Validation: test -f /home/barberb/lift_coding/.worktrees/ipfs-accelerate-lgswf-actual-head/data/agent_supervisor/logic_governed_semantic_work_fabric/run-actual-v6/discovery/2026-08-16-lgswf-142-reconciliation-e401f08594fd.md
- Acceptance: Reconciliation guardrail filed this because 1 branch or worktree cleanup candidates are blocked by main_checkout_dirty. Use evidence and the machine-readable reconciliation plan in /home/barberb/lift_coding/.worktrees/ipfs-accelerate-lgswf-actual-head/data/agent_supervisor/logic_governed_semantic_work_fabric/run-actual-v6/discovery/2026-08-16-lgswf-142-reconciliation-e401f08594fd.md, reconcile the dirty checkout or dirty worktree group deliberately, then rerun the supervisor cleanup/reconciliation pass and confirm that the blocked candidate count decreases.
