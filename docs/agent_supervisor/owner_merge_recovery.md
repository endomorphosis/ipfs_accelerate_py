# Native owner-backed merge recovery
...
The five cursor stages are priority tasks, completed requests, pending requests,
quarantined requests and processing requests. Reads return the exact owner-held
