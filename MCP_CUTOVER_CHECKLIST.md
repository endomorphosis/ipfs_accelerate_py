...
- [x] CLI and direct-entry startup remain stable.
  - Evidence: `ipfs_accelerate_py/mcp/tests/test_mcp_cli.py`, subprocess/direct-entry coverage recorded in `MCP_SERVER_UNIFICATION_PLAN.md`
...
- [x] Conformance docs are synchronized with executable evidence.
  - Evidence: `mcpplusplus/CONFORMANCE_CHECKLIST.md`, `mcpplusplus/SPEC_GAP_MATRIX.md`, `MCP_SERVER_UNIFICATION_PLAN.md`
