...
def setup_docker_error_reporting():
    ...
    try:
        ...
        if reporter.enabled:
            ...
            print(
                "! Error reporting disabled (missing GITHUB_TOKEN or GITHUB_REPO environment variables)"
            )
            return False
        ...
        try:
            ...
            if error_reporting_available:
                ...
                reporter.report_error(
                    ...
                    context={"module": module_name, "arguments": sys.argv},
                )
            raise
    else:
        # Script mode
        ...
        try:
            ...
            if error_reporting_available:
                ...
                reporter.report_error(
                    exception=e,
                    source_component="docker-container",
                    context={"script": script_path, "arguments": sys.argv},
                )
            raise
