...
class ModelManagerDashboardTest:
    ...
    async def test_model_browser_tab(self, page: Page):
        ...
        try:
            ...
            await page.screenshot(
                path=self.screenshots_dir / "02_model_browser_tab.png", full_page=True
            )
    ...
    async def test_search_functionality(self, page: Page):
        ...
        try:
            ...
            # Take screenshot
            await page.screenshot(
                path=self.screenshots_dir / "05_search_results.png", full_page=True
            )
        ...
        try:
            ...
            if details_btn:
                ...
                if modal:
                    ...
                    # Take screenshot
                    await page.screenshot(
                        path=self.screenshots_dir / "07_model_details.png", full_page=True
                    )
