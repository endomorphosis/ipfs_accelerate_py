...
from refactored_model_conversion_generator.core.registry import (
...
class TestModelConverter(unittest.TestCase):
    ...
    def test_convert_basic(self):
        ...
        result = self.converter.convert(
            model_path=self.model_path, output_path=output_path, model_type="test"
        )
    ...
    def test_convert_default_output_path(self):
        ...
        result = self.converter.convert(model_path=self.model_path, model_type="test")

        self.assertTrue(result.success)

        # Default output path should be in the same directory with target format extension
        expected_path = os.path.join(self.temp_dir.name, "sample_model_target.target")
    ...
    def test_convert_missing_model(self):
        ...
        result = self.converter.convert(model_path=non_existent_path, model_type="test")
