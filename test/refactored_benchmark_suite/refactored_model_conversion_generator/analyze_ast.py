...
class ASTAnalyzer:
    ...
    def _calculate_complexity(self, tree: ast.Module) -> Dict[str, Any]:
        ...
        return {"cyclomatic_complexity": overall_complexity, "lines_of_code": unique_lines}
            ...
            for imp in imports:
                if imp["type"] == "importfrom":
                    ...
                    for candidate in dependency_report:
                        ...
                        if (
                            len(candidate_parts) >= len(module_parts)
                            and candidate_parts[-len(module_parts) :] == module_parts
                        ):
