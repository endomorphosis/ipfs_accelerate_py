...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark wav2vec2-conformer skillset implementation")
    ...
    benchmark_name = "wav2vec2-conformer_inference_benchmark" if args.type == "inference" else "wav2vec2-conformer_throughput_benchmark"
