#!/usr/bin/env python3
"""
Benchmark for the mobilevit skillset implementation.

This benchmark measures the performance of the mobilevit model implementation
...
@BenchmarkRegistry.register(
    name="mobilevit_inference_benchmark",
    category="inference",
    models=["mobilevit"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class MobilevitInferenceBenchmark(BenchmarkBase):
    """Benchmark for mobilevit inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up mobilevit inference benchmark")
        ...
        try:
            ...
            # Import the mobilevit skillset
            self.model_name = "mobilevit"
            self.model_type_safe = "mobilevit"
    ...
    def execute(self):
        ...
        self.logger.info("Executing mobilevit inference benchmark")
...
@BenchmarkRegistry.register(
    name="mobilevit_throughput_benchmark",
    category="throughput",
    models=["mobilevit"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class MobilevitThroughputBenchmark(MobilevitInferenceBenchmark):
    """Benchmark for mobilevit throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing mobilevit throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark mobilevit skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "mobilevit_inference_benchmark"
        if args.type == "inference"
        else "mobilevit_throughput_benchmark"
    )
