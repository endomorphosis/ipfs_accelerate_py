#!/usr/bin/env python3
"""
Benchmark for the vitdet skillset implementation.

This benchmark measures the performance of the vitdet model implementation
...
@BenchmarkRegistry.register(
    name="vitdet_inference_benchmark",
    category="inference",
    models=["vitdet"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class VitdetInferenceBenchmark(BenchmarkBase):
    """Benchmark for vitdet inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up vitdet inference benchmark")
        ...
        try:
            ...
            # Import the vitdet skillset
            self.model_name = "vitdet"
            self.model_type_safe = "vitdet"
    ...
    def execute(self):
        ...
        self.logger.info("Executing vitdet inference benchmark")
...
@BenchmarkRegistry.register(
    name="vitdet_throughput_benchmark",
    category="throughput",
    models=["vitdet"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class VitdetThroughputBenchmark(VitdetInferenceBenchmark):
    """Benchmark for vitdet throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing vitdet throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark vitdet skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "vitdet_inference_benchmark" if args.type == "inference" else "vitdet_throughput_benchmark"
    )
