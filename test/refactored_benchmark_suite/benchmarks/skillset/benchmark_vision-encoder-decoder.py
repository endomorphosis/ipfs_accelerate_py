#!/usr/bin/env python3
"""
Benchmark for the vision-encoder-decoder skillset implementation.

This benchmark measures the performance of the vision-encoder-decoder model implementation
...
@BenchmarkRegistry.register(
    name="vision-encoder-decoder_inference_benchmark",
    category="inference",
    models=["vision-encoder-decoder"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class VisionEncoderDecoderInferenceBenchmark(BenchmarkBase):
    """Benchmark for vision-encoder-decoder inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up vision-encoder-decoder inference benchmark")
        ...
        try:
            ...
            # Import the vision-encoder-decoder skillset
            self.model_name = "vision-encoder-decoder"
            self.model_type_safe = "vision_encoder_decoder"
    ...
    def execute(self):
        ...
        self.logger.info("Executing vision-encoder-decoder inference benchmark")
...
@BenchmarkRegistry.register(
    name="vision-encoder-decoder_throughput_benchmark",
    category="throughput",
    models=["vision-encoder-decoder"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class VisionEncoderDecoderThroughputBenchmark(VisionEncoderDecoderInferenceBenchmark):
    """Benchmark for vision-encoder-decoder throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing vision-encoder-decoder throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark vision-encoder-decoder skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "vision-encoder-decoder_inference_benchmark"
        if args.type == "inference"
        else "vision-encoder-decoder_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: vision-encoder-decoder")
