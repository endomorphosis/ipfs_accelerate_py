#!/usr/bin/env python3
"""
Benchmark for the detr skillset implementation.

This benchmark measures the performance of the detr model implementation
...
@BenchmarkRegistry.register(
    name="detr_inference_benchmark",
    category="inference",
    models=["detr"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class DetrInferenceBenchmark(BenchmarkBase):
    """Benchmark for detr inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up detr inference benchmark")
        ...
        try:
            ...
            # Import the detr skillset
            self.model_name = "detr"
            self.model_type_safe = "detr"
    ...
    def execute(self):
        ...
        self.logger.info("Executing detr inference benchmark")
...
@BenchmarkRegistry.register(
    name="detr_throughput_benchmark",
    category="throughput",
    models=["detr"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class DetrThroughputBenchmark(DetrInferenceBenchmark):
    """Benchmark for detr throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing detr throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark detr skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "detr_inference_benchmark" if args.type == "inference" else "detr_throughput_benchmark"
    )
