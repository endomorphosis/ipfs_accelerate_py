...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark efficientformer skillset implementation")
    ...
    benchmark_name = "efficientformer_inference_benchmark" if args.type == "inference" else "efficientformer_throughput_benchmark"
