#!/usr/bin/env python3
"""
Benchmark for the wav2vec2 skillset implementation.

This benchmark measures the performance of the wav2vec2 model implementation
...
@BenchmarkRegistry.register(
    name="wav2vec2_inference_benchmark",
    category="inference",
    models=["wav2vec2"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class Wav2Vec2InferenceBenchmark(BenchmarkBase):
    """Benchmark for wav2vec2 inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up wav2vec2 inference benchmark")
    ...
    def execute(self):
        ...
        self.logger.info("Executing wav2vec2 inference benchmark")
...
@BenchmarkRegistry.register(
    name="wav2vec2_throughput_benchmark",
    category="throughput",
    models=["wav2vec2"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class Wav2Vec2ThroughputBenchmark(Wav2Vec2InferenceBenchmark):
    """Benchmark for wav2vec2 throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing wav2vec2 throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark wav2vec2 skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "wav2vec2_inference_benchmark"
        if args.type == "inference"
        else "wav2vec2_throughput_benchmark"
    )
