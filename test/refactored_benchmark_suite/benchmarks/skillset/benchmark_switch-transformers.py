...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark switch-transformers skillset implementation")
    ...
    benchmark_name = "switch-transformers_inference_benchmark" if args.type == "inference" else "switch-transformers_throughput_benchmark"
