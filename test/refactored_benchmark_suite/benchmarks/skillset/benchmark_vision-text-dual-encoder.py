...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark vision-text-dual-encoder skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "vision-text-dual-encoder_inference_benchmark"
        if args.type == "inference"
        else "vision-text-dual-encoder_throughput_benchmark"
    )
