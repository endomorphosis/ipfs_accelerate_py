...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark decision-transformer skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "decision-transformer_inference_benchmark"
        if args.type == "inference"
        else "decision-transformer_throughput_benchmark"
    )
