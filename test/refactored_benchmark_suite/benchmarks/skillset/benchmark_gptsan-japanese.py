#!/usr/bin/env python3
"""
Benchmark for the gptsan-japanese skillset implementation.

This benchmark measures the performance of the gptsan-japanese model implementation
...
@BenchmarkRegistry.register(
    name="gptsan-japanese_inference_benchmark",
    category="inference",
    models=["gptsan-japanese"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class GptsanJapaneseInferenceBenchmark(BenchmarkBase):
    """Benchmark for gptsan-japanese inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up gptsan-japanese inference benchmark")
        ...
        try:
            ...
            # Import the gptsan-japanese skillset
            self.model_name = "gptsan-japanese"
            self.model_type_safe = "gptsan_japanese"
    ...
    def execute(self):
        ...
        self.logger.info("Executing gptsan-japanese inference benchmark")
...
@BenchmarkRegistry.register(
    name="gptsan-japanese_throughput_benchmark",
    category="throughput",
    models=["gptsan-japanese"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class GptsanJapaneseThroughputBenchmark(GptsanJapaneseInferenceBenchmark):
    """Benchmark for gptsan-japanese throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing gptsan-japanese throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark gptsan-japanese skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "gptsan-japanese_inference_benchmark"
        if args.type == "inference"
        else "gptsan-japanese_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: gptsan-japanese")
