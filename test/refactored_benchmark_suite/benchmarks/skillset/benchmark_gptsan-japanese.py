...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark gptsan-japanese skillset implementation")
    ...
    benchmark_name = "gptsan-japanese_inference_benchmark" if args.type == "inference" else "gptsan-japanese_throughput_benchmark"
