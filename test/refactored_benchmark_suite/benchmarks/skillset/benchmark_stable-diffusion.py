...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark stable-diffusion skillset implementation")
    ...
    benchmark_name = "stable-diffusion_inference_benchmark" if args.type == "inference" else "stable-diffusion_throughput_benchmark"
