#!/usr/bin/env python3
"""
Benchmark for the gpt2 skillset implementation.

This benchmark measures the performance of the gpt2 model implementation
...
@BenchmarkRegistry.register(
    name="gpt2_inference_benchmark",
    category="inference",
    models=["gpt2"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"]
)
class Gpt2InferenceBenchmark(BenchmarkBase):
    """Benchmark for gpt2 inference performance."""
    
    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up gpt2 inference benchmark")
    ...
    def execute(self):
        ...
        self.logger.info("Executing gpt2 inference benchmark")
...
@BenchmarkRegistry.register(
    name="gpt2_throughput_benchmark",
    category="throughput",
    models=["gpt2"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"]
)
class Gpt2ThroughputBenchmark(Gpt2InferenceBenchmark):
    """Benchmark for gpt2 throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing gpt2 throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark gpt2 skillset implementation")
    ...
    benchmark_name = "gpt2_inference_benchmark" if args.type == "inference" else "gpt2_throughput_benchmark"
