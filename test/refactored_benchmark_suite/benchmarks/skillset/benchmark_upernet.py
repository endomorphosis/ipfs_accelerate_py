#!/usr/bin/env python3
"""
Benchmark for the upernet skillset implementation.

This benchmark measures the performance of the upernet model implementation
...
@BenchmarkRegistry.register(
    name="upernet_inference_benchmark",
    category="inference",
    models=["upernet"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class UpernetInferenceBenchmark(BenchmarkBase):
    """Benchmark for upernet inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up upernet inference benchmark")
        ...
        try:
            ...
            # Import the upernet skillset
            self.model_name = "upernet"
            self.model_type_safe = "upernet"
    ...
    def execute(self):
        ...
        self.logger.info("Executing upernet inference benchmark")
...
@BenchmarkRegistry.register(
    name="upernet_throughput_benchmark",
    category="throughput",
    models=["upernet"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class UpernetThroughputBenchmark(UpernetInferenceBenchmark):
    """Benchmark for upernet throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing upernet throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark upernet skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "upernet_inference_benchmark"
        if args.type == "inference"
        else "upernet_throughput_benchmark"
    )
