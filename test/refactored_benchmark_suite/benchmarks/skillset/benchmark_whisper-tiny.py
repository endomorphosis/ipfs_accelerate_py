#!/usr/bin/env python3
"""
Benchmark for the whisper-tiny skillset implementation.

This benchmark measures the performance of the whisper-tiny model implementation
...
@BenchmarkRegistry.register(
    name="whisper-tiny_inference_benchmark",
    category="inference",
    models=["whisper-tiny"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class WhisperTinyInferenceBenchmark(BenchmarkBase):
    """Benchmark for whisper-tiny inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up whisper-tiny inference benchmark")
        ...
        try:
            ...
            # Import the whisper-tiny skillset
            self.model_name = "whisper-tiny"
            self.model_type_safe = "whisper_tiny"
    ...
    def execute(self):
        ...
        self.logger.info("Executing whisper-tiny inference benchmark")
...
@BenchmarkRegistry.register(
    name="whisper-tiny_throughput_benchmark",
    category="throughput",
    models=["whisper-tiny"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class WhisperTinyThroughputBenchmark(WhisperTinyInferenceBenchmark):
    """Benchmark for whisper-tiny throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing whisper-tiny throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark whisper-tiny skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "whisper-tiny_inference_benchmark"
        if args.type == "inference"
        else "whisper-tiny_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: whisper-tiny")
