#!/usr/bin/env python3
"""
Benchmark for the speech-encoder-decoder skillset implementation.

This benchmark measures the performance of the speech-encoder-decoder model implementation
...
@BenchmarkRegistry.register(
    name="speech-encoder-decoder_inference_benchmark",
    category="inference",
    models=["speech-encoder-decoder"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class SpeechEncoderDecoderInferenceBenchmark(BenchmarkBase):
    """Benchmark for speech-encoder-decoder inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up speech-encoder-decoder inference benchmark")
        ...
        try:
            ...
            # Import the speech-encoder-decoder skillset
            self.model_name = "speech-encoder-decoder"
            self.model_type_safe = "speech_encoder_decoder"
    ...
    def execute(self):
        ...
        self.logger.info("Executing speech-encoder-decoder inference benchmark")
...
@BenchmarkRegistry.register(
    name="speech-encoder-decoder_throughput_benchmark",
    category="throughput",
    models=["speech-encoder-decoder"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class SpeechEncoderDecoderThroughputBenchmark(SpeechEncoderDecoderInferenceBenchmark):
    """Benchmark for speech-encoder-decoder throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing speech-encoder-decoder throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark speech-encoder-decoder skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "speech-encoder-decoder_inference_benchmark"
        if args.type == "inference"
        else "speech-encoder-decoder_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: speech-encoder-decoder")
