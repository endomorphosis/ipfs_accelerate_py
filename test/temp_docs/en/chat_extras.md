...
model = AutoModelForCausalLM.from_pretrained(
    "NousResearch/Hermes-2-Pro-Llama-3-8B", torch_dtype=torch.bfloat16, device_map="auto"
)
```
...
model_input = tokenizer.apply_chat_template(messages, tools=[current_time, multiply])
```
...
model = AutoModelForCausalLM.from_pretrained(
    "CohereForAI/c4ai-command-r-v01-4bit", device_map="auto"
)
