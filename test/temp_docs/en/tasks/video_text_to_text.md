...
To learn more about chat templates and token streaming for video-text-to-text models, refer to the [image-text-to-text](./image_text_to_text.md) task guide because these models work similarly.