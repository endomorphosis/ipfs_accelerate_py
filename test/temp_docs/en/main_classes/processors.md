...
- the objects that pre-process inputs for multi-modal models such as [Wav2Vec2](../model_doc/wav2vec2.md) (speech and text)
  or [CLIP](../model_doc/clip.md) (text and vision)
