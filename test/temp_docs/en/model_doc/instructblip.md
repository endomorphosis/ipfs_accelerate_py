...
InstructBLIP leverages the [BLIP-2](https://huggingface.co/docs/transformers/model_doc/blip-2) architecture for visual instruction tuning.
...
InstructBLIP uses the same architecture as [BLIP-2](https://huggingface.co/docs/transformers/model_doc/blip-2) with a tiny but important difference: it also feeds the text prompt (instruction) to the Q-Former.
