...
FocalNets completely replace self-attention (used in models like [ViT](vit.md) and [Swin](swin.md)) by a focal modulation mechanism for modeling token interactions in vision.
