...
Sablayrolles, Hervé Jégou. The [Vision Transformer (ViT)](./vit.md) introduced in [Dosovitskiy et al., 2020](https://arxiv.org/abs/2010.11929) has shown that one can match or even outperform existing convolutional neural
