...
Use [`YolosImageProcessor`] for preparing images (and optional targets) for the model. Contrary to [DETR](detr.md), YOLOS doesn't require a `pixel_mask` to be created.
