...
- Mask2Former uses the same preprocessing and postprocessing steps as [MaskFormer](./maskformer.md). Use [`Mask2FormerImageProcessor`] or [`AutoImageProcessor`] to prepare images and optional targets for the model.
