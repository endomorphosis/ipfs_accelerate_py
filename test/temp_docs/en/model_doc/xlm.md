...
- XLM has multilingual checkpoints which leverage a specific `lang` parameter. Check out the [multilingual](https://huggingface.co/docs/transformers/en/multilingual) page for more information.
