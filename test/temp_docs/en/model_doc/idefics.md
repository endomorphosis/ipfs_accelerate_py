...
This model was contributed by [HuggingFaceM4](https://huggingface.co/HuggingFaceM4). The IDEFICS implementation is maintained in the [Transformers IDEFICS implementation](https://github.com/huggingface/transformers/tree/main/src/transformers/models/idefics).
