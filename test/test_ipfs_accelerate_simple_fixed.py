            ...
            try:
                ...
                has_methods = all(
                    [
                        ...
                        for method in ["docker_tunnel", "marketplace"]
                    ]
                )
        ...
        if hasattr(ipfs_accelerate_py, "ipfs_accelerate"):
            ...
            try:
                ...
                if hasattr(ipfs_instance, "load_checkpoint_and_dispatch"):
                    logger.info(
                        "✅ IPFS accelerate instance has load_checkpoint_and_dispatch method"
                    )
                    results["basic_functionality"]["ipfs_accelerate_init"] = "Success"
                else:
                    logger.warning(
                        "⚠️ IPFS accelerate instance missing load_checkpoint_and_dispatch"
                    )
