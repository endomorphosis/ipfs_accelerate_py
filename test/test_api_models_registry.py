...
def test_backend_registry_preserves_muse_spark_compatibility_spellings():
    backend_registry = APIModelsRegistry(registry=APIModelRegistry())
    ...
    for model_name in (
        ...
        assert backend_registry.get_backend_for_model(model_name) == "meta_ai"
