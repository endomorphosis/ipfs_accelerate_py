...
class TestCLIErrorHandler:
    ...
    def test_init(self):
        ...
        handler = CLIErrorHandler(
            repo="test/repo", enable_auto_issue=False, enable_auto_pr=False, enable_auto_heal=False
        )
    ...
    def test_init_with_custom_log_lines(self):
        ...
        handler = CLIErrorHandler(repo="test/repo", log_context_lines=100)
    ...
    def test_capture_error_with_context(self):
        ...
        custom_context = {"operation": "test_operation", "user": "test_user"}
    ...
    def test_get_error_aggregator_passes_repo_to_peer_registry(
        self, mock_peer_registry, mock_aggregator
    ):
    ...
    def test_create_issue_disabled(self, mock_get_gh):
        ...
        handler = CLIErrorHandler(repo="test/repo", enable_auto_issue=False)
    ...
    def test_create_issue_no_github_cli(self, mock_get_gh):
        ...
        handler = CLIErrorHandler(repo="test/repo", enable_auto_issue=True)
