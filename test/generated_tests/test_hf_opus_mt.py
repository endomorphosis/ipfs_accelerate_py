#!/usr/bin/env python3
"""
Test file for OPUS_MT models (encoder-only architecture).

This test verifies the functionality of the opus_mt model.
"""
...
class TestOpus_mtModel(EncoderOnlyModelTest):
    """Test class for opus_mt model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "opus_mt"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test opus_mt model")
    ...
    test = TestOpus_mtModel(args.model_id, args.device)
