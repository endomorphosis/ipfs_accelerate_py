#!/usr/bin/env python3
"""
Test file for XLNET models (encoder-only architecture).

This test verifies the functionality of the xlnet model.
"""
...
class TestXlnetModel(EncoderOnlyModelTest):
    """Test class for xlnet model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xlnet model")
    ...
    test = TestXlnetModel(args.model_id, args.device)
