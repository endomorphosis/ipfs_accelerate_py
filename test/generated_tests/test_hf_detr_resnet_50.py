...
class TestDetrresnet50Models(unittest.TestCase):
    """Test detr-resnet-50 model across hardware platforms."""
    
    def setUp(self):
        """Set up test."""
        self.model_id = "detr-resnet-50"
    ...
    def test_with_openvino(self):
        """Test detr-resnet-50 with openvino."""
        # Test initialization
        try:
            # Initialize tokenizer
            tokenizer = AutoTokenizer.from_pretrained(self.model_id)
    ...
    def test_with_webnn(self):
        """Test detr-resnet-50 with webnn."""
        # Test initialization
        try:
            # Initialize tokenizer
            tokenizer = AutoTokenizer.from_pretrained(self.model_id)
    ...
    def test_with_webgpu(self):
        """Test detr-resnet-50 with webgpu."""
        # Test initialization
        try:
            # Initialize tokenizer
            tokenizer = AutoTokenizer.from_pretrained(self.model_id)
