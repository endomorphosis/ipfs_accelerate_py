#!/usr/bin/env python3
"""
Test file for HUBERT models (encoder-only architecture).

This test verifies the functionality of the hubert model.
"""
...
class TestHubertModel(EncoderOnlyModelTest):
    """Test class for hubert model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test hubert model")
    ...
    test = TestHubertModel(args.model_id, args.device)
