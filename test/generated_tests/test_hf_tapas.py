#!/usr/bin/env python3
"""
Test file for TAPAS models (encoder-only architecture).

This test verifies the functionality of the tapas model.
"""
...
class TestTapasModel(EncoderOnlyModelTest):
    """Test class for tapas model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test tapas model")
    ...
    test = TestTapasModel(args.model_id, args.device)
