...
class TestQwen27BModels(unittest.TestCase):
    """Test qwen2-7b model across hardware platforms."""
    
    def setUp(self):
        """Set up test."""
        self.model_id = "qwen2-7b"
