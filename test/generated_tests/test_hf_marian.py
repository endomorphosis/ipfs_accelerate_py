#!/usr/bin/env python3
"""
Test file for MARIAN models (encoder-decoder architecture).

This test verifies the functionality of the marian model.
"""
...
class TestMarianModel(EncoderDecoderModelTest):
    """Test class for marian model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test marian model")
    ...
    test = TestMarianModel(args.model_id, args.device)
