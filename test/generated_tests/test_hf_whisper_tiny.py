...
class TestWhispertinyModels(unittest.TestCase):
    """Test whisper-tiny model across hardware platforms."""
    ...
    def test_with_openvino(self):
        """Test whisper-tiny with openvino."""
        # Test initialization
        try:
            # Initialize tokenizer
            tokenizer = AutoTokenizer.from_pretrained(self.model_id)
