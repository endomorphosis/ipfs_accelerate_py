#!/usr/bin/env python3
"""
Test file for BIGBIRD models (encoder-only architecture).

This test verifies the functionality of the bigbird model.
"""
...
class TestBigbirdModel(EncoderOnlyModelTest):
    """Test class for bigbird model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bigbird model")
    ...
    test = TestBigbirdModel(args.model_id, args.device)
