...
class TestLlamaModels:
    ...
    def __init__(self, model_id=None):
        ...
        self.model_id = model_id or "meta-llama/Llama-2-7b-hf"
        ...
        if self.model_id not in LLAMA_MODELS_REGISTRY:
            ...
            self.model_info = LLAMA_MODELS_REGISTRY["meta-llama/Llama-2-7b-hf"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "meta-llama/Llama-2-7b-hf"
