...
Usage:
    Replace {MODEL_NAME}, {MODEL_ID}, {TASK_TYPE} with actual values.
"""
...
# Model configuration
MODEL_ID = "{MODEL_ID}"  # e.g., "bert-base-uncased"
MODEL_NAME = "{MODEL_NAME}"  # e.g., "bert"
TASK_TYPE = "{TASK_TYPE}"  # e.g., "text_embedding"
