...
def skip_if_no_cuda(func):
    ...
    return pytest.mark.skipif(
        not hardware_info["platforms"]["cuda"]["available"], reason="CUDA not available"
    )(func)
...
def skip_if_no_rocm(func):
    ...
    hardware_info = detect_hardware()
    return pytest.mark.skipif(
        not hardware_info["platforms"]["rocm"]["available"], reason="ROCm not available"
    )(func)
...
def skip_if_no_mps(func):
    ...
    hardware_info = detect_hardware()
    return pytest.mark.skipif(
        not hardware_info["platforms"]["mps"]["available"], reason="MPS not available"
    )(func)
...
def skip_if_no_openvino(func):
    ...
    hardware_info = detect_hardware()
    return pytest.mark.skipif(
        not hardware_info["platforms"]["openvino"]["available"], reason="OpenVINO not available"
    )(func)
...
def skip_if_no_qnn(func):
    ...
    hardware_info = detect_hardware()
    return pytest.mark.skipif(
        not hardware_info["platforms"]["qnn"]["available"], reason="QNN not available"
    )(func)
...
def skip_if_no_webgpu(func):
    ...
    hardware_info = detect_hardware()
    return pytest.mark.skipif(
        not hardware_info["platforms"]["webgpu"]["available"], reason="WebGPU not available"
    )(func)
...
def skip_if_no_webnn(func):
    ...
    hardware_info = detect_hardware()
    return pytest.mark.skipif(
        not hardware_info["platforms"]["webnn"]["available"], reason="WebNN not available"
    )(func)
