...
try:
    ...
    logger.error(
        "Could not import simplified_fix_hyphenated.py. Make sure it exists in the current directory."
    )
    sys.exit(1)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Regenerate test files for models with hyphenated names"
    )
