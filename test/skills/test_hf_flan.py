...
if "text2text-generation" == "protein-folding":
    try:
...
if "text2text-generation" in ["table-question-answering", "time-series-prediction"]:
    try:
        import pandas as pd
...
try:
    from ipfs_accelerate_py.worker.skillset.hf_flan import hf_flan
except ImportError:
...
class test_hf_flan:
    ...
    def __init__(self, resources=None, metadata=None):
        ...
        self.model = hf_flan(resources=self.resources, metadata=self.metadata)
        
        # Use a small model for testing
        self.model_name = "t5-small"  # Small text-to-text model
    ...
    def get_test_input(self, platform="cpu", batch=False):
        ...
        if "text2text-generation" == "text-generation" and hasattr(self, 'test_text'):
            return self.test_text
        elif "text2text-generation" in ["image-classification", "image-segmentation", "depth-estimation"] and hasattr(self, 'test_image'):
            return self.test_image
        elif "text2text-generation" in ["image-to-text", "visual-question-answering"] and hasattr(self, 'test_vqa'):
            return self.test_vqa
        elif "text2text-generation" in ["automatic-speech-recognition", "audio-classification", "text-to-audio"] and hasattr(self, 'test_audio'):
            return self.test_audio
        elif "text2text-generation" == "protein-folding" and hasattr(self, 'test_sequence'):
            return self.test_sequence
        elif "text2text-generation" == "table-question-answering" and hasattr(self, 'test_table'):
            return self.test_table
        elif "text2text-generation" == "time-series-prediction" and hasattr(self, 'test_time_series'):
            return self.test_time_series
        elif "text2text-generation" == "document-question-answering" and hasattr(self, 'test_document'):
            return self.test_document
        elif "text2text-generation" == "question-answering" and hasattr(self, 'test_qa'):
            return self.test_qa
