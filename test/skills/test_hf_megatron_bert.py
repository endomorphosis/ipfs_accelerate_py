...
try::
    ...
    """
    Class-based test file for all MEGATRON-BERT-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        megatron_bert_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "megatron-bert-base": {}}}}}}}}}}}}}}}}}}
        "description": "MEGATRON-BERT models",
        "class": "Megatron-BertModel"
        }

        }

class TestMegatronBertModels:
    """Base test class for all MEGATRON-BERT-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "megatron-bert-base"
        
        # Verify model exists in registry:
        if self.model_id not in megatron_bert_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = megatron_bert_MODELS_REGISTRY["megatron-bert-base"],
        else:
            self.model_info = megatron_bert_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_megatron_bert_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available MEGATRON-BERT models in the registry:."""
    return list())))megatron_bert_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered MEGATRON-BERT models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestMegatronBertModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_megatron_bert_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test MEGATRON-BERT-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable MEGATRON-BERT-family models:")
        for model in models:
            info = megatron_bert_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nMEGATRON-BERT Models Testing Summary:")
        total = len())))results)
