...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate standardized test files for HuggingFace models"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="standardized_tests",
        help="Directory to store generated test files",
    )
    parser.add_argument(
        "--models",
        nargs="*",
        help="Specific models to generate tests for (default: all supported models)",
    )
