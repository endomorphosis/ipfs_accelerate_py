...
try::
    ...
    """
    Class-based test file for all ROC_BERT-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        roc_bert_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "roc-bert-base": {}}}}}}}}}}}}}}}}}}
        "description": "ROC_BERT models",
        "class": "RocBertModel"
        }

        }

class TestRoc_BertModels:
    """Base test class for all ROC_BERT-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "roc-bert-base"
        
        # Verify model exists in registry:
        if self.model_id not in roc_bert_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = roc_bert_MODELS_REGISTRY["roc-bert-base"],
        else:
            self.model_info = roc_bert_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_roc_bert_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available ROC_BERT models in the registry:."""
    return list())))roc_bert_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered ROC_BERT models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestRoc_BertModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_roc_bert_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test ROC_BERT-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable ROC_BERT-family models:")
        for model in models:
            info = roc_bert_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nROC_BERT Models Testing Summary:")
        total = len())))results)
