...
try:
    ...
    HAS_SENTENCEPIECE = False
        logger.warning("sentencepiece not available, using mock")        if not HAS_TOKENIZERS:
    class MockTokenizer:
...
def decode(self, ids, **kwargs):
    ...
    tokenizers.Tokenizer = MockTokenizer        if not HAS_SENTENCEPIECE:
...
class TestBertModels:
 ...
 def test_pipeline(self,(self,(self,(self, device="auto"):
        ...
        results["pipeline_success"] = False
        return results        if not HAS_SENTENCEPIECE:
        results["pipeline_error_type"] = "missing_dependency"
        ...
        return results    def test_from_pretrained(self,(self,(self,(self, device="auto"):
        ...
        return results    def run_tests(self,(self,(self,(self, all_hardware=False):
        """
