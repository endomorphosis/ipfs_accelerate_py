...
class TestBarkModels:
    ...
    def __init__(self, model_id="google-bert/bert-base-uncased", device=None):
        ...
        Args:
            model_id: The model ID to test (default: "bark-base")
...
def main():
    ...
    bark_tester = TestBarkModels(model_id=args.model, device=args.device)

    # Run the tests
    results = bark_tester.run_tests()
    ...
    if success:
        ...
        print(f"  - Device: {bark_tester.device}")
