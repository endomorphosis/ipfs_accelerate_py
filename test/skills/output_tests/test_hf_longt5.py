...
class TestLongt5Models:
    ...
    def __init__(self, model_id="google-bert/bert-base-uncased", device=None):
        ...
        Args:
            model_id: The model ID to test (default: "longt5-base")
...
def main():
    ...
    longt5_tester = TestLongt5Models(model_id=args.model, device=args.device)

    # Run the tests
    results = longt5_tester.run_tests()
    ...
    if success:
        ...
        print(f"  - Device: {longt5_tester.device}")
