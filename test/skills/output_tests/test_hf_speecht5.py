...
class TestSpeecht5Models:
    ...
    def __init__(self, model_id="google-bert/bert-base-uncased", device=None):
        ...
        Args:
            model_id: The model ID to test (default: "speecht5-base")
...
def main():
    ...
    speecht5_tester = TestSpeecht5Models(model_id=args.model, device=args.device)

    # Run the tests
    results = speecht5_tester.run_tests()
    ...
    if success:
        ...
        print(f"  - Device: {speecht5_tester.device}")
