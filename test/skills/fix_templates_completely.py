...
problematic_templates = [
    {"file": "vision_text_template.py", "model_display": "VISION TEXT"},
    {"file": "speech_template.py", "model_display": "SPEECH"},
    {"file": "multimodal_template.py", "model_display": "MULTIMODAL"},
]
