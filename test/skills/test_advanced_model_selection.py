...
SAMPLE_API_RESPONSE = [
    ...
    {"id": "bert-base-cased", "downloads": 3000000, "tags": ["pytorch", "bert"]},
    {
...
class TestAdvancedModelSelection(unittest.TestCase):
    ...
    def test_task_specific_model_selection(self, mock_hardware, mock_query, mock_load_registry):
        ...
        mock_query.assert_called_with(
            "bert", limit=10, task="text-classification", size_mb=15000, framework=None
        )
    ...
    def test_hardware_constraints(
        self, mock_query, mock_estimate_size, mock_get_hardware, mock_load_registry
    ):
