...
def check_required_classes(suite_path):
    ...
    classes = [
        (
            "refactored_benchmark_suite",
            ["ModelBenchmark", "BenchmarkSuite", "BenchmarkConfig", "BenchmarkResults"],
        ),
        (
            "refactored_benchmark_suite.metrics",
        ...
        (
            "refactored_benchmark_suite.models",
            ["ModelAdapter", "TextModelAdapter", "VisionModelAdapter"],
        ),
    ]
...
def check_feature_parity(suite_path):
    ...
    try:
        ...
        from refactored_benchmark_suite.config.benchmark_config import (
            create_benchmark_configs_from_file,
        )
...
def main():
    ...
    parser.add_argument(
        "--suite-path",
        type=str,
        default=os.path.join(SCRIPT_DIR, "refactored_benchmark_suite"),
