...
"""
Test file for XLMRoBERTa models.
This file tests the XLMRoBERTa model type from HuggingFace Transformers.
"""
...
# Registry for XLMRoBERTa models
XLM_ROBERTA_MODELS_REGISTRY = {
    "xlm-roberta-base": {
        "full_name": "XLMRoBERTa Base",
        "architecture": "encoder-only",
        "description": "XLMRoBERTa model for text generation",
...
class TestXLMRoBERTaModels:
    """
    Test class for XLMRoBERTa models.
    """
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            test_input = "XLMRoBERTa is a <mask> language model."
