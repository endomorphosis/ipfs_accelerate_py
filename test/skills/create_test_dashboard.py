...
# Status Icons
STATUS_ICONS = {"success": "✅", "failure": "❌", "mock": "🔷", "real": "🚀"}
...
def create_hardware_comparison_chart(df):
    ...
    hw_stats = (
        df_success.groupby("hardware")["inference_time"]
...
def create_test_success_chart(df):
    ...
    fig.update_layout(title="Test Success Rate and Inference Type", barmode="stack", height=500)
...
def create_performance_comparison_chart(hardware_df):
    ...
    perf_stats = (
        df_perf.groupby(["model_type", "hardware"])["inference_time"].median().reset_index()
    )
    ...
    fig = px.bar(
        ...
        labels={
            "inference_time": "Median Inference Time (s)",
...
def create_memory_usage_chart(hardware_df):
    ...
    fig = px.bar(
        ...
        labels={
            "memory_usage": "Median Memory Usage (MB)",
            "model_type": "Model Architecture",
            "hardware": "Hardware Platform",
        },
    )
...
def create_dashboard_data(
    ...
    dist_dir="distributed_results",
    hardware_db="hardware_compatibility_matrix.duckdb",
    days=30,
):
    """
    ...
    data = {
        ...
        "hardware_results": hardware_results.to_dict("records")
        if not hardware_results.empty
        else [],
        "hardware_detection": hardware_detection.to_dict("records")
        if not hardware_detection.empty
        else [],
...
def create_interactive_dashboard(
                                        ...
                                        [
                                            html.Div(
                                                [
                                                    ...
                                                    html.P(
                                                        f"{test_df['architecture'].nunique()} model architectures"
                                                    )
                                                    if not test_df.empty
                                                    else html.P("No data"),
                                                ],
                                            ...
                                            html.Div(
                                                [
                                                    ...
                                                    html.P(
                                                        f"{len(hardware_results)} hardware tests"
                                                    ),
                                                    html.P(
                                                        f"{hardware_results['hardware'].nunique()} hardware platforms"
                                                    )
                                                    if not hardware_results.empty
                                                    else html.P("No data"),
                                                ],
                                            ...
                                            html.Div(
                                                [
                                                    ...
                                                    html.P(
                                                        f"{len(dist_tests)} distributed test runs"
                                                    ),
                                            ...
                                            html.Div(
                                                [
                                                    ...
                                                    dcc.Graph(
                                                        ...
                                                        figure=create_model_coverage_chart(test_df)
                                                        if not test_df.empty
                                                        else {},
                                                    ),
                                                ],
                                            ...
                                            html.Div(
                                                [
                                                    ...
                                                    dcc.Graph(
                                                        ...
                                                        figure=create_test_success_chart(test_df)
                                                        if not test_df.empty
                                                        else {},
                                                    ),
                                                ],
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(
                                                ...
                                                figure=create_hardware_matrix_heatmap(
                                                    hardware_results
                                                )
                                                if not hardware_results.empty
                                                else {},
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(
                                                ...
                                                figure=create_performance_trend_chart(test_df)
                                                if not test_df.empty
                                                else {},
                                            ),
                                        ],
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(
                                                ...
                                                figure=create_hardware_comparison_chart(
                                                    hardware_results
                                                )
                                                if not hardware_results.empty
                                                else {},
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(
                                                ...
                                                figure=create_performance_comparison_chart(
                                                    hardware_results
                                                )
                                                if not hardware_results.empty
                                                else {},
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(
                                                ...
                                                figure=create_memory_usage_chart(hardware_results)
                                                if not hardware_results.empty
                                                else {},
                                            ),
                                        ],
    ...
    @app.callback(
        ...
        [State("architecture-filter", "value"), State("status-filter", "value")],
    )
        ...
        for _, row in latest_detection.iterrows():
            ...
            card = html.Div(
                [
                    ...
                    html.P(html.Span(dangerouslySetInnerHTML={"__html": features_str}))
                    if features_str
                    else None,
                ],
                className="stat-card",
    ...
    def update_distributed_data(_):
        ...
        if dist_workers.empty:
            ...
            worker_stats = (
                dist_workers.groupby("worker_id")
                .agg({"execution_time": ["mean", "median", "count"]})
                .reset_index()
            )
            ...
            worker_fig = px.bar(
                ...
                labels={
                    "median_time": "Median Execution Time (s)",
                    "worker_id": "Worker ID",
...
def create_static_dashboard(
    ...
    if not hardware_results.empty:
        ...
        if performance_comparison:
            performance_comparison.write_html(
                os.path.join(output_dir, "performance_comparison.html")
            )
...
def main():
    ...
    parser.add_argument(
        "--dist-dir",
        type=str,
        default="distributed_results",
        help="Directory containing distributed test results",
    )
    parser.add_argument(
        "--hardware-db",
        type=str,
        default="hardware_compatibility_matrix.duckdb",
    ...
    parser.add_argument(
        "--output-dir", type=str, default="dashboard", help="Output directory for static dashboard"
    )
    parser.add_argument(
        "--port", type=int, default=8050, help="Port for interactive dashboard server"
    )
    parser.add_argument(
        "--interactive", action="store_true", help="Launch interactive dashboard server"
    )
    parser.add_argument("--static", action="store_true", help="Generate static HTML dashboard")
    ...
    if args.static:
        ...
        create_static_dashboard(
            data, args.results_dir, args.dist_dir, args.hardware_db, args.output_dir
        )
    ...
    if args.interactive:
        ...
        create_interactive_dashboard(
            data, args.results_dir, args.dist_dir, args.hardware_db, args.port
        )
