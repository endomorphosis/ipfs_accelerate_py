...
try::
    ...
    """
    Class-based test file for all DINAT-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        dinat_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "dinat-base": {}}}}}}}}}}}}}}}}}}
        "description": "DINAT models",
        "class": "DinatModel"
        }

        }

class TestDinatModels:
    """Base test class for all DINAT-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "dinat-base"
        
        # Verify model exists in registry:
        if self.model_id not in dinat_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = dinat_MODELS_REGISTRY["dinat-base"],
        else:
            self.model_info = dinat_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_dinat_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available DINAT models in the registry:."""
    return list())))dinat_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered DINAT models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestDinatModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_dinat_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test DINAT-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable DINAT-family models:")
        for model in models:
            info = dinat_MODELS_REGISTRY[model],
