...
def replace_model_registry(file_path):
    ...
    clean_registry = {
        "bert": {
            ...
            "default_model": registry_data.get("bert", {}).get(
        ...
        "vit": {
            ...
            "default_model": registry_data.get("vit", {}).get(
        ...
        "gpt-j": {
            ...
            "default_model": registry_data.get("gpt-j", {}).get(
        ...
        "gpt-neo": {
            ...
            "default_model": registry_data.get("gpt-neo", {}).get(
        ...
        "xlm-roberta": {
            ...
            "default_model": registry_data.get("xlm-roberta", {}).get(
        ...
        "distilbert": {
            ...
            "default_model": registry_data.get("distilbert", {}).get(
        ...
        "electra": {
            ...
            "default_model": registry_data.get("electra", {}).get(
        ...
        "bart": {
            ...
            "default_model": registry_data.get("bart", {}).get(
        ...
        "mbart": {
            ...
            "default_model": registry_data.get("mbart", {}).get(
        ...
        "pegasus": {
            ...
            "default_model": registry_data.get("pegasus", {}).get(
        ...
        "clip": {
            ...
            "default_model": registry_data.get("clip", {}).get(
        ...
        "blip": {
            ...
            "default_model": registry_data.get("blip", {}).get(
        ...
        "llava": {
            ...
            "default_model": registry_data.get("llava", {}).get(
        ...
        "whisper": {
            ...
            "default_model": registry_data.get("whisper", {}).get(
        ...
        "wav2vec2": {
            ...
            "default_model": registry_data.get("wav2vec2", {}).get(
        ...
        "hubert": {
            ...
            "default_model": registry_data.get("hubert", {}).get(
        ...
        "llama": {
            ...
            "default_model": registry_data.get("llama", {}).get(
        ...
        "bloom": {
            ...
            "default_model": registry_data.get("bloom", {}).get(
