...
try::
    ...
    """
    Class-based test file for all VIVIT-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        vivit_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "vivit-base": {}}}}}}}}}}}}}}}}}}
        "description": "VIVIT models",
        "class": "VivitModel"
        }

        }

class TestVivitModels:
    """Base test class for all VIVIT-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "vivit-base"
        
        # Verify model exists in registry:
        if self.model_id not in vivit_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = vivit_MODELS_REGISTRY["vivit-base"],
        else:
            self.model_info = vivit_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_vivit_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available VIVIT models in the registry:."""
    return list())))vivit_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered VIVIT models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestVivitModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_vivit_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test VIVIT-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable VIVIT-family models:")
        for model in models:
            info = vivit_MODELS_REGISTRY[model],
