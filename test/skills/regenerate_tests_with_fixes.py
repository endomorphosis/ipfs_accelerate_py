...
def main():
    ...
    parser.add_argument("--single", type=str, help="Regenerate a single model type (e.g. 'bert')")
    ...
    regenerated, failed, total = run_regeneration(
        directory=args.directory, pattern=args.pattern, verify=args.verify, force=args.force
    )
