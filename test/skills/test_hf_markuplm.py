...
try::
    ...
    """
    Class-based test file for all MarkupLM-family models.
...
class TestMarkupLMModels:
    """Base test class for all MarkupLM-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "microsoft/markuplm-base"
        
        # Verify model exists in registry:
        if self.model_id not in MARKUPLM_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = MARKUPLM_MODELS_REGISTRY["microsoft/markuplm-base"],
        else:
            self.model_info = MARKUPLM_MODELS_REGISTRY[self.model_id]
            ,
...
def test_from_pretrained())))self, device="auto"):
    ...
    try::
        ...
        **pretrained_kwargs
        ...
        model_class = None
        if self.class_name == "MarkupLMModel":
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_markuplm_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available MarkupLM models in the registry:."""
    return list())))MARKUPLM_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered MarkupLM models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestMarkupLMModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_markuplm_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test MarkupLM-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable MarkupLM-family models:")
        for model in models:
            info = MARKUPLM_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nMarkupLM Models Testing Summary:")
        total = len())))results)
    ...
    # Test single model ())))default or specified)
        model_id = args.model or "microsoft/markuplm-base"
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
