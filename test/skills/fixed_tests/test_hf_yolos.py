...
class TestYolosModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.YolosForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.YolosForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    yolos_tester = TestYolosModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = yolos_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {yolos_tester.device}")
