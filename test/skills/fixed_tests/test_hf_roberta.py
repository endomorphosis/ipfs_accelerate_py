...
ROBERTA_MODELS_REGISTRY = {
    "roberta-base-uncased": {
        "full_name": "ROBERTA Base Uncased",
        "architecture": "encoder-only",
        "description": "ROBERTA Base model with uncased vocabulary",
        "roberta": "roberta",
        "parameters": "110M",
        "context_length": 512,
        "embedding_dim": 768,
    ...
    "roberta-large-uncased": {
        "full_name": "ROBERTA Large Uncased",
        "architecture": "encoder-only",
        "description": "ROBERTA Large model with uncased vocabulary",
        "roberta": "roberta",
        "parameters": "336M",
        "context_length": 512,
        "embedding_dim": 1024,
    ...
    "roberta-base-cased": {
        "full_name": "ROBERTA Base Cased",
        "architecture": "encoder-only",
        "description": "ROBERTA Base model with cased vocabulary",
        "roberta": "roberta",
        "parameters": "110M",
        "context_length": 512,
        "embedding_dim": 768,
...
class TestModelTypeModels:
    def __init__(self, model_id="roberta-base-uncased", device=None):
        """Initialize the test class for ROBERTA models.
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(f"Testing ROBERTA model {self.model_id} with pipeline API on {self.device}")
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            logger.info(
                f"Testing ROBERTA model {self.model_id} with from_pretrained API on {self.device}"
            )
    ...
    def test_openvino(self):
        ...
        try:
            ...
            logger.info(f"Testing ROBERTA model {self.model_id} with OpenVINO")
...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="roberta-base-uncased", help="Model ID to test"
    )
    ...
    parser.add_argument("--list-models", action="store_true", help="List available ROBERTA models")
    ...
    print(f"\nSuccessfully tested ROBERTA model: {args.model}")
