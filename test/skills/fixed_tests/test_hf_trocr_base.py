...
class TestTrocr_baseModels:
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(
                f"Testing TrocrBase model {self.model_id} with pipeline API on {self.device}"
            )
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            logger.info(
                f"Testing TrocrBase model {self.model_id} with from_pretrained API on {self.device}"
            )
...
def main():
    ...
    parser.add_argument(
        "--list-models", action="store_true", help="List available TrocrBase models"
    )
