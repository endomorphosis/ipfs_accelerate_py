...
class TestDistildistilbertModels:
    def __init__(self, model_id="distildistilbert-base-uncased", device=None):
        """Initialize the test class for BERT models.
        
        Args:
            model_id: The model ID to test (default: "distildistilbert-base-uncased")
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.DistilbertForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.DistilbertForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    parser.add_argument("--model", type=str, default="distildistilbert-base-uncased", help="Model ID to test")
    ...
    distilbert_tester = TestDistildistilbertModels(model_id=args.model, device=args.device)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {distilbert_tester.device}")
