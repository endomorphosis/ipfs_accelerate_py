...
class TestGitModels(ModelTest):
    ...
    def load_model(self, model_name):
        ...
        try:
            ...
            model_info = GIT_MODELS_REGISTRY.get(
                model_name, GIT_MODELS_REGISTRY["microsoft/git-base"]
            )
            ...
            model = transformers.GitForCausalLM.from_pretrained(model_name, torch_dtype=dtype)
    ...
    def verify_model_output(self, model, input_data, expected_output=None):
        ...
        try:
            ...
            # Generate output
            with torch.no_grad():
                outputs = git_model.generate(**inputs, max_new_tokens=20, do_sample=False)
            ...
            result = {"generated_text": generated_text, "inference_time": inference_time}
    ...
    def test_with_openvino(self):
        ...
        try:
            ...
            return {"success": False, "error": str(e), "device": "openvino"}
