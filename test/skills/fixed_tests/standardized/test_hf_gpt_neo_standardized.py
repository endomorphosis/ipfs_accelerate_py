...
class TestGPTNeo(ModelTest):
    ...
    def test_long_context(self):
        ...
        long_context = " ".join(
            ["The GPT-Neo model is designed to handle longer contexts efficiently."] * 10
        )
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            results["tests"]["long_context"] = {"status": "passed", "results": long_context_results}
        except Exception as e:
            logger.error(f"Long context test failed: {e}")
            results["tests"]["long_context"] = {"status": "failed", "error": str(e)}
