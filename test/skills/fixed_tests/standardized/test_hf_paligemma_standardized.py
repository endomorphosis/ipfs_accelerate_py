...
class TestPaligemmaModels(ModelTest):
        ...
        try:
            ...
            if self.class_name == "PaligemmaForConditionalGeneration":
                ...
                self.assertIsInstance(
                    result["generated_text"], str, "Generated text should be a string"
                )
                self.assertGreater(
                    len(result["generated_text"]), 0, "Generated text should not be empty"
                )
            else:
                ...
                self.assertGreater(
                    len(result["output_shape"]), 0, "Output shape should not be empty"
                )
    ...
    def test_with_openvino(self):
        ...
        try:
            ...
            self.performance_stats["openvino"] = {"inference_time": inference_time}
