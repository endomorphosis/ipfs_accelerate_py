...
class TestLlavaNextModels(ModelTest):
    ...
    def verify_model_output(self, model, input_data, expected_output=None):
        ...
        try:
            ...
            result = {"prompt": prompt, "generated_text": generated_text}
    ...
    def test_multi_image_processing(self):
        ...
        try:
            ...
            # Prepare test input
            test_input = {"image": test_images, "prompt": "Describe both images shown here."}
            ...
            for idx, img in enumerate(test_images):
                single_input = {"image": img, "prompt": f"Describe image {idx + 1}."}
                ...
                try:
                    ...
                    combined_results.append(
                        {"prompt": single_input["prompt"], "generated_text": f"Error: {str(e)}"}
                    )
            ...
            self.examples.append(
                {
                    ...
                    "output_preview": str(combined_results)[:200] + "..."
                    if len(str(combined_results)) > 200
                    else str(combined_results),
                }
            )
...
def main():
    ...
    if args.unittest or "unittest" in sys.argv:
        ...
        # Print summary
        success = any(
            r.get("multi_image_success", False) for r in [results["results"].get("multi_image", {})]
        )
