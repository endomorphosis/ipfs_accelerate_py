...
def main():
    ...
    if success:
        ...
        if pipeline_success and f"pipeline_{roberta_tester.preferred_device}" in results["performance"]:
        ...
        if pretrained_success and f"from_pretrained_{roberta_tester.preferred_device}" in results["performance"]:
