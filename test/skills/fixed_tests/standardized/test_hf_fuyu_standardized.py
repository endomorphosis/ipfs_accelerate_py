...
class TestFuyuModels(ModelTest):
    ...
    def load_model(self, model_name):
        ...
        try:
            ...
            model_info = FUYU_MODELS_REGISTRY.get(
                model_name, FUYU_MODELS_REGISTRY["adept/fuyu-tiny-test"]
            )
            ...
            model = transformers.FuyuForCausalLM.from_pretrained(
                model_name, torch_dtype=dtype, device_map=self.preferred_device
            )
    ...
    def verify_model_output(self, model, input_data, expected_output=None):
        ...
        try:
            ...
            # Generate answer
            with torch.no_grad():
                outputs = fuyu_model.generate(**inputs, max_new_tokens=100, do_sample=False)
    ...
    def test_multiple_prompts(self):
        ...
        try:
            ...
            logger.info(
                f"Testing Fuyu model {self.model_id} with multiple prompts on {self.preferred_device}"
            )
            ...
            for i, prompt in enumerate(self.test_prompts):
                single_input = {"image": test_image, "prompt": prompt}
                ...
                try:
                    ...
                    results[f"prompt_{i + 1}"] = {"prompt": prompt, "error": str(e)}
            ...
            self.examples.append(
                {
                    ...
                    "output_preview": str(results)[:200] + "..."
...
def main():
    ...
    if args.unittest or "unittest" in sys.argv:
        ...
        # Print summary
        success = any(
            r.get("success", False) for r in [results["results"].get("multiple_prompts", {})]
        )
