...
def main():
    ...
    if success:
        ...
        if pipeline_success and f"pipeline_{llama_tester.preferred_device}" in results["performance"]:
        ...
        if pretrained_success and f"from_pretrained_{llama_tester.preferred_device}" in results["performance"]:
