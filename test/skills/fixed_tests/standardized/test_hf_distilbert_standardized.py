...
def main():
    ...
    if success:
        ...
        if (
            pipeline_success
            and f"pipeline_{distilbert_tester.preferred_device}" in results["performance"]
        ):
        ...
        if (
            pretrained_success
            and f"from_pretrained_{distilbert_tester.preferred_device}" in results["performance"]
        ):
