...
class TestImagebindModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.ImagebindForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.ImagebindForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    imagebind_tester = TestImagebindModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = imagebind_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {imagebind_tester.device}")
