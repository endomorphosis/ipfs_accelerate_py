...
class TestFuyuModels:
    ...
    def test_direct_model_inference(self):
        ...
        try:
            ...
            logger.info(
                f"Testing Fuyu model {self.model_id} with direct model inference on {self.device}"
            )
    ...
    def test_multiple_prompts(self):
        ...
        try:
            ...
            logger.info(
                f"Testing Fuyu model {self.model_id} with multiple prompts on {self.device}"
            )
            ...
            for i, prompt in enumerate(test_prompts):
                ...
                # Store result
                results[f"prompt_{i + 1}"] = {"prompt": prompt, "response": response}
