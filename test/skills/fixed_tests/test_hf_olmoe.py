...
class TestHFOlmoE(unittest.TestCase):
    """Test for the HuggingFace olmoe model"""
    ...
    def test_model_loading(self):
        """Test loading olmoe model with proper hardware detection"""
        try:
    ...
    def test_model_with_mock(self, mock_tokenizer, mock_model):
        """Test olmoe model functionality with mocks"""
        # Setup mocks
        mock_tokenizer_instance = MagicMock()
        mock_tokenizer_instance.decode.return_value = "This is a mock response from olmoe"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test olmoe model")
    parser.add_argument("--model", type=str, default="allenai/OLMo-7B-Instruct", help="Model ID to test")
