...
class TestDetrModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.DetrForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.DetrForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    detr_tester = TestDetrModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = detr_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {detr_tester.device}")
