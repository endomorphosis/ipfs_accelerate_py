...
class TestQwen3Models:
    ...
    def test_direct_model_inference(self):
        ...
        try:
            ...
            logger.info(
                f"Testing Qwen3 model {self.model_id} with direct model API on {self.device}"
            )
    ...
    def test_multiple_prompts(self):
        ...
        try:
            ...
            logger.info(
                f"Testing Qwen3 model {self.model_id} with multiple prompts on {self.device}"
            )
    ...
    def test_openvino_inference(self):
        ...
        return {"success": False, "error": "OpenVINO support not yet implemented for Qwen3 models"}
