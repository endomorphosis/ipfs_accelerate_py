...
class TestVisionEncoderDecoderModels:
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(
                f"Testing VisionEncoderDecoder model {self.model_id} with pipeline API on {self.device}"
            )
...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="nlpconnect/vit-gpt2-image-captioning", help="Model ID to test"
    )
    ...
    vision_encoder_decoder_tester = TestVisionEncoderDecoderModels(
