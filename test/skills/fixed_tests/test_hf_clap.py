...
class TestClapModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.ClapForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.ClapForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    clap_tester = TestClapModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = clap_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {clap_tester.device}")
