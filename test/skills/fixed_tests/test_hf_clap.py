...
CLAP_MODELS_REGISTRY = {
    "clap-base-uncased": {
        "full_name": "CLAP Base Uncased",
        "architecture": "encoder-only",
        "description": "CLAP Base model with uncased vocabulary",
        "clap": "clap",
        "parameters": "110M",
        "context_length": 512,
        "embedding_dim": 768,
    ...
    "clap-large-uncased": {
        "full_name": "CLAP Large Uncased",
        "architecture": "encoder-only",
        "description": "CLAP Large model with uncased vocabulary",
        "clap": "clap",
        "parameters": "336M",
        "context_length": 512,
        "embedding_dim": 1024,
    ...
    "clap-base-cased": {
        "full_name": "CLAP Base Cased",
        "architecture": "encoder-only",
        "description": "CLAP Base model with cased vocabulary",
        "clap": "clap",
        "parameters": "110M",
        "context_length": 512,
        "embedding_dim": 768,
...
class TestModelTypeModels:
    def __init__(self, model_id="clap-base-uncased", device=None):
        """Initialize the test class for CLAP models.

        Args:
            model_id: The model ID to test (default: "clap-base-uncased")
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(f"Testing CLAP model {self.model_id} with pipeline API on {self.device}")
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            logger.info(
                f"Testing CLAP model {self.model_id} with from_pretrained API on {self.device}"
            )
    ...
    def test_openvino(self):
        ...
        try:
            ...
            logger.info(f"Testing CLAP model {self.model_id} with OpenVINO")
...
def save_results(results, model_id=None, output_dir="collected_results"):
    ...
    try:
        ...
        filename = f"hf_clap_{model_id_safe}_{timestamp}.json"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test CLAP HuggingFace models")
    parser.add_argument("--model", type=str, default="clap-base-uncased", help="Model ID to test")
    ...
    parser.add_argument("--list-models", action="store_true", help="List available CLAP models")
    ...
    if args.list_models:
        ...
        for model_id, info in CLAP_MODELS_REGISTRY.items():
    ...
    print(f"\nSuccessfully tested CLAP model: {args.model}")
