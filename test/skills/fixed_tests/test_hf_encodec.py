...
class TestEncodecModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.EncodecForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.EncodecForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    encodec_tester = TestEncodecModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = encodec_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {encodec_tester.device}")
