...
class TestProphetnetModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.ProphetnetForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.ProphetnetForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    prophetnet_tester = TestProphetnetModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = prophetnet_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {prophetnet_tester.device}")
