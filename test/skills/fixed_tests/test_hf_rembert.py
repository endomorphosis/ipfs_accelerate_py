...
class TestRemrembertModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.RembertForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.RembertForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    rembert_tester = TestRemrembertModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = rembert_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {rembert_tester.device}")
