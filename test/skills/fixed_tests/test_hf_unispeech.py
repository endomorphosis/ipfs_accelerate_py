...
class TestUnispeechModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.UnispeechForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.UnispeechForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    unispeech_tester = TestUnispeechModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = unispeech_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {unispeech_tester.device}")
