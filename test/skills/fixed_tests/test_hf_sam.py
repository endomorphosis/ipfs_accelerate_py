...
class TestSamModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.SamForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.SamForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    sam_tester = TestSamModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = sam_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {sam_tester.device}")
