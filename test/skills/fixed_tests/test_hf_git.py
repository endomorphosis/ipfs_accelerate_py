...
class TestGitModels:
    ...
    def __init__(self, model_id=None):
        ...
        self.model_id = model_id or "microsoft/git-base"
    ...
    def test_from_pretrained(self, device="auto"):
        ...
        try:
            ...
            model = transformers.GitModel.from_pretrained(self.model_id, **pretrained_kwargs)
...
def test_all_models(output_dir="collected_results", all_hardware=False):
    ...
    summary_path = os.path.join(
        output_dir, f"hf_git_summary_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
