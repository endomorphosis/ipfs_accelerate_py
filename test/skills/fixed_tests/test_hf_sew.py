...
class TestSewModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.SewForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.SewForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    sew_tester = TestSewModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = sew_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {sew_tester.device}")
