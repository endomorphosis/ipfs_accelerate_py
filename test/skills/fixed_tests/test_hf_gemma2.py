...
class TestHFGemma2(unittest.TestCase):
    """Test for the HuggingFace gemma2 model"""
    ...
    def test_model_loading(self):
        """Test loading gemma2 model with proper hardware detection"""
        try:
    ...
    def test_model_with_mock(self, mock_tokenizer, mock_model):
        """Test gemma2 model functionality with mocks"""
        # Setup mocks
        mock_tokenizer_instance = MagicMock()
        mock_tokenizer_instance.decode.return_value = "This is a mock response from gemma2"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test gemma2 model")
    parser.add_argument("--model", type=str, default="google/gemma-2b", help="Model ID to test")
