...
class TestMask2formerModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.Mask2formerForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.Mask2formerForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    mask2former_tester = TestMask2formerModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = mask2former_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {mask2former_tester.device}")
