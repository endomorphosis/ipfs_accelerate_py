...
"""
Test file for Kosmos2 models.
This file tests the Kosmos2 model type from HuggingFace Transformers.
"""
...
# Registry for Kosmos2 models
KOSMOS_2_MODELS_REGISTRY = {
    "microsoft/kosmos-2-patch14-224": {
        "full_name": "Kosmos2 Base",
        "architecture": "encoder-only",
        "description": "Kosmos2 model for text generation",
        "model_type": "kosmos-2",
        "parameters": "1.3B",
        "context_length": 2048,
        "embedding_dim": 768,
...
class TestKosmos2Models:
    """
    Test class for Kosmos2 models.
    """

    def __init__(self, model_id="microsoft/kosmos-2-patch14-224", device=None):
        """Initialize the test class for Kosmos2 models.
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(f"Testing Kosmos2 model {self.model_id} with pipeline API on {self.device}")
            ...
            test_input = "Kosmos2 is a <mask> language model."
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test Kosmos2 HuggingFace models")
    parser.add_argument(
        "--model", type=str, default="microsoft/kosmos-2-patch14-224", help="Model ID to test"
    )
    ...
    kosmos_2_tester = TestKosmos2Models(model_id=args.model, device=args.device)

    # Run the tests
    results = kosmos_2_tester.run_tests()
    ...
    if success:
        ...
        print(f"  - Device: {kosmos_2_tester.device}")
