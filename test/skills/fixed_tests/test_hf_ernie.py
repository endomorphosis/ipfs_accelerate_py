...
class TestErnieModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.ErnieForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.ErnieForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    ernie_tester = TestErnieModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = ernie_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {ernie_tester.device}")
