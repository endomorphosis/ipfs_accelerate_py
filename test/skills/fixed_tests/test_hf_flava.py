...
class TestFlavaModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.FlavaForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.FlavaForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    flava_tester = TestFlavaModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = flava_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {flava_tester.device}")
