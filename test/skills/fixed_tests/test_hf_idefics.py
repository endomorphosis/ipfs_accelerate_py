...
class TestIdeficsModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.IdeficsForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.IdeficsForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    idefics_tester = TestIdeficsModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = idefics_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {idefics_tester.device}")
