...
class TestModelTypeModels:
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(
                f"Testing LONGFORMER model {self.model_id} with pipeline API on {self.device}"
            )
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            logger.info(
                f"Testing LONGFORMER model {self.model_id} with from_pretrained API on {self.device}"
            )
...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="longformer-base-uncased", help="Model ID to test"
    )
    ...
    parser.add_argument(
        "--list-models", action="store_true", help="List available LONGFORMER models"
    )
