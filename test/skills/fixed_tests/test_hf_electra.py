...
class TestElectraModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.ElectraForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.ElectraForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    electra_tester = TestElectraModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = electra_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {electra_tester.device}")
