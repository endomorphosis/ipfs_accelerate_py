...
class TestModelTypeModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            logger.info(f"Testing ELECTRA model {self.model_id} with from_pretrained API on {self.device}")
...
def main():
    ...
    parser.add_argument("--model", type=str, default="electra-base-uncased", help="Model ID to test")
