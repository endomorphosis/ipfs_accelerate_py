...
class TestQwen2Models:
    ...
    def test_direct_model_inference(self):
        ...
        try:
            ...
            logger.info(f"Testing Qwen2 model {self.model_id} with direct model API on {self.device}")
    ...
    def test_multiple_prompts(self):
        ...
        try:
            ...
            logger.info(f"Testing Qwen2 model {self.model_id} with multiple prompts on {self.device}")
