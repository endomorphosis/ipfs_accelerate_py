...
class TestGemmaModels:
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            model = transformers.GemmaForMaskedLM.from_pretrained(self.model_id)
    ...
    def test_openvino(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                ...
                pt_model = transformers.GemmaForMaskedLM.from_pretrained(self.model_id)
...
def main():
    ...
    gemma_tester = TestGemmaModels(model_id=args.model, device=args.device)
    
    # Run the tests
    results = gemma_tester.run_tests(all_hardware=args.all_hardware)
    ...
    print(f"\nModel: {args.model}")
    print(f"Device: {gemma_tester.device}")
