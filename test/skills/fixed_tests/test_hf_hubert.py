...
HUBERT_MODELS_REGISTRY = {
    "hubert-base-uncased": {
        "full_name": "HUBERT Base Uncased",
        "architecture": "encoder-only",
        "description": "HUBERT Base model with uncased vocabulary",
        "hubert": "hubert",
        "parameters": "110M",
        "context_length": 512,
        "embedding_dim": 768,
    ...
    "hubert-large-uncased": {
        "full_name": "HUBERT Large Uncased",
        "architecture": "encoder-only",
        "description": "HUBERT Large model with uncased vocabulary",
        "hubert": "hubert",
        "parameters": "336M",
        "context_length": 512,
        "embedding_dim": 1024,
    ...
    "hubert-base-cased": {
        "full_name": "HUBERT Base Cased",
        "architecture": "encoder-only",
        "description": "HUBERT Base model with cased vocabulary",
        "hubert": "hubert",
        "parameters": "110M",
        "context_length": 512,
        "embedding_dim": 768,
...
class TestModelTypeModels:
    def __init__(self, model_id="hubert-base-uncased", device=None):
        """Initialize the test class for HUBERT models.

        Args:
            model_id: The model ID to test (default: "hubert-base-uncased")
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(f"Testing HUBERT model {self.model_id} with pipeline API on {self.device}")
    ...
    def test_from_pretrained(self):
        ...
        try:
            ...
            logger.info(
                f"Testing HUBERT model {self.model_id} with from_pretrained API on {self.device}"
            )
    ...
    def test_openvino(self):
        ...
        try:
            ...
            logger.info(f"Testing HUBERT model {self.model_id} with OpenVINO")
...
def save_results(results, model_id=None, output_dir="collected_results"):
    ...
    try:
        ...
        filename = f"hf_hubert_{model_id_safe}_{timestamp}.json"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test HUBERT HuggingFace models")
    parser.add_argument("--model", type=str, default="hubert-base-uncased", help="Model ID to test")
    ...
    parser.add_argument("--list-models", action="store_true", help="List available HUBERT models")
    ...
    if args.list_models:
        ...
        for model_id, info in HUBERT_MODELS_REGISTRY.items():
    ...
    print(f"\nSuccessfully tested HUBERT model: {args.model}")
