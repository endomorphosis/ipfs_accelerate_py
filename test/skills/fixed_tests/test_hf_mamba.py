...
class TestHFMamba(unittest.TestCase):
    """Test for the HuggingFace mamba model"""

    def setUp(self):
        # Set up any needed variables or configurations
        self.model_name = "state-spaces/mamba-2.8b"
    ...
    def test_model_loading(self):
        """Test loading mamba model with proper hardware detection"""
        try:
    ...
    def test_model_with_mock(self, mock_tokenizer, mock_model):
        """Test mamba model functionality with mocks"""
        # Setup mocks
        mock_tokenizer_instance = MagicMock()
        mock_tokenizer_instance.decode.return_value = "This is a mock response from mamba"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test mamba model")
    parser.add_argument("--model", type=str, default="state-spaces/mamba-2.8b", help="Model ID to test")
