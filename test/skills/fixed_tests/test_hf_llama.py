...
LLAMA_MODELS_REGISTRY = {
    "llama": {
        "description": "LLAMA small model",
        "class": "LLAMALMHeadModel",
    },
    "llama-medium": {
        "description": "LLAMA medium model",
        "class": "LLAMALMHeadModel",
    },
    "distilllama": {
        "description": "DistilLLAMA model",
        "class": "LLAMALMHeadModel",
    },
}
...
class TestLlamaModels:
    """Base test class for all LLAMA-family models."""
    ...
    def test_pipeline(self, device="auto"):
        ...
        try:
            ...
            if tokenizer.pad_token is None:
                ...
                logger.info("Set pad_token to eos_token for LLAMA tokenizer")
    ...
    def test_from_pretrained(self, device="auto"):
        ...
        try:
            ...
            # Fix for LLAMA padding token issue
            if tokenizer.pad_token is None:
                tokenizer.pad_token = tokenizer.eos_token
                logger.info("Set pad_token to eos_token for LLAMA tokenizer")
...
def get_available_models():
    """Get a list of all available LLAMA models in the registry."""
    return list(LLAMA_MODELS_REGISTRY.keys())


def test_all_models(output_dir="collected_results", all_hardware=False):
    """Test all registered LLAMA models."""
    ...
    summary_path = os.path.join(
        output_dir, f"hf_llama_summary_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test LLAMA-family models")
