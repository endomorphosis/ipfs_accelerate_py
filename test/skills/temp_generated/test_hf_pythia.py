...
class TestPythiaModels:
    """Test class for pythia models."""

    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "pythia"
        ...
        if self.model_id not in PYTHIA_MODELS_REGISTRY:
            ...
            self.model_info = PYTHIA_MODELS_REGISTRY["pythia"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test pythia models")
