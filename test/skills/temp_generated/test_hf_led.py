...
class TestLedModels:
    """Test class for led models."""

    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "led-base"
        ...
        if self.model_id not in LED_MODELS_REGISTRY:
            ...
            self.model_info = LED_MODELS_REGISTRY["led-base"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "led-base"
