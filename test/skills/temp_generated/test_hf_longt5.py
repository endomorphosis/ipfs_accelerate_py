...
class TestLongt5Models:
    """Test class for longt5 models."""

    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "longt5-base"
        ...
        if self.model_id not in LONGT5_MODELS_REGISTRY:
            ...
            self.model_info = LONGT5_MODELS_REGISTRY["longt5-base"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "longt5-base"
