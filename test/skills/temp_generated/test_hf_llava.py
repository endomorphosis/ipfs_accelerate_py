...
LLAVA_MODELS_REGISTRY = {
    "llava-base": {
        "description": "llava base model",
        "class": "LlavaModel",
    }
}

class TestLlavaModels:
    """Test class for llava models."""
    
    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "llava-base"
        ...
        if self.model_id not in LLAVA_MODELS_REGISTRY:
            ...
            self.model_info = LLAVA_MODELS_REGISTRY["llava-base"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "llava-base"
