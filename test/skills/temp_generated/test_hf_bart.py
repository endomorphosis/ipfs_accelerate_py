...
class TestBartModels:
    ...
    def __init__(self, model_id=None):
        ...
        self.model_id = model_id or "facebook/bart-base"
        ...
        if self.model_id not in BART_MODELS_REGISTRY:
            ...
            self.model_info = BART_MODELS_REGISTRY["facebook/bart-base"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bart models")
    ...
    # Run test
    model_id = args.model or "facebook/bart-base"
