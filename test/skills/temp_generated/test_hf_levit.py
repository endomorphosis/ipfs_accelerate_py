...
class TestLevitModels:
    ...
    def __init__(self, model_id=None):
        ...
        self.model_id = model_id or "google/levit-base-patch16-224"
        ...
        if self.model_id not in LEVIT_MODELS_REGISTRY:
            ...
            self.model_info = LEVIT_MODELS_REGISTRY["google/levit-base-patch16-224"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "google/levit-base-patch16-224"
