...
try:
    ...
    # Hardware detection    def check_hardware():
...
class TestVisionTextModels:
    """Base test class for all vision-text models (BLIP, CLIP, etc.)."""    def __init__(self, model_id=None):
        ...
        self.results = {}
        self.examples = []
        self.performance_stats = {}    def _find_test_image(self):
        ...
        return None    def test_pipeline(self, device="auto"):
        ...
        try:
            ...
            return results    def test_from_pretrained(self, device="auto"):
        ...
        try:
            ...
            return results    def test_with_openvino(self):
        ...
        try:
            ...
            return results    def run_tests(self, all_hardware=False):
            """
    ...
    return output_path    def get_available_models():
    """Get a list of all available vision-text models in the registry."""
    return list(VISION_TEXT_MODELS_REGISTRY.keys())    def test_all_models(output_dir="collected_results", all_hardware=False):
