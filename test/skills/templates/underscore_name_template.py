...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="mosaicml/mpt-7b-instruct", help="Model ID to test"
    )
    ...
    mosaic_mpt_tester = TestMosaicMptModels(model_id=args.model, device=args.device)
    ...
    if pipeline_success:
        generated_text = results["pipeline"].get("generated_text", "N/A")
