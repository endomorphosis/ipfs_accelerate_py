...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fix syntax and indentation issues in template files"
    )
    parser.add_argument(
        "--templates-dir", type=str, default="templates", help="Directory containing template files"
    )
    parser.add_argument("--file", type=str, help="Fix a specific template file")
    parser.add_argument(
        "--dry-run", action="store_true", help="Check issues without modifying files"
    )
