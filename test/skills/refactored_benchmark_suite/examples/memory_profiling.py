            ...
            for batch_size in batch_sizes:
                for sequence_length in sequence_lengths:
                    ...
                    metrics = profile_model_memory(
                        model_id, task, hardware_type, batch_size, sequence_length
                    )
...
def main():
    ...
    # Profile models
    results = profile_models_on_available_hardware(models, batch_sizes, sequence_lengths)

    # Print summary
    logger.info("\nMemory Profiling Results Summary:")
    for result in results:
        logger.info(
            f"Model: {result['model_id']}, Hardware: {result['hardware']}, "
