        ...
        try:
            ...
            try:
                ...
                for device_name in devices:
                    ...
                    if device_name == "CPU":
                        device_data["optimization_capabilities"] = core.get_property(
                        ...
                        device_data["device_total_mem_size"] = core.get_property(
                            device_name, "DEVICE_TOTAL_MEM_SIZE"
                        )
                ...
                info.update(
                    {
                        ...
                        "cache_dir": core.get_property("CPU", "CACHE_DIR")
                        if "CPU" in devices
                        else None,
                    }
                )
    ...
    def initialize(self) -> Any:
        ...
        try:
            ...
            if self.device not in available_devices:
                logger.warning(
                    f"Requested OpenVINO device '{self.device}' not available, using {available_devices[0]}"
                )
