#!/usr/bin/env python3
"""
Class-based test file for all LLaMA-family models.
...
class TestLlamaModels:
    ...
    def __init__(self, model_id=None):
        ...
        # Define test inputs
        self.test_text = "In this paper, we propose"
        self.test_texts = [
            "In this paper, we propose",
            "In this paper, we propose (alternative)"
        ]
