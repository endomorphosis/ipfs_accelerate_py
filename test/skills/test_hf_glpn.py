...
class TestGlpnModels:
    """Base test class for all GLPN-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "glpn-base"
        
        # Verify model exists in registry:
        if self.model_id not in glpn_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = glpn_MODELS_REGISTRY["glpn-base"],
        else:
            self.model_info = glpn_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_glpn_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    ...
    return list())))glpn_MODELS_REGISTRY.keys())))))
...
def test_all_models())))output_dir="collected_results", all_hardware=False):
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_glpn_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    if args.list_models:
        ...
        for model in models:
            info = glpn_MODELS_REGISTRY[model],
