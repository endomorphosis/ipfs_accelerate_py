...
class TestVisionTextDualEncoderModels:
    ...
    def test_pipeline(self):
        ...
        try:
            ...
            logger.info(f"Testing VisionTextDualEncoder model {self.model_id} with pipeline API on {self.device}")
...
def main():
    ...
    vision_text_dual_encoder_tester = TestVisionTextDualEncoderModels(model_id=args.model, device=args.device)
