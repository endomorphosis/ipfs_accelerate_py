...
try::
    ...
    """
    Class-based test file for all XLNET-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        ...
        "xlnet-base": {}}}}}}}}}}}}}}}}}}
        "description": "XLNET models",
        "class": "XlnetModel"
        }

        }

class TestXlnetModels:
    """Base test class for all XLNET-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "xlnet-base"
        
        # Verify model exists in registry:
        if self.model_id not in xlnet_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = xlnet_MODELS_REGISTRY["xlnet-base"],
        else:
            self.model_info = xlnet_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_xlnet_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available XLNET models in the registry:."""
    return list())))xlnet_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered XLNET models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestXlnetModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_xlnet_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test XLNET-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable XLNET-family models:")
        for model in models:
            info = xlnet_MODELS_REGISTRY[model],
