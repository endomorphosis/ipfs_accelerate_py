...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create template-based test files for batch 2 models"
    )
    parser.add_argument(
        "--output-dir", default="fixed_tests", help="Output directory for the test files"
    )
    parser.add_argument(
        "--batch-file", default="batch_2_models.json", help="JSON file with batch model definitions"
    )
    args = parser.parse_args()
