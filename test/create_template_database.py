...
def parse_args():
    ...
    parser.add_argument(
        "--create", action="store_true", help="Create new database (will overwrite if exists)"
    )
    parser.add_argument(
        "--update", action="store_true", help="Update existing database with new templates"
    )
    parser.add_argument(
        "--export", action="store_true", help="Export database templates to JSON file"
    )
    parser.add_argument(
        "--import",
        action="store_true",
    ...
    parser.add_argument(
        "--list", action="store_true", help="List available templates in the database"
    )
    parser.add_argument(
        "--validate", action="store_true", help="Validate templates in the database"
    )
...
def list_templates(db_path):
    ...
    try:
        ...
        logger.info(
            f"Covering {model_type_count} model types and {template_type_count} template types"
        )
