...
class TestAPIKeyManager:
    ...
    def test_generate_key(self):
        ...
        key_string, api_key = manager.generate_key(name="test_key", rate_limit=50)
    ...
    def test_allowed_models(self):
        ...
        key_string, api_key = manager.generate_key(
            name="restricted_key", allowed_models=["gpt2", "bert-base"]
        )
...
class TestRateLimiter:
    ...
    async def test_check_limit(self):
        ...
        api_key = APIKey(key_id="test_key", key_hash="hash", name="test", rate_limit=5)
    ...
    async def test_window_reset(self):
        ...
        api_key = APIKey(key_id="test_key", key_hash="hash", name="test", rate_limit=3)
    ...
    def test_get_headers(self):
        ...
        api_key = APIKey(key_id="test_key", key_hash="hash", name="test", rate_limit=100)
...
class TestQueueManager:
    ...
    async def test_global_queue(self):
        ...
        manager = QueueManager(default_max_size=10, enable_per_model_queues=False)
    ...
    async def test_per_model_queues(self):
        ...
        manager = QueueManager(default_max_size=10, enable_per_model_queues=True)
...
class TestQueuedRequest:
    ...
    def test_is_expired(self):
        ...
        request = QueuedRequest(request_id="req1", model_id="gpt2", data={}, timeout_seconds=0.1)
    ...
    def test_comparison(self):
        ...
        req_low = QueuedRequest(
            request_id="low", model_id="gpt2", data={}, priority=RequestPriority.LOW
        )

        req_high = QueuedRequest(
            request_id="high", model_id="gpt2", data={}, priority=RequestPriority.HIGH
        )
