    ...
    async def test_complete_workflow(self, page: Page):
        ...
        try:
            ...
            await page.screenshot(
                path=self.screenshots_dir / "01_dashboard_loaded.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "02_hf_search_tab.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "03_search_filled.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "04_search_results.png", full_page=True
            )
            ...
            if len(download_buttons) > 0:
                ...
                await page.screenshot(
                    path=self.screenshots_dir / "05_download_initiated.png", full_page=True
                )
                ...
                await page.screenshot(
                    path=self.screenshots_dir / "05_no_download_buttons.png", full_page=True
                )

            # Step 6: Navigate to Model Browser tab
            print("\n📋 Step 6: Navigating to Model Browser tab...")
            model_browser_tab = await page.query_selector(
                'button.tab-button:has-text("Model Browser")'
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "06_model_browser_tab.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "07_final_verification.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "ERROR_workflow_failed.png", full_page=True
            )
...
if __name__ == "__main__":
    if not PLAYWRIGHT_AVAILABLE:
        print(
            "⚠️ Playwright not available - install with: pip install playwright && playwright install"
        )
        sys.exit(1)
