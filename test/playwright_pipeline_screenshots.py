...
class KitchenSinkScreenshotTester:
    ...
    async def test_inference_pipelines(self):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await page.screenshot(path=self.screenshots_dir / "00_overview.png", full_page=True)
    ...
    async def _test_text_generation_pipeline(self, page):
        ...
        try:
            ...
            await page.screenshot(
                path=self.screenshots_dir / "01_text_generation_form.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "02_text_generation_results.png", full_page=True
            )
    ...
    async def _test_text_classification_pipeline(self, page):
        ...
        try:
            ...
            # Fill in the form
            await page.fill(
                "#class-text", "This movie is absolutely amazing! I loved every minute of it."
            )

            # Take screenshot before submission
            await page.screenshot(
                path=self.screenshots_dir / "03_text_classification_form.png", full_page=True
            )
            ...
            # Take screenshot of results
            await page.screenshot(
                path=self.screenshots_dir / "04_text_classification_results.png", full_page=True
            )
    ...
    async def _test_text_embeddings_pipeline(self, page):
        ...
        try:
            ...
            # Take screenshot before submission
            await page.screenshot(
                path=self.screenshots_dir / "05_text_embeddings_form.png", full_page=True
            )
            ...
            # Take screenshot of results
            await page.screenshot(
                path=self.screenshots_dir / "06_text_embeddings_results.png", full_page=True
            )
    ...
    async def _test_model_recommendations_pipeline(self, page):
        ...
        try:
            ...
            # Take screenshot before submission
            await page.screenshot(
                path=self.screenshots_dir / "07_model_recommendations_form.png", full_page=True
            )
            ...
            # Take screenshot of results
            await page.screenshot(
                path=self.screenshots_dir / "08_model_recommendations_results.png", full_page=True
            )
    ...
    async def _test_model_manager_pipeline(self, page):
        ...
        try:
            ...
            await page.screenshot(
                path=self.screenshots_dir / "09_model_manager_overview.png", full_page=True
            )
            ...
            if search_input:
                ...
                await page.screenshot(
                    path=self.screenshots_dir / "10_model_manager_search.png", full_page=True
                )
    ...
    async def _test_mobile_responsiveness(self, page):
        ...
        try:
            ...
            await page.screenshot(
                path=self.screenshots_dir / "11_mobile_overview.png", full_page=True
            )
            ...
            await page.screenshot(
                path=self.screenshots_dir / "12_tablet_overview.png", full_page=True
            )
    ...
    def _generate_markdown_report(self):
        ...
        success_count = sum(1 for result in self.test_results.values() if "success" in str(result))
