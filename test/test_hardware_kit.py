...
try:
    from ipfs_accelerate_py.kit.hardware_kit import HardwareKit, HardwareInfo
...
class TestHardwareKit(unittest.TestCase):
    ...
    def test_test_hardware_cuda_unavailable(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=1, stdout="", stderr="CUDA not available")
    ...
    def test_recommend_hardware(self):
        ...
        result = self.kit.recommend_hardware(model_name="gpt2", task="inference")
