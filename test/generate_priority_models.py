...
def generate_priority_model_tests(output_dir: str, priority: str = "high") -> Dict[str, Any]:
    ...
    for model_type in models_to_generate:
        try:
            ...
            results[model_type] = {"success": False, "error": str(e), "model_type": model_type}
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate tests for high-priority HuggingFace models"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="priority_model_tests",
    ...
    parser.add_argument(
        "--report", action="store_true", help="Generate a report of missing high-priority models"
    )
    parser.add_argument(
        "--report-dir",
        type=str,
