...
class NotificationHistory:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        """
        return {"notifications": self.notifications, "max_history": self.max_history}
...
class NotificationManager:
    ...
    def _send_email(self, anomaly: Dict[str, Any], rule: NotificationRule) -> bool:
        ...
        try:
            ...
            subject = (
                f"{self.email_config.subject_prefix} {severity} - {api} {metric} anomaly detected"
            )
            msg["Subject"] = subject
        ...
        <div class="footer">
            ...
            if self.email_config.use_ssl:
                ...
                with smtplib.SMTP_SSL(
                    self.email_config.smtp_server, self.email_config.smtp_port, context=context
                ) as server:
            ...
            logger.info(
                f"Sent email notification to {len(self.email_config.to_addresses)} recipients"
            )
            return True
    ...
    def load_data(self) -> bool:
        ...
        if os.path.exists(history_file):
            try:
                ...
                logger.info(
                    f"Loaded notification history with {len(self.history.notifications)} entries"
                )
            except Exception as e:
    ...
    def get_notification_summary(self) -> Dict[str, Any]:
        ...
        if not recent:
            return {
                ...
                "status_counts": {"sent": 0, "partial_failure": 0, "failed": 0},
                "rule_counts": {},
                "channel_counts": {},
                "api_counts": {},
