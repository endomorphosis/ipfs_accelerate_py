...
class TestClipModel:
    ...
    def __init__(self, model_id="llava-hf/llava-v1.6-34b-hf", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="llava-hf/llava-v1.6-34b-hf", help="Specific model to test")
