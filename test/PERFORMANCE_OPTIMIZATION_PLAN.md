    ...
    with self.batch_lock:
        ...
        for model, batch in list(self.batch_queue.items()):
            ...
            if (
                ...
                or elapsed >= adjusted_timeout
                or (batch_size > 0 and elapsed >= 2.0)
            ):  # Force process after 2 seconds
...
def _get_cache_key(self, model, messages, **kwargs):
    ...
    normalized_messages = []
    for msg in messages:
        normalized_msg = {"role": msg["role"], "content": msg["content"]}
        normalized_messages.append(normalized_msg)

    # Create a dictionary of all parameters
    cache_dict = {"model": model, "messages": normalized_messages}
        ...
        while True:
            ...
            try:
                ...
                await self.client.async_execute(
                    operation_type, priority=self.client.PRIORITY_LOW, **params
                )
