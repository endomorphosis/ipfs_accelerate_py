...
class BrowserCapabilityDetector:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Browser capability detection complete. WebGPU available: {self.capabilities['webgpu']['available']}"
        )
    ...
    def _detect_webgpu_support(self) -> Dict[str, Any]:
        ...
        if browser_name in ["chrome", "chromium", "edge"]:
            ...
            if browser_version >= 118:  # Firefox 118+ has WebGPU support
                ...
                webgpu_support["features"] = ["compute_shaders", "texture_compression_bc"]
            ...
            if browser_version >= 17.0:  # Safari 17+ has WebGPU support
                ...
                webgpu_support["features"] = ["texture_compression_etc2"]
    ...
    def _detect_webassembly_support(self) -> Dict[str, Any]:
        ...
        if browser_name in ["chrome", "chromium", "edge"]:
            ...
            if browser_version >= 90:
                ...
                wasm_support["threads"] = True
                wasm_support["bulk_memory"] = True
                wasm_support["advanced_features"] = ["simd", "threads", "bulk-memory"]
        elif browser_name == "safari":
            if browser_version >= 16.4:
                wasm_support["simd"] = True
                wasm_support["bulk_memory"] = True
                wasm_support["advanced_features"] = ["simd", "bulk-memory"]
    ...
    def _detect_hardware_info(self) -> Dict[str, Any]:
        ...
        hardware_info = {
            "platform": platform.system().lower(),
            "cpu": {"cores": os.cpu_count(), "architecture": platform.machine()},
            "memory": {"total_gb": self._get_total_memory_gb()},
    ...
    def _detect_gpu_info(self) -> Dict[str, Any]:
        ...
        """
        gpu_info = {"vendor": "unknown", "model": "unknown", "memory_mb": 0}
            ...
            if platform.system() == "Linux":
                try:
                    ...
                    result = subprocess.run(
                        gpu_cmd, shell=True, check=True, stdout=subprocess.PIPE, text=True
                    )
    ...
    def _create_optimization_profile(self) -> Dict[str, Any]:
        ...
        if total_memory_gb < 4:
            ...
            profile["precision"]["ultra_low_precision_enabled"] = (
                profile["precision"]["ultra_low_precision_enabled"] and webgpu_caps["available"]
            )
...
def create_browser_optimization_profile(
    browser_info: Dict[str, Any], capabilities: Dict[str, Any]
) -> Dict[str, Any]:
    """
        ...
        profile.update(
            {
                ...
                "memory_optimizations": {"use_memory_snapshots": True, "enable_zero_copy": True},
                "workgroup_size": (128, 1, 1),
            }
        )
    elif browser_name == "firefox":
        profile.update(
            {
                ...
                "memory_optimizations": {"use_gpu_compressed_textures": True},
        ...
        profile.update(
            {
                ...
                "memory_optimizations": {"progressive_loading": True},
                "fallback_strategy": "wasm",
...
def get_hardware_capabilities() -> Dict[str, Any]:
    ...
    hardware_caps = {
        ...
        "cpu": {"cores": os.cpu_count() or 4, "architecture": platform.machine()},
        "memory": {
            "total_gb": 8.0  # Default value
        },
        "gpu": {"vendor": "unknown", "model": "unknown", "memory_mb": 0},
    }
...
def get_optimization_for_browser(browser: str, version: float = 0) -> Dict[str, Any]:
    ...
    profile = create_browser_optimization_profile(
        browser_info=capabilities["browser_info"], capabilities=capabilities
    )
...
def get_browser_feature_matrix() -> Dict[str, Dict[str, bool]]:
    ...
    """
    browsers = [("chrome", 115), ("firefox", 118), ("safari", 17), ("edge", 115)]
