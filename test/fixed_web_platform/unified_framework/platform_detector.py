...
class PlatformDetector:
    ...
    def __init__(self, browser: Optional[str] = None, version: Optional[float] = None):
        ...
        logger.info(
            f"Platform detector initialized. WebGPU available: {self.supports_feature('webgpu')}"
        )
        ...
        platform_info = {
            ...
            "features": {
                ...
                "webgpu_features": {
                    ...
                    "shader_precompilation": capabilities["webgpu"].get(
                        "shader_precompilation", False
                    ),
                    "storage_texture_binding": capabilities["webgpu"].get(
    ...
    def _create_simulated_capabilities(self) -> Dict[str, Any]:
        ...
        capabilities = {
            ...
            "hardware_info": {
                ...
                "memory": {"total_gb": float(os.environ.get("TEST_MEMORY_GB", "16.0"))},
                "gpu": {
            ...
            "webassembly": {"simd": True, "threads": True, "bulk_memory": True},
        }
    ...
    def _create_optimization_profile(self, capabilities: Dict[str, Any]) -> Dict[str, Any]:
        ...
        profile = {
            "precision": {
                "supported": [
                    f"{bits}bit" for bits, supported in precision_support.items() if supported
                ],
                "default": default_precision,
                "ultra_low_precision_enabled": precision_support["2bit"]
                and precision_support["3bit"],
            },
            "compute": {
                "use_compute_shaders": capabilities["webgpu"].get("compute_shaders", False),
                "use_shader_precompilation": capabilities["webgpu"].get(
                    "shader_precompilation", False
                ),
                "workgroup_size": self._get_optimal_workgroup_size(browser_name, is_mobile),
            },
            "loading": {"parallel_loading": not is_mobile, "progressive_loading": True},
            "memory": {
    ...
    def supports_feature(self, feature_name: str) -> bool:
        ...
        # Check optimization profile for other features
            ...
            return self.platform_info["optimization_profile"]["precision"][
...
def create_platform_profile(
    model_type: str, browser: Optional[str] = None, version: Optional[float] = None
) -> Dict[str, Any]:
    """
...
def get_feature_support_matrix() -> Dict[str, Dict[str, bool]]:
    ...
    for browser in browsers:
        ...
        browser_support["shader_precompilation"] = detector.supports_feature(
            "shader_precompilation"
        )
