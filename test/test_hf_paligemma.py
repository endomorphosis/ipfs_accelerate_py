...
PALIGEMMA_MODELS_REGISTRY = {
    "paligemma-base": {
        "description": "paligemma base model",
...
class TestPaligemmaModels:
    """Test class for paligemma models."""

    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "paligemma-base"
        ...
        if self.model_id not in PALIGEMMA_MODELS_REGISTRY:
            ...
            self.model_info = PALIGEMMA_MODELS_REGISTRY["paligemma-base"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test paligemma models")
    ...
    # Run test
    model_id = args.model or "paligemma-base"
