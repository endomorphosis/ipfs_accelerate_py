...
"""
    ...
    return {"rendered": rendered, "is_valid": is_valid, "error": error if not is_valid else None}
...
def main():
    ...
    print("\nOverall Result:")
    all_valid = (
        renderer_result["is_valid"] and models_result["valid_syntax"] == models_result["total"]
    )
