...
class hf_bert:
    ...
    def _create_mock_endpoint())))))))))))))))))))))))))))self, model_name, device_label):
        ...
        try:
            ...
            if device_label.startswith())))))))))))))))))))))))))))'cpu'):
                handler_method = self.create_cpu_fill_mask_endpoint_handler
            elif device_label.startswith())))))))))))))))))))))))))))'cuda'):
                handler_method = self.create_cuda_fill_mask_endpoint_handler
            elif device_label.startswith())))))))))))))))))))))))))))'openvino'):
                handler_method = self.create_openvino_fill_mask_endpoint_handler
            elif device_label.startswith())))))))))))))))))))))))))))'apple'):
                handler_method = self.create_apple_fill_mask_endpoint_handler
            elif device_label.startswith())))))))))))))))))))))))))))'qualcomm'):
                handler_method = self.create_qualcomm_fill_mask_endpoint_handler
            else:
                handler_method = self.create_cpu_fill_mask_endpoint_handler
    ...
    def init_cpu())))))))))))))))))))))))))))self, model_name, device, cpu_label):
        ...
        try:
            ...
            print())))))))))))))))))))))))))))f"())))))))))))))))))))))))))))REAL) Model loaded: {}}}}model_name}")
                    ...
                    # Create handler function
                        endpoint_handler = self.create_cpu_fill_mask_endpoint_handler())))))))))))))))))))))))))))
                        endpoint_model=model_name,
                        device=device,
    ...
    def init_cuda())))))))))))))))))))))))))))self, model_name, device, cuda_label):
        ...
        try:
            ...
            # Create the handler function
                    endpoint_handler = self.create_cuda_fill_mask_endpoint_handler())))))))))))))))))))))))))))
                    endpoint_model=model_name,
                    device=device,
    ...
    def init_openvino())))))))))))))))))))))))))))self, model_name, model_type, device, openvino_label, get_optimum_openvino_model=None, get_openvino_model=None, get_openvino_pipeline_type=None, openvino_cli_convert=None):
        ...
        try:
            ...
            # Create the handler
                endpoint_handler = self.create_openvino_fill_mask_endpoint_handler())))))))))))))))))))))))))))
                endpoint_model=model_name,
                tokenizer=tokenizer,
    ...
    def init_apple())))))))))))))))))))))))))))self, model, device, apple_label):
        ...
        try:
            ...
            endpoint_handler = self.create_apple_fill_mask_endpoint_handler())))))))))))))))))))))))))))endpoint, apple_label, endpoint, tokenizer)
        ...
        try:
            ...
            if ":" in qualcomm_label:
                ...
                if optimized_path != dlc_path:
                    ...
                    endpoint_handler = self.create_qualcomm_fill_mask_endpoint_handler())))))))))))))))))))))))))))endpoint, qualcomm_label, endpoint, tokenizer)
    ...
    def create_cpu_fill_mask_endpoint_handler())))))))))))))))))))))))))))self, endpoint_model, device, hardware_label, endpoint=None, tokenizer=None):
        ...
        def handler())))))))))))))))))))))))))))text_input, endpoint_model=endpoint_model, device=device, hardware_label=hardware_label, endpoint=endpoint, tokenizer=tokenizer):
            ...
            try:
                ...
                mock_embedding.mock_implementation = True
                            ...
                            return handler
:
    def create_openvino_fill_mask_endpoint_handler())))))))))))))))))))))))))))self, endpoint_model, tokenizer, openvino_label, endpoint=None):
            ...
            try:
                ...
                mock_embedding.mock_implementation = True
                    ...
                    return mock_embedding
                            ...
                            return handler
:
    def create_cuda_fill_mask_endpoint_handler())))))))))))))))))))))))))))self, endpoint_model, device, hardware_label, endpoint=None, tokenizer=None, is_real_impl=True, batch_size=8):
        ...
        try:
            ...
            try:
                ...
                return mock_embedding
                            ...
                            return handler
        :
    def create_apple_fill_mask_endpoint_handler())))))))))))))))))))))))))))self, endpoint_model, apple_label, endpoint=None, tokenizer=None):
    ...
    def create_qualcomm_fill_mask_endpoint_handler())))))))))))))))))))))))))))self, endpoint_model, qualcomm_label, endpoint=None, tokenizer=None):
