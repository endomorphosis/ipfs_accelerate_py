...
1. **fixed_scripts/generators/test_scripts/generators/merged_test_generator.py** - Generates tests for models with comprehensive hardware platform support
2. **scripts/generators/test_scripts/generators/merged_test_generator.py** - Simplified test generator with hardware platform support
3. **scripts/generators/skill_scripts/generators/integrated_skillset_generator.py** - Generates skill implementations with hardware platform support
...
python fixed_scripts/generators/test_scripts/generators/merged_test_generator.py -g bert -p cpu,cuda -o test_outputs/

# Generate a test for vit with all platforms
python fixed_scripts/generators/test_scripts/generators/merged_test_generator.py -g vit-base -p all -o test_outputs/

# Generate a skill for clip with WebNN and WebGPU platforms
python scripts/generators/skill_scripts/generators/integrated_skillset_generator.py -m clip -p webnn,webgpu -o test_outputs/
```
...
python scripts/generators/models/test_all_generators.py
```
...
- **fixed_merged_test_generator_clean.py** - Clean version of fixed_scripts/generators/test_scripts/generators/merged_test_generator.py
- **merged_test_generator_clean.py** - Clean version of scripts/generators/test_scripts/generators/merged_test_generator.py
- **integrated_skillset_generator_clean.py** - Clean version of scripts/generators/skill_scripts/generators/integrated_skillset_generator.py
