...
class TestBatchSizeEstimation:
    ...
    def test_estimate_batch_size_basic(self, cpu_optimizer):
        ...
        batch_size = cpu_optimizer.estimate_batch_size(model_size_mb=500, per_sample_memory_mb=10)
    ...
    def test_estimate_batch_size_small_model(self, cpu_optimizer):
        ...
        batch_size = cpu_optimizer.estimate_batch_size(model_size_mb=100, per_sample_memory_mb=1)
    ...
    def test_estimate_batch_size_large_model(self, cpu_optimizer):
        ...
        batch_size = cpu_optimizer.estimate_batch_size(model_size_mb=5000, per_sample_memory_mb=50)
    ...
    def test_estimate_batch_size_with_memory_budget(self, cpu_optimizer):
        ...
        try:
            batch_size = cpu_optimizer.estimate_batch_size(
                model_size_mb=1000, per_sample_memory_mb=10, available_memory_mb=4000
            )
    ...
    def test_batch_size_consistency(self, cpu_optimizer):
        ...
        batch_size1 = cpu_optimizer.estimate_batch_size(model_size_mb=1000, per_sample_memory_mb=10)
        batch_size2 = cpu_optimizer.estimate_batch_size(model_size_mb=1000, per_sample_memory_mb=10)
    ...
    def test_result_to_dict(self):
        ...
        try:
            result = OptimizationResult(
                batch_size=32, throughput=100.0, latency=0.01, memory_usage=1000.0
            )
