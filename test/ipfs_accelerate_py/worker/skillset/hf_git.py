...
class hf_git:
    ...
    def create_cpu_image_to_text_endpoint_handler(
    ...
    def create_cuda_image_to_text_endpoint_handler(
        self, endpoint_model, device, hardware_label, endpoint, tokenizer
    ):
    ...
    def create_rocm_image_to_text_endpoint_handler(
        self, endpoint_model, device, hardware_label, endpoint, tokenizer
    ):
    ...
    def create_openvino_image_to_text_endpoint_handler(
        self, endpoint_model, device, hardware_label, endpoint, tokenizer
    ):
    ...
    def create_apple_image_to_text_endpoint_handler(
        self, endpoint_model, device, hardware_label, endpoint, tokenizer
    ):
    ...
    def create_qualcomm_image_to_text_endpoint_handler(
        self, endpoint_model, device, hardware_label, endpoint, tokenizer
    ):
