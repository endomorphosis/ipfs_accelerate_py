...
class hf_bark:
    ...
    def init_openvino(self, model_name, device, openvino_label):
        ...
        try:
            ...
            model = OVModelForTextToAudio.from_pretrained(
                model_name,
                device=device,
                export=True
            )
    ...
    def create_cpu_text_to_audio_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_cuda_text_to_audio_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_rocm_text_to_audio_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_openvino_text_to_audio_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_apple_text_to_audio_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_qualcomm_text_to_audio_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
