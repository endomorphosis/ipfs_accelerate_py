...
class hf_clip:
    ...
    This class provides standardized interfaces for working with CLIP models
    across different hardware backends (CPU, CUDA, ROCm, OpenVINO, Apple, Qualcomm).

    This is a vision-text model used for image-text matching.
    """
    ...
    def init_rocm(self, model_name, device, rocm_label):
        """Initialize CLIP model for ROCm (AMD GPU) inference."""
        self.init()
    ...
    def init_openvino(self, model_name, device, openvino_label):
        """Initialize CLIP model for OpenVINO inference."""
        self.init()
    ...
    def init_apple(self, model_name, device, apple_label):
        """Initialize CLIP model for Apple Silicon (MPS) inference."""
        self.init()
    ...
    def init_qualcomm(self, model_name, device, qualcomm_label):
        """Initialize CLIP model for Qualcomm inference."""
        self.init()
