...
class hf_decision_transformer:
    ...
    This is a HuggingFace DECISION-TRANSFORMER model.
    """
    ...
    def __test__(self, endpoint_model, endpoint_handler, endpoint_label, tokenizer):
        ...
        test_input = "This is a test input for decision-transformer."
    ...
    def init_rocm(self, model_name, device, rocm_label):
        """Initialize DECISION-TRANSFORMER model for ROCm (AMD GPU) inference."""
        self.init()
