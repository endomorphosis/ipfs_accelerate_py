...
class hf_time_series_transformer:
    ...
    This is a HuggingFace TIME-SERIES-TRANSFORMER model.
    """
    ...
    def __test__(self, endpoint_model, endpoint_handler, endpoint_label, tokenizer):
        ...
        test_input = "This is a test input for time-series-transformer."
    ...
    def init_rocm(self, model_name, device, rocm_label):
        """Initialize TIME-SERIES-TRANSFORMER model for ROCm (AMD GPU) inference."""
        self.init()
