...
sys.path.append(
    os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "ipfs_accelerate_py")
)
        ...
        return iter(
            [
                ...
                },
                {
                    ...
                    "index": 0,
                    "delta": {"type": "text", "text": "This "},
                },
                {
                    "type": "content_block_delta",
                    "index": 0,
                    "delta": {"type": "text", "text": "is "},
                },
                {
                    "type": "content_block_delta",
                    "index": 0,
...
class TestClaude(ModelTest):
    ...
    def test_api_key_multiplexing(self):
        ...
        endpoint1 = self.claude.create_endpoint(
            api_key="test_claude_key_1", max_concurrent_requests=5
        )

        endpoint2 = self.claude.create_endpoint(
            api_key="test_claude_key_2", max_concurrent_requests=10
        )
    ...
    def test_queue_and_backoff(self):
        ...
        self.assertTrue(
            hasattr(self.claude, "initial_retry_delay"), "Initial retry delay setting should exist"
        )
    ...
    def save_results(
        self, results, expected_dir="expected_results", collected_dir="collected_results"
    ):
