...
class TestT5Model:
    ...
    def __init__(self, model_id="allenai/led-base-16384", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="allenai/led-base-16384", help="Specific model to test")
