...
class TestVitModel:
    ...
    def __init__(self, model_id="google/mobilenet_v2_1.0_224", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="google/mobilenet_v2_1.0_224", help="Specific model to test")
