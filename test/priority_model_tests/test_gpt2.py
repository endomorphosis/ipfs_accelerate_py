...
class TestGpt2Model:
    ...
    def __init__(self, model_id="meta-llama/Llama-2-7b-hf", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="meta-llama/Llama-2-7b-hf", help="Specific model to test")
