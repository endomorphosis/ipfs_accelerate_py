...
class TestBertModel:
    ...
    def __init__(self, model_id="google/electra-small-discriminator", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="google/electra-small-discriminator", help="Specific model to test")
