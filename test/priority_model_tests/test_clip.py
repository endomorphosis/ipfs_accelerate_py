...
class TestClipModel:
    ...
    def __init__(self, model_id="CIDAS/clipseg-rd64-refined", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="CIDAS/clipseg-rd64-refined", help="Specific model to test")
