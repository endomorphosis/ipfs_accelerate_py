#!/usr/bin/env python3
"""
Test for detr model with hardware platform support
...
class TestDetr(unittest.TestCase):
    """Test detr model with cross-platform hardware support."""
    ...
    def test_cpu(self):
        ...
        try:
            ...
            # Prepare input
            inputs = self.tokenizer("Test input for detr", return_tensors="pt")
