...
def generate_hardware_test(args: Dict[str, Any]) -> str:
    ...
    # Create the template
    template = HardwareTestTemplate(parameters=args, output_dir=args.get("output_dir", "test"))
...
def generate_api_test(args: Dict[str, Any]) -> str:
    ...
    # Create the template
    template = APITestTemplate(parameters=args, output_dir=args.get("output_dir", "test"))
...
def parse_arguments() -> argparse.Namespace:
    ...
    subparsers = parser.add_subparsers(
        dest="test_type", required=True, help="Type of test to generate"
    )

    # Model test arguments
    model_parser = subparsers.add_parser("model", help="Generate a model test")
    model_parser.add_argument(
        "--model-name", required=True, help="Name of the model (e.g., bert-base-uncased)"
    )
    model_parser.add_argument(
        "--model-type",
        required=True,
...
def main() -> None:
    ...
    common_args = {"output_dir": args.output_dir, "overwrite": args.overwrite}
