...
class TestCrossModelTensorSharing(unittest.TestCase):
    ...
    def test_tensor_view(self):
        ...
        parent = self.manager.register_shared_tensor(
            name="parent_tensor", shape=[1, 768], storage_type="cpu", producer_model="bert"
        )
    ...
    def test_tensor_sharing(self):
        ...
        result = self.manager.share_tensor_between_models(
            tensor_name="shared_tensor", from_model="vit", to_models=["llava", "xclip"]
        )
    ...
    def test_analyzing_sharing_opportunities(self):
        ...
        self.manager.register_shared_tensor(
            name="bert_emb", shape=[1, 768], storage_type="cpu", producer_model="bert"
        )

        self.manager.register_shared_tensor(
            name="t5_emb", shape=[1, 768], storage_type="cpu", producer_model="t5"
        )
    ...
    def test_stats_collection(self):
        ...
        self.manager.register_shared_tensor(
            name="stats_tensor_2", shape=[1, 1024], storage_type="webgpu", producer_model="model_d"
        )
