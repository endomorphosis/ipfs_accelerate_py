...
DEBERTA-V2_MODELS_REGISTRY = {
    "deberta-v2-base": {
        "description": "deberta-v2 base model",
        "class": "Deberta-v2Model",
    }
}

class TestDebertaV2Models:
    """Test class for deberta-v2 models."""
    
    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "deberta-v2-base"
        ...
        if self.model_id not in DEBERTA-V2_MODELS_REGISTRY:
            ...
            self.model_info = DEBERTA-V2_MODELS_REGISTRY["deberta-v2-base"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test deberta-v2 models")
    ...
    # Run test
    model_id = args.model or "deberta-v2-base"
