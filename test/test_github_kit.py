...
try:
    from ipfs_accelerate_py.kit.github_kit import GitHubKit, GitHubResult
...
class TestGitHubKit(unittest.TestCase):
    ...
    def test_list_repos_failure(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=1, stdout="", stderr="Authentication failed")
    ...
    def test_github_result_dataclass(self):
        ...
        result = GitHubResult(success=True, data={"test": "data"}, error=None)
