    ...
    async def capture_comprehensive_screenshots(self) -> Dict[str, str]:
        ...
        try:
            ...
            async with async_playwright() as p:
                ...
                await page.fill(
                    "#gen-prompt", "The future of artificial intelligence will revolutionize"
                )
                ...
                await page.fill(
                    "#class-text",
                    "This is an absolutely amazing product! I love it so much and would definitely recommend it to everyone!",
                )
                ...
                await page.fill(
                    "#embed-text",
                    "Generate semantic embeddings for this sample text to enable similarity search and clustering",
                )
