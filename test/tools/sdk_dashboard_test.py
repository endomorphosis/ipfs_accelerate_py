...
class SDKDashboardTester:
    ...
    def make_jsonrpc_request(self, method, params=None):
        ...
        request_data = {"jsonrpc": "2.0", "method": method, "params": params or {}, "id": 1}
    ...
    def test_dashboard_static_files(self):
        ...
        static_files = ["/static/js/mcp-sdk.js", "/static/js/kitchen-sink-sdk.js"]
    ...
    def generate_report(self):
        ...
        basic_tests = [self.test_results["dashboard_server"], self.test_results["jsonrpc_server"]]
        ...
        print(f"\n🔧 BASIC FUNCTIONALITY:")
        print(
            f"  Dashboard Server: {'✅ PASS' if self.test_results['dashboard_server'] else '❌ FAIL'}"
        )
        print(
            f"  JSON-RPC Server: {'✅ PASS' if self.test_results['jsonrpc_server'] else '❌ FAIL'}"
        )
        ...
        if self.test_results["failed_tests"] == 0:
            ...
            print(
                f"  Some tests failed. Please review the {self.test_results['failed_tests']} failed test(s)."
            )
