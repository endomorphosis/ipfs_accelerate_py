...
class TestSamModels:
    """Base test class for all SAM-family models."""
    ...
    def __init__())))self, model_id=None):
        ...
        if self.model_id not in SAM_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = SAM_MODELS_REGISTRY["facebook/sam-vit-base"],
        else:
            self.model_info = SAM_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_sam_{}}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    ...
    return list())))SAM_MODELS_REGISTRY.keys())))))
...
def test_all_models())))output_dir="collected_results", all_hardware=False):
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_sam_summary_{}}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test SAM-family models")
    ...
    if args.list_models:
        ...
        for model in models:
            info = SAM_MODELS_REGISTRY[model],
    ...
    # Test single model ())))default or specified)
        model_id = args.model or "facebook/sam-vit-base"
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}}model_id}")
