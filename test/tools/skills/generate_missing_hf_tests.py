...
def create_model_registry:_entry:(model_type):
    ...
    # Clean up None values
            if registry:_entry:["inputs"]["text"], is None:,
            del registry:_entry:["inputs"]["text"],
            if registry:_entry:["inputs"]["image_url"] is None:,
            del registry:_entry:["inputs"]["image_url"]
            ,
...
def generate_test_file(model_type):
    ...
    try::
        ...
        # Get model info
            model_info = create_model_registry:_entry:(model_type)
        ...
        # Create a registry: definition
            registry:_str = f"{}}}}}}}model_key.lower()}_MODELS_REGISTRY"
            model_registry: = f"""
# Models registry: - Maps model IDs to their specific configurations
        ...
        # This regex will match both the initialization in init and the fallback in the warning condition
            ...
            model_info_replacement = f'self.model_info = {}}}}}}}registry:_str}["{}}}}}}}default_model}"]',
        ...
        # Replace all other registry: references - handle lowercase versions too
            new_content = re.sub(r'AUDIO_SPECTROGRAM_TRANSFORMER_MODELS_REGISTRY', f'{}}}}}}}registry:_str.upper()}', new_content)
            new_content = re.sub(r'audio_spectrogram_transformer_MODELS_REGISTRY', f'{}}}}}}}registry:_str}', new_content)
        
        # Fix case consistency issues - ensure the same case is used everywhere
        if registry:_str.lower() != registry:_str:
            new_content = re.sub(rf'{}}}}}}}registry:_str.lower()}_MODELS_REGISTRY', f'{}}}}}}}registry:_str}', new_content, flags=re.IGNORECASE)
            
        # Fix case consistency with model access
            new_content = re.sub(rf'\b{}}}}}}}model_key.lower()}_MODELS_REGISTRY\b', f'{}}}}}}}registry:_str}', new_content, flags=re.IGNORECASE)
