...
try::
    ...
    """
    Class-based test file for all BIGBIRD_PEGASUS-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        bigbird_pegasus_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "bigbird-pegasus-base": {}}}}}}}}}}}}}}}}}}
        "description": "BIGBIRD_PEGASUS models",
        "class": "BigbirdPegasusModel"
        }

        }

class TestBigbird_PegasusModels:
    """Base test class for all BIGBIRD_PEGASUS-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "bigbird-pegasus-base"
        
        # Verify model exists in registry:
        if self.model_id not in bigbird_pegasus_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = bigbird_pegasus_MODELS_REGISTRY["bigbird-pegasus-base"],
        else:
            self.model_info = bigbird_pegasus_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_bigbird_pegasus_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available BIGBIRD_PEGASUS models in the registry:."""
    return list())))bigbird_pegasus_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered BIGBIRD_PEGASUS models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestBigbird_PegasusModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_bigbird_pegasus_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test BIGBIRD_PEGASUS-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable BIGBIRD_PEGASUS-family models:")
        for model in models:
            info = bigbird_pegasus_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nBIGBIRD_PEGASUS Models Testing Summary:")
        total = len())))results)
