...
try::
    ...
    """
    Class-based test file for all DEEPSEEK-VISION-family models.
This file provides a unified testing interface for:
    - Deepseek-VisionModel
    """
...
# Models registry: - Maps model IDs to their specific configurations
        deepseek_vision_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "deepseek-vision-base": {}}}}}}}}}}}}}}}}}}
        "description": "DEEPSEEK-VISION models",
        "class": "Deepseek-VisionModel"
        }

        }

class TestDeepseekVisionModels:
    """Base test class for all DEEPSEEK-VISION-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "deepseek-vision-base"
        
        # Verify model exists in registry:
        if self.model_id not in deepseek_vision_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = deepseek_vision_MODELS_REGISTRY["deepseek-vision-base"],
        else:
            self.model_info = deepseek_vision_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_deepseek_vision_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available DEEPSEEK-VISION models in the registry:."""
    return list())))deepseek_vision_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered DEEPSEEK-VISION models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestDeepseekVisionModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_deepseek_vision_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test DEEPSEEK-VISION-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable DEEPSEEK-VISION-family models:")
        for model in models:
            info = deepseek_vision_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nDEEPSEEK-VISION Models Testing Summary:")
        total = len())))results)
