...
try::
    ...
    """
    Class-based test file for all DEEPSEEK-R1-DISTIL-family models.
This file provides a unified testing interface for:
    - Deepseek-R1-DistilModel
    """
...
# Models registry: - Maps model IDs to their specific configurations
        deepseek_r1_distil_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "deepseek-r1-distil-base": {}}}}}}}}}}}}}}}}}}
        "description": "DEEPSEEK-R1-DISTIL models",
        "class": "Deepseek-R1-DistilModel"
        }

        }

class TestDeepseekR1DistilModels:
    """Base test class for all DEEPSEEK-R1-DISTIL-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "deepseek-r1-distil-base"
        
        # Verify model exists in registry:
        if self.model_id not in deepseek_r1_distil_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = deepseek_r1_distil_MODELS_REGISTRY["MIT/ast-finetuned-audioset-10-10-0.4593"],
        else:
            self.model_info = deepseek_r1_distil_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_deepseek_r1_distil_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available DEEPSEEK-R1-DISTIL models in the registry:."""
    return list())))deepseek_r1_distil_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered DEEPSEEK-R1-DISTIL models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestDeepseekR1DistilModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_deepseek_r1_distil_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test DEEPSEEK-R1-DISTIL-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable DEEPSEEK-R1-DISTIL-family models:")
        for model in models:
            info = deepseek_r1_distil_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nDEEPSEEK-R1-DISTIL Models Testing Summary:")
        total = len())))results)
