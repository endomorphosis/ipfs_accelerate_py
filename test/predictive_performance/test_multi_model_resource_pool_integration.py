...
class TestMultiModelResourcePoolIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_resource_pool.get_metrics.return_value = {
            "base_metrics": {"peak_memory_usage": 1800.0}
        }
    ...
    def test_initialization(self, mock_time):
        ...
        integration = MultiModelResourcePoolIntegration(
            predictor=self.mock_predictor, resource_pool=self.mock_resource_pool
        )
    ...
    def test_compare_strategies(self, mock_time):
        ...
        def get_metrics_for_strategy(
            model_configs, hardware_platform, execution_strategy, **kwargs
        ):
            metrics = {
                "parallel": {
                    "combined_throughput": 100.0,
                    "combined_latency": 30.0,
                    "combined_memory": 2000.0,
                },
                "sequential": {
                    "combined_throughput": 50.0,
                    "combined_latency": 60.0,
                    "combined_memory": 1000.0,
                },
                "batched": {
                    "combined_throughput": 80.0,
                    "combined_latency": 40.0,
                    "combined_memory": 1500.0,
                },
            }
        ...
        self.assertEqual(
            self.mock_predictor.predict_multi_model_performance.call_count, 3
        )  # 3 strategies
    ...
    def test_get_validation_metrics(self):
        ...
        # Check counts
        self.assertEqual(
            metrics["validation_count"], 3
        )  # All executions validated due to interval=1
    ...
    def test_update_strategy_configuration(self):
        ...
        new_config = {"parallel_threshold": 5, "sequential_threshold": 10, "batching_size": 6}
