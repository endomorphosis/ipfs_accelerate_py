...
class PluginBase:
    ...
    async def execute_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": False, "error": "Not implemented", "plugin_id": self.plugin_id}
    ...
    async def get_metrics(self) -> Dict[str, Any]:
        ...
        """
        return {"plugin_id": self.plugin_id, "metrics_available": False}
    ...
    async def shutdown(self) -> Dict[str, Any]:
        ...
        return {"success": True, "plugin_id": self.plugin_id}
