...
def create_test_suite(component=None):
    ...
    if component is None or component == "drm":
        suite.addTest(
            TestDynamicResourceManagerIntegration(
                "test_resource_manager_provisions_initial_workers"
            )
        )
        suite.addTest(
            TestDynamicResourceManagerIntegration("test_resource_manager_scales_up_with_high_queue")
        )
        suite.addTest(
            TestDynamicResourceManagerIntegration(
                "test_resource_manager_scales_down_with_low_queue"
            )
        )
        suite.addTest(
            TestDynamicResourceManagerIntegration("test_worker_registration_with_coordinator")
        )
