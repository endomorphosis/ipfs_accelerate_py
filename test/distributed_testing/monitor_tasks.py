...
async def monitor_workers(
    coordinator_url: str, api_key: Optional[str] = None, format: str = "table"
) -> None:
    """
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Monitor tasks in the distributed testing framework"
    )
    parser.add_argument(
    ...
    parser.add_argument("--limit", type=int, default=100, help="Maximum number of tasks to display")
    ...
    group.add_argument("--workers", action="store_true", help="Show workers instead of tasks")
    group.add_argument("--metrics", action="store_true", help="Show system metrics")
