...
class TestRailConnector(ExternalSystemInterface):
        ...
        try:
            ...
            async with self.session.get(url) as response:
                if response.status == 200:
                    ...
                    logger.info(
                        f"Connected to TestRail as {data.get('name')} ({data.get('email')})"
                    )
            ...
            if self.project_id:
                ...
                async with self.session.get(url) as response:
                    if response.status == 200:
                        ...
                        logger.debug(
                            f"Cached {len(data)} test suites for project {self.project_id}"
                        )
    ...
    async def _add_test_run(self, params: Dict[str, Any]) -> ExternalSystemResult:
        ...
        # Prepare data
        data = {"name": name, "include_all": params.get("include_all", True)}
        ...
        try:
            async with self.session.post(url, json=data) as response:
                ...
                if response.status in [200, 201]:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="add_test_run", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json=data) as response:
                ...
                if response.status in [200, 201]:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="add_test_case", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json=data) as response:
                ...
                if response.status in [200, 201]:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="add_test_result", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json=data) as response:
                ...
                if response.status in [200, 201]:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="add_test_plan", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.get(url) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="get_test_case", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.get(url) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="get_test_run", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.get(url) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="get_test_results", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.get(url) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="get_test_plan", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json=data) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="update_test_case", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json=data) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="update_test_run", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json={}) as response:
                ...
                if response.status == 200:
                    ...
                    return ExternalSystemResult(
                        success=True, operation="close_test_run", result_data=data
                    )
                else:
                    error_text = await response.text()
        ...
        try:
            async with self.session.post(url, json={}) as response:
                ...
                if response.status in [200, 204]:
                    return ExternalSystemResult(
                        success=True, operation="delete_test_run", result_data={"run_id": run_id}
                    )
                else:
                    error_text = await response.text()
    ...
    async def _delete_test_case(self, params: Dict[str, Any]) -> ExternalSystemResult:
        ...
        try:
            async with self.session.post(url, json={}) as response:
                ...
                if response.status in [200, 204]:
                    return ExternalSystemResult(
                        success=True, operation="delete_test_case", result_data={"case_id": case_id}
                    )
                else:
                    error_text = await response.text()
