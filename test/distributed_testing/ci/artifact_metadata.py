...
class ArtifactMetadata:
    ...
    def __init__(
        ...
        self.artifact_type = artifact_type or self._detect_artifact_type(
    ...
    def _extract_content_metadata(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.artifact_path.endswith(".json"):
                ...
                if (
                    self.artifact_type == "test_report"
                    or self.artifact_type == "performance_report"
                ):
                    metrics = {}
...
class ArtifactDiscovery:
    ...
    def find_latest_artifact(
        artifacts: List[ArtifactMetadata], artifact_type: str, test_run_id: Optional[str] = None
        ...
        matching = [
            ...
            and (test_run_id is None or a.test_run_id == test_run_id)
        ]
    ...
    def extract_metrics_from_artifacts(
        artifacts: List[ArtifactMetadata], metric_names: List[str]
    ) -> Dict[str, List[float]]:
        """
