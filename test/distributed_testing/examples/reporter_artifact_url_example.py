...
async def run_example(args):
    ...
    artifacts_to_create = [
        ...
        {
            "name": "test_metrics.csv",
            "content": "test,result,duration\ntest1,pass,0.5\ntest2,fail,1.2",
        },
        {
            "name": "test_log.txt",
    ...
    if ci_provider:
        ...
        artifacts = await reporter.collect_and_upload_artifacts(
            test_run_id=test_run_id, artifact_patterns=artifact_paths
        )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test Reporter with Artifact URL Retrieval Example"
    )
