...
class NotificationPlugin(Plugin):
    ...
    def __init__(self):
        ...
        super().__init__(
            name="SimpleNotification", version="1.0.0", plugin_type=PluginType.NOTIFICATION
        )
...
""")
        ...
        if notification_plugin_id:
            ...
            if notification_plugin:
                await plugin_manager.configure_plugin(
        ...
        for i in range(5):
            ...
            await coordinator.plugin_manager.invoke_hook(
                ...
                task_id,
                {
                    ...
                    "priority": 5,
                    "hardware_requirements": {"gpu_memory_gb": 4, "supports_cuda": True},
            ...
            if i % 4 != 0:  # 75% success rate
                ...
                await coordinator.plugin_manager.invoke_hook(
                    HookType.TASK_FAILED, task_id, "Model test failed due to out of memory error"
                )
        ...
        await coordinator.plugin_manager.invoke_hook(HookType.WORKER_DISCONNECTED, mock_worker_id)
