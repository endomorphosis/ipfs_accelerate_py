...
from .load_balancer_integration import (
    create_hardware_aware_load_balancer,
    register_type_specific_schedulers,
...
class TestHardwareAwareScheduler(unittest.TestCase):
    ...
    def _create_test_worker_capabilities(
        self, worker_id: str, worker_type: str
    ) -> WorkerCapabilities:
        ...
        capabilities = WorkerCapabilities(
            ...
            hardware_specs={"cpu": {"cores": 8, "threads": 16}, "memory": {"total_gb": 32}},
            software_versions={"python": "3.9.5"},
    ...
    def test_test_requirement_conversion(self):
        ...
        self.assertEqual(
            workload_profile.min_memory_bytes, int(requirements.minimum_memory * 1024 * 1024 * 1024)
        )
    ...
    def test_worker_selection(self):
        ...
        selected_worker = self.scheduler.select_worker(
            requirements, self.worker_capabilities, self.worker_loads, self.performance_data
        )
    ...
    def test_efficiency_adjustment(self):
        ...
        self.scheduler._update_worker_hardware_profiles(
    ...
    def test_composite_scheduler(self):
        ...
        load_balancer, workload_manager, scheduler = create_hardware_aware_load_balancer(
            use_composite=True, hardware_scheduler_weight=0.8
        )
    ...
    def test_type_specific_schedulers(self):
        ...
        self.assertEqual(
            load_balancer.test_type_schedulers["vision_classification"], mock_vision_scheduler
        )
        self.assertEqual(
            load_balancer.test_type_schedulers["nlp_text_classification"], mock_nlp_scheduler
        )
