...
from .hardware_workload_management import HardwareWorkloadManager, HardwareTaxonomy
...
def shutdown_integration(
    load_balancer: LoadBalancerService, workload_manager: HardwareWorkloadManager
) -> None:
    """
