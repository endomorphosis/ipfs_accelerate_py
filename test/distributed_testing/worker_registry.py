...
class WorkerRegistry:
    ...
    async def deregister(self, worker_id: str) -> bool:
        ...
        for capability in capabilities:
            if (
                capability in self.worker_capabilities
                and worker_id in self.worker_capabilities[capability]
            ):
