...
def main():
    ...
    parser.add_argument(
        "--detect-only",
        action="store_true",
        help="Only detect hardware capabilities, don't run examples",
    )
    parser.add_argument(
        "--with-browser", action="store_true", help="Enable browser-based WebGPU/WebNN detection"
    )
    parser.add_argument("--db-path", help="Path to DuckDB database for storing results")
    parser.add_argument(
        "--task-scheduling", action="store_true", help="Run task scheduling simulation"
    )
    parser.add_argument(
        "--worker-compatibility", action="store_true", help="Run worker compatibility example"
    )
    ...
    parser.add_argument(
        "--run-tests", action="store_true", help="Run tests for the hardware capability detector"
    )
