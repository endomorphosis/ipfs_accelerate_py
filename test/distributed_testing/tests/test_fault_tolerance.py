...
class TestDistributedStateManager(unittest.TestCase):
    ...
    def test_update_batch(self):
        """Test batch update operation."""
        # Update multiple values
        updates = {"worker-1": {"status": "active"}, "worker-2": {"status": "idle"}}
...
class TestErrorRecoveryStrategies(unittest.TestCase):
    ...
    def test_retry_strategy(self):
        ...
        error_info = {"operation": test_operation, "args": [], "kwargs": {}}
    ...
    def test_worker_recovery_strategy(self):
        ...
        self.coordinator.workers = {"worker-1": {"worker_id": "worker-1", "status": "active"}}
        ...
        # Execute strategy
        error_info = {"worker_id": "worker-1", "category": ErrorCategory.WORKER_OFFLINE.value}
    ...
    def test_strategy_selection(self):
        ...
        connection_strategy = self.recovery_manager.get_strategy_for_error(
            {"category": ErrorCategory.CONNECTION.value}
        )
        worker_strategy = self.recovery_manager.get_strategy_for_error(
            {"category": ErrorCategory.WORKER_OFFLINE.value}
        )
        unknown_strategy = self.recovery_manager.get_strategy_for_error(
