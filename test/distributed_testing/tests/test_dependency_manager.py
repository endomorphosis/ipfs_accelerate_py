...
class TestDependencyManagerTests(unittest.TestCase):
    ...
    def test_register_test(self):
        ...
        # Register a test
        self.manager.register_test(
            "test1",
            [Dependency("dep1"), Dependency("dep2", dependency_type=DependencyType.SOFT)],
            ["group1", "group2"],
        )
    ...
    def test_register_test_batch(self):
        ...
        self.manager.register_test_batch(
            [
                {"test_id": "test1", "dependencies": [Dependency("dep1")], "groups": ["group1"]},
                {"test_id": "test2", "dependencies": [Dependency("test1")], "groups": ["group2"]},
                {
                    "test_id": "test3",
                    "dependencies": [Dependency("test1"), Dependency("test2")],
    ...
    def test_update_test_status(self):
        ...
        self.manager.update_test_status(
            "test1", "completed", result={"passed": True}, metadata={"duration": 10.5}
        )
    ...
    def test_batch_update_test_statuses(self):
        ...
        self.manager.batch_update_test_statuses(
            [
                {"test_id": "test1", "status": "running"},
                {"test_id": "test2", "status": "completed", "result": {"passed": True}},
            ]
        )
    ...
    def test_resolve_dependencies_failed_hard(self):
        ...
        self.manager.register_test("test1")
        self.manager.register_test(
            "test2", [Dependency("test1", dependency_type=DependencyType.HARD)]
        )
    ...
    def test_resolve_dependencies_failed_soft(self):
        ...
        self.manager.register_test("test1")
        self.manager.register_test(
            "test2", [Dependency("test1", dependency_type=DependencyType.SOFT)]
        )
    ...
    def test_resolve_dependencies_optional(self):
        ...
        self.manager.register_test("test1")
        self.manager.register_test(
            "test2", [Dependency("test1", dependency_type=DependencyType.OPTIONAL)]
        )
    ...
    def test_prune_satisfied_dependencies(self):
        ...
        self.manager.register_test("test1")
        self.manager.register_test("test2")
        self.manager.register_test("test3", [Dependency("test1"), Dependency("test2")])
    ...
    def test_export_import_dependency_data(self):
        ...
        self.manager.register_test(
            "test3",
            [Dependency("test1"), Dependency("test2"), Dependency("group1", is_group=True)],
            ["group2"],
        )
    ...
    def test_dependency_graph_json(self):
        ...
        self.manager.register_test("test1")
        self.manager.register_test("test2", [Dependency("test1")], ["group1"])
        self.manager.register_test("test3", [Dependency("test1"), Dependency("test2")], ["group2"])
