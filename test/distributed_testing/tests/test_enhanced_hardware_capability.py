...
class HardwareCapabilityDetectorTests(unittest.TestCase):
    ...
    @unittest.skipUnless(
        ...
        and importlib.util.find_spec("cpuinfo") is not None,
    ...
    @unittest.skipUnless(
        importlib.util.find_spec("pynvml") is not None, "pynvml is required for this test"
    )
    ...
    def test_detect_all_capabilities(
        self, mock_webnn, mock_webgpu, mock_npu, mock_tpu, mock_gpu, mock_cpu
    ):
        ...
        self.assertEqual(
            worker_capabilities.hardware_capabilities[0].hardware_type, HardwareType.CPU
        )
        self.assertEqual(
            worker_capabilities.hardware_capabilities[1].hardware_type, HardwareType.GPU
        )
...
class HardwareCapabilityComparatorTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.gpu_capability = HardwareCapability(
            ...
            capabilities={"compute_capability": "8.6", "tensor_cores": True},
        )
    ...
    def test_is_compatible(self):
        ...
        requirements = {
            ...
            "min_scores": {"compute": CapabilityScore.GOOD},
            "required_capabilities": {"tensor_cores": True},
        }
        ...
        requirements = {"hardware_type": HardwareType.TPU}
        ...
        requirements = {"hardware_type": HardwareType.GPU, "min_memory_gb": 16.0}
        ...
        requirements = {
            "hardware_type": HardwareType.GPU,
            "min_scores": {"memory": CapabilityScore.EXCELLENT},
        }
        ...
        requirements = {
            "hardware_type": HardwareType.GPU,
            "required_capabilities": {"tensor_cores": False},
        }
    ...
    def test_estimate_performance(self):
        ...
        estimate = self.comparator.estimate_performance(
            self.gpu_capability,
            "inference",
            {"precision": PrecisionType.FP16, "memory_gb": 4.0, "batch_size": 8},
        )
        ...
        cpu_estimate = self.comparator.estimate_performance(
            self.cpu_capability,
            "inference",
            {"precision": PrecisionType.FP32, "memory_gb": 4.0, "batch_size": 1},
        )
        ...
        train_estimate = self.comparator.estimate_performance(
            self.gpu_capability,
            "training",
            {"precision": PrecisionType.FP16, "memory_gb": 8.0, "batch_size": 16},
        )
        ...
        incompatible_estimate = self.comparator.estimate_performance(
            self.gpu_capability, "inference", {"precision": PrecisionType.FP64, "memory_gb": 4.0}
        )
    ...
    def test_find_best_hardware(self):
        ...
        best_capability, estimate = self.comparator.find_best_hardware(
            capabilities,
            "inference",
            {"precision": PrecisionType.FP32, "memory_gb": 4.0, "batch_size": 4},
        )
        ...
        best_capability, estimate = self.comparator.find_best_hardware(
            capabilities, "inference", {"precision": PrecisionType.FP64, "memory_gb": 4.0}
        )
