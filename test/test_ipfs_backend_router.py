...
class TestKuboCLIBackend:
    ...
    def test_command_failure(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=1, stdout=b"", stderr=b"Error: command failed")
...
class TestConvenienceFunctions:
    ...
    def test_add_bytes_and_cat(self, temp_dir, sample_data, clean_env, monkeypatch):
        ...
        ipfs_backend_router.register_ipfs_backend(
            "hf_cache", lambda: ipfs_backend_router.HuggingFaceCacheBackend(cache_dir=temp_dir)
        )
