// Tests for SampleBackend API Backend
import { SampleBackend } from '../src/api_backends/sample_backend';
import { ApiMetadata, Message } from '../src/api_backends/types';

// Mock fetch for testing
global.fetch = jest.fn();

describe('SampleBackend API Backend', () => {
  ...
  beforeEach(() => {
    ...
    // Set up test data
    mockMetadata = {
      sample_backend_api_key: 'test-api-key'
    };
    
    // Create backend instance
    backend = new SampleBackend({}, mockMetadata);
  });
