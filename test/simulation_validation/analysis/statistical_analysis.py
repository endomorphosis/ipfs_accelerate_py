...
class StatisticalAnalyzer:
    ...
    def analyze_worst_configurations(
        self, df: Optional[pd.DataFrame] = None, n: int = 10
    ) -> Dict[str, Dict[str, Any]]:
        """
    ...
    def analyze_calibration_candidates(
        self, df: Optional[pd.DataFrame] = None, threshold: float = 0.7, min_accuracy: float = 0.5
    ) -> Dict[str, Dict[str, Any]]:
        """
    ...
    def analyze_drift_over_time(self, time_window: int = 90, db_api=None) -> Dict[str, Any]:
        """
