...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(sys.stdout), logging.FileHandler("converter_test.log")],
)
...
def main():
    ...
    sample_file = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "sample_webgpu_backend.py"
    )
    output_file = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "sample_webgpu_backend_improved.ts"
    )
