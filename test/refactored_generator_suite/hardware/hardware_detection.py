...
ARCHITECTURE_HARDWARE_COMPATIBILITY = {
    ...
    "vision": {"cpu": True, "cuda": True, "rocm": True, "mps": True, "openvino": True, "qnn": True},
    ...
    "speech": {"cpu": True, "cuda": True, "rocm": True, "mps": True, "openvino": True, "qnn": True},
    "multimodal": {
        "cpu": True,
        "cuda": True,
        "rocm": True,
    ...
    "rag": {"cpu": True, "cuda": True, "rocm": True, "mps": True, "openvino": False, "qnn": False},
}
...
def get_model_hardware_recommendations(arch_type: str) -> List[str]:
    ...
    return sorted(
        compatible_hw, key=lambda x: priority_order.index(x) if x in priority_order else 999
    )
