...
class ErnieSkillset:
    ...
    def __init__(self, model_id=None, device=None):
        ...
        Args:
            model_id: Model ID to use (default: ernie-base)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", help="Model path or name", default="ernie-base")
    ...
    skillset = ErnieSkillset(args.model)
