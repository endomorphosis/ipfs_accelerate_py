...
class Xlm_robertaSkillset:
    ...
    def __init__(self, model_id=None, device=None):
        ...
        Args:
            model_id: Model ID to use (default: xlm-roberta-base)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", help="Model path or name", default="xlm-roberta-base")
    ...
    skillset = Xlm_robertaSkillset(args.model)
