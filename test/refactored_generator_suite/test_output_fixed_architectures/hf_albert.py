...
class AlbertSkillset:
    ...
    def __init__(self, model_id=None, device=None):
        ...
        Args:
            model_id: Model ID to use (default: albert-base)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", help="Model path or name", default="albert-base")
    ...
    skillset = AlbertSkillset(args.model)
