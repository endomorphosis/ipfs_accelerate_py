#!/usr/bin/env python3
"""
Hugging Face model skillset for bloom model.
...
class {model_class_name}Skillset:
    """Skillset for bloom model across hardware backends."""
    ...
    def __init__(self, model_id=None, device=None):
        ...
        logger.info(f"Initialized bloom skillset with device={device}")
