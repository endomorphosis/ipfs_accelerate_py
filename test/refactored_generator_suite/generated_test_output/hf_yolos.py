#!/usr/bin/env python3
"""
Hugging Face model skillset for yolos model.
...
class {model_class_name}Skillset:
    """Skillset for yolos model across hardware backends."""
    ...
    def __init__(self, model_id=None, device=None):
        ...
        logger.info(f"Initialized yolos skillset with device={device}")
