#!/usr/bin/env python3
"""
Hugging Face model skillset for falcon model.
...
class {model_class_name}Skillset:
    """Skillset for falcon model across hardware backends."""
    ...
    def __init__(self, model_id=None, device=None):
        ...
        logger.info(f"Initialized falcon skillset with device={device}")
