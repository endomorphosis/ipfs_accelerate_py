#!/usr/bin/env python3
"""
Hugging Face model skillset for bert model.
...
class {model_class_name}Skillset:
    """Skillset for bert model across hardware backends."""
    ...
    def __init__(self, model_id=None, device=None):
        ...
        self.task = "fill-mask" if "bert" in ["bert", "roberta"] else "feature-extraction"
        ...
        self.test_cases = [
            {
                ...
                "platform": "CPU",
                "input": "This is a sample text for testing the bert model.",
        ...
        logger.info(f"Initialized bert skillset with device={device}")
