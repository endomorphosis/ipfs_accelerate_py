#!/usr/bin/env python3
"""
Hugging Face model skillset for mpnet model.
...
class {model_class_name}Skillset:
    """Skillset for mpnet model across hardware backends."""
    ...
    def __init__(self, model_id=None, device=None):
        ...
        self.task = "fill-mask" if "mpnet" in ["bert", "roberta"] else "feature-extraction"
        ...
        self.test_cases = [
            {
                ...
                "platform": "CPU",
                "input": "This is a sample text for testing the mpnet model.",
        ...
        logger.info(f"Initialized mpnet skillset with device={device}")
