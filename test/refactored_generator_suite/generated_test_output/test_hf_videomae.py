...
class hf_videomae:
    ...
    The videomae model is a Transformer model for NLP and ML tasks.
    """
    ...
    def _create_mock_processor(self):
        ...
        try:
            ...
            print("(MOCK) Created mock VIDEOMAE tokenizer")
            return tokenizer
            ...
            print("(MOCK) Created simple mock VIDEOMAE tokenizer")
    ...
    def _create_mock_endpoint(self, model_name, device_label):
        ...
        try:
            ...
            import asyncio
            print(f"(MOCK) Created mock VIDEOMAE endpoint for {{model_name}} on {{device_label}}")
