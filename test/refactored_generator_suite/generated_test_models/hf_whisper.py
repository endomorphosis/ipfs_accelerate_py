...
def mock_tokenize(audio, sampling_rate=16000, return_tensors="pt", **kwargs):
    ...
    return {
        ...
        "attention_mask": attention_mask
            ...
            print("(MOCK) Created mock WHISPER tokenizer")
            return tokenizer
...
def mock_tokenize(audio, sampling_rate=16000, return_tensors="pt", **kwargs):
    ...
    return {
        ...
        "attention_mask": attention_mask
            ...
            print("(MOCK) Created simple mock WHISPER tokenizer")
...
return result
            ...
            import asyncio
            print(f"(MOCK) Created mock WHISPER endpoint for {model_name} on {device_label}")
