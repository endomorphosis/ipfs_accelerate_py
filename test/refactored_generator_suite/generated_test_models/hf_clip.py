...
def mock_tokenize(text=None, images=None, return_tensors="pt", padding=None, truncation=None, max_length=None, **kwargs):
    ...
    return result
            ...
            print("(MOCK) Created mock CLIP tokenizer")
            return tokenizer
...
def mock_tokenize(text=None, images=None, return_tensors="pt", padding=None, truncation=None, max_length=None, **kwargs):
    ...
    return result
            ...
            print("(MOCK) Created simple mock CLIP tokenizer")
...
return result
            ...
            import asyncio
            print(f"(MOCK) Created mock CLIP endpoint for {model_name} on {device_label}")
