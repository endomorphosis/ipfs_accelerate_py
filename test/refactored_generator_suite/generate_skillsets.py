...
from scripts.generators.architecture_detector import get_architecture_type, normalize_model_name
from scripts.generators.model_generator import ModelSkillsetGenerator, PRIORITY_MODELS
...
def generate_skillsets(args):
    ...
    if args.model:
        ...
        logger.info(
            f"Generating skillsets for {len(models_to_generate)} {args.architecture} models"
        )
