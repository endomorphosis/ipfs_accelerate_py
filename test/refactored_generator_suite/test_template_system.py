...
def test_template_composer():
    ...
    success, output_file = composer.generate_model_implementation(
        model_name=model_type, arch_type=arch_type, hardware_types=["cpu"], force=True
    )
    ...
    success, output_file = composer.generate_model_implementation(
        model_name=vision_model_type, arch_type=vision_arch_type, hardware_types=["cpu"], force=True
    )
