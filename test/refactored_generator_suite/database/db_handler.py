...
class GeneratorDatabaseHandler:
    ...
    def store_task(self, task_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            result = self.connection.execute(
                "SELECT task_id FROM generator_tasks WHERE task_id = ?", [values["task_id"]]
            ).fetchone()
    ...
    def store_task_metric(
        self, task_id: str, metric_name: str, metric_value: float, metric_unit: str = ""
    ) -> bool:
        """
        ...
        try:
            ...
            """,
                [task_id, metric_name, float(metric_value), metric_unit],
            )
    ...
    def get_task(self, task_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if tags:
                task_data["tags"] = {tag["tag_name"]: tag["tag_value"] for tag in tags}
    ...
    def delete_task(self, task_id: str) -> bool:
        ...
        try:
            ...
            self.connection.execute(
                "DELETE FROM generator_task_metrics WHERE task_id = ?", [task_id]
            )
    ...
    def delete_batch_task(self, batch_id: str, delete_tasks: bool = False) -> bool:
        ...
        try:
            ...
            # Delete the batch
            self.connection.execute(
                "DELETE FROM generator_batch_tasks WHERE batch_id = ?", [batch_id]
            )
    ...
    def get_task_count(self, status: Optional[str] = None, model_name: Optional[str] = None) -> int:
        """
