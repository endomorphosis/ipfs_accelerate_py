...
def test_template_selection():
    ...
    test_cases = [
        ...
        {
            "model_type": "esm2",
            "model_info": {"architecture": "protein-folding", "task": "fill-mask", "name": "esm2"},
        },
        {
            "model_type": "videomae",
            "model_info": {
    ...
    for model_type in test_models:
        ...
        if result["success"]:
            ...
            if output_path.exists():
                ...
                if (
                    architecture.replace("-", "_") in content
                    or architecture.split("-")[0] in content
                ):
            ...
            print(
                f"  ✗ Failed to generate test for {model_type}: {result.get('error', 'Unknown error')}"
            )
