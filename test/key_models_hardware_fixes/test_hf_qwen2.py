...
class Qwen2TestBase:
    ...
    def __init__(
        self, model_id="Qwen/Qwen2-1.5B-Instruct", model_path=None, resources=None, metadata=None
    ):
        ...
        self.model_config = QWEN2_MODELS_REGISTRY.get(
            model_id,
            {
...
def main():
    ...
    parser.add_argument(
        "--platform",
        default="all",
        help="Platform to test (cpu, cuda, openvino, mps, rocm, webnn, webgpu, all)",
    )
    parser.add_argument(
        "--output", default="qwen2_test_results.json", help="Output file for test results"
    )
