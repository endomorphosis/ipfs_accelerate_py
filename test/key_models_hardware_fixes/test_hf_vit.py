...
class ViTTestBase:
    ...
    def __init__(
        self, model_id="google/vit-base-patch16-224", model_path=None, resources=None, metadata=None
    ):
        ...
        self.model_config = VIT_MODELS_REGISTRY.get(
            model_id,
            {
...
def main():
    ...
    parser.add_argument(
        "--output", default="vit_test_results.json", help="Output file for test results"
    )
