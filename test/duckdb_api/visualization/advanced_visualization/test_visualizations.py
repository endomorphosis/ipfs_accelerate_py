...
def generate_sample_data():
    ...
    # Metric values
    throughput_base = {"CPU": 50, "GPU": 200, "WebGPU": 180, "WebNN": 150, "MPS": 120}

    latency_base = {"CPU": 100, "GPU": 20, "WebGPU": 30, "WebNN": 40, "MPS": 50}

    memory_base = {"CPU": 500, "GPU": 1200, "WebGPU": 1000, "WebNN": 800, "MPS": 900}
...
def main():
    ...
    parser.add_argument(
        "--heatmap", action="store_true", help="Test hardware heatmap visualizations"
    )
    parser.add_argument(
        "--time-series", action="store_true", help="Test time series visualizations"
    )
    parser.add_argument("--all", action="store_true", help="Test all visualization types")
    parser.add_argument(
        "--output-dir", type=str, default=None, help="Output directory for visualizations"
    )
