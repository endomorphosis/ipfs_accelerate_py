...
def generate_drm_badge(input_file: str, output_file: str, label: str = "DRM Tests") -> bool:
    ...
    # Create badge data
    badge_data = {"schemaVersion": 1, "label": label, "message": status, "color": color}
...
def main():
    ...
    parser.add_argument(
        "--type", choices=["standard", "drm"], default="standard", help="Type of badge to generate"
    )
    parser.add_argument(
        "--component-badges", action="store_true", help="Generate component-specific badges"
    )
