...
class HardwareBackend:
    ...
    def __init__(
        self, hardware_profile: HardwareCapabilityProfile, taxonomy: EnhancedHardwareTaxonomy
    ):
        self.hardware_profile = hardware_profile
        self.taxonomy = taxonomy
        self.capabilities = taxonomy.get_hardware_capabilities(
            hardware_profile, include_inherited=True
        )
    ...
    def get_estimated_performance(self, context: OperationContext) -> float:
        ...
        for cap_id, cap_def in self.capabilities.items():
            ...
            if (
                hasattr(cap_def, "performance_impact")
                and cap_def.performance_impact
                and "throughput" in cap_def.performance_impact
            ):
...
class HardwareAbstractionLayer:
    ...
    def __init__(self, taxonomy: Optional[EnhancedHardwareTaxonomy] = None):
        ...
        self.backend_registry: Dict[
            str, Callable[[HardwareCapabilityProfile, EnhancedHardwareTaxonomy], HardwareBackend]
        ] = {}
    ...
    def find_best_backend_for_operation(
        self, context: OperationContext
    ) -> Optional[Tuple[HardwareBackend, float]]:
        """
