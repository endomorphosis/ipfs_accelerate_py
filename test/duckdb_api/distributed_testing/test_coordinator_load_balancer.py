...
def create_test_tasks(coordinator, count=20):
    ...
    for i in range(count):
        ...
        config = {
            "model": {"model_id": model_id, "model_family": model_family},
            "test_type": test_type,
        ...
        task_id = coordinator.add_task(
            task_type=test_type, config=config, priority=config["priority"]
        )
...
def main():
    ...
    try:
        ...
        logger.info(
            f"Coordinator started with load balancer {'enabled' if not args.disable_load_balancer else 'disabled'}"
        )
        ...
        for i in range(args.worker_count):
            ...
            if i % 4 == 0:
                ...
                capabilities = {
                    ...
                    "hardware": {
                        "gpu": {"available": True, "count": 1, "cuda_available": True},
                        "cpu": {"cores": 8, "threads": 16},
                        "memory": {"available_gb": 16.0},
                    },
                    "tags": {"vision_optimized": True},
                }
            elif i % 4 == 1:
                ...
                capabilities = {
                    ...
                    "hardware": {
                        ...
                        "memory": {"available_gb": 32.0},
                    },
                    "tags": {"text_optimized": True},
                }
            else:
            ...
            worker_thread = threading.Thread(
                target=simulate_worker, args=(api, worker_id, capabilities)
            )
