...
class TestEnhancedHardwareTaxonomy(unittest.TestCase):
    ...
    def test_capability_registry(self):
        ...
        self.assertEqual(
            retrieved_cap.supported_hardware_classes, {HardwareClass.CPU, HardwareClass.GPU}
        )
    ...
    def test_hardware_hierarchy(self):
        ...
        self.assertIn(
            (HardwareClass.TPU, 0.8), self.taxonomy.hardware_hierarchies[HardwareClass.GPU]
        )

        # Check the relationship was created
        relationships = self.taxonomy.get_hardware_relationships(
            hardware=HardwareClass.GPU, relationship_type="parent_of"
        )
    ...
    def test_hardware_relationship(self):
        ...
        relationships = self.taxonomy.get_hardware_relationships(
            hardware=HardwareClass.GPU, relationship_type="accelerates"
        )
    ...
    def test_capability_assignment(self):
        ...
        self.taxonomy.assign_capability_to_hardware(
            hardware_profile=self.gpu_profile, capability_id="matrix_multiplication"
        )
        ...
        capabilities = self.taxonomy.get_hardware_capabilities(
            self.gpu_profile, include_inherited=False
        )
    ...
    def test_capability_inheritance(self):
        ...
        self.taxonomy.assign_capability_to_hardware(
            hardware_profile=self.cpu_profile, capability_id="matrix_multiplication"
        )
        ...
        all_capabilities = self.taxonomy.get_hardware_capabilities(
            self.gpu_profile, include_inherited=True
        )
    ...
    def test_workload_capability_match(self):
        ...
        self.taxonomy.assign_capability_to_hardware(
            hardware_profile=self.gpu_profile, capability_id="tensor_core_acceleration"
        )

        # Assign to NPU
        self.taxonomy.assign_capability_to_hardware(
            hardware_profile=self.npu_profile, capability_id="low_precision_computation"
        )
    ...
    def test_register_profile_with_auto_discover(self):
        ...
        self.taxonomy.discover_capabilities = lambda hp: original_discover_capabilities(
            self.taxonomy, hp
        )
