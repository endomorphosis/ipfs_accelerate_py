...
class TestDynamicResourceManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.worker1_resources = {
            "cpu": {"cores": 8, "physical_cores": 4, "available_cores": 6.5},
        ...
        self.worker2_resources = {
            "cpu": {"cores": 16, "physical_cores": 8, "available_cores": 12.0},
        ...
        self.small_task_resources = {"cpu_cores": 2, "memory_mb": 4096, "gpu_memory_mb": 2048}

        self.large_task_resources = {"cpu_cores": 8, "memory_mb": 16384, "gpu_memory_mb": 8192}
    ...
    def test_register_worker(self):
        ...
        self.assertTrue(result)
        self.assertEqual(
            self.resource_manager.worker_resources["worker1"]["cpu"]["available_cores"], 7.0
        )
    ...
    def test_update_worker_resources(self):
        ...
        self.assertTrue(result)
        self.assertEqual(
            self.resource_manager.worker_resources["worker1"]["cpu"]["available_cores"], 4.0
        )
        self.assertEqual(
            self.resource_manager.worker_resources["worker1"]["memory"]["available_mb"], 6144
        )
    ...
    def test_reserve_resources(self):
        ...
        reservation_id = self.resource_manager.reserve_resources(
            worker_id="worker1", task_id="task1", resource_requirements=self.small_task_resources
        )

        self.assertIsNotNone(reservation_id)
        self.assertIn(reservation_id, self.resource_manager.resource_reservations)
        self.assertEqual(
            self.resource_manager.resource_reservations[reservation_id]["worker_id"], "worker1"
        )
        self.assertEqual(
            self.resource_manager.resource_reservations[reservation_id]["task_id"], "task1"
        )

        # Check that worker resources are updated
        worker_resources = self.resource_manager.worker_resources["worker1"]
        self.assertEqual(
            worker_resources["cpu"]["reserved_cores"], self.small_task_resources["cpu_cores"]
        )
        self.assertEqual(
            worker_resources["memory"]["reserved_mb"], self.small_task_resources["memory_mb"]
        )
        self.assertEqual(
        ...
        self.assertEqual(self.resource_manager.task_reservation["task1"], reservation_id)
    ...
    def test_check_resource_availability(self):
        ...
        availability = self.resource_manager.check_resource_availability(
            worker_id="worker1", resource_requirements=self.small_task_resources
        )
        ...
        availability = self.resource_manager.check_resource_availability(
            worker_id="worker1", resource_requirements=self.large_task_resources
        )
        ...
        availability = self.resource_manager.check_resource_availability(
            worker_id="nonexistent", resource_requirements=self.small_task_resources
        )
        self.assertFalse(availability["available"])
    ...
    def test_calculate_task_worker_fitness(self):
        ...
        fitness2 = self.resource_manager.calculate_task_worker_fitness(
            worker_id="worker2", resource_requirements=self.small_task_resources
        )
        ...
        fitness4 = self.resource_manager.calculate_task_worker_fitness(
            worker_id="worker2", resource_requirements=self.large_task_resources
        )
    ...
    def test_evaluate_scaling_low_utilization(self):
        ...
        self.resource_manager.last_scale_down_time = time.time() - (
            self.resource_manager.scale_down_cooldown + 60
        )
