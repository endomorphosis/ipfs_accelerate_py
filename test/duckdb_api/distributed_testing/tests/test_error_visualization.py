...
class TestErrorVisualization(unittest.TestCase):
            ...
            error_report = {
                ...
                "system_context": {
                    ...
                    "metrics": {
                        ...
                        "memory": {"used_percent": 70, "total_gb": 32, "available_gb": 9.6},
                        "disk": {"used_percent": 50, "total_gb": 512, "free_gb": 256},
                    },
                },
                "hardware_context": {
                    "hardware_type": "cuda",
    ...
    def test_is_recurring_error(self):
        ...
        non_recurring_error = {
            "error_frequency": {
                "recurring": False,
                "same_type": {"last_1h": 1, "last_6h": 1, "last_24h": 1},
                "similar_message": {"last_1h": 1, "last_6h": 2, "last_24h": 3},
            }
        }
    ...
    def test_is_critical_error(self):
        ...
        critical_by_category = {"error_category": "HARDWARE_NOT_AVAILABLE"}
