...
from data.duckdb.distributed_testing.circuit_breaker import CircuitBreaker, CircuitState
...
class TestCircuitBreakerVisualization(unittest.TestCase):
    ...
    def test_generate_iframe_html(self):
        ...
        # Check iframe HTML
        self.assertIn(
            '<iframe src="dashboards/circuit_breakers/circuit_breaker_dashboard.html"', iframe_html
        )
...
class TestCircuitBreakerDashboardIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.coordinator.circuit_breaker_integration.get_circuit_breaker_metrics = MagicMock(
            return_value={
                "worker_circuits": {},
                "task_circuits": {},
                "endpoint_circuits": {},
        ...
        self.dashboard_integration = CircuitBreakerDashboardIntegration(
            coordinator=self.coordinator, output_dir=self.temp_dir
        )
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            self.dashboard_integration.circuit_breaker_integration,
            self.coordinator.circuit_breaker_integration,
        )
    ...
    def test_generate_dashboard(self):
        ...
        # Mock visualization
        self.dashboard_integration.visualization.generate_dashboard = MagicMock(
            return_value="Dashboard HTML"
        )
    ...
    def test_get_dashboard_iframe_html(self):
        ...
        # Mock visualization
        self.dashboard_integration.visualization.generate_iframe_html = MagicMock(
            return_value="<iframe></iframe>"
        )
    ...
    def test_get_metrics_summary(self):
        ...
        # Mock visualization
        self.dashboard_integration.visualization.get_latest_metrics_summary = MagicMock(
            return_value={"global_health": 100.0}
        )
