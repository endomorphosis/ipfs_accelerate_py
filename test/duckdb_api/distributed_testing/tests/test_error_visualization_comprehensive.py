...
class TestSeverityDetection(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.error_viz = ErrorVisualizationIntegration(output_dir=self.output_dir, db_path=None)
...
class TestJavaScriptSeverityDetection(unittest.TestCase):
    ...
    def test_js_error_severity_logic(self):
        ...
        def determine_error_severity(error):
            ...
            if any(
                category in error_category
                for category in ["HARDWARE_NOT_AVAILABLE", "RESOURCE_EXHAUSTED", "WORKER_CRASHED"]
            ):
                return "critical"
...
class TestWebSocketIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.error_viz = ErrorVisualizationIntegration(
            output_dir=self.output_dir, db_path=None, websocket_manager=self.websocket_manager
        )
    ...
    async def _test_report_error(self):
        ...
        error_data = {
            ...
            "error_frequency": {
                "recurring": False,
                "same_type": {"last_1h": 1, "last_6h": 1, "last_24h": 1},
                "similar_message": {"last_1h": 0, "last_6h": 0, "last_24h": 0},
            },
        }
        ...
        self.websocket_manager.broadcast.assert_any_call(
            ...
            message={
                "type": "error_visualization_update",
                "data": {"error": self.error_viz._prepare_error_for_display(error_data)},
            },
        )
    ...
    async def _test_prepare_error_for_display(self):
        ...
        error = {
            ...
            "error_category": "RESOURCE_EXHAUSTED",
            "message": "Out of memory: CUDA out of memory",
            "error_frequency": {"recurring": True, "same_type": {"last_1h": 3}},
            "hardware_context": {"hardware_status": {"memory_pressure": True}},
            "system_context": {"metrics": {"cpu": {"percent": 95}}},
        }
...
class TestErrorVisualizationIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create error visualization integration
        self.error_viz = ErrorVisualizationIntegration(
            output_dir=self.output_dir, db_path=self.db_path
        )
