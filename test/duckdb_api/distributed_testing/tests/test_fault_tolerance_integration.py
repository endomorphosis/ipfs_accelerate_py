...
class TestFaultToleranceIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fault_tolerance_manager._determine_fallback_hardware_class = MagicMock(
            return_value="CPU"
        )
    ...
    def test_handle_failure_no_open_circuits(self):
        ...
        mock_recovery_action = RecoveryAction(
            strategy=RecoveryStrategy.DELAYED_RETRY, message="Test recovery action"
        )
        self.fault_tolerance_manager._determine_recovery_strategy = MagicMock(
        ...
        self.fault_tolerance_manager._determine_recovery_strategy.assert_called_once_with(
            failure_context
        )
    ...
    def test_handle_failure_hardware_circuit_open(self):
        ...
        self.fault_tolerance_manager._determine_fallback_hardware_class.assert_called_once_with(
            "GPU"
        )
    ...
    def test_track_success(self):
        ...
        self.integration.track_success(
            task_id="task1", worker_id="worker1", hardware_class="GPU", task_type="benchmark"
        )
    ...
    def test_configure_hardware_circuits(self):
        ...
        self.integration.configure_hardware_circuits(
            {"failure_threshold": 5, "recovery_timeout": 300.0}
        )
    ...
    def test_configure_task_type_circuits(self):
        ...
        self.integration.configure_task_type_circuits(
            {"failure_threshold": 15, "recovery_timeout": 600.0}
        )
