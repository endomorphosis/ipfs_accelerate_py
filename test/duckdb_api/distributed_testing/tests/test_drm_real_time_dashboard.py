...
@unittest.skipIf(
    not DASHBOARD_AVAILABLE or not DASH_AVAILABLE, "DRM Real-Time Dashboard or Dash not available"
)
class TestDRMRealTimeDashboard(unittest.TestCase):
    ...
    def test_regression_detection(self):
        ...
        if (
            not hasattr(self.dashboard, "regression_detector")
            or self.dashboard.regression_detector is None
        ):
