...
from ..hardware_abstraction_layer import HardwareAbstractionLayer, OperationContext, HardwareBackend
...
class TestHardwareAbstractionLayer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.taxonomy.assign_capability_to_hardware(
            hardware_profile=self.npu_profile, capability_id="matrix_multiplication"
        )
