...
class TestMultiDeviceOrchestratorWithDRM(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.resource_manager = DynamicResourceManager(
            target_utilization=0.7, scale_up_threshold=0.8, scale_down_threshold=0.3
        )
        ...
        self.worker_manager.add_worker(
            "cpu_worker", {"hardware_type": "cpu", "cpu_cores": 8, "memory_gb": 16, "gpu": None}
        )
    ...
    def test_data_parallel_orchestration_with_resource_management(self):
        ...
        task_id = self.orchestrator.orchestrate_task(
            task_data=task_data, strategy=SplitStrategy.DATA_PARALLEL
        )
    ...
    def test_ensemble_orchestration_with_mixed_resources(self):
        ...
        task_data = {
            ...
            "type": "benchmark",
            "config": {"model": "bert-base-uncased", "execution_time_ms": 250},
            "ensemble_configs": [
                {
                    "variant": "fp32_cpu",
                    "precision": "fp32",
                ...
                },
                {
                    ...
                    "hardware": "tpu",
                    "batch_size": 16,
                    "resource_requirements": {"cpu_cores": 1, "memory_mb": 4096, "tpu_cores": 4},
                },
            ],
        }
        ...
        # Orchestrate task
        task_id = self.orchestrator.orchestrate_task(
            task_data=task_data, strategy=SplitStrategy.ENSEMBLE
        )
