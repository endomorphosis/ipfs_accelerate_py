...
def example_data_parallel_task():
    ...
    task = {
        "task_data": {
            ...
            "input_data": dataset,
            "config": {"processing_type": "basic_transform", "output_format": "json"},
        },
...
def example_ensemble_task():
    ...
    ensemble_task = {
        "task_data": {
            ...
            "config": {"ensemble_method": "averaging", "threshold": 0.5},
        },
        "strategy": "ensemble",
        "priority": 6,
    }
...
def example_function_parallel_task():
    ...
    function_task = {
        "task_data": {
            ...
            "config": {"batch_sizes": [1, 2, 4, 8, 16], "iterations": 100, "warmup_iterations": 10},
        },
...
def main():
    ...
    if args.examples:
        ...
        anyio.run(
            run_coordinator_with_orchestration(args.host, args.port, args.db_path, args.api_key)
        )
