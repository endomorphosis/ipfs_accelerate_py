...
class TestResultAggregator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.aggregator = ResultAggregatorService(
            db_manager=self.mock_db_manager, trend_analyzer=self.mock_trend_analyzer
        )

        # Configure with model_family_grouping disabled for testing
        self.aggregator.configure({"model_family_grouping": False})
        ...
        for model_id in models:
            for hardware_id in hardware:
                ...
                for i in range(10):
                    ...
                    throughput = (
                        base_throughput * hw_factor * (2 - variation)
            ...
            for browser in browsers:
                for platform in platforms:
                    ...
                    for i in range(5):
                        ...
                        inference_time = (
                            base_inference * platform_inference_factor * model_factor * variation
                        )
    ...
    def test_configuration(self):
        ...
        new_config = {"cache_ttl_seconds": 600, "anomaly_threshold": 3.0, "min_data_points": 10}
    ...
    def test_aggregate_with_filtering(self):
        ...
        filter_params = {"model_id": "model1", "hardware_id": "hw1"}
    ...
    def test_caching(self):
        ...
        self.aggregator.aggregate_results(
            result_type=RESULT_TYPE_PERFORMANCE, aggregation_level=AGGREGATION_LEVEL_HARDWARE
        )
    ...
    def test_anomaly_detection(self):
        ...
        self.mock_db_manager.get_performance_results.side_effect = lambda **kwargs: (
            anomalous_performance_results
        )
    ...
    def test_compatibility_results(self):
        ...
        aggregated = self.aggregator.aggregate_results(
            result_type=RESULT_TYPE_COMPATIBILITY, aggregation_level=AGGREGATION_LEVEL_HARDWARE
        )
    ...
    def test_integration_results(self):
        ...
        aggregated = self.aggregator.aggregate_results(
            result_type=RESULT_TYPE_INTEGRATION, aggregation_level=AGGREGATION_LEVEL_TASK_TYPE
        )
    ...
    def test_web_platform_results(self):
        ...
        aggregated = self.aggregator.aggregate_results(
            result_type=RESULT_TYPE_WEB_PLATFORM, aggregation_level=AGGREGATION_LEVEL_TASK_TYPE
        )
    ...
    def test_comparative_analysis(self):
        ...
        self.mock_db_manager.get_performance_results.side_effect = lambda **kwargs: (
            historical_results
            if "time_range" in kwargs and kwargs["time_range"] is not None
    ...
    def test_correlation_analysis(self):
        ...
        self.assertIn(
            "average_latency_ms_vs_throughput_items_per_second", correlation_results["correlations"]
        )

        # Check correlation details
        correlation = correlation_results["correlations"][
            "average_latency_ms_vs_throughput_items_per_second"
        ]
    ...
    def test_aggregation_level_handling(self):
        ...
        for level in levels:
            ...
            # Aggregate results
            aggregated = self.aggregator.aggregate_results(
                result_type=RESULT_TYPE_PERFORMANCE, aggregation_level=level
            )
