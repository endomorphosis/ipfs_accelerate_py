...
class TestMonitoringDashboard(unittest.TestCase):
    ...
    def test_configuration(self):
        ...
        dashboard = MonitoringDashboard(host="localhost", port=8082, output_dir=self.output_dir)

        # Test configuration updates
        dashboard.configure({"auto_refresh": 60, "theme": "light", "enable_alerts": False})
    ...
    def test_async_start_stop(self):
        ...
        dashboard.configure(
            {"auto_refresh": 0, "update_interval": 1, "auto_connect_coordinator": False}
        )
    ...
    def test_get_status_data(self):
        ...
        dashboard.system_metrics = {"health_score": 85, "coordinator_status": "active"}
