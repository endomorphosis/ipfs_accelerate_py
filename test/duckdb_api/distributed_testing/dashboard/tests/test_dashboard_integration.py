...
class MockDBManager:
    ...
    def get_compatibility_results(
        self, aggregation_level=None, filter_params=None, time_range=None
    ):
...
class TestDashboardIntegration(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.dashboard_generator = DashboardGenerator(
            result_aggregator=cls.result_aggregator, output_dir=cls.output_dir
        )
