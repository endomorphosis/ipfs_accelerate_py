...
class DRMVisualizationIntegration:
    ...
    def __init__(
        ...
        try:
            ...
            logger.warning(
                "DRMVisualization not available. Visualization integration will be limited."
            )
    ...
    def _load_registry(self):
        ...
        if os.path.exists(self.registry_file):
            try:
                ...
                logger.info(
                    f"Loaded {len(self.visualization_registry)} visualizations from registry"
                )
    ...
    def update_visualizations(self, force=False):
        ...
        try:
            ...
            if hasattr(self.drm_visualization, "create_cloud_resource_visualization") and bool(
                getattr(self.drm_visualization, "cloud_usage_history", {})
            ):
