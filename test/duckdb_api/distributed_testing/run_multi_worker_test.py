...
def parse_args():
    ...
    parser.add_argument(
        "--num-workers", type=int, default=3, help="Number of worker clients to run"
    )
    ...
    parser.add_argument(
        "--random-disconnects", action="store_true", help="Randomly disconnect workers"
    )

    parser.add_argument(
        "--demo-tasks", type=int, default=10, help="Number of demo tasks to submit (0 to disable)"
    )

    parser.add_argument(
        "--duration", type=float, default=60.0, help="Duration of the test in seconds"
    )
    ...
    try:
        ...
        if args.random_disconnects:
            ...
            reconnect_thread = threading.Thread(
                target=random_reconnect_thread, args=(workers, should_stop), daemon=True
            )
