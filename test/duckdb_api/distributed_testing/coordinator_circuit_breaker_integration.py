...
from data.duckdb.distributed_testing.fault_tolerance_integration import CircuitBreakerIntegration
...
class CoordinatorCircuitBreakerIntegration:
    ...
    def __init__(self, coordinator):
        ...
        if self.fault_tolerance_manager:
            self.fault_tolerance_integration = CircuitBreakerIntegration(
    ...
    def wrap_worker_execution(
        self, worker_id: str, action: Callable, fallback: Optional[Callable] = None
    ):
        """
    ...
    def wrap_task_execution(
        self, task_id: str, task_type: str, action: Callable, fallback: Optional[Callable] = None
    ):
        """
