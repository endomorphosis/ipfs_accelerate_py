...
class TestValidationReporter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reporter = ValidationReporterImpl({"output_directory": "./output"})
    ...
    def test_report_generation_html(self):
        ...
        report = self.reporter.generate_report(
            self.validation_results, report_format="html", include_visualizations=True
        )
    ...
    def test_report_generation_markdown(self):
        ...
        # Generate report
        report = self.reporter.generate_report(
            self.validation_results, report_format="markdown", include_visualizations=True
        )
    ...
    def test_report_generation_json(self):
        ...
        # Generate report
        report = self.reporter.generate_report(self.validation_results, report_format="json")
    ...
    def test_report_export(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result_path = self.reporter.export_report(
                self.validation_results, output_path=output_path, report_format="html"
            )
    ...
    def test_empty_results(self):
        ...
        report = self.reporter.generate_report([], report_format="html")
