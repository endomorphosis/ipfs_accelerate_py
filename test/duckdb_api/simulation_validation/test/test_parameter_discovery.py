...
class TestParameterDiscovery(unittest.TestCase):
    ...
    def test_discover_parameters(self):
        ...
        parameter_recommendations = self.parameter_discovery.discover_parameters(
        ...
        metrics_with_params = [
            m
            for m in parameter_recommendations["parameters_by_metric"]
            if parameter_recommendations["parameters_by_metric"][m]
        ]
