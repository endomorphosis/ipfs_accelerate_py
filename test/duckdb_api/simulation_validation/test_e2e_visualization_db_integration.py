...
class TestE2EVisualizationDBIntegration(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.connector = ValidationVisualizerDBConnector(
            db_integration=cls.db_integration, visualizer=cls.visualizer
        )
    ...
    def _populate_test_database(cls):
        ...
        for i in range(10):
            ...
            hw_result = HardwareResult(
                ...
                test_environment={"os": "Linux", "cuda_version": "11.4"},
            )
        ...
        for i in range(10):
            ...
            hw_result = HardwareResult(
                ...
                hardware_details={"name": "Intel Xeon", "cores": 24, "threads": 48},
                test_environment={"os": "Linux", "memory_gb": 64},
            )
            hardware_results.append(hw_result)
    ...
    def test_e2e_drift_visualization(self):
        ...
        result = self.connector.create_drift_visualization_from_db(
            hardware_type="gpu_rtx3080", model_type="bert-base-uncased", output_path=output_path
        )
    ...
    def test_e2e_comprehensive_dashboard(self):
        ...
        result = self.connector.create_comprehensive_dashboard_from_db(
            hardware_id="gpu_rtx3080", model_id="bert-base-uncased", output_path=output_path
        )
