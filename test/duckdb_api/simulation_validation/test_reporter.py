...
def main():
    ...
    try:
        html_report = reporter.generate_report(
            validation_results=validation_results, format="html", include_visualizations=True
        )
        ...
        reporter.export_report(
            validation_results=validation_results, output_path=json_path, format="json"
        )
        ...
        reporter.export_report(
            validation_results=validation_results, output_path=md_path, format="markdown"
        )
