...
# Import base classes
from core.base import SimulationResult, HardwareResult, ValidationResult, SimulationValidator
...
class BasicStatisticalValidator(SimulationValidator):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.default_config = {
            ...
            "validation_methods": ["absolute_error", "relative_error", "mape", "percent_error"],
    ...
    def validate_batch(
        ...
        for sim_result in simulation_results:
            ...
            if matching_hw_results:
                ...
                logger.warning(
                    f"No matching hardware result found for simulation: {sim_result.model_id}, {sim_result.hardware_id}"
                )
    ...
    def summarize_validation(self, validation_results: List[ValidationResult]) -> Dict[str, Any]:
            ...
            if hasattr(val_result, "additional_metrics") and val_result.additional_metrics:
                if "overall_accuracy_score" in val_result.additional_metrics:
                    model_results[model_id].append(
                        val_result.additional_metrics["overall_accuracy_score"]
                    )
        ...
        for val_result in validation_results:
            ...
            if hasattr(val_result, "additional_metrics") and val_result.additional_metrics:
                if "overall_accuracy_score" in val_result.additional_metrics:
                    hardware_results[hardware_id].append(
                        val_result.additional_metrics["overall_accuracy_score"]
                    )
    ...
    def _generate_additional_metrics(
        ...
        if "overall_accuracy_score" in additional_metrics:
            ...
            additional_metrics["is_acceptable"] = (
                additional_metrics["overall_accuracy_score"] <= threshold
            )
