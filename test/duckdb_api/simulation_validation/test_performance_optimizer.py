...
class TestPerformanceOptimizer:
    ...
    def test_get_performance_metrics(self):
        ...
        with (
            ...
            patch.object(
                self.optimizer,
                "_get_cache_performance_metrics",
                return_value={
                    "value": 75,
                    "status": "good",
                    "unit": "percent",
    ...
    def test_get_overall_status(self):
        ...
        with patch.object(
            ...
            if status != "warning":
                print(
                    f"❌ FAIL: Status should be 'warning' when one metric has warning status, got '{status}'"
                )
                return False
        ...
        with patch.object(
            ...
            if status != "error":
                print(
                    f"❌ FAIL: Status should be 'error' when one metric has error status, got '{status}'"
                )
                return False
