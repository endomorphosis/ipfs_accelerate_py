    ...
    if template:
        ...
        dashboard_path = viz.create_dashboard(
            ...
            components=[
                ...
                {"type": "power", "title": "Power Efficiency Analysis", "width": 2, "height": 1},
                {
                    "type": "time-series",
                    "metric": "throughput_items_per_second",
                    "dimensions": ["model_family", "hardware_type"],
...
def main():
    ...
    parser.add_argument(
        "--output-dir", default="./advanced_visualizations", help="Directory to save visualizations"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--viz-type",
        choices=["3d", "heatmap", "power", "time-series", "dashboard", "all"],
        default="all",
