#!/usr/bin/env python3
"""
Test file for bert-base-uncased on openvino
...
class TestBertbaseuncased(unittest.TestCase):
    """Test bert-base-uncased model on openvino platform."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test environment."""
        try:
            cls.tokenizer = transformers.AutoTokenizer.from_pretrained("bert-base-uncased")
            cls.model = transformers.AutoModel.from_pretrained("bert-base-uncased")
