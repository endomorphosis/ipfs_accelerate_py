...
from utils.model_compatibility import get_detailed_performance_analysis, benchmark_model_performance
...
class TestPerformanceModeling:
    ...
    def test_hardware_recommendations(self):
        ...
        recommendations = get_hardware_recommendations("gpt2", ["cpu", "cuda", "mps"])
    ...
    def test_comprehensive_model_tests(self):
        ...
        for result in results:
            ...
            assert any(
                ...
                for status in ["simulated_success", "test_error", "load_failed"]
            )
