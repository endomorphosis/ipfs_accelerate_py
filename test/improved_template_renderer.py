        ...
        for match in re.finditer(for_pattern, result, re.DOTALL):
            ...
            if collection and isinstance(collection, (list, tuple, dict)):
                ...
                for item in collection:
                    ...
                    rendered_content = TemplateRenderer._render_variables(
    ...
    def _fix_indentation(template_str: str) -> str:
        ...
        for i, line in enumerate(lines):
            ...
            if (
                ...
                and not (":" in stripped and '"' in stripped and "," in stripped)
            ):  # Skip dict definitions
                current_indent += 1
                indent_stack.append(":")
...
class TemplateManager:
    ...
    def __init__(self, template_dir: Optional[str] = None):
        ...
        if template_dir:
            ...
            self.template_dir = (
                Path(os.path.dirname(os.path.abspath(__file__))) / "skills" / "templates"
            )
    ...
    def _load_templates(self) -> None:
        ...
        for architecture, template_file in self.template_files.items():
            ...
            if not template_path.exists():
                logger.warning(
                    f"Template file {template_file} for {architecture} architecture not found"
                )
...
ARCHITECTURE_MAPPING = {
    ...
    "speech": ["whisper", "wav2vec2", "hubert", "sew", "unispeech", "clap", "musicgen", "encodec"],
}
...
def generate_test(
    model_type: str, output_dir: str = "./generated_tests_improved"
) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="./generated_tests_improved",
