...
STABLELM_MODELS_REGISTRY = {
    "stablelm-base": {
        "description": "stablelm base model",
        "class": "StablelmModel",
    }
}
...
class TestStablelmModels:
    """Test class for stablelm models."""

    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "stablelm-base"
        ...
        if self.model_id not in STABLELM_MODELS_REGISTRY:
            ...
            self.model_info = STABLELM_MODELS_REGISTRY["stablelm-base"]
        else:
...
def main():
    ...
    # Run test
    model_id = args.model or "stablelm-base"
    tester = TestStablelmModels(model_id)
