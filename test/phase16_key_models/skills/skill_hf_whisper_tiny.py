#!/usr/bin/env python3
"""
Skill implementation for whisper-tiny with hardware platform support
"""
...
class WhispertinySkill:
    """Skill for whisper-tiny model with hardware platform support."""
...
def create_skill(model_id="whisper-tiny", device=None):
    """Create a skill instance."""
            return WhispertinySkill(model_id=model_id, device=device)