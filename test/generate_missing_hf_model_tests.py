...
HUGGINGFACE_MODEL_FAMILIES = {
    ...
    "bert": {
        ...
        "description": "BERT masked language models",
        "priority": "critical",
    },
    "roberta": {
        "architecture_type": "encoder-only",
    ...
    "albert": {
        "architecture_type": "encoder-only",
        "description": "ALBERT masked language models",
        "priority": "high",
    },
    "electra": {
        "architecture_type": "encoder-only",
    ...
    "camembert": {
        "architecture_type": "encoder-only",
        "description": "CamemBERT masked language models",
        "priority": "medium",
    },
    "xlm-roberta": {
        "architecture_type": "encoder-only",
        "description": "XLM-RoBERTa masked language models",
        "priority": "high",
    },
    "deberta": {
        "architecture_type": "encoder-only",
    ...
    "deberta-v2": {
        "architecture_type": "encoder-only",
        "description": "DeBERTa-v2 masked language models",
        "priority": "high",
    },
    "xlnet": {
        "architecture_type": "encoder-only",
        "description": "XLNet autoregressive language models",
        "priority": "medium",
    },
    "reformer": {
        "architecture_type": "encoder-only",
        "description": "Reformer efficient transformer models",
        "priority": "medium",
    },
    "layoutlm": {
        "architecture_type": "encoder-only",
        "description": "LayoutLM document understanding models",
        "priority": "medium",
    },
    "layoutlmv2": {
        "architecture_type": "encoder-only",
        "description": "LayoutLMv2 document understanding models",
        "priority": "medium",
    },
    "layoutlmv3": {
        "architecture_type": "encoder-only",
        "description": "LayoutLMv3 document understanding models",
        "priority": "medium",
    },
    "roformer": {
        "architecture_type": "encoder-only",
        "description": "RoFormer rotary position embedding models",
        "priority": "medium",
    },
    # Decoder-only models
    "gpt2": {
    ...
    "gpt-neox": {
        "architecture_type": "decoder-only",
        "description": "GPT-NeoX autoregressive language models",
        "priority": "high",
    },
    "bloom": {
        "architecture_type": "decoder-only",
        "description": "BLOOM multilingual autoregressive language models",
        "priority": "high",
    },
    "llama": {
        "architecture_type": "decoder-only",
        "description": "LLaMA autoregressive language models",
        "priority": "critical",
    },
    "mistral": {
        "architecture_type": "decoder-only",
        "description": "Mistral autoregressive language models",
        "priority": "critical",
    },
    "falcon": {
        "architecture_type": "decoder-only",
        "description": "Falcon autoregressive language models",
        "priority": "high",
    },
    "phi": {
        "architecture_type": "decoder-only",
    ...
    "mixtral": {
        "architecture_type": "decoder-only",
        "description": "Mixtral mixture of experts models",
        "priority": "high",
    },
    "mpt": {
        "architecture_type": "decoder-only",
        "description": "MPT autoregressive language models",
        "priority": "medium",
    },
    "ctrl": {
        "architecture_type": "decoder-only",
        "description": "CTRL controllable language models",
        "priority": "medium",
    },
    "opt": {
        "architecture_type": "decoder-only",
        "description": "OPT Open Pre-trained Transformers",
        "priority": "high",
    },
    "gemma": {
        "architecture_type": "decoder-only",
        "description": "Gemma lightweight models",
        "priority": "high",
    },
    "codegen": {
        "architecture_type": "decoder-only",
        "description": "CodeGen code generation models",
        "priority": "medium",
    },
    "stablelm": {
        "architecture_type": "decoder-only",
        "description": "StableLM autoregressive language models",
        "priority": "medium",
    },
    # Encoder-decoder models
    "t5": {
        "architecture_type": "encoder-decoder",
        "description": "T5 text-to-text transfer transformer models",
        "priority": "critical",
    },
    "bart": {
        "architecture_type": "encoder-decoder",
    ...
    "mbart": {
        "architecture_type": "encoder-decoder",
        "description": "Multilingual BART models",
        "priority": "high",
    },
    "longt5": {
        "architecture_type": "encoder-decoder",
        "description": "LongT5 long sequence text-to-text models",
        "priority": "medium",
    },
    "led": {
        "architecture_type": "encoder-decoder",
        "description": "Longformer Encoder-Decoder models",
        "priority": "medium",
    },
    "marian": {
        "architecture_type": "encoder-decoder",
        "description": "Marian machine translation models",
        "priority": "medium",
    },
    "mt5": {
        "architecture_type": "encoder-decoder",
    ...
    "flan-t5": {
        "architecture_type": "encoder-decoder",
        "description": "Flan-T5 instruction-tuned models",
        "priority": "high",
    },
    "flan-ul2": {
        "architecture_type": "encoder-decoder",
        "description": "Flan-UL2 unified language learner",
        "priority": "medium",
    },
    "prophetnet": {
        "architecture_type": "encoder-decoder",
        "description": "ProphetNet sequence-to-sequence models",
        "priority": "medium",
    },
    "bigbird": {
        "architecture_type": "encoder-decoder",
        "description": "BigBird long sequence models",
        "priority": "medium",
    },
    # Vision models
    "vit": {
    ...
    "deit": {
        "architecture_type": "vision",
        "description": "Data-efficient Image Transformers",
        "priority": "high",
    },
    "beit": {
        "architecture_type": "vision",
        "description": "BERT pre-training for Image Transformers",
        "priority": "high",
    },
    "convnext": {
        "architecture_type": "vision",
        "description": "ConvNeXT modern CNN models",
        "priority": "high",
    },
    "poolformer": {
        "architecture_type": "vision",
        "description": "PoolFormer MetaFormer models",
        "priority": "medium",
    },
    "dinov2": {
        "architecture_type": "vision",
    ...
    "resnet": {
        "architecture_type": "vision",
        "description": "ResNet convolutional neural networks",
        "priority": "medium",
    },
    "segformer": {
        "architecture_type": "vision",
        "description": "SegFormer image segmentation models",
        "priority": "medium",
    },
    "maskformer": {
        "architecture_type": "vision",
        "description": "MaskFormer segmentation models",
        "priority": "medium",
    },
    "sam": {
        "architecture_type": "vision",
    ...
    "yolos": {
        "architecture_type": "vision",
        "description": "YOLOS object detection transformers",
        "priority": "medium",
    },
    # Speech models
    "wav2vec2": {
        "architecture_type": "speech",
        "description": "Wav2Vec2 speech recognition models",
        "priority": "high",
    },
    "hubert": {
        "architecture_type": "speech",
        "description": "HuBERT speech models",
        "priority": "high",
    },
    "whisper": {
        "architecture_type": "speech",
    ...
    "speecht5": {
        "architecture_type": "speech",
        "description": "SpeechT5 unified speech models",
        "priority": "medium",
    },
    "unispeech": {
        "architecture_type": "speech",
        "description": "UniSpeech speech models",
        "priority": "medium",
    },
    "unispeech-sat": {
        "architecture_type": "speech",
        "description": "UniSpeech-SAT speech models",
        "priority": "medium",
    },
    "encodec": {
        "architecture_type": "speech",
        "description": "EnCodec neural audio codec",
        "priority": "medium",
    },
    "musicgen": {
        "architecture_type": "speech",
        "description": "MusicGen music generation models",
        "priority": "medium",
    },
    # Multimodal models
    "clip": {
    ...
    "llava": {
        "architecture_type": "multimodal",
        "description": "LLaVA multimodal language-vision models",
        "priority": "high",
    },
    "git": {
        "architecture_type": "multimodal",
        "description": "GIT Generative Image-to-text models",
        "priority": "medium",
    },
    "pix2struct": {
        "architecture_type": "multimodal",
        "description": "Pix2Struct image-to-text models",
        "priority": "medium",
    },
    "paligemma": {
        "architecture_type": "multimodal",
        "description": "Paligemma multimodal models",
        "priority": "medium",
    },
    "video-llava": {
        "architecture_type": "multimodal",
        "description": "Video-LLaVA video-language models",
        "priority": "medium",
    },
    "donut": {
        "architecture_type": "multimodal",
        "description": "DONUT document understanding models",
        "priority": "medium",
    },
    "bridgetower": {
        "architecture_type": "multimodal",
        "description": "BridgeTower vision-language models",
        "priority": "medium",
    },
    "flava": {
        "architecture_type": "multimodal",
        "description": "FLAVA multimodal foundation models",
        "priority": "medium",
    },
    "imagebind": {
        "architecture_type": "multimodal",
        "description": "ImageBind multimodal models",
        "priority": "medium",
    },
}
...
def get_class_name(model_family):
    ...
    architecture_type = HUGGINGFACE_MODEL_FAMILIES.get(model_family, {}).get(
        "architecture_type", "encoder-only"
    )
...
"""
    ...
    if new_models:
        ...
        if "## Recently Added Models" in content:
            ...
            section_content = (
                f"## Recently Added Models\n\nThe following models were recently added:\n\n"
            )
            for family in sorted(new_models):
                arch_type = HUGGINGFACE_MODEL_FAMILIES.get(family, {}).get(
...
def main():
    ...
    action_group.add_argument("--list", action="store_true", help="List missing model families")
    action_group.add_argument(
        "--generate", action="store_true", help="Generate test files for missing model families"
    )
    action_group.add_argument(
        "--verify", action="store_true", help="Verify syntax of all test files"
    )
    action_group.add_argument(
        "--update-readme", action="store_true", help="Update README in fixed_tests directory"
    )
    action_group.add_argument(
        "--find-high-priority",
        action="store_true",
    ...
    if args.list:
            ...
            for priority in ["critical", "high", "medium"]:
                if by_priority[priority]:
                    ...
                    for family in sorted(by_priority[priority]):
                        description = HUGGINGFACE_MODEL_FAMILIES.get(family, {}).get(
                            "description", ""
                        )
        ...
        generate_missing_tests(
            arch_types=args.arch, priorities=args.priority, max_models=args.max_models
        )
