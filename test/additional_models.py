...
ADDITIONAL_ARCHITECTURE_MAPPINGS = {
    ...
    "encoder-decoder": ["m2m-100", "seamless-m4t", "switch-transformers", "umt5"],
    "vision": [
        "beit3",
        "conditional-detr",
        "convnextv2",
    ...
    "vision-text": ["instructblip", "vision-encoder-decoder", "xclip", "vision-text-dual-encoder"],
    "speech": ["speech-to-text", "speech-to-text-2", "wav2vec2-conformer"],
    "multimodal": [
        "idefics2",
        "idefics3",
        "llava-next-video",
