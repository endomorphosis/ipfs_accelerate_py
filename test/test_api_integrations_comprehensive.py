...
class TestHuggingFaceHubCache:
    ...
    def test_hf_hub_dataset_info_caching(self):
        ...
        dataset_data = {"datasetId": "squad", "downloads": 50000, "size": "10MB"}
...
class TestDockerCache:
    ...
    def test_docker_image_info_caching(self):
        ...
        image_data = {"Id": "sha256:abc123", "RepoTags": ["ubuntu:latest"], "Size": 72800000}
    ...
    def test_docker_container_status_caching(self):
        ...
        container_data = {"Id": "container123", "State": "running", "Status": "Up 2 hours"}
...
class TestKubernetesCache:
    ...
    def test_k8s_deployment_info_caching(self):
        ...
        deployment_data = {"metadata": {"name": "my-deployment"}, "spec": {"replicas": 3}}

        cache.put(
            "deployment_info", deployment_data, deployment_name="my-deployment", namespace="default"
        )

        cached = cache.get("deployment_info", deployment_name="my-deployment", namespace="default")
        assert cached is not None
...
class TestHuggingFaceHugsCache:
    ...
    def test_hugs_user_profile_caching(self):
        ...
        user_data = {"username": "testuser", "fullname": "Test User", "numModels": 10}
