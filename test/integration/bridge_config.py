...
DEFAULT_CONFIG = {
    "benchmark_predictive_performance": {
        ...
        "high_priority_models": ["bert-base-uncased", "gpt2", "t5-base", "vit-base-patch16-224"],
...
def update_bridge_config(
    config: Dict[str, Any], bridge_name: str, bridge_config: Dict[str, Any]
) -> Dict[str, Any]:
    """
...
def main():
    ...
    create_parser.add_argument(
        "--path", type=str, default="bridge_config.json", help="Path to save configuration file"
    )
