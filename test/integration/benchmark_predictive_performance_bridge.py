...
class BenchmarkPredictivePerformanceBridge:
    ...
    def check_connections(self) -> Dict[str, bool]:
        ...
        """
        status = {"benchmark_db": False, "predictive_api": False}
    ...
    def get_benchmark_schema(self) -> Dict[str, List[Dict[str, str]]]:
        ...
        try:
            ...
            for table_name in [row[0] for row in result]:
                ...
                tables[table_name] = [{"column": row[0], "type": row[1]} for row in schema]
        except Exception as e:
    ...
    def sync_result(self, benchmark_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not measurement.get("hardware_platform"):
                return {
                    "success": False,
                    "error": "Missing hardware_platform",
                    "result_id": benchmark_result.get("result_id"),
                }
            ...
            try:
                ...
                logger.warning(
                    f"Unknown hardware platform {measurement['hardware_platform']}, defaulting to CPU"
                )
    ...
    def sync_by_model(self, model_name: str, days: int = 30, limit: int = 100) -> Dict[str, Any]:
        """
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        """
        if not self.benchmark_conn:
            return {"success": False, "error": "No benchmark database connection"}
        ...
        try:
            ...
            report = {
                ...
                "sync_percentage": round(
                    synced_results / total_results * 100 if total_results > 0 else 0, 2
                ),
...
def main():
    ...
    parser.add_argument(
        "--limit", type=int, default=100, help="Maximum number of results to synchronize"
    )
    ...
    try:
        ...
        if args.model:
            ...
            result = bridge.sync_by_model(model_name=args.model, days=args.days, limit=args.limit)
        else:
