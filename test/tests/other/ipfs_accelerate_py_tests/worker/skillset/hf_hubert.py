...
class hf_hubert:
    ...
    def create_cpu_audio_classification_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_cuda_audio_classification_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_rocm_audio_classification_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
        ...
        try:
            def handler(input_text, **kwargs):
                ...
                elif 'audio_classification' == 'text_generation' or 'audio_classification' == 'causal_lm':
                    # For text generation
    ...
    def create_openvino_audio_classification_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_apple_audio_classification_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
    ...
    def create_qualcomm_audio_classification_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint, tokenizer):
