...
try:
    ...
    from test.tests.web.web_platform.enhanced_resource_pool_tester import EnhancedWebResourcePoolTester
...
async def main_async():
    ...
    if args.test_enhanced:
        ...
        try:
            ...
            from test.tests.web.web_platform.enhanced_resource_pool_tester_mock import EnhancedWebResourcePoolTester
            tester = EnhancedWebResourcePoolTester(args)
    else:
