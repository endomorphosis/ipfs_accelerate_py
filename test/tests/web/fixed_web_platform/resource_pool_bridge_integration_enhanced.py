...
from test.tests.web.web_platform.circuit_breaker import CircuitBreaker, BrowserCircuitBreakerManager
CIRCUIT_BREAKER_AVAILABLE = True

# Import performance trend analyzer
from test.tests.web.web_platform.performance_trend_analyzer import PerformanceTrendAnalyzer, TrendDirection, RegressionSeverity
