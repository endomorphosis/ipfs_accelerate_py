...
try:
    from test.tests.web.web_platform.webgpu_audio_compute_shaders import (
...
try:
    from test.tests.web.web_platform.webgpu_shader_precompilation import (
...
def setup_4bit_llm_inference(model_path, model_type="text", config=None):
    ...
    try:
        ...
        from test.tests.web.web_platform.webgpu_quantization import WebGPU4BitInferenceHandler
