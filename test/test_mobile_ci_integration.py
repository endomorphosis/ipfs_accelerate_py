...
class TestMobileCIIntegration(unittest.TestCase):
            ...
            "models": {
                "bert-base-uncased": {
                    "platforms": {
                        "android": {
                            "batch_sizes": {
                                "1": {"throughput": 10.5, "latency": 95.2},
                                "4": {"throughput": 32.1, "latency": 124.6},
                            }
                        },
                        "ios": {
                            "batch_sizes": {
                                "1": {"throughput": 12.3, "latency": 81.5},
                                "4": {"throughput": 38.5, "latency": 103.8},
                            }
                        },
                    }
                },
                "mobilenet-v2": {
                    "platforms": {
                        "android": {
                            "batch_sizes": {
                                "1": {"throughput": 45.3, "latency": 22.1},
                                "4": {"throughput": 120.8, "latency": 33.2},
                            }
                        },
                        "ios": {
                            "batch_sizes": {
                                "1": {"throughput": 58.9, "latency": 17.0},
                                "4": {"throughput": 150.2, "latency": 26.7},
                            }
                        },
                    }
                },
    ...
    def test_1_database_merger_initialization(self):
        ...
        try:
            merger = BenchmarkDatabaseMerger(
                output_db=self.merged_db_path, input_dbs=[self.android_db_path, self.ios_db_path]
            )
    ...
    def test_3_regression_detector_initialization(self):
        ...
        try:
            detector = MobileRegressionDetector(data_file=self.analysis_json_path, threshold=15.0)
    ...
    def test_4_load_analysis_data(self):
        ...
        detector = MobileRegressionDetector(data_file=self.analysis_json_path)
    ...
    def test_5_dashboard_generator_initialization(self):
        ...
        try:
            generator = MobileDashboardGenerator(
                data_file=self.analysis_json_path, output_path=self.dashboard_path, theme="dark"
            )
    ...
    def test_6_load_dashboard_data(self):
        ...
        generator = MobileDashboardGenerator(
            data_file=self.analysis_json_path, output_path=self.dashboard_path
        )
