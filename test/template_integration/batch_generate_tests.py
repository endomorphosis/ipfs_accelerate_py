...
def main():
    ...
    # Other options
    parser.add_argument(
        "--dry-run", action="store_true", help="Don't generate files, just show what would be done"
    )
    parser.add_argument(
        "--list-models", action="store_true", help="List available models by architecture"
    )
