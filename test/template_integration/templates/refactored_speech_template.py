            ...
            try:
                ...
                try:
                    ...
                    dummy_audio = np.zeros(
                        self.audio_sampling_rate * self.test_audio_duration, dtype=np.float32
                    )
    ...
    def load_model(self, model_id=None):
        ...
        try:
            ...
            processor_class = getattr(
                transformers, self.processor_class, transformers.AutoProcessor
            )
...
def main():
    ...
    parser.add_argument(
        "--task", type=str, help="Task to test (automatic-speech-recognition, audio-classification)"
    )
