...
def main():
    ...
    try:
        ...
        harness = AndroidTestHarness(device_serial=args.serial, output_dir=args.output_dir)
        ...
        if result.get("status") == "success":
            ...
            if args.generate_report:
                report_path = os.path.join(
                    args.output_dir, f"{os.path.basename(model_path)}_report.md"
                )
