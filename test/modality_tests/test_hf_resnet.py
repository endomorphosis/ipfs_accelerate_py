#!/usr/bin/env python3
"""
Test implementation for resnet models
"""
...
def test_from_pretrained()):
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained()"resnet-base")
        model = transformers.AutoModel.from_pretrained()"resnet-base")
