#!/usr/bin/env python3
"""
Test implementation for hubert models
"""
...
def test_from_pretrained()):
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained()"hubert-base")
        model = transformers.AutoModel.from_pretrained()"hubert-base")
