#!/usr/bin/env python3
"""
Test implementation for vilt models
"""
...
def test_from_pretrained()):
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained()"vilt-base")
        model = transformers.AutoModel.from_pretrained()"vilt-base")
