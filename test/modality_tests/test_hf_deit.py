#!/usr/bin/env python3
"""
Test implementation for deit models
"""
...
def test_from_pretrained():
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained("deit-base")
        model = transformers.AutoModel.from_pretrained("deit-base")
