#!/usr/bin/env python3
"""
Test implementation for distilbert models
"""
...
class TestHFDistilbert:
    ...
    def __init__(self, resources=None, metadata=None):
        ...
        # Model parameters
        self.model_name = "distilbert-base"
...
def test_from_pretrained():
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained("distilbert-base")
        model = transformers.AutoModel.from_pretrained("distilbert-base")
