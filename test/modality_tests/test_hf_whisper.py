#!/usr/bin/env python3
"""
Test implementation for whisper models
"""
...
def test_from_pretrained()):
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained()"whisper-base")
        model = transformers.AutoModel.from_pretrained()"whisper-base")
