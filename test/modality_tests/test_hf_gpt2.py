...
def test_from_pretrained():
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained("gpt2-base")
        model = transformers.AutoModel.from_pretrained("gpt2-base")
