#!/usr/bin/env python3
"""
Test implementation for flava models
"""
...
def test_from_pretrained():
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained("flava-base")
        model = transformers.AutoModel.from_pretrained("flava-base")
