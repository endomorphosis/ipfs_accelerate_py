#!/usr/bin/env python3
"""
Test implementation for speecht5 models
"""
...
def test_from_pretrained()):
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained()"speecht5-base")
        model = transformers.AutoModel.from_pretrained()"speecht5-base")
