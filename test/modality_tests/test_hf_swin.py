#!/usr/bin/env python3
"""
Test implementation for swin models
"""
...
def test_from_pretrained():
    ...
    try:
        ...
        processor = transformers.AutoProcessor.from_pretrained("swin-base")
        model = transformers.AutoModel.from_pretrained("swin-base")
