...
|----------|-------------|-------------------|
| Hardware Detection | Tests hardware detection capabilities | hardware_detection.py |
...
| Web Platform Support | Tests WebNN and WebGPU integration | hardware_detection.py, ResourcePool |
...
2. **hardware_detection.py Missing**:
