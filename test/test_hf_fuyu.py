...
class TestFuyuModels:
    ...
    def __init__(self, model_id=None):
        ...
        self.model_id = model_id or "fuyu-base"
        ...
        if self.model_id not in FUYU_MODELS_REGISTRY:
            ...
            self.model_info = FUYU_MODELS_REGISTRY["fuyu-base"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test fuyu models")
    ...
    # Run test
    model_id = args.model or "fuyu-base"
    tester = TestFuyuModels(model_id)
