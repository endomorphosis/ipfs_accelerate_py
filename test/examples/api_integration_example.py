...
class WorkflowManager:
    ...
    def generate_model(self, model_name: str, hardware: List[str]) -> Dict[str, Any]:
        ...
        request_data = {"model_name": model_name, "hardware": hardware, "force": True}
    ...
    def run_tests(
        self, model_name: str, hardware: List[str], test_type: str = "basic"
    ) -> Dict[str, Any]:
        """
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="basic",
        choices=["basic", "comprehensive", "fault_tolerance"],
        help="Test type",
    )
    parser.add_argument(
        "--gateway-url", type=str, default="http://localhost:8080", help="Gateway URL"
    )
    parser.add_argument(
        "--generator-url", type=str, default="http://localhost:8001", help="Generator API URL"
    )
    parser.add_argument(
        "--test-url", type=str, default="http://localhost:8000", help="Test API URL"
    )
    parser.add_argument(
        "--benchmark-url", type=str, default="http://localhost:8002", help="Benchmark API URL"
    )
    parser.add_argument(
        "--use-gateway", action="store_true", help="Use gateway instead of direct APIs"
    )
