...
def run_example(args):
    ...
    for fmt in formats:
        ...
        output_path = os.path.join(reports_dir, f"comprehensive_benchmark_report_{timestamp}.{fmt}")
        ...
        # Run the command
        logger.info(f"Generating {fmt} report: {' '.join(cmd)}")
        try:
    ...
    logger.info(f"Generated example reports index: {index_path}")
    print(f"\nExample complete! Generated reports index: {index_path}")
