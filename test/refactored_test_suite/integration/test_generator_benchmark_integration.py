...
class GeneratorBenchmarkIntegrationTest(unittest.TestCase):
    ...
    @unittest.skipIf(
        not (GENERATOR_AVAILABLE and BENCHMARK_AVAILABLE),
            ...
            with self.subTest(model=model_name):
                ...
                try:
                    output_path = generate_model(
                        model_name, output_dir=str(self.temp_dir), force=True
                    )
...
class ApiIntegrationTest(unittest.TestCase):
    ...
    @unittest.skipIf(
        ...
        or not hasattr(ApiIntegrationTest, "API_AVAILABLE")
        or not ApiIntegrationTest.API_AVAILABLE,
