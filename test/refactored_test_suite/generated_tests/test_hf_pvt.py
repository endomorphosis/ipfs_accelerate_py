#!/usr/bin/env python3
"""
Test file for PVT models (encoder-only architecture).

This test verifies the functionality of the pvt model.
"""
...
class TestPvtModel(EncoderOnlyModelTest):
    """Test class for pvt model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test pvt model")
    ...
    test = TestPvtModel(args.model_id, args.device)
