#!/usr/bin/env python3
"""
Test file for MEGA models (encoder-only architecture).

This test verifies the functionality of the mega model.
"""
...
class TestMegaModel(EncoderOnlyModelTest):
    """Test class for mega model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mega model")
    ...
    test = TestMegaModel(args.model_id, args.device)
