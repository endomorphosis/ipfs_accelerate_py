#!/usr/bin/env python3
"""
Test file for PEGASUS models (encoder-decoder architecture).

This test verifies the functionality of the pegasus model.
"""
...
class TestPegasusModel(EncoderDecoderModelTest):
    """Test class for pegasus model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test pegasus model")
    ...
    test = TestPegasusModel(args.model_id, args.device)
