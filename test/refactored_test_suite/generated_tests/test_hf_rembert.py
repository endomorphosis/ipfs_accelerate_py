#!/usr/bin/env python3
"""
Test file for REMBERT models (encoder-only architecture).

This test verifies the functionality of the rembert model.
"""
...
class TestRembertModel(EncoderOnlyModelTest):
    """Test class for rembert model."""
...
def main():
    ...
    test = TestRembertModel(args.model_id, args.device)
