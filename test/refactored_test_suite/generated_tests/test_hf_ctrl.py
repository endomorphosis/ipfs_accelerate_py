#!/usr/bin/env python3
"""
Test file for CTRL models (encoder-only architecture).

This test verifies the functionality of the ctrl model.
"""
...
class TestCtrlModel(EncoderOnlyModelTest):
    """Test class for ctrl model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test ctrl model")
    ...
    test = TestCtrlModel(args.model_id, args.device)
