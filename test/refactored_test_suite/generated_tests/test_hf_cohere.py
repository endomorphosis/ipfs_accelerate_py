#!/usr/bin/env python3
"""
Test file for COHERE models (encoder-only architecture).

This test verifies the functionality of the cohere model.
"""
...
class TestCohereModel(EncoderOnlyModelTest):
    """Test class for cohere model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test cohere model")
    ...
    test = TestCohereModel(args.model_id, args.device)
