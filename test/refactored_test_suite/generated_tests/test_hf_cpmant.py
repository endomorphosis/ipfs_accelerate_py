#!/usr/bin/env python3
"""
Test file for CPMANT models (encoder-only architecture).

This test verifies the functionality of the cpmant model.
"""
...
class TestCpmantModel(EncoderOnlyModelTest):
    """Test class for cpmant model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "cpmant"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test cpmant model")
    ...
    test = TestCpmantModel(args.model_id, args.device)
