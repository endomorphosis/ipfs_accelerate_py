#!/usr/bin/env python3
"""
Test file for DPR models (encoder-only architecture).

This test verifies the functionality of the dpr model.
"""
...
class TestDprModel(EncoderOnlyModelTest):
    """Test class for dpr model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test dpr model")
    ...
    test = TestDprModel(args.model_id, args.device)
