#!/usr/bin/env python3
"""
Test file for LONGFORMER models (encoder-only architecture).

This test verifies the functionality of the longformer model.
"""
...
class TestLongformerModel(EncoderOnlyModelTest):
    """Test class for longformer model."""
...
def main():
    ...
    test = TestLongformerModel(args.model_id, args.device)
