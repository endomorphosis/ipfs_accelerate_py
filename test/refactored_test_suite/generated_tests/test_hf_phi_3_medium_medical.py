#!/usr/bin/env python3
"""
Test file for PHI_3_MEDIUM_MEDICAL models (decoder-only architecture).

This test verifies the functionality of the phi_3_medium_medical model.
"""
...
class TestGPT2Model(DecoderOnlyModelTest):
    """Test class for phi_3_medium_medical model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "phi_3_medium_medical"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test phi_3_medium_medical model")
