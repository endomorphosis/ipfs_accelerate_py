#!/usr/bin/env python3
"""
Test file for LLAMAGUARD models (decoder-only architecture).

This test verifies the functionality of the llamaguard model.
"""
...
class TestGPT2Model(DecoderOnlyModelTest):
    """Test class for llamaguard model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "llamaguard"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test llamaguard model")
