#!/usr/bin/env python3
"""
Test file for OPENAI models (encoder-only architecture).

This test verifies the functionality of the openai model.
"""
...
class TestOpenaiModel(EncoderOnlyModelTest):
    """Test class for openai model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test openai model")
    ...
    test = TestOpenaiModel(args.model_id, args.device)
