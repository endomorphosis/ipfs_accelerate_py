#!/usr/bin/env python3
"""
Test file for NAT models (encoder-only architecture).

This test verifies the functionality of the nat model.
"""
...
class TestNatModel(EncoderOnlyModelTest):
    """Test class for nat model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test nat model")
    ...
    test = TestNatModel(args.model_id, args.device)
