#!/usr/bin/env python3
"""
Test file for BIGBIRD_PEGASUS models (encoder-only architecture).

This test verifies the functionality of the bigbird_pegasus model.
"""
...
class TestBigbird_pegasusModel(EncoderOnlyModelTest):
    """Test class for bigbird_pegasus model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "bigbird_pegasus"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bigbird_pegasus model")
    ...
    test = TestBigbird_pegasusModel(args.model_id, args.device)
