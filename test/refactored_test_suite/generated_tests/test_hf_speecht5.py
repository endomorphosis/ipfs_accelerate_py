#!/usr/bin/env python3
"""
Test file for SPEECHT5 models (encoder-decoder architecture).

This test verifies the functionality of the speecht5 model.
"""
...
class TestSpeecht5Model(EncoderDecoderModelTest):
    """Test class for speecht5 model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "speecht5"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test speecht5 model")
    ...
    test = TestSpeecht5Model(args.model_id, args.device)
