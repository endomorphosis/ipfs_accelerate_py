#!/usr/bin/env python3
"""
Test file for XLSR_WA models (encoder-only architecture).

This test verifies the functionality of the xlsr_wa model.
"""
...
class TestXlsr_waModel(EncoderOnlyModelTest):
    """Test class for xlsr_wa model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "xlsr_wa"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xlsr_wa model")
    ...
    test = TestXlsr_waModel(args.model_id, args.device)
