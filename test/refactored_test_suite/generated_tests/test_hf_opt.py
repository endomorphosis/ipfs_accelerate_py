#!/usr/bin/env python3
"""
Test file for OPT models (decoder-only architecture).

This test verifies the functionality of the opt model.
"""
...
class TestOptModel(DecoderOnlyModelTest):
    """Test class for opt model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test opt model")
    ...
    test = TestOptModel(args.model_id, args.device)
