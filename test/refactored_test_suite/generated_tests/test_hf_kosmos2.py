#!/usr/bin/env python3
"""
Test file for KOSMOS2 models (encoder-only architecture).

This test verifies the functionality of the kosmos2 model.
"""
...
class TestKosmos2Model(EncoderOnlyModelTest):
    """Test class for kosmos2 model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "kosmos2"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test kosmos2 model")
    ...
    test = TestKosmos2Model(args.model_id, args.device)
