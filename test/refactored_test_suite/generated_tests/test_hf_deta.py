#!/usr/bin/env python3
"""
Test file for DETA models (encoder-only architecture).

This test verifies the functionality of the deta model.
"""
...
class TestDetaModel(EncoderOnlyModelTest):
    """Test class for deta model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test deta model")
    ...
    test = TestDetaModel(args.model_id, args.device)
