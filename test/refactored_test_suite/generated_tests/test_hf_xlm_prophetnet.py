#!/usr/bin/env python3
"""
Test file for XLM_PROPHETNET models (encoder-only architecture).

This test verifies the functionality of the xlm_prophetnet model.
"""
...
class TestXlm_prophetnetModel(EncoderOnlyModelTest):
    """Test class for xlm_prophetnet model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "xlm_prophetnet"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xlm_prophetnet model")
    ...
    test = TestXlm_prophetnetModel(args.model_id, args.device)
