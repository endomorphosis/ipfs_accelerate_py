#!/usr/bin/env python3
"""
Test file for TAPEX models (encoder-only architecture).

This test verifies the functionality of the tapex model.
"""
...
class TestTapexModel(EncoderOnlyModelTest):
    """Test class for tapex model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test tapex model")
    ...
    test = TestTapexModel(args.model_id, args.device)
