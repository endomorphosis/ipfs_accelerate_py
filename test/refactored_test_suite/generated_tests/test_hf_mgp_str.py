#!/usr/bin/env python3
"""
Test file for MGP_STR models (encoder-only architecture).

This test verifies the functionality of the mgp_str model.
"""
...
class TestMgp_strModel(EncoderOnlyModelTest):
    """Test class for mgp_str model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mgp_str"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mgp_str model")
    ...
    test = TestMgp_strModel(args.model_id, args.device)
