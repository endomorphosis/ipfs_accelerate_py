#!/usr/bin/env python3
"""
Test file for VAN models (encoder-only architecture).

This test verifies the functionality of the van model.
"""
...
class TestVanModel(EncoderOnlyModelTest):
    """Test class for van model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test van model")
    ...
    test = TestVanModel(args.model_id, args.device)
