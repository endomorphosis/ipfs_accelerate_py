#!/usr/bin/env python3
"""
Test file for IBERT models (encoder-only architecture).

This test verifies the functionality of the ibert model.
"""
...
class TestIbertModel(EncoderOnlyModelTest):
    """Test class for ibert model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "ibert"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test ibert model")
    ...
    test = TestIbertModel(args.model_id, args.device)
