#!/usr/bin/env python3
"""
Test file for CPM models (encoder-only architecture).

This test verifies the functionality of the cpm model.
"""
...
class TestCpmModel(EncoderOnlyModelTest):
    """Test class for cpm model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test cpm model")
    ...
    test = TestCpmModel(args.model_id, args.device)
