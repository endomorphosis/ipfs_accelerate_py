#!/usr/bin/env python3
"""
Test file for PERCEIVER_IMAGE models (encoder-only architecture).

This test verifies the functionality of the perceiver_image model.
"""
...
class TestPerceiver_imageModel(EncoderOnlyModelTest):
    """Test class for perceiver_image model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "perceiver_image"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test perceiver_image model")
    ...
    test = TestPerceiver_imageModel(args.model_id, args.device)
