#!/usr/bin/env python3
"""
Test file for GPT_2 models (decoder-only architecture).

This test verifies the functionality of the gpt_2 model.
"""
...
class TestGpt_2Model(DecoderOnlyModelTest):
    """Test class for gpt_2 model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "gpt_2"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test gpt_2 model")
    ...
    test = TestGpt_2Model(args.model_id, args.device)
