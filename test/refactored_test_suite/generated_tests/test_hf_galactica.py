#!/usr/bin/env python3
"""
Test file for GALACTICA models (encoder-only architecture).

This test verifies the functionality of the galactica model.
"""
...
class TestGalacticaModel(EncoderOnlyModelTest):
    """Test class for galactica model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "galactica"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test galactica model")
    ...
    test = TestGalacticaModel(args.model_id, args.device)
