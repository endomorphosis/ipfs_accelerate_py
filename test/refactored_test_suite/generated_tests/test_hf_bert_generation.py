#!/usr/bin/env python3
"""
Test file for BERT_GENERATION models (encoder-only architecture).

This test verifies the functionality of the bert_generation model.
"""
...
class TestBert_generationModel(EncoderOnlyModelTest):
    """Test class for bert_generation model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "bert_generation"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bert_generation model")
    ...
    test = TestBert_generationModel(args.model_id, args.device)
