#!/usr/bin/env python3
"""
Test file for PHI_1 models (decoder-only architecture).

This test verifies the functionality of the phi_1 model.
"""
...
class TestGPT2Model(DecoderOnlyModelTest):
    """Test class for phi_1 model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "phi_1"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test phi_1 model")
