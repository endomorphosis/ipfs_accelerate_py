#!/usr/bin/env python3
"""
Test file for MOBILEBERT models (encoder-only architecture).

This test verifies the functionality of the mobilebert model.
"""
...
class TestMobilebertModel(EncoderOnlyModelTest):
    """Test class for mobilebert model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mobilebert model")
    ...
    test = TestMobilebertModel(args.model_id, args.device)
