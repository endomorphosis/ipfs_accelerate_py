#!/usr/bin/env python3
"""
Test file for PALIGEMMA models (decoder-only architecture).

This test verifies the functionality of the paligemma model.
"""
...
class TestPaligemmaModel(DecoderOnlyModelTest):
    """Test class for paligemma model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test paligemma model")
    ...
    test = TestPaligemmaModel(args.model_id, args.device)
