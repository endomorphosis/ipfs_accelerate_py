#!/usr/bin/env python3
"""
Test file for JAIS models (encoder-only architecture).

This test verifies the functionality of the jais model.
"""
...
class TestJaisModel(EncoderOnlyModelTest):
    """Test class for jais model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "jais"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test jais model")
    ...
    test = TestJaisModel(args.model_id, args.device)
