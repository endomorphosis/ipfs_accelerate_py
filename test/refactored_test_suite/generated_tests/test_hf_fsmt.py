#!/usr/bin/env python3
"""
Test file for FSMT models (encoder-only architecture).

This test verifies the functionality of the fsmt model.
"""
...
class TestFsmtModel(EncoderOnlyModelTest):
    """Test class for fsmt model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test fsmt model")
    ...
    test = TestFsmtModel(args.model_id, args.device)
