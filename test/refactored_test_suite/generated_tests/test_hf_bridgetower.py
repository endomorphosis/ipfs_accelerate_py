#!/usr/bin/env python3
"""
Test file for BRIDGETOWER models (encoder-only architecture).

This test verifies the functionality of the bridgetower model.
"""
...
class TestBridgetowerModel(EncoderOnlyModelTest):
    """Test class for bridgetower model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bridgetower model")
    ...
    test = TestBridgetowerModel(args.model_id, args.device)
