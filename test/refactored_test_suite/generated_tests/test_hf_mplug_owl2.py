#!/usr/bin/env python3
"""
Test file for MPLUG_OWL2 models (encoder-only architecture).

This test verifies the functionality of the mplug_owl2 model.
"""
...
class TestMplug_owl2Model(EncoderOnlyModelTest):
    """Test class for mplug_owl2 model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mplug_owl2"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mplug_owl2 model")
    ...
    test = TestMplug_owl2Model(args.model_id, args.device)
