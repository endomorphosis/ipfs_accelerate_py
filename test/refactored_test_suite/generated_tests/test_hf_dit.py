#!/usr/bin/env python3
"""
Test file for DIT models (encoder-only architecture).

This test verifies the functionality of the dit model.
"""
...
class TestDitModel(EncoderOnlyModelTest):
    """Test class for dit model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test dit model")
    ...
    test = TestDitModel(args.model_id, args.device)
