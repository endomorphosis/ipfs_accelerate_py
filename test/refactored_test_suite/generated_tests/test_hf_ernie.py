#!/usr/bin/env python3
"""
Test file for ERNIE models (encoder-only architecture).

This test verifies the functionality of the ernie model.
"""
...
class TestErnieModel(EncoderOnlyModelTest):
    """Test class for ernie model."""
...
def main():
    ...
    test = TestErnieModel(args.model_id, args.device)
