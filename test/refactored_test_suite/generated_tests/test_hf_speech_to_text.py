#!/usr/bin/env python3
"""
Test file for SPEECH_TO_TEXT models (encoder-only architecture).

This test verifies the functionality of the speech_to_text model.
"""
...
class TestSpeech_to_textModel(EncoderOnlyModelTest):
    """Test class for speech_to_text model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test speech_to_text model")
    ...
    test = TestSpeech_to_textModel(args.model_id, args.device)
