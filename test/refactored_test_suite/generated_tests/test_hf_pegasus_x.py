#!/usr/bin/env python3
"""
Test file for PEGASUS_X models (encoder-decoder architecture).

This test verifies the functionality of the pegasus_x model.
"""
...
class TestPegasus_xModel(EncoderDecoderModelTest):
    """Test class for pegasus_x model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "pegasus_x"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test pegasus_x model")
    ...
    test = TestPegasus_xModel(args.model_id, args.device)
