#!/usr/bin/env python3
"""
Test file for FUYU models (encoder-only architecture).

This test verifies the functionality of the fuyu model.
"""
...
class TestFuyuModel(EncoderOnlyModelTest):
    """Test class for fuyu model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "fuyu"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test fuyu model")
    ...
    test = TestFuyuModel(args.model_id, args.device)
