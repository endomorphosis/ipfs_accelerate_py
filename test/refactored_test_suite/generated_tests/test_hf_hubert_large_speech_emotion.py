#!/usr/bin/env python3
"""
Test file for HUBERT_LARGE_SPEECH_EMOTION models (encoder-only architecture).

This test verifies the functionality of the hubert_large_speech_emotion model.
"""
...
class TestBertModel(EncoderOnlyModelTest):
    """Test class for hubert_large_speech_emotion model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "hubert_large_speech_emotion"
        self.task = "fill-mask"
    ...
    def get_default_model_id(self) -> str:
        ...
        return "hubert-large-speech-emotion"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test hubert_large_speech_emotion model")
