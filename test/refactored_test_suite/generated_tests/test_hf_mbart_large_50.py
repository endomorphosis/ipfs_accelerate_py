#!/usr/bin/env python3
"""
Test file for MBART_LARGE_50 models (encoder-decoder architecture).

This test verifies the functionality of the mbart_large_50 model.
"""
...
class TestT5Model(EncoderDecoderModelTest):
    """Test class for mbart_large_50 model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mbart_large_50"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mbart_large_50 model")
