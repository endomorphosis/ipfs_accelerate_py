#!/usr/bin/env python3
"""
Test file for MGPT models (decoder-only architecture).

This test verifies the functionality of the mgpt model.
"""
...
class TestGPT2Model(DecoderOnlyModelTest):
    """Test class for mgpt model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mgpt"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mgpt model")
