#!/usr/bin/env python3
"""
Test file for MMS models (encoder-only architecture).

This test verifies the functionality of the mms model.
"""
...
class TestMmsModel(EncoderOnlyModelTest):
    """Test class for mms model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mms model")
    ...
    test = TestMmsModel(args.model_id, args.device)
