#!/usr/bin/env python3
"""
Test file for SWIFTFORMER models (encoder-only architecture).

This test verifies the functionality of the swiftformer model.
"""
...
class TestSwiftformerModel(EncoderOnlyModelTest):
    """Test class for swiftformer model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "swiftformer"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test swiftformer model")
    ...
    test = TestSwiftformerModel(args.model_id, args.device)
