#!/usr/bin/env python3
"""
Test file for CODEGEN models (encoder-only architecture).

This test verifies the functionality of the codegen model.
"""
...
class TestCodegenModel(EncoderOnlyModelTest):
    """Test class for codegen model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "codegen"
        self.task = "fill-mask"
...
def main():
    ...
    test = TestCodegenModel(args.model_id, args.device)
