#!/usr/bin/env python3
"""
Test file for MBERT models (encoder-only architecture).

This test verifies the functionality of the mbert model.
"""
...
class TestBertModel(EncoderOnlyModelTest):
    """Test class for mbert model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mbert"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mbert model")
    ...
    test = TestBertModel(args.model_id, args.device)
