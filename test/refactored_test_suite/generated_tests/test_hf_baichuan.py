#!/usr/bin/env python3
"""
Test file for BAICHUAN models (encoder-only architecture).

This test verifies the functionality of the baichuan model.
"""
...
class TestBaichuanModel(EncoderOnlyModelTest):
    """Test class for baichuan model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test baichuan model")
    ...
    test = TestBaichuanModel(args.model_id, args.device)
