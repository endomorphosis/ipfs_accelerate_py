#!/usr/bin/env python3
"""
Test file for CEREBRAS models (encoder-only architecture).

This test verifies the functionality of the cerebras model.
"""
...
class TestCerebrasModel(EncoderOnlyModelTest):
    """Test class for cerebras model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "cerebras"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test cerebras model")
    ...
    test = TestCerebrasModel(args.model_id, args.device)
