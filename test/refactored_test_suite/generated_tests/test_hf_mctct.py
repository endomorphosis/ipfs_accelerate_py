#!/usr/bin/env python3
"""
Test file for MCTCT models (encoder-only architecture).

This test verifies the functionality of the mctct model.
"""
...
class TestMctctModel(EncoderOnlyModelTest):
    """Test class for mctct model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mctct"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mctct model")
    ...
    test = TestMctctModel(args.model_id, args.device)
