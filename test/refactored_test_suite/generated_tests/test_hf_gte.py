#!/usr/bin/env python3
"""
Test file for GTE models (encoder-only architecture).

This test verifies the functionality of the gte model.
"""
...
class TestGteModel(EncoderOnlyModelTest):
    """Test class for gte model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test gte model")
    ...
    test = TestGteModel(args.model_id, args.device)
