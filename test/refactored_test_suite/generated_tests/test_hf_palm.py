#!/usr/bin/env python3
"""
Test file for PALM models (encoder-only architecture).

This test verifies the functionality of the palm model.
"""
...
class TestPalmModel(EncoderOnlyModelTest):
    """Test class for palm model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test palm model")
    ...
    test = TestPalmModel(args.model_id, args.device)
