#!/usr/bin/env python3
"""
Test file for MAMBA_2_8B models (state-space architecture).

This test verifies the functionality of the mamba_2_8b model.
"""
...
class TestMamba28bModel(StateSpaceModelTest):
    """Test class for mamba_2_8b model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mamba_2_8b"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mamba_2_8b model")
    ...
    test = TestMamba28bModel(args.model_id, args.device)
