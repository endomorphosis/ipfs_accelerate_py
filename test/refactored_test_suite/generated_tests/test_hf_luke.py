#!/usr/bin/env python3
"""
Test file for LUKE models (encoder-only architecture).

This test verifies the functionality of the luke model.
"""
...
class TestLukeModel(EncoderOnlyModelTest):
    """Test class for luke model."""
...
def main():
    ...
    test = TestLukeModel(args.model_id, args.device)
