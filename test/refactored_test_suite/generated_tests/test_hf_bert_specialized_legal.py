#!/usr/bin/env python3
"""
Test file for BERT_SPECIALIZED_LEGAL models (encoder-only architecture).

This test verifies the functionality of the bert_specialized_legal model.
"""
...
class TestBertModel(EncoderOnlyModelTest):
    """Test class for bert_specialized_legal model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "bert_specialized_legal"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bert_specialized_legal model")
