#!/usr/bin/env python3
"""
Test file for XVLM models (encoder-only architecture).

This test verifies the functionality of the xvlm model.
"""
...
class TestXvlmModel(EncoderOnlyModelTest):
    """Test class for xvlm model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "xvlm"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xvlm model")
    ...
    test = TestXvlmModel(args.model_id, args.device)
