#!/usr/bin/env python3
"""
Test file for BLOOMZ models (decoder-only architecture).

This test verifies the functionality of the bloomz model.
"""
...
class TestBloomzModel(DecoderOnlyModelTest):
    """Test class for bloomz model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "bloomz"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test bloomz model")
    ...
    test = TestBloomzModel(args.model_id, args.device)
