#!/usr/bin/env python3
"""
Test file for MOBILENET_ models (encoder-only architecture).

This test verifies the functionality of the mobilenet_ model.
"""
...
class TestMobilenet_Model(EncoderOnlyModelTest):
    """Test class for mobilenet_ model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "mobilenet_"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mobilenet_ model")
    ...
    test = TestMobilenet_Model(args.model_id, args.device)
