#!/usr/bin/env python3
"""
Test file for XGLM models (encoder-only architecture).

This test verifies the functionality of the xglm model.
"""
...
class TestXglmModel(EncoderOnlyModelTest):
    """Test class for xglm model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xglm model")
    ...
    test = TestXglmModel(args.model_id, args.device)
