#!/usr/bin/env python3
"""
Test file for TROCR models (encoder-only architecture).

This test verifies the functionality of the trocr model.
"""
...
class TestTrocrModel(EncoderOnlyModelTest):
    """Test class for trocr model."""
...
def main():
    ...
    test = TestTrocrModel(args.model_id, args.device)
