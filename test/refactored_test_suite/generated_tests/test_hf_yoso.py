#!/usr/bin/env python3
"""
Test file for YOSO models (encoder-only architecture).

This test verifies the functionality of the yoso model.
"""
...
class TestYosoModel(EncoderOnlyModelTest):
    """Test class for yoso model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test yoso model")
    ...
    test = TestYosoModel(args.model_id, args.device)
