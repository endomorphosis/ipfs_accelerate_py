#!/usr/bin/env python3
"""
Test file for PERCEIVER models (encoder-only architecture).

This test verifies the functionality of the perceiver model.
"""
...
class TestPerceiverModel(EncoderOnlyModelTest):
    """Test class for perceiver model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test perceiver model")
    ...
    test = TestPerceiverModel(args.model_id, args.device)
