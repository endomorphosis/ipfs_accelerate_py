#!/usr/bin/env python3
"""
Test file for DEBERTA models (encoder-only architecture).

This test verifies the functionality of the deberta model.
"""
...
class TestDebertaModel(EncoderOnlyModelTest):
    """Test class for deberta model."""
...
def main():
    ...
    test = TestDebertaModel(args.model_id, args.device)
