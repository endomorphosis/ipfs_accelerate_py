#!/usr/bin/env python3
"""
Test file for CLVP models (encoder-only architecture).

This test verifies the functionality of the clvp model.
"""
...
class TestClvpModel(EncoderOnlyModelTest):
    """Test class for clvp model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test clvp model")
    ...
    test = TestClvpModel(args.model_id, args.device)
