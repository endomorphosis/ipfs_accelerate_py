#!/usr/bin/env python3
"""
Test file for XLM_ROBERTA models (encoder-only architecture).

This test verifies the functionality of the xlm_roberta model.
"""
...
class TestXlm_robertaModel(EncoderOnlyModelTest):
    """Test class for xlm_roberta model."""
...
def main():
    ...
    test = TestXlm_robertaModel(args.model_id, args.device)
