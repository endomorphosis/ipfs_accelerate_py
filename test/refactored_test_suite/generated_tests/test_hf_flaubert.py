#!/usr/bin/env python3
"""
Test file for FLAUBERT models (encoder-only architecture).

This test verifies the functionality of the flaubert model.
"""
...
class TestFlaubertModel(EncoderOnlyModelTest):
    """Test class for flaubert model."""
...
def main():
    ...
    test = TestFlaubertModel(args.model_id, args.device)
