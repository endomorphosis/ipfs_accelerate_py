#!/usr/bin/env python3
"""
Test file for CLAUDE_3_HAIKU models (encoder-only architecture).

This test verifies the functionality of the claude_3_haiku model.
"""
...
class TestBertModel(EncoderOnlyModelTest):
    """Test class for claude_3_haiku model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "claude_3_haiku"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test claude_3_haiku model")
