#!/usr/bin/env python3
"""
Test file for BIG_BIRD models (encoder-only architecture).

This test verifies the functionality of the big_bird model.
"""
...
class TestBig_birdModel(EncoderOnlyModelTest):
    """Test class for big_bird model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test big_bird model")
    ...
    test = TestBig_birdModel(args.model_id, args.device)
