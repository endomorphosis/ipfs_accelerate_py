#!/usr/bin/env python3
"""
Test file for MPT models (encoder-only architecture).

This test verifies the functionality of the mpt model.
"""
...
class TestMptModel(EncoderOnlyModelTest):
    """Test class for mpt model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mpt model")
    ...
    test = TestMptModel(args.model_id, args.device)
