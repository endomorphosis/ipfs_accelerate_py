#!/usr/bin/env python3
"""
Test file for WA models (encoder-only architecture).

This test verifies the functionality of the wa model.
"""
...
class TestWaModel(EncoderOnlyModelTest):
    """Test class for wa model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test wa model")
    ...
    test = TestWaModel(args.model_id, args.device)
