#!/usr/bin/env python3
"""
Test file for DOLLY models (encoder-only architecture).

This test verifies the functionality of the dolly model.
"""
...
class TestDollyModel(EncoderOnlyModelTest):
    """Test class for dolly model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "dolly"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test dolly model")
    ...
    test = TestDollyModel(args.model_id, args.device)
