#!/usr/bin/env python3
"""
Test file for XMOD models (encoder-only architecture).

This test verifies the functionality of the xmod model.
"""
...
class TestXmodModel(EncoderOnlyModelTest):
    """Test class for xmod model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xmod model")
    ...
    test = TestXmodModel(args.model_id, args.device)
