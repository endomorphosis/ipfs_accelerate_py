#!/usr/bin/env python3
"""
Test file for DEBERTA_ models (encoder-only architecture).

This test verifies the functionality of the deberta_ model.
"""
...
class TestDeberta_Model(EncoderOnlyModelTest):
    """Test class for deberta_ model."""
    
    def __init__(self, model_id=None, device=None):
        """Initialize the test."""
        # Set model type explicitly
        self.model_type = "deberta_"
        self.task = "fill-mask"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test deberta_ model")
    ...
    test = TestDeberta_Model(args.model_id, args.device)
