#!/usr/bin/env python3
"""
Test file for DINAT models (encoder-only architecture).

This test verifies the functionality of the dinat model.
"""
...
class TestDinatModel(EncoderOnlyModelTest):
    """Test class for dinat model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test dinat model")
    ...
    test = TestDinatModel(args.model_id, args.device)
