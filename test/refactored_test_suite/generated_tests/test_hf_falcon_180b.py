#!/usr/bin/env python3
"""
Test file for FALCON models (decoder-only architecture).

This test verifies the functionality of the falcon model.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test falcon model")
