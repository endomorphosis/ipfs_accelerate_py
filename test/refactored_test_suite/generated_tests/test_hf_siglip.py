#!/usr/bin/env python3
"""
Test file for SIGLIP models (encoder-only architecture).

This test verifies the functionality of the siglip model.
"""
...
class TestSiglipModel(EncoderOnlyModelTest):
    """Test class for siglip model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test siglip model")
    ...
    test = TestSiglipModel(args.model_id, args.device)
