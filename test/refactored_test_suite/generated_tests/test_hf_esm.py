#!/usr/bin/env python3
"""
Test file for ESM models (encoder-only architecture).

This test verifies the functionality of the esm model.
"""
...
class TestEsmModel(EncoderOnlyModelTest):
    """Test class for esm model."""
...
def main():
    ...
    test = TestEsmModel(args.model_id, args.device)
