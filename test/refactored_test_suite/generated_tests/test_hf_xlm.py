#!/usr/bin/env python3
"""
Test file for XLM models (encoder-only architecture).

This test verifies the functionality of the xlm model.
"""
...
class TestXlmModel(EncoderOnlyModelTest):
    """Test class for xlm model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test xlm model")
    ...
    test = TestXlmModel(args.model_id, args.device)
