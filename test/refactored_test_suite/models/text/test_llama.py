...
class TestLlamaModel(ModelTest):
    ...
    def test_cpu_inference(self):
        ...
        try:
            ...
            self.assertGreater(
                len(generated_text), len(self.test_prompt), "Model should generate additional text"
            )
        ...
        for device in devices_to_test:
            ...
            try:
                ...
                self.assertIsNotNone(
                    generated_text, f"Generated text on {device} should not be None"
                )
                self.assertGreater(
                    len(generated_text),
                    len(self.test_prompt),
