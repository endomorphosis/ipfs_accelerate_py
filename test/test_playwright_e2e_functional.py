...
def test_api_endpoints_directly():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(
                f"   {'⚠️  Using fallback data' if is_fallback else '✅ Using real HuggingFace API'}"
            )
    ...
    try:
        ...
        response = requests.post(
            f"{base_url}/api/mcp/models/download", json={"model_id": test_model_id}, timeout=15
        )
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                page.screenshot(
                    path=str(screenshots_dir / "01_dashboard_validated.png"), full_page=True
                )
                ...
                page.screenshot(
                    path=str(screenshots_dir / "02_search_validated.png"), full_page=True
                )
                ...
                page.screenshot(
                    path=str(screenshots_dir / "03_download_interaction.png"), full_page=True
                )
