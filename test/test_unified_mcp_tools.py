...
class TestUnifiedMCPTools(unittest.TestCase):
    ...
    def test_register_unified_tools_calls_all_modules(self):
        ...
        with (
            patch.object(unified_tools, "register_github_tools") as mock_github,
    ...
    def test_all_registration_functions_in_module(self):
        ...
        for func_name in expected_functions:
            self.assertTrue(hasattr(unified_tools, func_name), f"Missing function: {func_name}")
            self.assertTrue(
                callable(getattr(unified_tools, func_name)), f"Not callable: {func_name}"
            )
