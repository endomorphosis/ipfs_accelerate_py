...
class TestMemorySavings:
    ...
    def test_estimate_memory_savings_4bit(self):
        ...
        savings = manager.estimate_memory_savings(
            QuantizationMethod.BITSANDBYTES_4BIT, model_size_gb=10.0
        )
    ...
    def test_estimate_memory_savings_8bit(self):
        ...
        manager = QuantizationManager("cuda")
        savings = manager.estimate_memory_savings(
            QuantizationMethod.BITSANDBYTES_8BIT, model_size_gb=10.0
        )
    ...
    def test_estimate_memory_savings_none(self):
        ...
        manager = QuantizationManager("cuda")
        savings = manager.estimate_memory_savings(QuantizationMethod.NONE, model_size_gb=10.0)
    ...
    def test_memory_savings_consistency(self):
        ...
        savings_none = manager.estimate_memory_savings(QuantizationMethod.NONE, model_size)
