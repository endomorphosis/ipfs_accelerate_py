...
def generate_test(test_type: str, output_dir: str):
    ...
    if test_type == "model":
        ...
        template = ModelTestTemplate(
            template_name=f"{params['model_name']}_test", output_dir=output_dir, parameters=params
        )
        ...
        template = APITestTemplate(
            template_name=f"{params['api_name']}_test", output_dir=output_dir, parameters=params
        )
    else:
