# Original model name: llava-next
#!/usr/bin/env python3
...
LLAVA_NEXT_MODELS_REGISTRY = {
    "llava_next-base": {
        "description": "llava_next base model",
        "class": "Llava_nextModel",
    }
}

class TestLlavaNextModels:
    """Test class for llava_next models."""
    
    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "llava_next-base"
        ...
        if self.model_id not in LLAVA_NEXT_MODELS_REGISTRY:
            ...
            self.model_info = LLAVA_NEXT_MODELS_REGISTRY["llava_next-base"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test llava_next models")
    ...
    # Run test
    model_id = args.model or "llava_next-base"
    tester = TestLlavaNextModels(model_id)
