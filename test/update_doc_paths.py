...
def update_file_paths(file_path, dry_run=False):
    ...
    try:
        ...
        if changes_made > 0:
            print(f"Found {changes_made} path references to update in {file_path}")
            ...
            print(f"No path references to update in {file_path}")
...
def main():
    ...
    if args.file:
        ...
        print(f"No file or directory specified. Using current directory: {current_dir}")
