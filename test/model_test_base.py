...
class EncoderOnlyModelTest(ModelTest):
    ...
    def test_model_loading(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.performance_stats["model_loading"] = {"load_time": load_time}
    ...
    def verify_model_output(
        self, model_data, input_text="The [MASK] runs quickly.", expected_output=None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if len(mask_token_index) > 0:
                ...
                # Add to performance stats
                self.performance_stats["model_inference"] = {"inference_time": inference_time}

                # Add to examples
                self.examples.append({"input": input_text, "top_predictions": top_tokens})
...
class DecoderOnlyModelTest(ModelTest):
    ...
    def verify_model_output(
        self, model_data, input_text="Once upon a time", expected_output=None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            with torch.no_grad():
                outputs = model.generate(
                    **inputs, max_length=50, num_return_sequences=1, temperature=0.7, top_p=0.9
                )
            inference_time = time.time() - start_time
            ...
            # Add to examples
            self.examples.append({"input": input_text, "generated_text": generated_text})
...
class VisionModelTest(ModelTest):
    ...
    def verify_model_output(
        self, model_data, input_image=None, expected_output=None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(outputs, "logits"):
                ...
                # Add to examples
                self.examples.append({"input_type": "image", "top_prediction": predicted_class})
                ...
                return {"success": False, "error": "No logits found in model output"}
