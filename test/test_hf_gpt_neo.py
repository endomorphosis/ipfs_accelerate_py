...
GPT_NEO_MODELS_REGISTRY = {
    "gpt_neo": {
        "description": "gpt_neo base model",
        "class": "Gpt_neoForCausalLM",
    }
}


class TestGptNeoModels:
    """Test class for gpt_neo models."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test gpt_neo models")
