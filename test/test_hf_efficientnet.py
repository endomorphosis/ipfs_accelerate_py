...
EFFICIENTNET_MODELS_REGISTRY = {
    "google/efficientnet-base-patch16-224": {
        "description": "efficientnet base model",
...
class TestEfficientnetModels:
    """Test class for efficientnet models."""

    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "google/efficientnet-base-patch16-224"
        ...
        if self.model_id not in EFFICIENTNET_MODELS_REGISTRY:
            ...
            self.model_info = EFFICIENTNET_MODELS_REGISTRY["google/efficientnet-base-patch16-224"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test efficientnet models")
    ...
    # Run test
    model_id = args.model or "google/efficientnet-base-patch16-224"
