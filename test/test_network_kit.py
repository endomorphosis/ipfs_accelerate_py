...
class TestNetworkKit(unittest.TestCase):
    ...
    def test_network_result_dataclass(self):
        ...
        result = self.NetworkResult(
            success=True, data={"peers": ["QmPeer1", "QmPeer2"]}, error=None, message="Success"
        )
    ...
    def test_peer_info_dataclass(self):
        ...
        peer_info = self.PeerInfo(
            peer_id="QmPeer123", addresses=["/ip4/1.2.3.4/tcp/4001"], latency=50.5, connected=True
        )
    ...
    def test_bandwidth_stats_dataclass(self):
        ...
        stats = self.BandwidthStats(total_in=1024, total_out=2048, rate_in=100.5, rate_out=200.5)
