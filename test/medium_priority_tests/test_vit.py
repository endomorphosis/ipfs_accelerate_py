...
class TestVitModel:
    ...
    def __init__(self, model_id="microsoft/swinv2-tiny-patch4-window8-256", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="microsoft/swinv2-tiny-patch4-window8-256", help="Specific model to test")
