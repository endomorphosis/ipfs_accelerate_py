...
class TestT5Model:
    ...
    def __init__(self, model_id="google/pegasus-x-base", device=None):
...
def main():
    ...
    parser.add_argument("--model", type=str, default="google/pegasus-x-base", help="Specific model to test")
