...
[Reformer](https://huggingface.co/docs/transformers/v4.46.0/en/model_doc/reformer) uses LSH attention. In the softmax(QK^t), only the biggest elements (in the softmax
...
[Longformer](https://huggingface.co/docs/transformers/v4.46.0/en/model_doc/longformer) uses local attention: often, the local context (e.g., what are the two tokens to the
...
[Reformer](https://huggingface.co/docs/transformers/v4.46.0/en/model_doc/reformer) uses axial positional encodings: in traditional transformer models, the positional encoding
