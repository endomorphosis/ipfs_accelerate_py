...
Usage:
    Replace XLM_ROBERTA_XL, xlm_roberta_xl-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "xlm_roberta_xl-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "XLM_ROBERTA_XL"  # e.g., "bert"
