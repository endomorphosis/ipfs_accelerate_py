...
Usage:
    Replace ENCODER_ONLY, encoder_only-base-uncased, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "encoder_only-base-uncased"  # e.g., "bert-base-uncased"
MODEL_NAME = "ENCODER_ONLY"  # e.g., "bert"
