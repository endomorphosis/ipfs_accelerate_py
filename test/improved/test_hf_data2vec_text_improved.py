...
Usage:
    Replace DATA2VEC_TEXT, data2vec_text-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "data2vec_text-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DATA2VEC_TEXT"  # e.g., "bert"
