...
Usage:
    Replace SWITCH-TRANSFORMERS, switch-transformers-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "switch-transformers-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SWITCH-TRANSFORMERS"  # e.g., "bert"
