...
Usage:
    Replace MEGATRON-BERT, megatron-bert-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "megatron-bert-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MEGATRON-BERT"  # e.g., "bert"
