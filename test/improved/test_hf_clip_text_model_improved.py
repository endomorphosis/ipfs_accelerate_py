...
Usage:
    Replace CLIP_TEXT_MODEL, clip_text_model-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "clip_text_model-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CLIP_TEXT_MODEL"  # e.g., "bert"
