...
Usage:
    Replace XLM-PROPHETNET, xlm-prophetnet-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "xlm-prophetnet-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "XLM-PROPHETNET"  # e.g., "bert"
