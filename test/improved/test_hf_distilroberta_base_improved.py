...
Usage:
    Replace DISTILROBERTA_BASE, distilroberta_base-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "distilroberta_base-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DISTILROBERTA_BASE"  # e.g., "bert"
