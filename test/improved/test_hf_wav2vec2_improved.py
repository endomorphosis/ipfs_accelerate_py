...
Usage:
    Replace WAV2VEC2, facebook/wav2vec2-base-960h, automatic-speech-recognition with actual values.
"""
...
# Model configuration
MODEL_ID = "facebook/wav2vec2-base-960h"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2"  # e.g., "bert"
