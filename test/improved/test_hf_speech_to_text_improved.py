...
Usage:
    Replace SPEECH_TO_TEXT, speech_to_text-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "speech_to_text-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SPEECH_TO_TEXT"  # e.g., "bert"
