...
Usage:
    Replace DATA2VEC-VISION, data2vec-vision-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "data2vec-vision-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DATA2VEC-VISION"  # e.g., "bert"
