...
Usage:
    Replace STABLE-DIFFUSION, stable-diffusion-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "stable-diffusion-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "STABLE-DIFFUSION"  # e.g., "bert"
