...
Usage:
    Replace QWEN2_7B, Qwen/Qwen2-7B-Instruct, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "Qwen/Qwen2-7B-Instruct"  # e.g., "bert-base-uncased"
MODEL_NAME = "QWEN2_7B"  # e.g., "bert"
