...
Usage:
    Replace RECURRENT_GEMMA, recurrent_gemma-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "recurrent_gemma-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "RECURRENT_GEMMA"  # e.g., "bert"
