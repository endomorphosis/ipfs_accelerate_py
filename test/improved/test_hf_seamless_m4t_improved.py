...
Usage:
    Replace SEAMLESS_M4T, seamless_m4t-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "seamless_m4t-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SEAMLESS_M4T"  # e.g., "bert"
