...
Usage:
    Replace MOBILENET-V2, mobilenet-v2-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "mobilenet-v2-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MOBILENET-V2"  # e.g., "bert"
