...
Usage:
    Replace DECISION_TRANSFORMER, decision_transformer-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "decision_transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DECISION_TRANSFORMER"  # e.g., "bert"
