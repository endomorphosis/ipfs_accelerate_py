...
Usage:
    Replace LLAVA_NEXT_VIDEO, llava_next_video-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "llava_next_video-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "LLAVA_NEXT_VIDEO"  # e.g., "bert"
