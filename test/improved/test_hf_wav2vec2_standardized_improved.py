...
Usage:
    Replace WAV2VEC2_STANDARDIZED, wav2vec2_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "wav2vec2_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2_STANDARDIZED"  # e.g., "bert"
