...
Usage:
    Replace DATA2VEC_AUDIO, data2vec_audio-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "data2vec_audio-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DATA2VEC_AUDIO"  # e.g., "bert"
