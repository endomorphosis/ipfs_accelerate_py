...
Usage:
    Replace MISTRAL_NEMO, mistral_nemo-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "mistral_nemo-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MISTRAL_NEMO"  # e.g., "bert"
