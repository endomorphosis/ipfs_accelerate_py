...
Usage:
    Replace TGI_CONTAINER, tgi_container-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "tgi_container-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TGI_CONTAINER"  # e.g., "bert"
