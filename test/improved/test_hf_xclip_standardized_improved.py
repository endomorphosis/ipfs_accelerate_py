...
Usage:
    Replace XCLIP_STANDARDIZED, microsoft/xclip-base-patch32, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "microsoft/xclip-base-patch32"  # e.g., "bert-base-uncased"
MODEL_NAME = "XCLIP_STANDARDIZED"  # e.g., "bert"
