...
Usage:
    Replace WHISPER-TINY, whisper-tiny-base, automatic-speech-recognition with actual values.
"""
...
# Model configuration
MODEL_ID = "whisper-tiny-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WHISPER-TINY"  # e.g., "bert"
