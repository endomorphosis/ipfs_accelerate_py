...
Usage:
    Replace SIGLIP_VISION_MODEL, siglip_vision_model-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "siglip_vision_model-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SIGLIP_VISION_MODEL"  # e.g., "bert"
