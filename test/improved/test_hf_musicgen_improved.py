...
Usage:
    Replace MUSICGEN, musicgen-base, automatic-speech-recognition with actual values.
"""
...
# Model configuration
MODEL_ID = "musicgen-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MUSICGEN"  # e.g., "bert"
