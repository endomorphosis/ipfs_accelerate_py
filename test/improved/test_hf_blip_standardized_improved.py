...
Usage:
    Replace BLIP_STANDARDIZED, blip_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "blip_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BLIP_STANDARDIZED"  # e.g., "bert"
