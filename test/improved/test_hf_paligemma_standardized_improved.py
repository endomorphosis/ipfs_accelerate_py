...
Usage:
    Replace PALIGEMMA_STANDARDIZED, google/paligemma-3b-pt-224, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "google/paligemma-3b-pt-224"  # e.g., "bert-base-uncased"
MODEL_NAME = "PALIGEMMA_STANDARDIZED"  # e.g., "bert"
