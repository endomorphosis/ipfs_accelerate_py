...
Usage:
    Replace MASKFORMER_SWIN, maskformer_swin-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "maskformer_swin-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MASKFORMER_SWIN"  # e.g., "bert"
