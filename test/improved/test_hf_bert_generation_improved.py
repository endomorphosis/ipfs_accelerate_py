...
Usage:
    Replace BERT_GENERATION, bert_generation-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "bert_generation-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BERT_GENERATION"  # e.g., "bert"
