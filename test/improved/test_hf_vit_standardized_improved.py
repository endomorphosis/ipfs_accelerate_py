...
Usage:
    Replace VIT_STANDARDIZED, vit_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "vit_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VIT_STANDARDIZED"  # e.g., "bert"
