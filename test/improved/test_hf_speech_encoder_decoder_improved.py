...
Usage:
    Replace SPEECH_ENCODER_DECODER, speech_encoder_decoder-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "speech_encoder_decoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SPEECH_ENCODER_DECODER"  # e.g., "bert"
