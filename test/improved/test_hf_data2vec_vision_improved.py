...
Usage:
    Replace DATA2VEC_VISION, data2vec_vision-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "data2vec_vision-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DATA2VEC_VISION"  # e.g., "bert"
