...
Usage:
    Replace INSTRUCT_BLIP, instruct_blip-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "instruct_blip-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "INSTRUCT_BLIP"  # e.g., "bert"
