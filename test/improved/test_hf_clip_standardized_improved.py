...
Usage:
    Replace CLIP_STANDARDIZED, clip_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "clip_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CLIP_STANDARDIZED"  # e.g., "bert"
