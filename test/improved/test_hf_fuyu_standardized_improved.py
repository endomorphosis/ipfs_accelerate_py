...
Usage:
    Replace FUYU_STANDARDIZED, adept/fuyu-tiny-test, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "adept/fuyu-tiny-test"  # e.g., "bert-base-uncased"
MODEL_NAME = "FUYU_STANDARDIZED"  # e.g., "bert"
