...
Usage:
    Replace BARTPHO, bartpho-base, summarization with actual values.
"""
...
# Model configuration
MODEL_ID = "bartpho-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BARTPHO"  # e.g., "bert"
TASK_TYPE = "summarization"  # e.g., "text_embedding"
