...
Usage:
    Replace T5_MINIMAL, t5_minimal-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "t5_minimal-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "T5_MINIMAL"  # e.g., "bert"
