...
Usage:
    Replace CHINESE_CLIP_VISION_MODEL, chinese_clip_vision_model-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "chinese_clip_vision_model-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CHINESE_CLIP_VISION_MODEL"  # e.g., "bert"
