...
Usage:
    Replace TRAJECTORY_TRANSFORMER, trajectory_transformer-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "trajectory_transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TRAJECTORY_TRANSFORMER"  # e.g., "bert"
