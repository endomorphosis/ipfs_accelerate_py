...
Usage:
    Replace EFFICIENTFORMER, efficientformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "efficientformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "EFFICIENTFORMER"  # e.g., "bert"
