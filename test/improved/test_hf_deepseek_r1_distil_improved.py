...
Usage:
    Replace DEEPSEEK_R1_DISTIL, deepseek_r1_distil-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "deepseek_r1_distil-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEEPSEEK_R1_DISTIL"  # e.g., "bert"
