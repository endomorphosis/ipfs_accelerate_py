...
Usage:
    Replace VISION-TEXT-DUAL-ENCODER, vision-text-dual-encoder-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "vision-text-dual-encoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VISION-TEXT-DUAL-ENCODER"  # e.g., "bert"
