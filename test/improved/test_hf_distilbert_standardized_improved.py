...
Usage:
    Replace DISTILBERT_STANDARDIZED, distilbert_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "distilbert_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DISTILBERT_STANDARDIZED"  # e.g., "bert"
