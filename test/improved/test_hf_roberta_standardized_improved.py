...
Usage:
    Replace ROBERTA_STANDARDIZED, roberta_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "roberta_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "ROBERTA_STANDARDIZED"  # e.g., "bert"
