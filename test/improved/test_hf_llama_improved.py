...
Usage:
    Replace LLAMA, meta-llama/Llama-2-7b-hf, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "meta-llama/Llama-2-7b-hf"  # e.g., "bert-base-uncased"
MODEL_NAME = "LLAMA"  # e.g., "bert"
