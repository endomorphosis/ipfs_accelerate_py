...
Usage:
    Replace TEI_CONTAINER, tei_container-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "tei_container-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TEI_CONTAINER"  # e.g., "bert"
