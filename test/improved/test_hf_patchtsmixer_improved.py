...
Usage:
    Replace PATCHTSMIXER, patchtsmixer-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "patchtsmixer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "PATCHTSMIXER"  # e.g., "bert"
