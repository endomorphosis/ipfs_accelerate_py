...
Usage:
    Replace DETR_RESNET_50, facebook/detr-resnet-50, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "facebook/detr-resnet-50"  # e.g., "bert-base-uncased"
MODEL_NAME = "DETR_RESNET_50"  # e.g., "bert"
