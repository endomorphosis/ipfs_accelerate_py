...
Usage:
    Replace INSTRUCTBLIP, instructblip-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "instructblip-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "INSTRUCTBLIP"  # e.g., "bert"
