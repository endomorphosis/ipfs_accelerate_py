...
Usage:
    Replace GPT_NEOX_JAPANESE, gpt_neox_japanese-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "gpt_neox_japanese-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPT_NEOX_JAPANESE"  # e.g., "bert"
