...
Usage:
    Replace MUSICGEN_MELODY, musicgen_melody-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "musicgen_melody-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MUSICGEN_MELODY"  # e.g., "bert"
