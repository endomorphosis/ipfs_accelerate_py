...
Usage:
    Replace GEMMA_STANDARDIZED, google/gemma-2b, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "google/gemma-2b"  # e.g., "bert-base-uncased"
MODEL_NAME = "GEMMA_STANDARDIZED"  # e.g., "bert"
