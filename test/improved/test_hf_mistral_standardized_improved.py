...
Usage:
    Replace MISTRAL_STANDARDIZED, mistral_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "mistral_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MISTRAL_STANDARDIZED"  # e.g., "bert"
