...
Usage:
    Replace FASTSPEECH2_CONFORMER, fastspeech2_conformer-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "fastspeech2_conformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "FASTSPEECH2_CONFORMER"  # e.g., "bert"
