...
Usage:
    Replace WAV2VEC2-BERT, wav2vec2-bert-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "wav2vec2-bert-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2-BERT"  # e.g., "bert"
