...
Usage:
    Replace CLIP_VISION_MODEL, clip_vision_model-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "clip_vision_model-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CLIP_VISION_MODEL"  # e.g., "bert"
