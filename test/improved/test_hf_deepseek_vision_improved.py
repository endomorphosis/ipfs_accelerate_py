...
Usage:
    Replace DEEPSEEK_VISION, deepseek_vision-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "deepseek_vision-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEEPSEEK_VISION"  # e.g., "bert"
