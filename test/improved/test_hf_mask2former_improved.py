...
Usage:
    Replace MASK2FORMER, mask2former-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "mask2former-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MASK2FORMER"  # e.g., "bert"
