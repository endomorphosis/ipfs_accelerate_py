...
Usage:
    Replace TIMESFORMER, timesformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "timesformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TIMESFORMER"  # e.g., "bert"
