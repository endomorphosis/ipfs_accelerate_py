...
Usage:
    Replace ELECTRA_STANDARDIZED, electra_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "electra_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "ELECTRA_STANDARDIZED"  # e.g., "bert"
