...
Usage:
    Replace WAV2VEC2_BASE, facebook/wav2vec2-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "facebook/wav2vec2-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2_BASE"  # e.g., "bert"
