...
Usage:
    Replace WAV2VEC2_CONFORMER, wav2vec2_conformer-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "wav2vec2_conformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2_CONFORMER"  # e.g., "bert"
