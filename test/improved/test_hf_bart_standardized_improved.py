...
Usage:
    Replace BART_STANDARDIZED, bart_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "bart_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BART_STANDARDIZED"  # e.g., "bert"
