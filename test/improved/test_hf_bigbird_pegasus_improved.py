...
Usage:
    Replace BIGBIRD_PEGASUS, bigbird_pegasus-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "bigbird_pegasus-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BIGBIRD_PEGASUS"  # e.g., "bert"
