...
Usage:
    Replace ENCODER_DECODER, encoder_decoder-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "encoder_decoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "ENCODER_DECODER"  # e.g., "bert"
