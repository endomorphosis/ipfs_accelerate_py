...
Usage:
    Replace SWIFTFORMER, swiftformer-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "swiftformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SWIFTFORMER"  # e.g., "bert"
