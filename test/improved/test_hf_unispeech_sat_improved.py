...
Usage:
    Replace UNISPEECH_SAT, unispeech_sat-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "unispeech_sat-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "UNISPEECH_SAT"  # e.g., "bert"
