...
Usage:
    Replace BLOOM_STANDARDIZED, bigscience/bloom-560m, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "bigscience/bloom-560m"  # e.g., "bert-base-uncased"
MODEL_NAME = "BLOOM_STANDARDIZED"  # e.g., "bert"
