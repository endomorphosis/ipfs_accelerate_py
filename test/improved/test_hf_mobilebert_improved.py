...
Usage:
    Replace MOBILEBERT, mobilebert-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "mobilebert-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MOBILEBERT"  # e.g., "bert"
