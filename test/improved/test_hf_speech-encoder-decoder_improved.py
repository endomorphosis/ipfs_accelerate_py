...
Usage:
    Replace SPEECH-ENCODER-DECODER, speech-encoder-decoder-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "speech-encoder-decoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SPEECH-ENCODER-DECODER"  # e.g., "bert"
