...
Usage:
    Replace GROUNDING_DINO, grounding_dino-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "grounding_dino-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GROUNDING_DINO"  # e.g., "bert"
