...
Usage:
    Replace FLAMINGO_STANDARDIZED, openflamingo/tiny-random-flamingo, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "openflamingo/tiny-random-flamingo"  # e.g., "bert-base-uncased"
MODEL_NAME = "FLAMINGO_STANDARDIZED"  # e.g., "bert"
