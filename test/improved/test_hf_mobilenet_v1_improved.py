...
Usage:
    Replace MOBILENET_V1, mobilenet_v1-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "mobilenet_v1-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MOBILENET_V1"  # e.g., "bert"
