...
Usage:
    Replace WHISPER_TINY, openai/whisper-tiny, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "openai/whisper-tiny"  # e.g., "bert-base-uncased"
MODEL_NAME = "WHISPER_TINY"  # e.g., "bert"
