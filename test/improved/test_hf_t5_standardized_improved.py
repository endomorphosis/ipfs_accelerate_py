...
Usage:
    Replace T5_STANDARDIZED, t5_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "t5_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "T5_STANDARDIZED"  # e.g., "bert"
