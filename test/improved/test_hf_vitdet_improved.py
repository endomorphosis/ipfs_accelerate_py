...
Usage:
    Replace VITDET, vitdet-base, image-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "vitdet-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VITDET"  # e.g., "bert"
TASK_TYPE = "image-classification"  # e.g., "text_embedding"
