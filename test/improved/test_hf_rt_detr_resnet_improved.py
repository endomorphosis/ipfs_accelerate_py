...
Usage:
    Replace RT_DETR_RESNET, rt_detr_resnet-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "rt_detr_resnet-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "RT_DETR_RESNET"  # e.g., "bert"
