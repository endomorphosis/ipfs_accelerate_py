...
Usage:
    Replace DECISION-TRANSFORMER, decision-transformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "decision-transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DECISION-TRANSFORMER"  # e.g., "bert"
