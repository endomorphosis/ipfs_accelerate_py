...
Usage:
    Replace QWEN2_AUDIO_ENCODER, qwen2_audio_encoder-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "qwen2_audio_encoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "QWEN2_AUDIO_ENCODER"  # e.g., "bert"
