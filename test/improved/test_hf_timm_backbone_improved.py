...
Usage:
    Replace TIMM_BACKBONE, timm_backbone-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "timm_backbone-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TIMM_BACKBONE"  # e.g., "bert"
