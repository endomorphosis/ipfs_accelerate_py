...
Usage:
    Replace SPEECH-TO-TEXT-2, speech-to-text-2-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "speech-to-text-2-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SPEECH-TO-TEXT-2"  # e.g., "bert"
