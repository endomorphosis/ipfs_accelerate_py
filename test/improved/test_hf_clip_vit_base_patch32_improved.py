...
Usage:
    Replace CLIP_VIT_BASE_PATCH32, openai/clip-vit-base-patch32, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "openai/clip-vit-base-patch32"  # e.g., "bert-base-uncased"
MODEL_NAME = "CLIP_VIT_BASE_PATCH32"  # e.g., "bert"
