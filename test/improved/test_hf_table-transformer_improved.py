...
Usage:
    Replace TABLE-TRANSFORMER, table-transformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "table-transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TABLE-TRANSFORMER"  # e.g., "bert"
