...
Usage:
    Replace TEI_UNIFIED, tei_unified-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "tei_unified-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TEI_UNIFIED"  # e.g., "bert"
