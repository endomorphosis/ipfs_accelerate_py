...
Usage:
    Replace WAV2VEC2-CONFORMER, wav2vec2-conformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "wav2vec2-conformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2-CONFORMER"  # e.g., "bert"
