...
Usage:
    Replace TABLE_TRANSFORMER, table_transformer-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "table_transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TABLE_TRANSFORMER"  # e.g., "bert"
