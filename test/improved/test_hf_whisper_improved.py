...
Usage:
    Replace WHISPER, openai/whisper-small, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "openai/whisper-small"  # e.g., "bert-base-uncased"
MODEL_NAME = "WHISPER"  # e.g., "bert"
