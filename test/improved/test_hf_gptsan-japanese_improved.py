...
Usage:
    Replace GPTSAN-JAPANESE, gptsan-japanese-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "gptsan-japanese-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPTSAN-JAPANESE"  # e.g., "bert"
