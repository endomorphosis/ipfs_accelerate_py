...
Usage:
    Replace EFFICIENTNET, efficientnet-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "efficientnet-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "EFFICIENTNET"  # e.g., "bert"
