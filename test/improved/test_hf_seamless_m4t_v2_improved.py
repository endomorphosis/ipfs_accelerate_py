...
Usage:
    Replace SEAMLESS_M4T_V2, seamless_m4t_v2-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "seamless_m4t_v2-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SEAMLESS_M4T_V2"  # e.g., "bert"
