...
Usage:
    Replace MISTRAL_NEXT, mistral_next-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "mistral_next-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MISTRAL_NEXT"  # e.g., "bert"
