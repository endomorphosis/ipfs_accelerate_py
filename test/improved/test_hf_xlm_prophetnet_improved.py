...
Usage:
    Replace XLM_PROPHETNET, xlm_prophetnet-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "xlm_prophetnet-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "XLM_PROPHETNET"  # e.g., "bert"
