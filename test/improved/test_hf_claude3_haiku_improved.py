...
Usage:
    Replace CLAUDE3_HAIKU, claude3_haiku-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "claude3_haiku-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CLAUDE3_HAIKU"  # e.g., "bert"
