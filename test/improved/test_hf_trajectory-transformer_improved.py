...
Usage:
    Replace TRAJECTORY-TRANSFORMER, trajectory-transformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "trajectory-transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TRAJECTORY-TRANSFORMER"  # e.g., "bert"
