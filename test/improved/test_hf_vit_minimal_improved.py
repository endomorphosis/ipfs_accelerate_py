...
Usage:
    Replace VIT_MINIMAL, vit_minimal-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "vit_minimal-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VIT_MINIMAL"  # e.g., "bert"
