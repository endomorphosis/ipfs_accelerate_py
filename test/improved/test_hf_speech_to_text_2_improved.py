...
Usage:
    Replace SPEECH_TO_TEXT_2, speech_to_text_2-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "speech_to_text_2-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SPEECH_TO_TEXT_2"  # e.g., "bert"
