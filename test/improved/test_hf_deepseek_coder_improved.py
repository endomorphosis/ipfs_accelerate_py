...
Usage:
    Replace DEEPSEEK_CODER, deepseek_coder-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "deepseek_coder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEEPSEEK_CODER"  # e.g., "bert"
