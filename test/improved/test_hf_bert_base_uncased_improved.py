...
Usage:
    Replace BERT_BASE_UNCASED, bert_base_uncased-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "bert_base_uncased-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BERT_BASE_UNCASED"  # e.g., "bert"
