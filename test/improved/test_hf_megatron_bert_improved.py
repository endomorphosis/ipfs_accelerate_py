...
Usage:
    Replace MEGATRON_BERT, megatron_bert-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "megatron_bert-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MEGATRON_BERT"  # e.g., "bert"
