...
Usage:
    Replace CHINESE-CLIP, chinese-clip-base, zero-shot-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "chinese-clip-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CHINESE-CLIP"  # e.g., "bert"
TASK_TYPE = "zero-shot-classification"  # e.g., "text_embedding"
