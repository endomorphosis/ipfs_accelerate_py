...
Usage:
    Replace DATA2VEC-AUDIO, data2vec-audio-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "data2vec-audio-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DATA2VEC-AUDIO"  # e.g., "bert"
