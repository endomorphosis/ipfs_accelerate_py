...
Usage:
    Replace ALBERT_STANDARDIZED, albert_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "albert_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "ALBERT_STANDARDIZED"  # e.g., "bert"
