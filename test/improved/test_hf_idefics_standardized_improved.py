...
Usage:
    Replace IDEFICS_STANDARDIZED, HuggingFaceM4/tiny-random-idefics, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "HuggingFaceM4/tiny-random-idefics"  # e.g., "bert-base-uncased"
MODEL_NAME = "IDEFICS_STANDARDIZED"  # e.g., "bert"
TASK_TYPE = "token-classification"  # e.g., "text_embedding"
