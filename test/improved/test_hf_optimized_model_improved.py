...
Usage:
    Replace OPTIMIZED_MODEL, optimized_model-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "optimized_model-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "OPTIMIZED_MODEL"  # e.g., "bert"
