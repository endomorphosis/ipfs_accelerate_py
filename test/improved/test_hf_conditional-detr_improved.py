...
Usage:
    Replace CONDITIONAL-DETR, conditional-detr-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "conditional-detr-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CONDITIONAL-DETR"  # e.g., "bert"
