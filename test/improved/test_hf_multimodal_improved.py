...
Usage:
    Replace MULTIMODAL, multimodal-base-uncased, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "multimodal-base-uncased"  # e.g., "bert-base-uncased"
MODEL_NAME = "MULTIMODAL"  # e.g., "bert"
