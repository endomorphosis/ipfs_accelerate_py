...
Usage:
    Replace SQUEEZEBERT, squeezebert-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "squeezebert-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SQUEEZEBERT"  # e.g., "bert"
