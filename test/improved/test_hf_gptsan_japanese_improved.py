...
Usage:
    Replace GPTSAN_JAPANESE, gptsan_japanese-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "gptsan_japanese-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPTSAN_JAPANESE"  # e.g., "bert"
