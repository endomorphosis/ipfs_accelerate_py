...
Usage:
    Replace BERT_BASE_UNCASED_WITH_AMD, Xenova/bert-base-uncased, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "Xenova/bert-base-uncased"  # e.g., "bert-base-uncased"
MODEL_NAME = "BERT_BASE_UNCASED_WITH_AMD"  # e.g., "bert"
