...
Usage:
    Replace API_INTEGRATION, api_integration-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "api_integration-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "API_INTEGRATION"  # e.g., "bert"
