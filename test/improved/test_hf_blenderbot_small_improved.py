...
Usage:
    Replace BLENDERBOT_SMALL, blenderbot_small-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "blenderbot_small-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BLENDERBOT_SMALL"  # e.g., "bert"
