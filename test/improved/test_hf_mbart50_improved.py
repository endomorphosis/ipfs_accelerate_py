...
Usage:
    Replace MBART50, mbart50-base, translation with actual values.
"""
...
# Model configuration
MODEL_ID = "mbart50-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MBART50"  # e.g., "bert"
TASK_TYPE = "translation"  # e.g., "text_embedding"
