...
Usage:
    Replace TIME-SERIES-TRANSFORMER, time-series-transformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "time-series-transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TIME-SERIES-TRANSFORMER"  # e.g., "bert"
