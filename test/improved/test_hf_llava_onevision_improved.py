...
Usage:
    Replace LLAVA_ONEVISION, llava_onevision-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "llava_onevision-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "LLAVA_ONEVISION"  # e.g., "bert"
