...
Usage:
    Replace DEEPSEEK_DISTIL, deepseek_distil-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "deepseek_distil-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEEPSEEK_DISTIL"  # e.g., "bert"
