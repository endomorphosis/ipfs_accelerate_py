...
Usage:
    Replace DISTILBERT, distilbert-base-uncased, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "distilbert-base-uncased"  # e.g., "bert-base-uncased"
MODEL_NAME = "DISTILBERT"  # e.g., "bert"
