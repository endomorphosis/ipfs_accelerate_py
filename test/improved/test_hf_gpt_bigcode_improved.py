...
Usage:
    Replace GPT_BIGCODE, gpt_bigcode-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "gpt_bigcode-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPT_BIGCODE"  # e.g., "bert"
