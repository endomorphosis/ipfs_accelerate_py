...
Usage:
    Replace LLAVA_NEXT_STANDARDIZED, katuni4ka/tiny-random-llava-next, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "katuni4ka/tiny-random-llava-next"  # e.g., "bert-base-uncased"
MODEL_NAME = "LLAVA_NEXT_STANDARDIZED"  # e.g., "bert"
