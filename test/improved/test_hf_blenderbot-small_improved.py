...
Usage:
    Replace BLENDERBOT-SMALL, blenderbot-small-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "blenderbot-small-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BLENDERBOT-SMALL"  # e.g., "bert"
