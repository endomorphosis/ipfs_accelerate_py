...
Usage:
    Replace DEIT_STANDARDIZED, deit_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "deit_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEIT_STANDARDIZED"  # e.g., "bert"
