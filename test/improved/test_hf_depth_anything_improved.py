...
Usage:
    Replace DEPTH_ANYTHING, depth_anything-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "depth_anything-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEPTH_ANYTHING"  # e.g., "bert"
