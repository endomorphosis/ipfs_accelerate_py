...
Usage:
    Replace CLAP_HTSAT_FUSED, laion/clap-htsat-unfused, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "laion/clap-htsat-unfused"  # e.g., "bert-base-uncased"
MODEL_NAME = "CLAP_HTSAT_FUSED"  # e.g., "bert"
