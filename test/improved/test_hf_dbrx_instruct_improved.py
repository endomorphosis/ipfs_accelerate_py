...
Usage:
    Replace DBRX_INSTRUCT, dbrx_instruct-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "dbrx_instruct-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DBRX_INSTRUCT"  # e.g., "bert"
