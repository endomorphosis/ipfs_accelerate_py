...
Usage:
    Replace DEFORMABLE_DETR, deformable_detr-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "deformable_detr-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DEFORMABLE_DETR"  # e.g., "bert"
