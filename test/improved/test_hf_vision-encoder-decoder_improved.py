...
Usage:
    Replace VISION-ENCODER-DECODER, vision-encoder-decoder-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "vision-encoder-decoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VISION-ENCODER-DECODER"  # e.g., "bert"
