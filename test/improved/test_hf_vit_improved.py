...
Usage:
    Replace VIT, google/vit-base-patch16-224, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "google/vit-base-patch16-224"  # e.g., "bert-base-uncased"
MODEL_NAME = "VIT"  # e.g., "bert"
