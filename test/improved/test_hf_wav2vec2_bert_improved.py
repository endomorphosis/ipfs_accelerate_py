...
Usage:
    Replace WAV2VEC2_BERT, wav2vec2_bert-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "wav2vec2_bert-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "WAV2VEC2_BERT"  # e.g., "bert"
