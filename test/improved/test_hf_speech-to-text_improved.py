...
Usage:
    Replace SPEECH-TO-TEXT, speech-to-text-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "speech-to-text-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SPEECH-TO-TEXT"  # e.g., "bert"
