...
Usage:
    Replace VISION_ENCODER_DECODER, vision_encoder_decoder-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "vision_encoder_decoder-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VISION_ENCODER_DECODER"  # e.g., "bert"
