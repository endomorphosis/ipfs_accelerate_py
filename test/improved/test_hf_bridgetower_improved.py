...
Usage:
    Replace BRIDGETOWER, bridgetower-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "bridgetower-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BRIDGETOWER"  # e.g., "bert"
