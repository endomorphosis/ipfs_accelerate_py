...
Usage:
    Replace GPT_NEO_STANDARDIZED, EleutherAI/gpt-neo-125M, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "EleutherAI/gpt-neo-125M"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPT_NEO_STANDARDIZED"  # e.g., "bert"
