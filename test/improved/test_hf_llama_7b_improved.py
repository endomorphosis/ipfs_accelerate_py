...
Usage:
    Replace LLAMA_7B, TinyLlama/TinyLlama-1.1B-Chat-v1.0, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"  # e.g., "bert-base-uncased"
MODEL_NAME = "LLAMA_7B"  # e.g., "bert"
