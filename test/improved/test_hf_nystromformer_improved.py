...
Usage:
    Replace NYSTROMFORMER, nystromformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "nystromformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "NYSTROMFORMER"  # e.g., "bert"
