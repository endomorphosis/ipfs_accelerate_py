...
Usage:
    Replace MOBILEVITV2, mobilevitv2-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "mobilevitv2-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "MOBILEVITV2"  # e.g., "bert"
