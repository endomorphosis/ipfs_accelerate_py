...
def replace_json_output_with_db(file_path):
    ...
    for pattern in JSON_WRITE_PATTERNS:
        ...
        for match in matches:
            ...
            # Look for the full block of code that writes to JSON# JSON output deprecated in favor of database storage
logger.info("Storing results in database")
            ...
            if "DEPRECATE_JSON_OUTPUT" in code_block:
                ...
                new_block = code_block.split("# JSON output deprecated in favor of database storage
logger.info("Storing results in database")
