...
class TestCopilotSDK:
    ...
    def test_destroy_session(self, mock_client_class):
        ...
        # Mock the response
        expected_response = {"success": True, "message": f"Session {session_id} destroyed"}
    ...
    def test_stop(self, mock_client_class):
        ...
        sdk._active_sessions = {"session1": mock_session1, "session2": mock_session2}

        # Mock the response
        expected_response = {"success": True, "message": "Copilot SDK stopped"}
