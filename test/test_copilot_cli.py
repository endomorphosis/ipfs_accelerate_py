...
class TestCopilotCLI:
    ...
    def test_suggest_command(self):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            mock_run.return_value = Mock(returncode=0, stdout="ls -la | grep txt", stderr="")
    ...
    def test_suggest_git_command(self):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            mock_run.return_value = Mock(returncode=0, stdout="git commit -am 'message'", stderr="")
    ...
    def test_command_failure(self):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            mock_run.return_value = Mock(returncode=1, stdout="", stderr="Error: Invalid input")
