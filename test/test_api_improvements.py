...
class TestApiImprovements(unittest.TestCase):
    ...
    def test_endpoint_creation(self):
        ...
        for api_name, client in self.api_clients.items():
            ...
            self.assertEqual(endpoint["initial_retry_delay"], 2, f"{api_name} custom initial_retry_delay not set")
    ...
    def test_backoff_retry_mechanism(self):
        ...
        for api_name, client in self.api_clients.items():
            ...
            endpoint_id = client.create_endpoint(
                max_retries=3,
                initial_retry_delay=0.01,  # Small delay for faster testing
                backoff_factor=2
            )
