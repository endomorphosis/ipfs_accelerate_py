...
class _Provider:
    ...
    def run(self, _attempt):
        raise DatabasePortalBridgeError("outer callback failed after Portal work")
...
def test_zero_count_failure_needs_explicit_callback_proof_before_cas(tmp_path, verified):
