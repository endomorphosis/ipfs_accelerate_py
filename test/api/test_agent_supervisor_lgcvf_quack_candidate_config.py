...
RUNTIME_ROOT = (
    ...
    "logic_governed_compositional_verification_fabric/run-v29"
)
QUACK_OWNER = f"{RUNTIME_ROOT}/quack-owner"
QUACK_HANDLE = "env://IPFS_ACCELERATE_AGENT_QUACK_TOKEN"
QUACK_ENDPOINT = "quack:127.0.0.1:24691"
...
def test_lgcvf_quack_candidate_is_additive_run_v29_fail_closed_profile() -> None:
    ...
    assert program["store_generation"] == "lgcvf-run-v29"
    assert program["export_profile"] == "lgcvf-run-v29"
...
def test_lgcvf_quack_candidate_loads_and_renders_detached_launch_plan(
    ...
    assert environment[STATE_STORE_GENERATION_ENV] == "lgcvf-run-v29"
