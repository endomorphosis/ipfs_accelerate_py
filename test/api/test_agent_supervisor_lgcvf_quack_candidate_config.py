...
RUNTIME_ROOT = (
    ...
    "logic_governed_compositional_verification_fabric/run-v19"
)
...
def test_lgcvf_quack_candidate_is_additive_run_v19_fail_closed_profile() -> None:
    ...
    assert program["store_generation"] == "lgcvf-run-v19"
    assert program["export_profile"] == "lgcvf-run-v19"
...
def test_lgcvf_quack_candidate_loads_and_renders_detached_launch_plan(
    ...
    assert environment[STATE_STORE_GENERATION_ENV] == "lgcvf-run-v19"
