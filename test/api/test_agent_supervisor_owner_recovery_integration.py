...
def test_bridge_cursor_survives_reconstruction_and_stale_cas(admitted):
    ...
    cursors["false_completed_requests"] = "request:false-completed:032"
    cursors["false_pending_requests"] = "request:false-pending:016"
    cursors["false_processing_requests"] = "request:false-processing:008"
...
class BindingDaemon:
    ...
    @staticmethod
    def recover_blocked_false_completed_merge(value):
        pytest.fail("empty queue cannot recover a false completion")

    @staticmethod
    def preauthorize_false_completed_merge_recovery(value):
        pytest.fail("empty queue cannot authorize a false completion")
