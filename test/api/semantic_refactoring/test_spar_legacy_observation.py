...
def _load_config(path):
    ...
    return SimpleNamespace(repo_root=ROOT, board_namespace="SPAR", max_lanes=3, task_prefix="SPAR-",
        runtime_paths=paths, payload={"runtime_paths": paths, "merge_target_branch": "main"},
