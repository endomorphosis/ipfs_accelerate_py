...
PRODUCTION = "external/ipfs_datasets/ipfs_datasets_py/logic/zkp/pctdd"
OUTPUTS = (
    "artifacts/parallel_content_sealing_proof_carrying_tdd/receipts/PCTDD-005.json",
    "external/ipfs_datasets/tests/unit/logic/zkp/pctdd/test_pctdd_005_prepared_canonical_block.py",
)
...
def _review(tmp_path, monkeypatch, *, metadata, extra_paths=(), missing_output=False):
    ...
    changed = [
        *OUTPUTS,
        ...
        PRODUCTION + "/prepared_canonical_block_contracts.py",
        *extra_paths,
    ]
