...
MPT_MODELS_REGISTRY = {
    "mpt": {
        "description": "mpt base model",
        "class": "MptForCausalLM",
    }
}

class TestMptModels:
    """Test class for mpt models."""
    
    def __init__(self, model_id=None):
        """Initialize the test class."""
        self.model_id = model_id or "mpt"
        ...
        if self.model_id not in MPT_MODELS_REGISTRY:
            ...
            self.model_info = MPT_MODELS_REGISTRY["mpt"]
        else:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test mpt models")
