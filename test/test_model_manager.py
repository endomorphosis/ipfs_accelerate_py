        ...
        self.test_model = ModelMetadata(
            ...
            outputs=[
                IOSpec(
                    ...
                    shape=(None, 512, 30522),
                    description="Prediction logits",
                )
            ],
            huggingface_config={
...
class TestRepositoryStructure(unittest.TestCase):
    ...
    def test_create_model_from_huggingface_with_repo_structure(self):
        ...
        model_without_repo = create_model_from_huggingface(
            model_id="test-model", hf_config=hf_config, fetch_repo_structure=False
        )
        ...
        model_with_repo_attempt = create_model_from_huggingface(
            model_id="test-model-2", hf_config=hf_config, fetch_repo_structure=True
        )
