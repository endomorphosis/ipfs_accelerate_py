...
class TestMonitoringDashboardConnector(unittest.TestCase):
    ...
    def test_update_panel_data(self, mock_put):
        ...
        mock_put.return_value = MockResponse(
            200, {"panel_id": "mock-panel-id", "dashboard_id": "mock-dashboard-id", "updated": True}
        )
        ...
        mock_get.side_effect = [
            ...
            MockResponse(
                200,
                {
                    ...
                    "data_source": {"query": {"metric": "query_time"}},
                },
            ),
            # Third call to get panel2 details
            MockResponse(200, {"panel_id": "panel2", "type": "database-summary"}),
        ]
    ...
    def test_create_database_performance_dashboard(self, mock_post):
        ...
        mock_post.side_effect = [
            ...
            MockResponse(
                201, {"panel_id": "panel1", "dashboard_id": "mock-db-dashboard-id"}
            ),  # Summary panel
            MockResponse(
                201, {"panel_id": "panel2", "dashboard_id": "mock-db-dashboard-id"}
            ),  # Trend panel
            MockResponse(
                201, {"panel_id": "panel3", "dashboard_id": "mock-db-dashboard-id"}
            ),  # Metric panel 1
            MockResponse(
                201, {"panel_id": "panel4", "dashboard_id": "mock-db-dashboard-id"}
            ),  # Metric panel 2
        ...
        )  # 1 dashboard + 4 panels + 2 alerts + 1 scheduled update
    ...
    def test_create_complete_monitoring_solution(self, mock_get, mock_post):
        ...
        mock_post.side_effect = [
            ...
            # Simulation panels
            MockResponse(
                201, {"panel_id": "sim-panel1", "dashboard_id": "mock-complete-dashboard-id"}
            ),
            MockResponse(
                201, {"panel_id": "sim-panel2", "dashboard_id": "mock-complete-dashboard-id"}
            ),
            MockResponse(
                201, {"panel_id": "sim-panel3", "dashboard_id": "mock-complete-dashboard-id"}
            ),
            # Scheduled update response
            MockResponse(
                201,
        ...
        mock_get.return_value = MockResponse(
            200, {"panel": {"type": "mape-comparison", "data_source": {"query": {}}}}
        )
        ...
        )  # At least dashboard + monitoring setup + scheduled update
