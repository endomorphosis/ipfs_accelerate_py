...
try::
    ...
    """
    Class-based test file for all Wav2Vec2-BERT-family models.
...
class TestWav2Vec2BertModels:
    """Base test class for all Wav2Vec2-BERT-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "facebook/wav2vec2-bert-base"
        
        # Verify model exists in registry:
        if self.model_id not in WAV2VEC2-BERT_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = WAV2VEC2-BERT_MODELS_REGISTRY["facebook/wav2vec2-bert-base"],
        else:
            self.model_info = WAV2VEC2-BERT_MODELS_REGISTRY[self.model_id]
            ,
...
def test_from_pretrained())))self, device="auto"):
    ...
    try::
        ...
        **pretrained_kwargs
        ...
        model_class = None
        if self.class_name == "Wav2Vec2BertModel":
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_wav2vec2_bert_{}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available Wav2Vec2-BERT models in the registry:."""
    return list())))WAV2VEC2-BERT_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered Wav2Vec2-BERT models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}model_id}")
        tester = TestWav2Vec2BertModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_wav2vec2_bert_summary_{}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test Wav2Vec2-BERT-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable Wav2Vec2-BERT-family models:")
        for model in models:
            info = WAV2VEC2-BERT_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nWav2Vec2-BERT Models Testing Summary:")
        total = len())))results)
    ...
    # Test single model ())))default or specified)
        model_id = args.model or "facebook/wav2vec2-bert-base"
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}model_id}")
