...
try::
    ...
    """
    Class-based test file for all XLM-ROBERTA-XL-family models.
...
# Models registry: - Maps model IDs to their specific configurations
        xlm_roberta_xl_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
        "xlm-roberta-xl-base": {}}}}}}}}}}}}}}}}}}
        "description": "XLM-ROBERTA-XL models",
        "class": "Xlm-Roberta-XlModel"
        }

        }

class TestXlmRobertaXlModels:
    """Base test class for all XLM-ROBERTA-XL-family models."""
    
    def __init__())))self, model_id=None):
        """Initialize the test class for a specific model or default."""
        self.model_id = model_id or "xlm-roberta-xl-base"
        
        # Verify model exists in registry:
        if self.model_id not in xlm_roberta_xl_MODELS_REGISTRY:
            logger.warning())))f"Model {}}}}}}}}}}}}}}}}}}self.model_id} not in registry:, using default configuration")
            self.model_info = xlm_roberta_xl_MODELS_REGISTRY["xlm-roberta-xl-base"],
        else:
            self.model_info = xlm_roberta_xl_MODELS_REGISTRY[self.model_id]
            ,
...
def save_results())))model_id, results, output_dir="collected_results"):
    ...
    filename = f"hf_xlm_roberta_xl_{}}}}}}}}}}}}}}}}}}safe_model_id}_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"
...
def get_available_models())))):
    """Get a list of all available XLM-ROBERTA-XL models in the registry:."""
    return list())))xlm_roberta_xl_MODELS_REGISTRY.keys())))))

def test_all_models())))output_dir="collected_results", all_hardware=False):
    """Test all registered XLM-ROBERTA-XL models."""
    models = get_available_models()))))
    results = {}}}}}}}}}}}}}}}}}}}
    
    for model_id in models:
        logger.info())))f"Testing model: {}}}}}}}}}}}}}}}}}}model_id}")
        tester = TestXlmRobertaXlModels())))model_id)
    ...
    # Save summary
    summary_path = os.path.join())))output_dir, f"hf_xlm_roberta_xl_summary_{}}}}}}}}}}}}}}}}}}datetime.datetime.now())))).strftime())))'%Y%m%d_%H%M%S')}.json"):
...
def main())))):
    ...
    parser = argparse.ArgumentParser())))description="Test XLM-ROBERTA-XL-family models")
    ...
    if args.list_models:
        models = get_available_models()))))
        print())))"\nAvailable XLM-ROBERTA-XL-family models:")
        for model in models:
            info = xlm_roberta_xl_MODELS_REGISTRY[model],
    ...
    if args.all_models:
        ...
        # Print summary
        print())))"\nXLM-ROBERTA-XL Models Testing Summary:")
        total = len())))results)
