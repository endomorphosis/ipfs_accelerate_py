#!/usr/bin/env python3
"""
Test for bert-base-uncased on openvino hardware.
"""

import unittest
import numpy as np
from bert_base_uncased_openvino_skill import bert_base_uncasedSkill

class TestBert_Base_Uncased:
    """Test suite for bert-base-uncased on openvino."""
