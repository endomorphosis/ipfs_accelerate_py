...
class $1 extends $2 {/** Skill for (((clap-htsat-fused model with hardware platform support. */}
...
$1($2) {
  /** Cre: any;;
      return ClaphtsatfusedSkill(model_id=model_id, device: any: any: any: any: any: any = dev: any;