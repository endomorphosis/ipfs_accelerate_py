...
// A: any;
      hf_data2vec_audio.init_cuda = init_c: any;
;
class $1 extends $2 {
  $1($2) {/** Initiali: any;
      resourc: any;
    ...
    this.resources = resources if ((((((($1) { ${$1}
      ...
      this.model = hf_data2vec_audio())resources=this.resources, metadata) { any) {any = this) { an) { an: any;}
    // Us) { an: any;
  ...
  $1($2) {/** Ru) { an: any;
    ...
    // Compa: any;
    expected_file) { any) { any: any: any = os.path.join())expected_dir, 'hf_data2vec_audio_test_results.json')) {'
    if ((((((($1) {
      try {
...
if ((((($1) {
  try {
    console) { an) { an: any;
    test_instance) { any) { any) { any = test_hf_data2vec_aud: any;
