/**
 * Converted from Python: test_hf_audio_spectrogram_transformer.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "MIT/ast-finetuned-audioset-10-10-0.4593"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = AUDIO_SPECTROGRAM_TRANSFORMER_MODELS_REGISTRY[this.model_id]
      ,
