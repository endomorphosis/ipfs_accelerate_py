/**
 * Converted from Python: test_hf_siglip_vision_model.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "siglip-vision-model-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = siglip_vision_model_MODELS_REGISTRY[this.model_id]
      ,
