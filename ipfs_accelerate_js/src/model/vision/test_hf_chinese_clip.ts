...
// A: any;
      hf_chinese_clip.init_cuda = init_c: any;
;
class $1 extends $2 {
  $1($2) {/** Initiali: any;
      resourc: any;
    ...
    this.resources = resources if ((((((($1) { ${$1}
      ...
      this.model = hf_chinese_clip())resources=this.resources, metadata) { any) {any = this) { an) { an: any;}
    // Us) { an: any;
      this.model_name = "google/vit-base-patch16-224-in21k"  // Ima: any;"
    
    // Te: any;
      this.test_image = "test.jpg"  // Pa: any;"
  ...
  $1($2) {/** Ru) { an: any;
    ...
    // Compa: any;
    expected_file) { any) { any: any: any = os.path.join())expected_dir, 'hf_chinese_clip_test_results.json')) {'
    if ((((((($1) {
      try {
...
if ((((($1) {
  try {
    console) { an) { an: any;
    test_instance) { any) { any) { any = test_hf_chinese_cl: any;
