/**
 * Converted from Python: test_hf_deepseek_vision.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "deepseek-vision-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = deepseek_vision_MODELS_REGISTRY[this.model_id]
      ,
