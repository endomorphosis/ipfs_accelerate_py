/**
 * Converted from Python: test_hf_clip_text_model.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "clip-text-model-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = clip_text_model_MODELS_REGISTRY[this.model_id]
      ,
