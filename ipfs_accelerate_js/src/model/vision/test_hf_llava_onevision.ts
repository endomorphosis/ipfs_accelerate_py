/**
 * Converted from Python: test_hf_llava_onevision.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "llava-onevision-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = llava_onevision_MODELS_REGISTRY[this.model_id]
      ,
