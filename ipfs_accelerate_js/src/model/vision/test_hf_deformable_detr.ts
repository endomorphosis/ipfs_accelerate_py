/**
 * Converted from Python: test_hf_deformable_detr.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "deformable-detr-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = deformable_detr_MODELS_REGISTRY[this.model_id]
      ,
