/**
 * Converted from Python: test_hf_gpt_neox_japanese.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "gpt-neox-japanese-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = gpt_neox_japanese_MODELS_REGISTRY[this.model_id]
      ,
