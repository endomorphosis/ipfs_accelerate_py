...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    try {
      ...
      if ($1) {
        handler_method = this.create_cpu_fill_mask_endpoint_handler
      elif ($1) {
        handler_method = this.create_cuda_fill_mask_endpoint_handler
      elif ($1) {
        handler_method = this.create_openvino_fill_mask_endpoint_handler
      elif ($1) {
        handler_method = this.create_apple_fill_mask_endpoint_handler
      elif ($1) ${$1} else {
        handler_method = this.create_cpu_fill_mask_endpoint_handler
  ...
  $1($2) {
    ...
    try {
      ...
      # Create the handler function
          endpoint_handler = this.create_cuda_fill_mask_endpoint_handler())))))))))))))))))))))))))))
          endpoint_model=model_name,
          device=device,
  ...
  $1($2) {
    ...
    try ${$1} catch($2: $1) {
      ...
      endpoint_handler = this.create_apple_fill_mask_endpoint_handler())))))))))))))))))))))))))))endpoint, apple_label, endpoint, tokenizer)
