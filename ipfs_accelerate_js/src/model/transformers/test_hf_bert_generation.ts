/**
 * Converted from Python: test_hf_bert_generation.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_id = model_id || "bert-generation-base"
    
  }
    # Verify model exists in registry {
    if ($1) ${$1} else {
      this.model_info = bert_generation_MODELS_REGISTRY[this.model_id]
      ,
