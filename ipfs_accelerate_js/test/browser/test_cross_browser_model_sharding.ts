/**
 * Converted from Python: test_cross_browser_model_sharding.py
...
$1($2) {
  ...
  return {}}'input_features': $3.map(($2) => $1) for _ in range())))3000)]]}:,
  }
  elif ($1) {
  return {}}
  }
  'input_ids': [101, 2023, 2003, 1037, 3231, 102],
  'attention_mask': [1, 1, 1, 1, 1, 1],,
  'pixel_values': $3.map(($2) => $1) for _ in range())))224)] for _ in range())))1)]:,
  }
  } else {
