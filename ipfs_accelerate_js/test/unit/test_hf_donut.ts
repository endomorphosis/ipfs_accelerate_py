/**
 * Converted from Python: test_hf_donut.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = DONUT_MODELS_REGISTRY[this.model_id]
      ,
...
$1($2) {
  ...
  # Test single model ())))default || specified)
    model_id = args.model || "naver-clova-ix/donut-base-finetuned-docvqa"
    logger.info())))`$1`)
