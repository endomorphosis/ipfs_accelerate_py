/**
 * Converted from Python: test_hf_encoder_decoder.py
...
class $1 extends $2 {
  """Base test class for all ENCODER-DECODER-family models."""
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = encoder_decoder_MODELS_REGISTRY[this.model_id]
      ,
...
$1($2) {
  ...
  parser = argparse.ArgumentParser())))description="Test ENCODER-DECODER-family models")
