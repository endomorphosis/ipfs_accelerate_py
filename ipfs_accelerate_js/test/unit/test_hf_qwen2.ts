...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    this.model_config = QWEN2_MODELS_REGISTRY.get(model_id, ${$1})
  ...
  $1($2) {
    ...
    try {
      ...
      tokenizer = transformers.AutoTokenizer.from_pretrained(this.model_path)
...
$1($2) {
  ...
  parser.add_argument("--prompt", default=null, help="Test prompt to use")
