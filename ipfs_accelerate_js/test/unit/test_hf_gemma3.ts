/**
 * Converted from Python: test_hf_gemma3.py
...
class $1 extends $2 {
        ...
        try ${$1} catch($2: $1) {
          ...
          if ($1) {
            ...
            if ($1) {
              ...
              gemma3_models = $3.map(($2) => $1)],,"gemma3", "gemma-3"])]
              :
  ...
  $1($2) {
    ...
    $1: string: Path to the created model
      """
    try {
      console.log($1))))))))))"Creating local test model for Gemma3 testing...")
    ...
    try {
      ...
      try {
        ...
        patch())))))))))'transformers.AutoTokenizer.from_pretrained') as mock_tokenizer, \
          ...
          :
            test_handler = this.lm.create_cpu_lm_endpoint_handler())))))))))
            tokenizer,
            this.model_name,
            "cpu",
            endpoint
          ...
          # Record example
            mock_text = "Gemma3 is a cutting-edge language model developed by Google. It's the latest evolution in the Gemma family, featuring significant improvements over previous versions. Key features include: 1) Increased context length up to 8K tokens, 2) Enhanced multilingual capabilities, 3) Improved instruction-following performance, 4) Better calibration && factuality, 5) New parameter scales ())))))))))1B, 2B, 8B, && 27B parameters), && 6) More efficient training methodology. Gemma3 models are available in both base && instruction-tuned variants, with the latter optimized for chat, instruction-following, && assistive use cases."
            this.$1.push($2)))))))))){}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
            "input": this.test_prompt,
            "output": {}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
      ...
      try {
        ...
        try {
            ...
            if ($1) {
              ...
              if ($1) {
                ...
                try {
                  ...
                  batch_prompts = []],,this.test_prompt, "Compare Gemma3 with other language models."]
                  ...
                  if ($1) {
                    if ($1) {
                      ...
                      results[]],,"cuda_batch_sample"] = sample_batch_text[]],,:50] + "..." if ($1) ${$1} else ${$1} else ${$1} catch($2: $1) {
                  console.log($1))))))))))`$1`)
                      }
                  results[]],,"cuda_batch"] = `$1`
                ...
                try {
                  ...
                  config_output = handler())))))))))this.test_prompt, generation_config=generation_config)
                  ...
                  if ($1) {
                    ...
                    # Include example in results
                    results[]],,"cuda_config_sample"] = config_text[]],,:50] + "..." if ($1) ${$1} else ${$1} catch($2: $1) ${$1} else ${$1} else ${$1} catch($2: $1) {
          # Fall back to mock if ($1) {:
                    }
          console.log($1))))))))))`$1`)
          ...
          patch())))))))))'transformers.AutoTokenizer.from_pretrained') as mock_tokenizer, \
            ...
            :
              test_handler = this.lm.create_cuda_gemma3_endpoint_handler())))))))))
              tokenizer,
              this.model_name,
              "cuda:0",
              endpoint,
    ...
    try {
      ...
      if ($1) {
        ...
        with patch())))))))))'openvino.runtime.Core' if ($1) {
          ...
          test_handler = this.lm.create_openvino_lm_endpoint_handler())))))))))
          tokenizer,
            this.model_name,:
              "openvino:0",
              endpoint
