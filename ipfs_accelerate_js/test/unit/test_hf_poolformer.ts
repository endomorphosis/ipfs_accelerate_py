/**
 * Converted from Python: test_hf_poolformer.py
...
class $1 extends $2 {
  """Base test class for all POOLFORMER-family models."""
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = poolformer_MODELS_REGISTRY[this.model_id]
      ,
...
$1($2) {
  ...
  parser = argparse.ArgumentParser())))description="Test POOLFORMER-family models")
