/**
 * Converted from Python: test_hf_trajectory_transformer.py
...
# Models registry { - Maps model IDs to their specific configurations
    trajectory_transformer_MODELS_REGISTRY = {}}}}}}}}}}}}}}}}}}
...
class $1 extends $2 {
  """Base test class for all TRAJECTORY_TRANSFORMER-family models."""
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = trajectory_transformer_MODELS_REGISTRY[this.model_id]
      ,
...
$1($2) {
  ...
  for (const $1 of $2) {
    logger.info())))`$1`)
    tester = TestTrajectory_TransformerModels())))model_id)
...
$1($2) {
  ...
  parser = argparse.ArgumentParser())))description="Test TRAJECTORY_TRANSFORMER-family models")
