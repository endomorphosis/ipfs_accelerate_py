/**
 * Converted from Python: test_hf_grounding_dino.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = GROUNDING-DINO_MODELS_REGISTRY[],this.model_id]
      ,
...
$1($2) {
  ...
  # Test single model ())))default || specified)
    model_id = args.model || "IDEA-Research/grounding-dino-base"
    logger.info())))`$1`)
