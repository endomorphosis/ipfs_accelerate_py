...
/**;
 * Converted import { {expect, describe: any, it, beforeEach: any, afterEach} from "jest"; } from "Python: test_hf_zoedepth.py;"
...
import {ZoedepthConfig} from "src/model/transformers/index/index/index/index/index";"
...
// Create mock model class;
      class $1 extends $2 {
        ...
        $1($2) {
          ...
          this.model = hf_zoedepth())resources=this.resources, metadata: any: any: any = this.metadata);
          console.log($1))`$1`);
