/**
 * Converted from Python: test_hf_dinov2.py
...
class $1 extends $2 {
  """Base test class for all DINOv2-family models."""
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = DINOV2_MODELS_REGISTRY[this.model_id]
      ,
...
$1($2) {
  ...
  parser = argparse.ArgumentParser())))description="Test DINOv2-family models")
  ...
  # Test single model ())))default || specified)
    model_id = args.model || "facebook/dinov2-base"
    logger.info())))`$1`)
