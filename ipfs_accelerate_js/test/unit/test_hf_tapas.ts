/**
 * Converted from Python: test_hf_tapas.py
...
class $1 extends $2 {
  $1($2) {
    ...
    # Initialize model
      this.model = hf_tapas())resources=this.resources, metadata=this.metadata)
  ...
  $1($2) {
    ...
    try {
      ...
      this.model_name, "table-question-answering", device_arg
      )
