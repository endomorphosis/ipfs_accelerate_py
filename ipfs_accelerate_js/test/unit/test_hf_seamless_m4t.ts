/**
 * Converted from Python: test_hf_seamless_m4t.py
...
class $1 extends $2 {
  ...
  $1($2) {
    ...
    if ($1) ${$1} else {
      this.model_info = SEAMLESS-M4T_MODELS_REGISTRY[],this.model_id]
      ,
...
$1($2) {
  ...
  # Test single model ())))default || specified)
    model_id = args.model || "facebook/seamless-m4t-large"
    logger.info())))`$1`)
