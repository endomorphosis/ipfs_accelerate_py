...
Usage:
    Replace DISTILROBERTA, distilroberta-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "distilroberta-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "DISTILROBERTA"  # e.g., "bert"
