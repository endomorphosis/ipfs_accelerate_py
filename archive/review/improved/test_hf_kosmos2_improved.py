...
Usage:
    Replace KOSMOS2, microsoft/kosmos-2-patch14-224, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "microsoft/kosmos-2-patch14-224"  # e.g., "bert-base-uncased"
MODEL_NAME = "KOSMOS2"  # e.g., "bert"
