...
Usage:
    Replace GPT_J_STANDARDIZED, gpt_j_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "gpt_j_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPT_J_STANDARDIZED"  # e.g., "bert"
