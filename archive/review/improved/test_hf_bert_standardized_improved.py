...
Usage:
    Replace BERT_STANDARDIZED, bert_standardized-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "bert_standardized-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "BERT_STANDARDIZED"  # e.g., "bert"
