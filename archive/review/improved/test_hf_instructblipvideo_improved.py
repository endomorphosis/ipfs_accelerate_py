...
Usage:
    Replace INSTRUCTBLIPVIDEO, instructblipvideo-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "instructblipvideo-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "INSTRUCTBLIPVIDEO"  # e.g., "bert"
