...
Usage:
    Replace OMDET_TURBO, omdet_turbo-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "omdet_turbo-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "OMDET_TURBO"  # e.g., "bert"
