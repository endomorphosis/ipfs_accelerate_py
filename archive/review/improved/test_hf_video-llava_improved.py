...
Usage:
    Replace VIDEO-LLAVA, video-llava-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "video-llava-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "VIDEO-LLAVA"  # e.g., "bert"
