...
Usage:
    Replace SWITCH_TRANSFORMERS, switch_transformers-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "switch_transformers-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SWITCH_TRANSFORMERS"  # e.g., "bert"
