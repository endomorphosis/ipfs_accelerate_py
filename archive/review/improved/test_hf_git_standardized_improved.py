...
Usage:
    Replace GIT_STANDARDIZED, microsoft/git-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "microsoft/git-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GIT_STANDARDIZED"  # e.g., "bert"
