...
Usage:
    Replace GPT2_MINIMAL, gpt2_minimal-base, text-generation with actual values.
"""
...
# Model configuration
MODEL_ID = "gpt2_minimal-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "GPT2_MINIMAL"  # e.g., "bert"
