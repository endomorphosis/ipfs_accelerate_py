...
Usage:
    Replace FALCON_MAMBA, falcon_mamba-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "falcon_mamba-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "FALCON_MAMBA"  # e.g., "bert"
