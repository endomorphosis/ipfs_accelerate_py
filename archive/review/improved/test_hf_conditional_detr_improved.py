...
Usage:
    Replace CONDITIONAL_DETR, conditional_detr-base, text-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "conditional_detr-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "CONDITIONAL_DETR"  # e.g., "bert"
