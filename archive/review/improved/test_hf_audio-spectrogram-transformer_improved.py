...
Usage:
    Replace AUDIO-SPECTROGRAM-TRANSFORMER, audio-spectrogram-transformer-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "audio-spectrogram-transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "AUDIO-SPECTROGRAM-TRANSFORMER"  # e.g., "bert"
