...
Usage:
    Replace TIME_SERIES_TRANSFORMER, time_series_transformer-base, token-classification with actual values.
"""
...
# Model configuration
MODEL_ID = "time_series_transformer-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "TIME_SERIES_TRANSFORMER"  # e.g., "bert"
