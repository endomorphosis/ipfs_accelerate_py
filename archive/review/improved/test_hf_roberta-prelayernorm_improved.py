...
Usage:
    Replace ROBERTA-PRELAYERNORM, roberta-prelayernorm-base, fill-mask with actual values.
"""
...
# Model configuration
MODEL_ID = "roberta-prelayernorm-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "ROBERTA-PRELAYERNORM"  # e.g., "bert"
