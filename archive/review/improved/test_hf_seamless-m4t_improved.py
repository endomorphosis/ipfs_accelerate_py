...
Usage:
    Replace SEAMLESS-M4T, seamless-m4t-base, feature-extraction with actual values.
"""
...
# Model configuration
MODEL_ID = "seamless-m4t-base"  # e.g., "bert-base-uncased"
MODEL_NAME = "SEAMLESS-M4T"  # e.g., "bert"
