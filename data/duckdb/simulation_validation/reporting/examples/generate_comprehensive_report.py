...
def main():
    ...
    print(
        f"Generated comprehensive report (HTML): {os.path.basename(comprehensive_report['path'])}"
    )
    ...
    print(
        f"Generated comprehensive report (Markdown): {os.path.basename(comprehensive_md_report['path'])}"
    )
