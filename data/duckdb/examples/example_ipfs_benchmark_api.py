...
def example_basic_usage():
    ...
    api = create_benchmark_api(db_path="./example_benchmark.duckdb", enable_ipfs=False)
...
def example_ipfs_enabled():
    ...
    api = create_benchmark_api(db_path="./example_ipfs_benchmark.duckdb", enable_ipfs=True)
