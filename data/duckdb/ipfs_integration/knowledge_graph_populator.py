...
class KnowledgeGraphPopulator:
    ...
    def populate_from_benchmarks(
        self, benchmarks: List[Dict[str, Any]], discover_relationships: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        stats = {"nodes_added": 0, "edges_added": 0, "relationships_discovered": 0}
        ...
        if discover_relationships:
            ...
            for rel in relationships:
                self.kg.add_edge(
                    rel["from_node"], rel["to_node"], rel["relationship_type"], rel["properties"]
                )
                stats["edges_added"] += 1
    ...
    def discover_relationships(self, benchmarks: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    def _apply_relationship_rule(
        self, benchmarks: List[Dict[str, Any]], rule: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """
    ...
    def compute_semantic_similarity(
        self, node1_id: str, node2_id: str, use_cache: bool = True
    ) -> float:
        """
    ...
    def find_similar_benchmarks(
        self, benchmark_id: str, top_k: int = 5, min_similarity: float = 0.5
    ) -> List[Dict[str, Any]]:
        """
    ...
    def detect_performance_patterns(self, benchmarks: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    def _deduplicate_relationships(
        ...
        for rel in relationships:
            # Create a unique key
            key = (rel["from_node"], rel["to_node"], rel["relationship_type"])
