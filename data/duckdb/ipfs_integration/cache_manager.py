...
class IPFSCacheManager:
    ...
    def set(
        self, query: str, result: Dict[str, Any], params: Optional[Dict[str, Any]] = None
    ) -> bool:
        """Cache query result.
    ...
    def invalidate(
        self, query: Optional[str] = None, params: Optional[Dict[str, Any]] = None
    ) -> int:
    ...
    def prefetch(
        self, queries: list[tuple[str, Optional[Dict[str, Any]]]], executor: Callable
    ) -> int:
