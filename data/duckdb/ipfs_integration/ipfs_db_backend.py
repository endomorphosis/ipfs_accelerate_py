...
class IPFSDBBackend:
    ...
    def __init__(self, db_path: str, config: Optional[IPFSConfig] = None, auto_sync: bool = False):
        """
    ...
    def is_ipfs_enabled(self) -> bool:
        ...
        return self.config.enable_ipfs_storage and self.storage.is_available()
...
class IPFSDBMigration:
    ...
    def migrate_database(self, db_path: str, create_backup: bool = True) -> Optional[str]:
        """
    ...
    def batch_migrate(
        self, db_paths: List[str], create_backups: bool = True
...
def create_ipfs_backend(db_path: str, config: Optional[IPFSConfig] = None) -> IPFSDBBackend:
    """
