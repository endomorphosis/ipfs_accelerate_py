...
def test_qnn_support_module():
    ...
    try:
        ...
        logger.info(
            f"QNNSDKWrapper initialized: available={wrapper.available}, simulation_mode={wrapper.simulation_mode}"
        )
...
def main():
    ...
    logger.info(
        f"QNN_SIMULATION_MODE environment: {os.environ.get('QNN_SIMULATION_MODE', 'Not set')}"
    )
