...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("stale_reports_cleanup.log")],
)
...
def generate_completion_report():
    ...
    with open(report_path, "w") as f:
        ...
        f.write("## Summary\n\n")
        f.write(
            "The stale reports cleanup process has been completed to address item #10 in NEXT_STEPS.md:\n\n"
        )
        ...
        f.write(
            "All benchmark reports now have clear indications when they contain simulated data:\n\n"
        )
        ...
        f.write("## Next Steps\n\n")
        f.write(
            "With this task completed, focus can shift to the remaining items in NEXT_STEPS.md:\n\n"
        )
...
def main():
    ...
    parser.add_argument(
        "--skip-schema-check", action="store_true", help="Skip database schema check"
    )
