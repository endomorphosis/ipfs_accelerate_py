    ...
    try:
        ...
        try:
            ...
            if os.path.exists("/home/barberb/ipfs_accelerate_py/hardware_detection/qnn_support.py"):
                ...
                "/home/barberb/ipfs_accelerate_py/test/hardware_detection/qnn_support_fixed.py"
            ):
...
def main():
    ...
    group.add_argument("--disable", action="store_true", help="Disable QNN simulation mode")
    group.add_argument(
        "--check", action="store_true", help="Check if QNN simulation mode is enabled"
    )
