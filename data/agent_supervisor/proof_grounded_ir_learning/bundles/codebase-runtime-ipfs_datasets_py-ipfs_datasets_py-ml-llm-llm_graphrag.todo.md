# Codebase Bundle: codebase/runtime/ipfs_datasets_py-ipfs_datasets_py-ml-llm-llm_graphrag
...
## PGIR-114 Resolve code annotation in ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py:736
...
- Track: runtime
- Depends on: 
- Outputs: /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery, ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py
- Validation: python3 -m py_compile ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py
...
- Canonical task key: task/v1/69d5d720acdfdf3fc9aa4ed2e5401d05c9994478edd62ba9695124b7c9280ae7
- Canonical task CID: baguqeeranhk5oifm37pt7snkj3jokqa5axezsrdy5xlcxkljkeslpsjibltq
- Semantic identity: 69d5d720acdfdf3fc9aa4ed2e5401d05c9994478edd62ba9695124b7c9280ae7
- Acceptance subset: Resolve annotated_followup at ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py:736
- Preconditions: ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py exists and the scan evidence remains applicable
- Effects: resolve annotated_followup in ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py and pass focused validation
- Evidence subset: ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py:736, /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery/2026-08-16-pgir-114-codebase-scan-881f61cee68f.md
- Resource class: cpu-small
- Token class: small
- Resources: python, focused validation runner
- Merge fate: ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py
- Rejection reasons: none
- Missing evidence: Resolve code annotation in ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py:736
- Candidate kind: codebase_scan
- Todo vector key: 881f61cee68f6ed7
- Bundle: codebase/runtime/ipfs_datasets_py-ipfs_datasets_py-ml-llm-llm_graphrag
- Bundle shard: data/agent_supervisor/proof_grounded_ir_learning/bundles/codebase-runtime-ipfs_datasets_py-ipfs_datasets_py-ml-llm-llm_graphrag.todo.md
- Bundle strategy: codebase_file_ast
- Parallel lane: codebase/runtime/ipfs_datasets_py-ipfs_datasets_py-ml-llm-llm_graphrag
- Conflict policy: serialize findings for the same file; allow independent file bundles to run concurrently
- Predicted files: ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py
...
- Merge key: codebase/runtime/ipfs_datasets_py-ipfs_datasets_py-ml-llm-llm_graphrag
- Merge family: ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py
- Merge role: codebase_scan
- Work item count: 1
- Work scope: codebase_file_ast
- Acceptance: Goal-scoped refill admitted this finding from ipfs_datasets_py/ipfs_datasets_py/ml/llm/llm_graphrag.py:736 for PGIR-G040. Use evidence in /home/barberb/lift_coding/.pgir_campaign/runtime/parallel/discovery/2026-08-16-pgir-114-codebase-scan-881f61cee68f.md, make only the smallest change required by that goal lineage, add or update focused validation when appropriate, and do not expand into adjacent cleanup.
