...
def main():
    ...
    model_group.add_argument(
        "--multimodal", action="store_true", help="Benchmark multimodal models"
    )
    ...
    parser.add_argument(
        "--bits", type=int, choices=[2, 4, 8, 16], help="Bit precision for quantization"
    )
    parser.add_argument(
        "--mixed-precision", action="store_true", help="Use mixed precision quantization"
    )
    ...
    parser.add_argument(
        "--repeats", type=int, default=3, help="Number of repeats for each configuration"
    )
