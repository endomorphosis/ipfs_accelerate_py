{
    ...
    "performance": {"inference_speedup": 1.6, "speedup_target_met": true},
    "quality": {},
    "kv_cache": {
        "enabled": true,
        "context_length": 2048,
    ...
    "next_steps_features": {
        "specialized_compute_shaders": {"enabled": false, "metrics": {}},
        "firefox_optimizations": {"enabled": false, "metrics": {}},
        "safari_compatibility": {"enabled": false, "metrics": {}},
        "reinforcement_learning": {"enabled": false, "metrics": {}},
    },
    "timestamps": {"start": 1741338662.755313, "end": null},
    "precision_comparison": {
        ...
        "comparisons": {
            ...
            "int4_vs_int8": {"memory_reduction_percent": 50.0, "speedup": 1.4166666666666667},
            "optimization_impact": {"percent_improvement": 14.285714285714285},
        },
    },
}
