...
class SkillsetThroughputBenchmark(SkillsetInferenceBenchmark):
    ...
    def execute(self):
        ...
        if len(self.model_list) >= self.concurrent_models:
            ...
            concurrent_models = [
                model_name for model_name, _ in model_times[: self.concurrent_models]
            ]
        else:
            # Use all models
        ...
        try:
            ...
            for model_name in model_list:
                ...
                init_functions.append(
                    (model_name, create_init_func(init_method, model_name, self.hardware.name))
                )
        ...
        if base_processed and "summary" in base_processed:
            ...
            if fastest_init_time > 0:
                ...
                if actual_concurrent_time > 0:
                    ...
                    processed_results["throughput"]["theoretical_sequential_time_ms"] = (
...
def main():
    ...
    parser.add_argument("--output-file", type=str, help="Filename for benchmark results")
