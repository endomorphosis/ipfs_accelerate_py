#!/usr/bin/env python3
"""
Benchmark for the bigbird skillset implementation.

This benchmark measures the performance of the bigbird model implementation
...
@BenchmarkRegistry.register(
    name="bigbird_inference_benchmark",
    category="inference",
    models=["bigbird"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class BigbirdInferenceBenchmark(BenchmarkBase):
    """Benchmark for bigbird inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up bigbird inference benchmark")
        ...
        try:
            ...
            # Import the bigbird skillset
            self.model_name = "bigbird"
            self.model_type_safe = "bigbird"
    ...
    def execute(self):
        ...
        self.logger.info("Executing bigbird inference benchmark")
...
@BenchmarkRegistry.register(
    name="bigbird_throughput_benchmark",
    category="throughput",
    models=["bigbird"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class BigbirdThroughputBenchmark(BigbirdInferenceBenchmark):
    """Benchmark for bigbird throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing bigbird throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark bigbird skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "bigbird_inference_benchmark"
        if args.type == "inference"
        else "bigbird_throughput_benchmark"
    )
