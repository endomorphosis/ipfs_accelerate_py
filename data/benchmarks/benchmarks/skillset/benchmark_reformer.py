#!/usr/bin/env python3
"""
Benchmark for the reformer skillset implementation.

This benchmark measures the performance of the reformer model implementation
...
@BenchmarkRegistry.register(
    name="reformer_inference_benchmark",
    category="inference",
    models=["reformer"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class ReformerInferenceBenchmark(BenchmarkBase):
    """Benchmark for reformer inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up reformer inference benchmark")
        ...
        try:
            ...
            # Import the reformer skillset
            self.model_name = "reformer"
            self.model_type_safe = "reformer"
    ...
    def execute(self):
        ...
        self.logger.info("Executing reformer inference benchmark")
...
@BenchmarkRegistry.register(
    name="reformer_throughput_benchmark",
    category="throughput",
    models=["reformer"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class ReformerThroughputBenchmark(ReformerInferenceBenchmark):
    """Benchmark for reformer throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing reformer throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark reformer skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "reformer_inference_benchmark"
        if args.type == "inference"
        else "reformer_throughput_benchmark"
    )
