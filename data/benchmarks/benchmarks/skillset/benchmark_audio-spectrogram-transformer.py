...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark audio-spectrogram-transformer skillset implementation")
    ...
    benchmark_name = "audio-spectrogram-transformer_inference_benchmark" if args.type == "inference" else "audio-spectrogram-transformer_throughput_benchmark"
