#!/usr/bin/env python3
"""
Benchmark for the xlnet skillset implementation.

This benchmark measures the performance of the xlnet model implementation
...
@BenchmarkRegistry.register(
    name="xlnet_inference_benchmark",
    category="inference",
    models=["xlnet"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class XlnetInferenceBenchmark(BenchmarkBase):
    """Benchmark for xlnet inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up xlnet inference benchmark")
        ...
        try:
            ...
            # Import the xlnet skillset
            self.model_name = "xlnet"
            self.model_type_safe = "xlnet"
    ...
    def execute(self):
        ...
        self.logger.info("Executing xlnet inference benchmark")
...
@BenchmarkRegistry.register(
    name="xlnet_throughput_benchmark",
    category="throughput",
    models=["xlnet"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class XlnetThroughputBenchmark(XlnetInferenceBenchmark):
    """Benchmark for xlnet throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing xlnet throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark xlnet skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "xlnet_inference_benchmark" if args.type == "inference" else "xlnet_throughput_benchmark"
    )
