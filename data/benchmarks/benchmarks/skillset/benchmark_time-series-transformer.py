...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark time-series-transformer skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "time-series-transformer_inference_benchmark"
        if args.type == "inference"
        else "time-series-transformer_throughput_benchmark"
    )
