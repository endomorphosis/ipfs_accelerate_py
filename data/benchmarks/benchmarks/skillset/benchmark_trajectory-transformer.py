...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark trajectory-transformer skillset implementation")
    ...
    benchmark_name = "trajectory-transformer_inference_benchmark" if args.type == "inference" else "trajectory-transformer_throughput_benchmark"
