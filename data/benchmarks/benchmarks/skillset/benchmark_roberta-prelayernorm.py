...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark roberta-prelayernorm skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "roberta-prelayernorm_inference_benchmark"
        if args.type == "inference"
        else "roberta-prelayernorm_throughput_benchmark"
    )
