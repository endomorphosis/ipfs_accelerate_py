...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark vision-encoder-decoder skillset implementation")
    ...
    benchmark_name = "vision-encoder-decoder_inference_benchmark" if args.type == "inference" else "vision-encoder-decoder_throughput_benchmark"
