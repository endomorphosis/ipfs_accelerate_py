#!/usr/bin/env python3
"""
Benchmark for the table-transformer skillset implementation.

This benchmark measures the performance of the table-transformer model implementation
...
@BenchmarkRegistry.register(
    name="table-transformer_inference_benchmark",
    category="inference",
    models=["table-transformer"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class TableTransformerInferenceBenchmark(BenchmarkBase):
    """Benchmark for table-transformer inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up table-transformer inference benchmark")
        ...
        try:
            ...
            # Import the table-transformer skillset
            self.model_name = "table-transformer"
            self.model_type_safe = "table_transformer"
    ...
    def execute(self):
        ...
        self.logger.info("Executing table-transformer inference benchmark")
...
@BenchmarkRegistry.register(
    name="table-transformer_throughput_benchmark",
    category="throughput",
    models=["table-transformer"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class TableTransformerThroughputBenchmark(TableTransformerInferenceBenchmark):
    """Benchmark for table-transformer throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing table-transformer throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark table-transformer skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "table-transformer_inference_benchmark"
        if args.type == "inference"
        else "table-transformer_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: table-transformer")
