...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark table-transformer skillset implementation")
    ...
    benchmark_name = "table-transformer_inference_benchmark" if args.type == "inference" else "table-transformer_throughput_benchmark"
