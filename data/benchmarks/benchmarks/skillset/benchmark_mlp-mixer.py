#!/usr/bin/env python3
"""
Benchmark for the mlp-mixer skillset implementation.

This benchmark measures the performance of the mlp-mixer model implementation
...
@BenchmarkRegistry.register(
    name="mlp-mixer_inference_benchmark",
    category="inference",
    models=["mlp-mixer"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class MlpMixerInferenceBenchmark(BenchmarkBase):
    """Benchmark for mlp-mixer inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up mlp-mixer inference benchmark")
        ...
        try:
            ...
            # Import the mlp-mixer skillset
            self.model_name = "mlp-mixer"
            self.model_type_safe = "mlp_mixer"
    ...
    def execute(self):
        ...
        self.logger.info("Executing mlp-mixer inference benchmark")
...
@BenchmarkRegistry.register(
    name="mlp-mixer_throughput_benchmark",
    category="throughput",
    models=["mlp-mixer"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class MlpMixerThroughputBenchmark(MlpMixerInferenceBenchmark):
    """Benchmark for mlp-mixer throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing mlp-mixer throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark mlp-mixer skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "mlp-mixer_inference_benchmark"
        if args.type == "inference"
        else "mlp-mixer_throughput_benchmark"
    )
