#!/usr/bin/env python3
"""
Benchmark for the speech-to-text skillset implementation.

This benchmark measures the performance of the speech-to-text model implementation
...
@BenchmarkRegistry.register(
    name="speech-to-text_inference_benchmark",
    category="inference",
    models=["speech-to-text"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class SpeechToTextInferenceBenchmark(BenchmarkBase):
    """Benchmark for speech-to-text inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up speech-to-text inference benchmark")
        ...
        try:
            ...
            # Import the speech-to-text skillset
            self.model_name = "speech-to-text"
            self.model_type_safe = "speech_to_text"
    ...
    def execute(self):
        ...
        self.logger.info("Executing speech-to-text inference benchmark")
...
@BenchmarkRegistry.register(
    name="speech-to-text_throughput_benchmark",
    category="throughput",
    models=["speech-to-text"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class SpeechToTextThroughputBenchmark(SpeechToTextInferenceBenchmark):
    """Benchmark for speech-to-text throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing speech-to-text throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark speech-to-text skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "speech-to-text_inference_benchmark"
        if args.type == "inference"
        else "speech-to-text_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: speech-to-text")
