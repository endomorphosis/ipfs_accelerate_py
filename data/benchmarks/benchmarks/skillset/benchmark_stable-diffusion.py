#!/usr/bin/env python3
"""
Benchmark for the stable-diffusion skillset implementation.

This benchmark measures the performance of the stable-diffusion model implementation
...
@BenchmarkRegistry.register(
    name="stable-diffusion_inference_benchmark",
    category="inference",
    models=["stable-diffusion"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class StableDiffusionInferenceBenchmark(BenchmarkBase):
    """Benchmark for stable-diffusion inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up stable-diffusion inference benchmark")
        ...
        try:
            ...
            # Import the stable-diffusion skillset
            self.model_name = "stable-diffusion"
            self.model_type_safe = "stable_diffusion"
    ...
    def execute(self):
        ...
        self.logger.info("Executing stable-diffusion inference benchmark")
...
@BenchmarkRegistry.register(
    name="stable-diffusion_throughput_benchmark",
    category="throughput",
    models=["stable-diffusion"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class StableDiffusionThroughputBenchmark(StableDiffusionInferenceBenchmark):
    """Benchmark for stable-diffusion throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing stable-diffusion throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark stable-diffusion skillset implementation"
    )
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "stable-diffusion_inference_benchmark"
        if args.type == "inference"
        else "stable-diffusion_throughput_benchmark"
    )
    ...
    try:
        ...
        if args.type == "inference":
            ...
            logger.info(f"Model: stable-diffusion")
