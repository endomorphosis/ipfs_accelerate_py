#!/usr/bin/env python3
"""
Benchmark for the van skillset implementation.

This benchmark measures the performance of the van model implementation
...
@BenchmarkRegistry.register(
    name="van_inference_benchmark",
    category="inference",
    models=["van"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class VanInferenceBenchmark(BenchmarkBase):
    """Benchmark for van inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up van inference benchmark")
        ...
        try:
            ...
            # Import the van skillset
            self.model_name = "van"
            self.model_type_safe = "van"
    ...
    def execute(self):
        ...
        self.logger.info("Executing van inference benchmark")
...
@BenchmarkRegistry.register(
    name="van_throughput_benchmark",
    category="throughput",
    models=["van"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class VanThroughputBenchmark(VanInferenceBenchmark):
    """Benchmark for van throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing van throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark van skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "van_inference_benchmark" if args.type == "inference" else "van_throughput_benchmark"
    )
