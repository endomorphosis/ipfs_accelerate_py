#!/usr/bin/env python3
"""
Benchmark for the gpt-neox skillset implementation.

This benchmark measures the performance of the gpt-neox model implementation
...
@BenchmarkRegistry.register(
    name="gpt-neox_inference_benchmark",
    category="inference",
    models=["gpt-neox"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class GptNeoxInferenceBenchmark(BenchmarkBase):
    """Benchmark for gpt-neox inference performance."""

    def setup(self):
        """Set up benchmark environment."""
        self.logger.info("Setting up gpt-neox inference benchmark")
        ...
        try:
            ...
            # Import the gpt-neox skillset
            self.model_name = "gpt-neox"
            self.model_type_safe = "gpt_neox"
    ...
    def execute(self):
        ...
        self.logger.info("Executing gpt-neox inference benchmark")
...
@BenchmarkRegistry.register(
    name="gpt-neox_throughput_benchmark",
    category="throughput",
    models=["gpt-neox"],
    hardware=["cpu", "cuda", "rocm", "openvino", "mps", "qnn"],
)
class GptNeoxThroughputBenchmark(GptNeoxInferenceBenchmark):
    """Benchmark for gpt-neox throughput performance."""
    ...
    def execute(self):
        """Execute the benchmark."""
        self.logger.info("Executing gpt-neox throughput benchmark")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark gpt-neox skillset implementation")
    parser.add_argument(
        "--type",
        type=str,
    ...
    benchmark_name = (
        "gpt-neox_inference_benchmark"
        if args.type == "inference"
        else "gpt-neox_throughput_benchmark"
    )
