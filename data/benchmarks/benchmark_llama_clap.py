...
MODELS = {"llama": "TinyLlama/TinyLlama-1.1B-Chat-v1.0", "clap": "laion/clap-htsat-unfused"}
...
def benchmark_model(
    model_key, model_path, hardware, batch_sizes=[1], warmup_iters=1, benchmark_iters=3
):
    """
...
def main():
    ...
    parser.add_argument(
        "--batch-sizes", type=int, nargs="+", default=[1, 2, 4], help="Batch sizes to test"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="./benchmark_results/direct",
