...
class hf_bert:
    ...
    def __init__(self, resources=None, metadata=None):
        ...
        self.create_cpu_fill-mask_endpoint_handler = self.create_cpu_fill-mask_endpoint_handler
        self.create_cuda_fill-mask_endpoint_handler = self.create_cuda_fill-mask_endpoint_handler
        self.create_openvino_fill-mask_endpoint_handler = self.create_openvino_fill-mask_endpoint_handler
        self.create_apple_fill-mask_endpoint_handler = self.create_apple_fill-mask_endpoint_handler
        self.create_qualcomm_fill-mask_endpoint_handler = self.create_qualcomm_fill-mask_endpoint_handler
    ...
    def _create_mock_endpoint(self, model_name, device_label):
        ...
        try:
            ...
            if device_label.startswith('cpu'):
                handler_method = self.create_cpu_fill-mask_endpoint_handler
            elif device_label.startswith('cuda'):
                handler_method = self.create_cuda_fill-mask_endpoint_handler
            elif device_label.startswith('openvino'):
                handler_method = self.create_openvino_fill-mask_endpoint_handler
            elif device_label.startswith('apple'):
                handler_method = self.create_apple_fill-mask_endpoint_handler
            elif device_label.startswith('qualcomm'):
                handler_method = self.create_qualcomm_fill-mask_endpoint_handler
            else:
                handler_method = self.create_cpu_fill-mask_endpoint_handler
        ...
        try:
            ...
            if "transformers" in self.resources and hasattr(self.resources["transformers"], "AutoModel"):
                ...
                try:
                    ...
                    # Create handler function
                    endpoint_handler = self.create_cpu_fill-mask_endpoint_handler(
                        endpoint_model=model_name,
                        device=device,
    ...
    def init_cuda(self, model_name, device, cuda_label):
        ...
        try:
            ...
            endpoint_handler = self.create_cuda_fill-mask_endpoint_handler(
                endpoint_model=model_name,
                device=device,
    ...
    def init_openvino(self, model_name, model_type, device, openvino_label, get_optimum_openvino_model=None, get_openvino_model=None, get_openvino_pipeline_type=None, openvino_cli_convert=None):
        ...
        try:
            ...
            # Create the handler
            endpoint_handler = self.create_openvino_fill-mask_endpoint_handler(
                endpoint_model=model_name,
                tokenizer=tokenizer,
    ...
    def init_apple(self, model, device, apple_label):
        ...
        endpoint_handler = self.create_apple_fill-mask_endpoint_handler(endpoint, apple_label, endpoint, tokenizer)
    ...
    def init_qualcomm(self, model, device, qualcomm_label):
        ...
        try:
            ...
            endpoint_handler = self.create_qualcomm_fill-mask_endpoint_handler(endpoint, qualcomm_label, endpoint, tokenizer)
    ...
    def create_cpu_fill-mask_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint=None, tokenizer=None):
    ...
    def create_openvino_fill-mask_endpoint_handler(self, endpoint_model, tokenizer, openvino_label, endpoint=None):
    ...
    def create_cuda_fill-mask_endpoint_handler(self, endpoint_model, device, hardware_label, endpoint=None, tokenizer=None, is_real_impl=True, batch_size=8):
    ...
    def create_apple_fill-mask_endpoint_handler(self, endpoint_model, apple_label, endpoint=None, tokenizer=None):
    ...
    def create_qualcomm_fill-mask_endpoint_handler(self, endpoint_model, qualcomm_label, endpoint=None, tokenizer=None):
