...
try:
    ...
    from duckdb_api.benchmark_timing_report import BenchmarkTimingReport
except ImportError:
...
try:
    # Try importing from the same directory (new structure)
    from duckdb_api.benchmark_db_api import BenchmarkDBAPI
