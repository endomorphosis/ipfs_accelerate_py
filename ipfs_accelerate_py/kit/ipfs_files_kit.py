...
class IPFSFilesKit:
        ...
        try:
            ...
            try:
                ...
                self.ipfs_client = IPFSKitStorage(
                    enable_ipfs_kit=True, cache_dir=self.config.cache_dir
                )
    ...
    def add_file(self, path: str, pin: Optional[bool] = None) -> IPFSFileResult:
        """
        Add a file to IPFS.
        ...
        if not os.path.exists(path):
            return IPFSFileResult(
                success=False, message=f"File not found: {path}", error="FileNotFoundError"
            )
        ...
        try:
            ...
            if self.ipfs_available and self.ipfs_client:
                try:
                    ...
                    return IPFSFileResult(
                        success=True, message=f"File added to IPFS: {cid}", data=file_info.to_dict()
                    )
            ...
            return IPFSFileResult(
                success=False, message=f"Error adding file: {str(e)}", error=type(e).__name__
            )

    def get_file(self, cid: str, output_path: str) -> IPFSFileResult:
        """
        ...
        try:
            ...
            return IPFSFileResult(
                success=False, message=f"Error getting file: {str(e)}", error=type(e).__name__
            )
    ...
    def cat_file(self, cid: str) -> IPFSFileResult:
        ...
        try:
            ...
            try:
                ...
                if result.returncode == 0:
                    return IPFSFileResult(
                        ...
                        data={"cid": cid, "content": result.stdout, "size": len(result.stdout)},
                    )
                else:
                    raise subprocess.CalledProcessError(
            ...
            return IPFSFileResult(
                success=False, message=f"Error reading file: {str(e)}", error=type(e).__name__
            )
    ...
    def pin_file(self, cid: str) -> IPFSFileResult:
        ...
        try:
            ...
            try:
                ...
                return IPFSFileResult(
                    success=False, message="IPFS not available for pinning", error=str(e)
                )

        except Exception as e:
            logger.error(f"Error pinning file: {e}")
            return IPFSFileResult(
                success=False, message=f"Error pinning file: {str(e)}", error=type(e).__name__
            )
    ...
    def unpin_file(self, cid: str) -> IPFSFileResult:
        ...
        try:
            ...
            try:
                ...
                return IPFSFileResult(
                    success=False, message="IPFS not available for unpinning", error=str(e)
                )

        except Exception as e:
            logger.error(f"Error unpinning file: {e}")
            return IPFSFileResult(
                success=False, message=f"Error unpinning file: {str(e)}", error=type(e).__name__
            )
    ...
    def list_files(self, path: str = "/") -> IPFSFileResult:
        ...
        try:
            ...
            try:
                ...
                return IPFSFileResult(
                    success=False, message="IPFS not available for listing", error=str(e)
                )

        except Exception as e:
            logger.error(f"Error listing files: {e}")
            return IPFSFileResult(
                success=False, message=f"Error listing files: {str(e)}", error=type(e).__name__
            )
    ...
    def validate_cid(self, cid: str) -> IPFSFileResult:
        ...
        try:
            ...
            if is_valid:
                try:
                    result = subprocess.run(
                        ["ipfs", "cid", "format", cid], capture_output=True, text=True, timeout=5
                    )
            ...
            return IPFSFileResult(
                success=False, message=f"Error validating CID: {str(e)}", error=type(e).__name__
            )
