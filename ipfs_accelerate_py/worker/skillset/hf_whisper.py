...
class hf_whisper:
    ...
    def init_cpu (self, model, device, cpu_label):
        ...
        batch_size = 0
        return endpoint, processor, endpoint_handler, # TODO: Replace with anyio.create_memory_object_stream - AnyioQueue(64), batch_size
    ...
    def init_openvino(self, model, model_type, device, openvino_label, get_optimum_openvino_model, get_openvino_model, get_openvino_pipeline_type, openvino_cli_convert):
        ...
        if "openvino" not in list(self.resources.keys()):
            try:
                ...
                return None, None, None, # TODO: Replace with anyio.create_memory_object_stream - AnyioQueue(64), 0
        else:
