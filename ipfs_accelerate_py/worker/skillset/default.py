...
class default:
    def __init__(self, resources=None, metadata=None):
        ...
        self.create_openvino_default_endpoint_handler = (
            self.create_openvino_default_endpoint_handler
        )
    ...
    def create_cpu_default_endpoint_handler(
    ...
    def create_cuda_default_endpoint_handler(
        self, local_cuda_endpoint, local_cuda_processor, endpoint_model, cuda_label
    ):
        def handler(
            x,
    ...
    def create_openvino_default_endpoint_handler(
