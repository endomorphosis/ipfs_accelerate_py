...
class SNPEUtils:
    ...
    def convert_model(self, model_name, model_type, output_path):
        ...
        try:
            ...
            command = [tool_path, "-i", onnx_path, "-o", output_path]
            ...
            if self._snpe_lib:
                ...
                if device_type == "adreno":
                    tool_path = os.path.join(
                        self._find_snpe_root(), "bin", "snpe-dlc-graph-prepare"
                    )
                    if os.name == "nt":  # Windows
                        tool_path += ".exe"
                ...
                target_map = {"adreno": "gpu", "hexagon": "dsp", "hta": "hta"}
