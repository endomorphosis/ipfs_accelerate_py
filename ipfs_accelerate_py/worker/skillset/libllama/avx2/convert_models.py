        ...
        if os.path.isdir(os.path.join(models_dir, model)):
            ...
            if os.path.isfile(os.path.join(this_dir, "checkpoint.bin.bak")):
                ...
                if os.path.isfile(os.path.join(this_dir, "checkpoint.bin")):
                    ...
                    os.system(
                        "mv "
                        + os.path.join(this_dir, "checkpoint.bin.bak")
                        + " "
                        + os.path.join(this_dir, "checkpoint.bin")
                    )
                pass
            ...
            if os.path.isfile(os.path.join(this_dir, "checkpoint.bin")):
                os.chdir(this_dir)
                os.system(
                    "python ../../skillset/convert-llama-ggmlv3-to-gguf.py --input checkpoint.bin --output checkpoint.gguf.bin ; mv checkpoint.bin checkpoint.bin.bak ; mv checkpoint.gguf.bin checkpoint.bin"
                )
                os.chdir(dir)
            else:
