...
class IPFSAccelerateContext:
    ...
    def register_accelerated_model(
        self, original_cid: str, accelerated_cid: str, device: str, metadata: Dict[str, Any]
    ) -> None:
    ...
    def get_accelerated_model(
        self, original_cid: str, device: Optional[str] = None
