    ...
    try:
        ...
        try:
            ...
            system_info["cpu_frequency"] = {
                ...
                "min_mhz": round(psutil.cpu_freq().min)
                if psutil.cpu_freq() and hasattr(psutil.cpu_freq(), "min")
                else None,
                "max_mhz": round(psutil.cpu_freq().max)
                if psutil.cpu_freq() and hasattr(psutil.cpu_freq(), "max")
                else None,
            }
            ...
            system_info["cpu_count"] = {"physical": os.cpu_count(), "logical": os.cpu_count()}
        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                system_info["cuda"] = {"is_available": False}
        except ImportError:
            system_info["cuda"] = {"is_available": "unknown"}
        ...
        try:
            ...
            if hasattr(ipfs_accelerate_py, "get_config"):
                ...
                if isinstance(ipfs_config, dict):
                    ...
                    # Merge performance
                    if "performance" in ipfs_config and isinstance(
                        ipfs_config["performance"], dict
                    ):
