            ...
            "models": [
                {
                    ...
                    "memory_requirements": {"fp32": 28, "fp16": 14, "int8": 7, "int4": 3.5},
                },
                {
                    "name": "llama-13b",
                    ...
                    "accelerators": ["cuda", "cpu"],
                    "tags": ["language", "text-generation"],
                    "memory_requirements": {"fp32": 52, "fp16": 26, "int8": 13, "int4": 6.5},
                },
            ],
        },
        "vision": {
            ...
            "models": [
                {
                    ...
                    "memory_requirements": {"fp32": 1.6, "fp16": 0.8, "int8": 0.4},
                }
            ],
        },
        "audio": {
            ...
            "models": [
                {
                    ...
                    "memory_requirements": {"fp32": 6, "fp16": 3, "int8": 1.5},
                }
            ],
        },
        "multimodal": {
