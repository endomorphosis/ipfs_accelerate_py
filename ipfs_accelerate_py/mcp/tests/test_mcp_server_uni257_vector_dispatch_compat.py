#!/usr/bin/env python3
"""UNI-257 vector dispatch compatibility tests for focused parity coverage."""
...
class TestMCPServerUNI257VectorDispatchCompat(unittest.TestCase):
    ...
    def test_vector_dispatch_infers_error_status_from_contradictory_delegate_payloads(self, mock_wrapper) -> None:
        class DummyServer:
            def __init__(self):
                self.tools = {}
                self.mcp = None
        ...
        async def _run_flow() -> None:
            with patch.dict(
                ...
                server = create_mcp_server(name="vector-dispatch-compat-errors")
