#!/usr/bin/env python3
"""UNI-262 email dispatch compatibility tests for focused parity coverage."""
...
class TestMCPServerUNI262EmailDispatchCompat(unittest.TestCase):
    ...
    def test_email_dispatch_infers_error_status_from_contradictory_delegate_payloads(self, mock_wrapper) -> None:
        class DummyServer:
            def __init__(self):
                self.tools = {}
                self.mcp = None
        ...
        async def _run_flow() -> None:
            with patch.dict(
                ...
                server = create_mcp_server(name="email-dispatch-compat-errors")
