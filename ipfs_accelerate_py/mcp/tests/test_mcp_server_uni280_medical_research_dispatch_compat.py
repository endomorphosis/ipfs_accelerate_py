#!/usr/bin/env python3
"""UNI-280 medical research dispatch compatibility tests for focused parity coverage."""
...
class TestMCPServerUNI280MedicalResearchDispatchCompat(unittest.TestCase):
    ...
    def test_medical_research_dispatch_infers_error_status_from_contradictory_delegate_payloads(
        self,
        mock_wrapper,
    ) -> None:
        class DummyServer:
        ...
        async def _run_flow() -> None:
            with patch.dict(
                ...
                pubmed = self._assert_dispatch_success_envelope(
                    await dispatch(
                ...
                self.assertEqual(pubmed.get("error"), "delegate failure")
