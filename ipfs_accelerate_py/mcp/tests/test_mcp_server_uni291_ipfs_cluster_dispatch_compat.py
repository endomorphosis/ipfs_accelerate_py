#!/usr/bin/env python3
"""UNI-291 IPFS cluster dispatch compatibility tests for focused parity coverage."""
...
class TestMCPServerUNI291IPFSClusterDispatchCompat(unittest.TestCase):
    ...
    def test_ipfs_cluster_dispatch_infers_error_status_from_contradictory_delegate_payloads(self, mock_wrapper) -> None:
        class DummyServer:
            def __init__(self):
                self.tools = {}
                self.mcp = None
        ...
        async def _run_flow() -> None:
            with patch.dict(
                ...
                server = create_mcp_server(name="ipfs-cluster-dispatch-compat-errors")
