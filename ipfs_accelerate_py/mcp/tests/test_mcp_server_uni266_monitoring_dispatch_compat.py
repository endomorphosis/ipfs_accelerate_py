#!/usr/bin/env python3
"""UNI-266 monitoring dispatch compatibility tests for focused parity coverage."""
...
class TestMCPServerUNI266MonitoringDispatchCompat(unittest.TestCase):
    ...
    def test_monitoring_dispatch_infers_error_status_from_contradictory_delegate_payloads(
        self,
        mock_wrapper,
    ) -> None:
        class DummyServer:
        ...
        async def _run_flow() -> None:
            with patch.dict(
                ...
                server = create_mcp_server(name="monitoring-dispatch-compat-errors")
