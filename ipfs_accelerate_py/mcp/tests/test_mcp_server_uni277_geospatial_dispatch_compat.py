#!/usr/bin/env python3
"""UNI-277 geospatial dispatch compatibility tests for focused parity coverage."""
...
class TestMCPServerUNI277GeospatialDispatchCompat(unittest.TestCase):
    ...
    def test_geospatial_dispatch_infers_error_status_from_contradictory_delegate_payloads(
        self,
        mock_wrapper,
    ) -> None:
        class DummyServer:
