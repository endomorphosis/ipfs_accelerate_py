...
def register_tools(mcp: Any) -> None:
    ...
    @mcp.tool()
    def gh_list_runners(repo: Optional[str] = None, org: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "error": str(e), "runners": []}

    @mcp.tool()
    def gh_create_workflow_queues(
        owner: Optional[str] = None, since_days: int = 1, filter_by_arch: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "error": str(e), "queues": {}}
    ...
    def gh_list_workflow_runs(
        repo: str, status: Optional[str] = None, limit: int = 20, branch: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            runs = workflow_mgr.list_workflow_runs(
                repo=repo, status=status, limit=limit, branch=branch, use_cache=True
            )
