...
def register_shared_tools(mcp: FastMCP) -> None:
    ...
    @mcp.tool()
    def generate_text(
        prompt: str, model: str = "gpt2", max_length: int = 100, temperature: float = 0.7
    ) -> Dict[str, Any]:
        """
        ...
        try:
            result = inference_ops.run_text_generation(
                model=model, prompt=prompt, max_length=max_length, temperature=temperature
            )
    ...
    @mcp.tool()
    def classify_text(
        text: str, model: str = "distilbert-base-uncased-finetuned-sst-2-english"
    ) -> Dict[str, Any]:
        """
        ...
        """
        try:
            result = inference_ops.run_text_classification(model=model, text=text)
    ...
    def list_available_models() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "tool": "list_available_models", "timestamp": time.time()}

    # Add the specific tools that the JavaScript dashboard expects
    @mcp.tool()
    def run_inference(
        prompt: str, max_length: int = 100, temperature: float = 0.7, model: str = "gpt2"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "generated_text": result.get(
                    "generated_text", result.get("result", "Generated text would appear here")
                ),
                "model": model,
    ...
    @mcp.tool()
    def add_file(content: str, filename: str = "untitled.txt") -> Dict[str, Any]:
        """
    ...
    @mcp.tool()
    def run_model_test(
        test_type: str, test_name: str, model_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def check_network_status() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "tool": "check_network_status", "timestamp": time.time()}
    ...
    def get_connected_peers() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "tool": "get_connected_peers", "timestamp": time.time()}
    ...
    def get_system_status() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "tool": "get_system_status", "timestamp": time.time()}
    ...
    def get_queue_status() -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error in get_queue_status: {e}")
            return {"error": str(e), "tool": "get_queue_status", "timestamp": time.time()}
    ...
    def get_queue_history() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "tool": "get_queue_history", "timestamp": time.time()}
        ...
        try:
            ...
            for endpoint_id, endpoint in matching_endpoints.items():
                handlers[endpoint_id] = {
                    ...
                    "device_info": endpoint.get(
                        "device", endpoint.get("peer_id", endpoint.get("provider", "unknown"))
                    ),
                }
