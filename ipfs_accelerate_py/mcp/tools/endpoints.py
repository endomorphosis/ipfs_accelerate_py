...
def register_tools(mcp):
    ...
    @mcp.tool()
    def add_endpoint(
        model: str, device: str = "cpu", max_batch_size: int = 16, description: str = ""
    ) -> Dict[str, Any]:
        """
        Add a new endpoint
        ...
        try:
            ...
            return {"error": f"Error adding endpoint: {str(e)}"}
    ...
    def remove_endpoint(endpoint_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": f"Error removing endpoint: {str(e)}"}
        ...
        try:
            ...
            if status is not None:
                if status not in ["active", "inactive"]:
                    return {"error": f"Invalid status: {status}. Must be 'active' or 'inactive'."}
            ...
            return {"error": f"Error updating endpoint: {str(e)}"}
    ...
    def get_endpoint(endpoint_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": f"Error getting endpoint: {str(e)}"}
    ...
    def log_request(
        ...
        try:
            ...
            logger.info(
                f"Logged request to endpoint {endpoint_id}: {inputs_processed} inputs processed in {processing_time:.3f}s"
            )
            ...
            return {"error": f"Error logging request: {str(e)}"}
