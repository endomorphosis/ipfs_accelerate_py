...
class MockIPFSClient:
    ...
    def add_file(self, path: str, wrap_with_directory: bool = False) -> Dict[str, Any]:
        ...
        return {"Hash": cid, "Size": file_size, "Name": file_name}
    ...
    def ls(self, cid: str) -> Dict[str, Any]:
        ...
        return {"Objects": [{"Hash": cid, "Links": mock_entries}]}
    ...
    def files_stat(self, path: str) -> Dict[str, Any]:
        ...
        if path.startswith("/ipfs/"):
            ...
            return {"Hash": cid, "Size": 1024, "CumulativeSize": 1024, "Blocks": 1, "Type": "file"}
    ...
    def pin_add(self, cid: str, recursive: bool = True) -> Dict[str, Any]:
        ...
        self.pins[cid] = {"type": "recursive" if recursive else "direct", "pinned_at": time.time()}
    ...
    def pin_ls(self, cid: str = None) -> Dict[str, Any]:
        ...
        if cid is not None:
            ...
            return {"Keys": {cid: {"Type": self.pins[cid]["type"]}}}
    ...
    def id(self) -> Dict[str, Any]:
        ...
        return {
            "ID": "Qm"
            + "".join(random.choice(string.ascii_lowercase + string.digits) for _ in range(44)),
            "PublicKey": "",
            "Addresses": ["/ip4/127.0.0.1/tcp/4001", "/ip4/192.168.1.100/tcp/4001"],
    ...
    def swarm_connect(self, addr: str) -> Dict[str, Any]:
        ...
        return {"Strings": [f"Connection success: {addr}"]}
