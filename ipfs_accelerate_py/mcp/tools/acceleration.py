...
def register_acceleration_tools(mcp: FastMCP) -> None:
    ...
    async def ipfs_get_hardware_info(ctx: Context) -> Dict[str, Any]:
        ...
        try:
            if hardware_detection_available:
                ...
                await ctx.info(
                    "Using simulated hardware information (hardware_detection not available)"
                )
                return {
                    "gpu": {
                        "devices": [
    ...
    async def ipfs_accelerate_model(cid: str, ctx: Context, device: str = "auto") -> Dict[str, Any]:
        ...
        try:
            ...
            return {"cid": cid, "accelerated": False, "error": str(e)}

    @mcp.tool()
    async def ipfs_benchmark_model(
        cid: str, ctx: Context, device: str = "auto", iterations: int = 5
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"cid": cid, "success": False, "error": str(e)}
    ...
    async def ipfs_model_status(cid: str, ctx: Context) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                if model_exists and "stat_result" in locals()
                else 0,
            ...
            return {"cid": cid, "exists": False, "error": str(e)}
