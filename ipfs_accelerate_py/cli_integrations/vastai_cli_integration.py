...
class VastAICLIIntegration(BaseCLIWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(cli_path=vastai_path, cache=cache, enable_cache=enable_cache, **kwargs)

    def get_tool_name(self) -> str:
        return "Vast AI CLI"

    def search_offers(self, query: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        """
        ...
        return self._run_command_with_retry(args, "search_offers", query=query or "all")
    ...
    def show_instances(self, **kwargs) -> Dict[str, Any]:
        ...
        return self._run_command_with_retry(args, "show_instances")

    def show_instance(self, instance_id: str, **kwargs) -> Dict[str, Any]:
        """
        ...
        return self._run_command_with_retry(args, "show_instance", instance_id=instance_id)
