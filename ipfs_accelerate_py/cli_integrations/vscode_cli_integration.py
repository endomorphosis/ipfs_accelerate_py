...
class VSCodeCLIIntegration(BaseCLIWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(cli_path=code_path, cache=cache, enable_cache=enable_cache, **kwargs)
    ...
    def list_extensions(self, **kwargs) -> Dict[str, Any]:
        ...
        return self._run_command_with_retry(args, "extension_list")

    def search_extensions(self, query: str, **kwargs) -> Dict[str, Any]:
        """
        ...
        return self._run_command_with_retry(args, "extension_search", query=query)
