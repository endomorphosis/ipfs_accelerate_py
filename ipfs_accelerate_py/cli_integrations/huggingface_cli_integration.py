...
class HuggingFaceCLIIntegration(BaseCLIWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(cli_path=hf_path, cache=cache, enable_cache=enable_cache, **kwargs)

    def get_tool_name(self) -> str:
        return "HuggingFace CLI"

    def list_models(
        self, search: Optional[str] = None, limit: int = 20, **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        return self._run_command_with_retry(args, "search_models", search=search or "", limit=limit)

    def model_info(self, model_id: str, **kwargs) -> Dict[str, Any]:
        """
        ...
        return self._run_command_with_retry(args, "model_info", model=model_id)
    ...
    def list_datasets(
        ...
        return self._run_command_with_retry(
            args, "search_datasets", search=search or "", limit=limit
        )
    ...
    def download_model(self, model_id: str, **kwargs) -> Dict[str, Any]:
        ...
        return self._run_command_with_retry(args, "download_model", model=model_id)
