...
class CachedHFTEIAPI:
    ...
    def embed(
        self, texts: List[str], model: Optional[str] = None, use_cache: bool = True, **kwargs
    ) -> Any:
        """
...
class CachedOVMSAPI:
    ...
    def infer(
        self, inputs: Any, model: Optional[str] = None, use_cache: bool = True, **kwargs
    ) -> Any:
        """
        ...
        # Cache response
        self._cache.cache_completion(
            prompt=input_str, response=response, model=model_name, temperature=0.0, **kwargs
        )
...
class CachedOPEAAPI:
    ...
    def run_pipeline(self, inputs: Any, pipeline: str, use_cache: bool = True, **kwargs) -> Any:
        """
        ...
        # Check cache
        cached = self._cache.get_completion(
            prompt=input_str, model=pipeline, temperature=0.0, **kwargs
        )
        ...
        # Cache response
        self._cache.cache_completion(
            prompt=input_str, response=response, model=pipeline, temperature=0.0, **kwargs
        )
