...
class CachedS3API:
    ...
    def list_objects(self, bucket: str, prefix: str = "", use_cache: bool = True, **kwargs) -> Any:
        """
    ...
    def head_object(self, bucket: str, key: str, use_cache: bool = True, **kwargs) -> Any:
        """
    ...
    def get_object_url(
        self, bucket: str, key: str, expires_in: int = 3600, use_cache: bool = True, **kwargs
    ) -> str:
        """
        ...
        cached = self._cache.get(
            "get_object_url", bucket=bucket, key=key, expires_in=expires_in, **kwargs
        )
        ...
        cache_ttl = min(
            expires_in - 60, 3600
        )  # Cache for expiration - 60s or 1 hour, whichever is less
        self._cache.put(
            "get_object_url",
            url,
            ttl=cache_ttl,
