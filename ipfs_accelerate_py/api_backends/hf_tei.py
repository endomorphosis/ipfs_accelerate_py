...
class hf_tei(BaseAPIBackend):
    ...
    def make_post_request_hf_tei(
        self, endpoint_url, data, api_token=None, request_id=None, endpoint_id=None
    ):
    ...
    def run_inference(
        self, model_id, text=None, texts=None, request_id=None, endpoint_id=None, **kwargs
    ):
    ...
    def create_remote_text_embedding_endpoint_handler(
