...
class hf_tgi(BaseAPIBackend):
    ...
    def make_post_request_hf_tgi(
        self, endpoint_url, data, api_token=None, stream=False, request_id=None, endpoint_id=None
    ):
            ...
            while True:
                try:
                    response = requests.post(
                        endpoint_url, json=data, headers=headers, timeout=60, stream=stream
                    )
    ...
    def generate_text(
        self, model_id, inputs, parameters=None, api_token=None, request_id=None, endpoint_id=None
    ):
    ...
    def run_inference(
        self, model_id, inputs, parameters=None, priority=None, request_id=None, endpoint_id=None
    ):
    ...
    def stream_generate(
        ...
        # Prepare data
        data = {"inputs": inputs, "stream": True}
        if parameters:
            data["parameters"] = parameters
    ...
    def stream_chat(self, model, messages, options=None, request_id=None, endpoint_id=None):
        ...
        for chunk in response_stream:
            if isinstance(chunk, dict) and "token" in chunk:
                ...
                result = {"text": text, "done": done, "model": model}
                ...
                text = str(chunk)
                result = {"text": text, "done": False, "model": model}
    ...
    def create_remote_text_generation_endpoint_handler(
        self, endpoint_url=None, api_key=None, endpoint_id=None
    ):
    ...
    def test_hf_tgi_endpoint(
        self, endpoint_url=None, api_token=None, model_id=None, endpoint_id=None, request_id=None
    ):
