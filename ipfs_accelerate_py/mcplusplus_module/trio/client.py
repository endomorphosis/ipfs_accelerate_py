...
class TrioMCPClient:
    ...
    def __init__(self, server_url: str, config: Optional[ClientConfig] = None, **kwargs):
...
async def call_tool(
    server_url: str, tool_name: str, arguments: Optional[Dict[str, Any]] = None, **config_kwargs
) -> Dict[str, Any]:
