...
class StorageWrapper:
        ...
        if self._use_distributed:
            try:
                ...
                self._storage = get_storage(
                    enable_ipfs_kit=True, cache_dir=cache_dir, force_fallback=False
                )
    ...
    def write_file(
        self, data: Union[bytes, str], filename: Optional[str] = None, pin: bool = False
    ) -> str:
        """
    ...
    def _write_file_local(self, data: Union[bytes, str], filename: Optional[str]) -> str:
