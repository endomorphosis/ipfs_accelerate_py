"""Planning proof obligations using existing logic (EAAEF-072).

This accelerator-owned file records the obligation surface. The datasets-owned
module lives at ipfs_datasets_py/logic/external_work_plan_obligations.py for
the board's datasets repository path.
"""
...
OBLIGATION_SCHEMA: Final[str] = (
    "ipfs_accelerate_py/agent-supervisor/external-work-plan-obligations@1"
)
