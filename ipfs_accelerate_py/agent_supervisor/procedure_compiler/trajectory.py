...
P0 contract helpers continue to validate already-normalized wire artifacts.
PCPC-009 adds :class:`TrajectoryNormalizer` and
:class:`TrajectoryAdmissionPolicy` for admission-controlled source episodes;
raw or unadmitted historical material is never treated as a trajectory.
"""
