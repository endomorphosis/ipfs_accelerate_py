...
def resolve_reviewer_local_profile_state(
    *,
    ...
    board-scoped directories. Route authorization names the reviewer DID; the
    signed DID registry is the only locator that may select that directory.
    The default profile directory is never consulted.
    """
    ...
    if (
        ...
        or (expected_profile_id and profile.profile_id != expected_profile_id)
        or (
    ...
    if (
        ...
        raise LocalProfileTampered("reviewer local profile state paths drifted")
