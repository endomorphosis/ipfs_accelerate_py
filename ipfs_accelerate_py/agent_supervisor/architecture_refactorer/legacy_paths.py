...
CURRENT_LEGACY_BINDINGS: tuple[LegacySourceBinding, ...] = (
    LegacySourceBinding(
        ...
        path="ipfs_accelerate_py/compatibility/simulation/legacy_mock_coordinator.py",
        nominated_symbol="MockWorker",
        origin_taint=OriginTaint.MOCK,
        reachability=ReachabilityDisposition.COMPATIBILITY_ONLY,
        source_path="ipfs_accelerate_py/compatibility/simulation/legacy_mock_coordinator.py",
        start_line=37,
        end_line=37,
        uncertainty="quarantined_simulation_namespace_not_ordinary_runtime",
    ),
    LegacySourceBinding(
    ...
    LegacySourceBinding(
        ...
        path="ipfs_accelerate_py/compatibility/simulation/fabricated_hardware.py",
        nominated_symbol="MockHardwareDetection",
        origin_taint=OriginTaint.SIMULATION,
        reachability=ReachabilityDisposition.COMPATIBILITY_ONLY,
        source_path="ipfs_accelerate_py/compatibility/simulation/fabricated_hardware.py",
        start_line=105,
        end_line=105,
        uncertainty="quarantined_mock_hardware_detection_is_not_a_live_probe",
    ),
    LegacySourceBinding(
        path_id="cuda-mock-impl",
        kind=PathKind.SIMULATED_HARDWARE,
        path="ipfs_accelerate_py/compatibility/simulation/fabricated_hardware.py",
        nominated_symbol="create_simulated_cuda_implementation",
        origin_taint=OriginTaint.SIMULATION,
        reachability=ReachabilityDisposition.COMPATIBILITY_ONLY,
        source_path="ipfs_accelerate_py/compatibility/simulation/fabricated_hardware.py",
        start_line=233,
    ...
    LegacySourceBinding(
        ...
        start_line=502,
        end_line=502,
        uncertainty="canonical_cidv1_replaces_synthetic_bafy_cache_keys",
    ),
    LegacySourceBinding(
        path_id="mock-ipfs-random-cid",
        kind=PathKind.FAKE_OR_COMPATIBILITY_CIDS,
        path="ipfs_accelerate_py/compatibility/simulation/pseudo_cid.py",
        nominated_symbol="random_cid",
        origin_taint=OriginTaint.SIMULATION,
        reachability=ReachabilityDisposition.COMPATIBILITY_ONLY,
        source_path="ipfs_accelerate_py/compatibility/simulation/pseudo_cid.py",
        start_line=168,
        end_line=168,
        uncertainty="quarantined_random_qm_cid_requires_explicit_simulation_and_canonical_bytes",
    ),
    LegacySourceBinding(
        ...
        start_line=20,
        end_line=20,
        uncertainty="dynamic_import_of_quarantined_simulation_mock_client",
    ),
    LegacySourceBinding(
    ...
    LegacySourceBinding(
        ...
        start_line=13,
        end_line=13,
        uncertainty="quarantined_requires_explicit_simulation_not_ordinary_runtime",
    ),
    LegacySourceBinding(
