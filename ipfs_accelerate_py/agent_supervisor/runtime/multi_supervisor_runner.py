...
_ORDERED_FALLBACK_REASONING_EFFORTS = frozenset({"medium", "high"})
...
def seal_ordered_implementation_provider_route(
    ...
    for name, value in observed.items():
        ...
        if (
            ...
            and value in _ORDERED_FALLBACK_REASONING_EFFORTS
        ):
            continue
        if value != expected:
    ...
    if incompatible:
        ...
        raise ValueError(
            ...
            "grok_cli/grok-4.5 -> codex/gpt-5.6-terra at an admitted "
