...
def load_datasets_authoritative_operational_base_catalog() -> MigrationCatalog:
    """Return the published operational v1 base for separately versioned profiles.

    EAAEF@2 and ordinary operational hash@2 have different published version-2
    identities. They share this exact base, not each other's extension history.
    """
...
def load_datasets_authoritative_operational_catalog() -> MigrationCatalog:
    ...
    return MigrationCatalog.from_migrations((*base.migrations, hash_observations))
