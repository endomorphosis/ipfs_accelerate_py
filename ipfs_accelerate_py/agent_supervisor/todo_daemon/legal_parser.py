...
def build_legal_parser_spec(repo_root: Optional[str] = None) -> ManagedDaemonSpec:
    ...
    return ManagedDaemonSpec(
        ...
        daemon_process_match_all=("ipfs_accelerate_py.agent_supervisor.todo_daemon.legal_parser_daemon",),
    ...
    *,
    ...
    for pid, args in list(iter_processes()):
        ...
        if "run_legal_parser_optimizer_daemon.sh" in args or (
            "ipfs_accelerate_py.agent_supervisor.todo_daemon.legal_parser_daemon" in args
        ):
...
def run_legal_parser_daemon_runtime(argv: Optional[Sequence[str]] = None) -> int:
    ...
    from ipfs_accelerate_py.agent_supervisor.todo_daemon.legal_parser_daemon import main as runtime_main
