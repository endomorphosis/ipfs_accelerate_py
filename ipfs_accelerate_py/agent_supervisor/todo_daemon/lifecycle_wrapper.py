...
class LifecycleWrapperSpec:
    ...
    pythonpath_expr: str
    module: str = "ipfs_accelerate_py.agent_supervisor.todo_daemon"
    ...
    return (
        ...
        LifecycleWrapperScriptSpec(
            ...
            wrapper=LifecycleWrapperSpec(
                ...
                compatibility_markers=(
                    "Compatibility markers for older tests/docs that inspected this shell body.",
                    "The implementation now lives in ipfs_accelerate_py.agent_supervisor.todo_daemon.legal_parser.",
