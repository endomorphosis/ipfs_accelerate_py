"""PCPR-031 hardware capability ladder.
...
This module does not qualify live CUDA, CPU execution, or a closed PCPR
release. Full ladder consolidation across remaining detectors is PCPR-034.
"""
...
def assess_ladder(report: Mapping[str, Any]) -> dict[str, Any]:
    ...
    # qualification is PCPR-038 and this evaluator has no live campaign.
    return {
        "production_authorized": False,
        "qualified": False,
        "live": False,
        "outcome": "Unavailable",
        "reason": "pcpr_031_does_not_authorize_production",
