...
class ProvenanceLogger:
    ...
    def log_inference(
        self, model_name: str, data: Dict[str, Any], metadata: Optional[Dict[str, Any]] = None
    ) -> Optional[str]:
        """
        ...
        if self.enabled and self.provenance_tracker:
            try:
                ...
                prov_record = self.provenance_tracker.create_record(
                    ...
                    metadata={"model": model_name, **data, **(metadata or {})},
                )
    ...
    def log_worker_execution(
        self, worker_id: str, task_id: str, data: Dict[str, Any]
    ) -> Optional[str]:
        """
        ...
        if self.enabled and self.provenance_tracker:
            try:
                ...
                prov_record = self.provenance_tracker.create_record(
                    ...
                    metadata={"worker_id": worker_id, "task_id": task_id, **data},
                )
                return prov_record.cid
            except Exception:
                pass
    ...
    def log_pr_activity(
        self, pr_number: int, activity_type: str, data: Dict[str, Any]
    ) -> Optional[str]:
        """
        ...
        if self.enabled and self.provenance_tracker:
            try:
                ...
                prov_record = self.provenance_tracker.create_record(
                    ...
                    metadata={"pr_number": pr_number, "activity_type": activity_type, **data},
                )
                return prov_record.cid
            except Exception:
                pass
