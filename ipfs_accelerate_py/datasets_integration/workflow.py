...
class WorkflowCoordinator:
    ...
    def get_next_task(
        self, worker_id: Optional[str] = None, capabilities: Optional[List[str]] = None
    ...
    def complete_task(self, task_id: str, result: Dict[str, Any]) -> bool:
        ...
        completion = {"task_id": task_id, "status": "completed", "result": result}
    ...
    def fail_task(self, task_id: str, error: str) -> bool:
        ...
        failure = {"task_id": task_id, "status": "failed", "error": error}
    ...
    def cancel_task(self, task_id: str) -> bool:
        ...
        if task_found:
            cancellation = {"task_id": task_id, "status": "cancelled"}
