...
def demonstrate_basic_usage():
    ...
    with ModelManager(storage_path="./demo_models.json", use_database=False) as manager:
        ...
        custom_model = ModelMetadata(
            ...
            huggingface_config={
                ...
                "task_specific_params": {
                    "text-classification": {"problem_type": "single_label_classification"}
                },
            },
            ...
            performance_metrics={"accuracy": 0.92, "f1_score": 0.89, "inference_time_ms": 45},
        ...
        gpt2_model.performance_metrics = {"perplexity": 29.2, "inference_time_ms": 120}
        ...
        if gpt2_model.repository_structure:
            ...
            for file_path in example_files:
                ...
                print(
                    f"     * {file_path} (size: {file_info.get('size', 0):,} bytes, hash: {file_info.get('oid', 'unknown')[:8]}...)"
                )
...
def demonstrate_integration():
    ...
    added_count = integration.populate_huggingface_models(popular_models, fetch_configs=False)
