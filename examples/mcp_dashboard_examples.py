...
def list_github_repos(owner):
    ...
    result = call_tool_via_jsonrpc("github_list_repos", {"owner": owner, "limit": 10})
...
def list_docker_containers():
    ...
    result = call_tool_via_jsonrpc("docker_list_containers", {"all": True})
...
def list_ipfs_files(path="/"):
    """List files in IPFS."""
    result = call_tool_via_jsonrpc("ipfs_files_list", {"path": path})
    ...
    batch_request = [
        {
            "jsonrpc": "2.0",
            "method": "tools/call",
            "params": {"name": "hardware_get_info", "arguments": {}},
            "id": 1,
        },
        {
            "jsonrpc": "2.0",
            "method": "tools/call",
            "params": {"name": "network_list_peers", "arguments": {}},
            "id": 2,
        },
        {
            "jsonrpc": "2.0",
            "method": "tools/call",
            "params": {"name": "docker_list_containers", "arguments": {"all": True}},
            "id": 3,
        },
    ]
