#!/usr/bin/env python3
"""
Test file for {model_type_upper} models (speech architecture).

This test verifies the functionality of the {model_type} model for speech recognition or audio tasks.
"""
...
class {test_class_name}(SpeechModelTest):
    ...
    def __init__(self, model_id=None, device=None):
        ...
        self.sampling_rate = {sampling_rate}  # Default sampling rate for this model
