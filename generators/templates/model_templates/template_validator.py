...
def validate_cross_platform_support(content: str) -> Tuple[bool, List[str], List[str]]:
    ...
    if 'detect_available_hardware' in content or 'hardware_detection' in content:
        ...
        # When centralized detection is used, check for specific hardware references
...
def validate_generator_compatibility(template_content: str, generator_type: str) -> Tuple[bool, List[str]]:
    ...
    if generator_type == 'merged':
        ...
        if 'from generators.test_generators.merged_test_generator import' not in template_content and 'import generators.test_generators.merged_test_generator as merged_test_generator' not in template_content:
        ...
        if 'from generators.test_generators.simple_test_generator import' not in template_content and 'import generators.test_generators.simple_test_generator as simple_test_generator' not in template_content:
