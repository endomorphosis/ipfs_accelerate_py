#!/usr/bin/env python3
"""
Test for opt-125m model with hardware platform support
"""
...
class TestOpt125MModels(unittest.TestCase):
    """Test opt-125m model across hardware platforms."""
    
    def setUp(self):
        """Set up test."""
        self.model_id = "opt-125m"
        self.test_text = "This is a test sentence."
        self.test_batch = ["First test sentence.", "Second test sentence."]

    def test_with_cpu(self):
        """Test opt-125m with cpu."""
        # Test initialization
        try:
