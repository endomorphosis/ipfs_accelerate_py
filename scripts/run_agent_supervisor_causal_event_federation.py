...
# read-only validator.  CASF-002..036 likewise have committed outputs and
# declared validators.  CASF-037..043 remain model-routed because their
# declared outputs are not part of the sealed landed tranche.
CASF_DETERMINISTIC_TASK_ALIASES: Final = frozenset(
    f"CASF-{ordinal:03d}" for ordinal in range(37)
)
