...
class ComprehensiveMCPServer:
    ...
    def _perform_inference(self, 
        ...
        try:
            ...
            result = run_inference(task_type, model_id, input_data)
    ...
    def _mock_inference(self, task_type: str, model_id: str, input_data: Any) -> Dict[str, Any]:
        """Ordinary mock inference is typed unavailable, never live success."""
        from ipfs_accelerate_py.compatibility.simulation.fabricated_endpoint_success import (
    ...
    def _generate_mock_result(self, task_type: str, model_id: str, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """PCPR-033: mock demonstration payloads are not live inference results."""
        from ipfs_accelerate_py.compatibility.simulation.fabricated_endpoint_success import (
            ordinary_mock_inference,
        )
