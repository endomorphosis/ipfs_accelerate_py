...
6. `/scripts/generators/templates/template_db.json`
7. `/scripts/generators/templates/README.md`
8. `/scripts/generators/templates/HARDWARE_COMPATIBILITY.md`
9. `/scripts/generators/templates/NEXT_STEPS.md`
...
# Fix template syntax
python fix_template_syntax.py --db-path ../scripts/generators/templates/template_db.json
```