...
- **benchmark_scripts/generators/**: Generators for benchmark code
...
python update_scripts/generators/update_test_generators.py

# 2. Update hardware template system
python update_scripts/generators/update_hardware_template_system.py
