...
from model_selection.filters import TaskFilter, HardwareFilter, SizeFilter, FrameworkFilter
...
class ModelFiltersTest(unittest.TestCase):
    ...
    def test_hardware_filter(self):
        ...
        basic_hw_profile = {"cuda_compute": 6.0, "ram_gb": 16, "gpu_vram_gb": 8}
        ...
        limited_hw_profile = {"cuda_compute": 4.0, "ram_gb": 4, "gpu_vram_gb": 2}
        ...
        very_limited_hw_profile = {"cuda_compute": 2.0, "ram_gb": 2, "gpu_vram_gb": 1}
    ...
    def test_framework_filter(self):
        ...
        non_existent_framework_models = self.framework_filter.filter(
            self.test_models, "non-existent-framework"
        )
...
class ModelSelectorTest(unittest.TestCase):
    ...
    def test_select_model_with_criteria(self):
        ...
        small_gpt2_model = self.selector.select_model("gpt2", task="text-completion", max_size=600)
        ...
        complex_bert_model = self.selector.select_model(
            "bert", task="sequence-classification", framework="pt", max_size=500
        )
        ...
        impossible_bert_model = self.selector.select_model(
            "bert", task="non-existent-task", framework="non-existent-framework", max_size=100
        )
