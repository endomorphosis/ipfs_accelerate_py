...
class HardwareDetectorTest(unittest.TestCase):
    ...
    def test_rocm_detector(self):
        ...
        with (
            patch("torch.version", spec=["hip"], hip=None),
...
class HardwareDetectionManagerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_rocm_detector.detect.return_value = {"available": False}

        self.mock_mps_detector = Mock()
        self.mock_mps_detector.detect.return_value = {"available": False}
...
class HardwareRecommendationTest(unittest.TestCase):
    ...
    def setup_mock_detectors(self):
        ...
        mock_rocm_detector.detect.return_value = {"available": False}

        # MPS detector
        mock_mps_detector = Mock()
        mock_mps_detector.detect.return_value = {"available": False}
        ...
        mock_webnn_detector.detect.return_value = {"available": False}

        # WebGPU detector
        mock_webgpu_detector = Mock()
        mock_webgpu_detector.detect.return_value = {"available": False}
    ...
    def test_get_recommended_device(self):
        ...
        try:
            ...
            self.manager.select_device = lambda model_info=None: self._mock_select_device(
                model_info
            )
