...
class DependencyManager:
    ...
    def _check_generic(self, dependency: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "mocked": False, "version": version}
        except ImportError:
            return {"available": False, "mocked": False, "error": "Import failed"}
        except Exception as e:
            return {"available": False, "mocked": False, "error": str(e)}
    ...
    def check_transformers(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "mocked": False, "version": transformers.__version__}
        except ImportError:
            return {"available": False, "mocked": False, "error": "Import failed"}
        except Exception as e:
            return {"available": False, "mocked": False, "error": str(e)}
    ...
    def check_tokenizers(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "mocked": False, "version": tokenizers.__version__}
        except ImportError:
            return {"available": False, "mocked": False, "error": "Import failed"}
        except Exception as e:
            return {"available": False, "mocked": False, "error": str(e)}
    ...
    def check_sentencepiece(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"available": True, "mocked": False, "version": sentencepiece.__version__}
        except ImportError:
            return {"available": False, "mocked": False, "error": "Import failed"}
        except Exception as e:
            return {"available": False, "mocked": False, "error": str(e)}
