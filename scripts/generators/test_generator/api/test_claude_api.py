...
class TestClaudeAPI(ModelTest):
    ...
    def test_api_endpoint_configuration(self):
        ...
        self.assertTrue(
            instance.endpoint.startswith("http"),
            f"Endpoint should start with http: {instance.endpoint}",
        )
    ...
    def test_basic_class_method(self):
        ...
        # Call method
        result = self.claude_instance_mock.completion(prompt="Hello, Claude!", max_tokens=100)
