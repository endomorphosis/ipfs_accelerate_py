    ...
    def test_pipeline_api(self):
        ...
        try:
            ...
            pipeline = transformers.pipeline(
                "image-to-text", model=self.model_id, device=self.device
            )
            ...
            pipeline_input = {"image": image, "text": prompt}
    ...
    def test_multiple_prompts(self):
        ...
        try:
            ...
            for prompt in self.test_prompts:
                ...
                prompt_results[prompt] = {"response": output_text, "inference_time": inference_time}
    ...
    def test_hardware_compatibility(self):
        ...
        for device in devices_to_test:
            ...
            try:
                ...
                self.assertTrue(
                    len(output_text) > 0, f"Model output on {device} should not be empty"
                )
