...
├── scripts/generators/              # Test generation components
...
The architecture detector (`scripts/generators/architecture_detector.py`) provides:
...
The test generator (`scripts/generators/test_generator.py`) offers:
