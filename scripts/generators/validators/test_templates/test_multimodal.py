...
class Testclipvitbasepatch32:
    ...
    def test_basic_inference(self):
        ...
        try:
            # Prepare input
            # Prepare multimodal input (text and image)
            ...
            if hasattr(outputs, "last_hidden_state"):
                ...
                logger.info(
                    f"Output keys: {outputs.keys() if hasattr(outputs, 'keys') else 'No keys'}"
                )
