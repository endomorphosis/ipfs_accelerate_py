...
def validate_generator_compatibility(template_content: str, generator_type: str) -> Tuple[bool, List[str]]:
    ...
    if generator_type == 'merged':
        ...
        if 'from scripts.generators.test_generators.merged_test_generator import' not in template_content and 'import scripts.generators.test_generators.merged_test_generator as merged_test_generator' not in template_content:
        ...
        if 'from scripts.generators.test_generators.simple_test_generator import' not in template_content and 'import scripts.generators.test_generators.simple_test_generator as simple_test_generator' not in template_content:
