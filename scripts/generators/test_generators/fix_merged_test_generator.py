...
def fix_import_templates(file_path):
    ...
    if "import scripts.generators.templates.template_database as template_database as db" not in content and "from hardware_test_templates import scripts.generators.templates.template_database as template_database" not in content:
