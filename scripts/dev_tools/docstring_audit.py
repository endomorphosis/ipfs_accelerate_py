...
def main():
    ...
    print(
        f"Files with module docstrings: {len(python_files) - files_without_module_docstring}/{len(python_files)}"
    )
    ...
    if total_functions > 0:
        print(
            f"Function documentation rate: {total_functions_documented / total_functions * 100:.1f}%"
        )
            ...
            json.dump(
                {
                    "summary": {
                        ...
                        "files_with_module_docstrings": len(python_files)
