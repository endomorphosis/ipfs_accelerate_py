...
def print_stats(cache):
    ...
    if stats["p2p_enabled"]:
        ...
        if connected_peers > 0:
            ...
            peer_hit_rate = (
                stats["peer_hits"] / stats["total_requests"] * 100
    ...
    if stats["total_requests"] > 0:
        ...
        api_reduction = (
            stats["api_calls_saved"] / (stats["api_calls_saved"] + stats["misses"]) * 100
            if (stats["api_calls_saved"] + stats["misses"]) > 0
            else 0
        )
...
def main():
    ...
    parser.add_argument(
        "--interval", type=int, default=10, help="Update interval in seconds (default: 10)"
    )
