...
* ``bootstrap`` verifies the canonical run-v17 recovery and publishes one
  no-overwrite run-v20 database clone with a provenance receipt;
...
SUCCESSOR_RUN_RELATIVE: Final = PROGRAM_ROOT_RELATIVE / "run-v20"
...
def clone_verified_successor(
    ...
    *,
    ...
    # cloning; a hidden .run-v20.* stage would otherwise appear as untracked
    ...
    try:
        ...
        while True:
            ...
            while view:
                ...
                if written <= 0:
                    raise SuccessorOperatorError("run-v20 clone write made no progress")
                view = view[written:]
        ...
        if (
            ...
            raise SuccessorOperatorError("run-v20 clone differs from verified run-v17")
        ...
        receipt = {
            ...
            "issued_at": _utc_now(),
            "source_generation": "lgcvf-run-v17",
            "target_generation": "lgcvf-run-v20",
...
def _require_ignored_successor(root: Path) -> None:
    ...
    for relative, noun in (
        (SUCCESSOR_DATABASE_RELATIVE, "run-v20 successor Git-ignore policy"),
        (stage_lock, "run-v20 staging Git-ignore policy"),
    ):
        _git_quiet(
            root,
...
def _load_provenance(paths: Mapping[str, Path], *, root: Path = ROOT) -> dict[str, Any]:
    ...
    if admission_mode == "canonical_fresh_generation_recovery":
        ...
        if (
            ...
            or receipt.get("target_generation") != "lgcvf-run-v20"
...
def _validate_successor_board(
    ...
    *,
    ...
    if (
        ...
        or program.store_generation != "lgcvf-run-v20"
    ...
    *,
    ...
    try:
        ...
        extension_environment = {
            ...
            STORE_GENERATION_ENV: "lgcvf-run-v20",
        }
