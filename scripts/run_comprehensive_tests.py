...
def test_hf_hub_cache():
    ...
    model_data = {"modelId": "bert-base-uncased", "author": "google", "downloads": 1000000}
...
def test_hugs_cache():
    ...
    model_data = {"id": "bert-base-uncased", "downloads": 1000000, "likes": 500}
