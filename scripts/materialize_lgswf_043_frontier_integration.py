...
PAIRS = (
    ("scripts/lgswf_payloads/frontier_integration.py",
     "ipfs_accelerate_py/agent_supervisor/planning/frontier_integration.py"),
    ("scripts/lgswf_payloads/test_agent_supervisor_frontier_acceptance.py",
     "test/api/test_agent_supervisor_frontier_acceptance.py"),
)
